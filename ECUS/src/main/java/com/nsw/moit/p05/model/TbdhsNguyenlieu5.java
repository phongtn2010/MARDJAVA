...
public class TbdhsNguyenlieu5 {
    ...
    private String fiDangkyNhapkhauNamx1;
    //@Size(max = 250)
    //@Column(name = "FI_SOLUONG_CAP_X1")
    private String fiSoluongCapX1;
    //@Size(max = 250)
    //@Column(name = "FI_UOC_THUCHIEN_X1")
    private String fiUocThuchienX1;
    //@Size(max = 250)
    //@Column(name = "FI_DANGKY_NHAPKHAU_NAMX")
    private String fiDangkyNhapkhauNamx;
    ...
    public String getFiDangkyNhapkhauNamx1() {
        return fiDangkyNhapkhauNamx1;
    }

    public void setFiDangkyNhapkhauNamx1(String fiDangkyNhapkhauNamx1) {
        this.fiDangkyNhapkhauNamx1 = fiDangkyNhapkhauNamx1;
    }

    public String getFiSoluongCapX1() {
        return fiSoluongCapX1;
    }

    public void setFiSoluongCapX1(String fiSoluongCapX1) {
        this.fiSoluongCapX1 = fiSoluongCapX1;
    }

    public String getFiUocThuchienX1() {
        return fiUocThuchienX1;
    }

    public void setFiUocThuchienX1(String fiUocThuchienX1) {
        this.fiUocThuchienX1 = fiUocThuchienX1;
    }

    public String getFiDangkyNhapkhauNamx() {
        return fiDangkyNhapkhauNamx;
    }

    public void setFiDangkyNhapkhauNamx(String fiDangkyNhapkhauNamx) {
