...
public class TbdHoSo7DTO {
	...
	public String toString() {
		return "HoSo7Model [idHoSo=" + idHoSo + ", maHoSo=" + maHoSo + ", tenDoanhNghiep=" + tenDoanhNghiep + ", trangThai=" + trangThai + ", ngayNop=" + ngayNop + ", ngayCapGiayPhep=" + ngayCapGiayPhep + ", maSoGP=" + maSoGP + ", tenTrangThai=" + tenTrangThai + "]";
	}
}
