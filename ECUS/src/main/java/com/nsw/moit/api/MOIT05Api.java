...
@RestController
@RequestMapping("/moit/05")
public class MOIT05Api extends BaseApi {

    static final String TAG = "MOIT05Api";
    ...
    ResponseJson getCategory(
        ...
        try {
            switch (key) {
                case MOIT05Constant.DANHMUC.DM_TRANGTHAI:
                    json = BackendRequestHelper.getInstance().doGetRequest(MOIT05Constant.getInstance().getApiUrl(environment, MOIT05Constant.API.DANHMUC_TRANGTHAI));
                    break;
                case MOIT05Constant.DANHMUC.DM_LOAIFILE:
                    json = BackendRequestHelper.getInstance().doGetRequest(MOIT05Constant.getInstance().getApiUrl(environment, MOIT05Constant.API.DANHMUC_LOAIFILE) + id);
                    break;
                case MOIT05Constant.DANHMUC.DM_LOAINGUYENLIEU:
                    json = BackendRequestHelper.getInstance().doGetRequest(MOIT05Constant.getInstance().getApiUrl(environment, MOIT05Constant.API.DANHMUC_LOAINGUYENLIEU));
                    break;
                case MOIT05Constant.DANHMUC.DM_TENNGUYENLIEU:
                    json = BackendRequestHelper.getInstance().doGetRequest(MOIT05Constant.getInstance().getApiUrl(environment, MOIT05Constant.API.DANHMUC_TENNGUYENLIEU));
                    break;
                default:
                    break;
            }
...
//            filter.setNguoiTao(getUsername());
            ResponseJson json = BackendRequestHelper.getInstance().doPostRequest(MOIT05Constant.getInstance().getApiUrl(environment, MOIT05Constant.API.HOSO_SEARCH), filter);
            return json;
        } catch (Exception ex) {
            LogUtil.addLog(ex);
            String errorInfo = AppConstant.APP_NAME + AppConstant.MESSAGE_SEPARATOR + TAG + AppConstant.MESSAGE_SEPARATOR + Thread.currentThread().getStackTrace()[1].getMethodName() + AppConstant.MESSAGE_SEPARATOR + ex.toString();
...
//        ResponseJson json = BackendRequestHelper.getInstance().doGetRequest(MOIT05Constant.getInstance().getApiUrl(environment, MOIT05Constant.API.HOSO_OWNER) + fiHoso + "/" + getUsername());
...
//        ResponseJson json = BackendRequestHelper.getInstance().doPostRequest(MOIT05Constant.getInstance().getApiUrl(environment, MOIT05Constant.API.HOSO_DELETE) + "/" + fiIdHoso, map);
//        return json;
//    }
    ...
    ResponseJson lichSuXuLyHoSo(
        ...
        try {
            ...
            json = BackendRequestHelper.getInstance().doPostRequest(MOIT05Constant.getInstance().getApiUrl(environment, MOIT05Constant.API.LICHSU_SEARCH), filterForm);
...
//            @RequestBody SendMessage05 message
//    ) {
//        ResponseJson json = new ResponseJson();
//        json.setSuccess(false);
//        try {
...
//                return json;
//            }
//            message.setType(MOIT05Constant.MSG_TYPE.TYPE_15);
//            ResponseJson hosoJson = BackendRequestHelper.getInstance().doGetRequest(MOIT05Constant.getInstance().getApiUrl(environment, MOIT05Constant.API.HOSO_GET_BYID) + message.getFiIdHoso());
...
//                    if (Objects.equals(fiTrangthai, MOIT05Constant.FILE_STATUS.CHO_TIEP_NHAN)
//                            || Objects.equals(fiTrangthai, MOIT05Constant.FILE_STATUS.DA_BO_SUNG_HOSO)
//                            || Objects.equals(fiTrangthai, MOIT05Constant.FILE_STATUS.YC_BO_SUNG)) {
//                        message.setFunction(MOIT05Constant.MSG_FUNC.FUNC_03);
//                    } else {
//                        message.setFunction(MOIT05Constant.MSG_FUNC.FUNC_12);
//                    }
//                    json = BackendRequestHelper.getInstance().doPostRequest(MOIT05Constant.getInstance().getApiUrl(environment, MOIT05Constant.API.HOSO_SEND), message);
//                }
//            }
//
//        } catch (Exception ex) {
...
//    }
    ...
    ResponseJson getHoso(
        ...
        json.setSuccess(false);
        try {
            String url = MOIT05Constant.getInstance().getApiUrl(environment, MOIT05Constant.API.HOSO_GET_BYID);
...
//            }
    ...
    ResponseJson quyetDinhHoSo(
        ...
        json = BackendRequestHelper.getInstance().doGetRequest(MOIT05Constant.getInstance().getApiUrl(environment, MOIT05Constant.API.HOSO_THONGBAO) + filterForm.getFiMaHoso());
        return json;
    }
...
//                tbdHoso.setFiTrangthai(MOIT05Constant.FILE_STATUS.TAO_MOI);
//                tbdHoso.setFiTenTt(MOIT05Constant.FILE_STATUS.TAO_MOI_STR);
//            }
//            json = BackendRequestHelper.getInstance().doPostRequest(MOIT05Constant.getInstance().getApiUrl(environment, MOIT05Constant.API.HOSO_INSERT), tbdHoso);
//
//        } catch (Exception ex) {
//            LogUtil.addLog(ex);
//            String errorInfo = AppConstant.APP_NAME + AppConstant.MESSAGE_SEPARATOR + TAG + AppConstant.MESSAGE_SEPARATOR + Thread.currentThread().getStackTrace()[1].getMethodName() + AppConstant.MESSAGE_SEPARATOR + ex.toString();
...
//            }
//
//            json = BackendRequestHelper.getInstance().doCustomRequest(MOIT05Constant.getInstance().getApiUrl(environment, MOIT05Constant.API.HOSO_UPDATE), HttpMethod.PUT, tbdHoso, new HashMap<>());
//        } catch (Exception ex) {
//            LogUtil.addLog(ex);
//            String errorInfo = AppConstant.APP_NAME + AppConstant.MESSAGE_SEPARATOR + TAG + AppConstant.MESSAGE_SEPARATOR + Thread.currentThread().getStackTrace()[1].getMethodName() + AppConstant.MESSAGE_SEPARATOR + ex.toString();
//            RabbitMQErrorHelper.pushLogToRabbitMQ(errorInfo, getRabbitMQ());
...
//                        MOIT05Constant.getInstance().getApiUrl(environment, MOIT05Constant.API.HOSO_INSERT), tbdHoso);
//            } else {
//                if (!isOwner(fiIdHoso)) {
//                    return json;
//                }
...
//                        MOIT05Constant.getInstance().getApiUrl(environment, MOIT05Constant.API.HOSO_UPDATE), HttpMethod.PUT, tbdHoso, new HashMap<>());
//            }
//
//            if (json.isSuccess()) {
...
//                    SendMessage05 message = new SendMessage05();
//                    message.setType(MOIT05Constant.MSG_TYPE.TYPE_10);
//                    message.setFiIdHoso(fiIdHoso);
//                    message.setLyDo(tbdHoso.getLyDo());
//
//                    if (Objects.equals(fiTrangthai, MOIT05Constant.FILE_STATUS.TAO_MOI)) {
//                        message.setFunction(MOIT05Constant.MSG_FUNC.FUNC_01);
//                    } else if (Objects.equals(fiTrangthai, MOIT05Constant.FILE_STATUS.CHO_TIEP_NHAN)
//                            || Objects.equals(fiTrangthai, MOIT05Constant.FILE_STATUS.DA_BO_SUNG_HOSO)) {
//                        //Doanh nghiep gui cap nhat ho so khi Bo chua tiep nhan
//                        message.setFunction(MOIT05Constant.MSG_FUNC.FUNC_02);
//                    } else if (Objects.equals(fiTrangthai, MOIT05Constant.FILE_STATUS.YC_BO_SUNG)) {
//                        //Doanh nghiep gui bo sung theo yeu cau cua ben Bo
//                        message.setFunction(MOIT05Constant.MSG_FUNC.FUNC_04);
//                    } else {
//                        //Doanh nghiep xin sua ho so
//                        if (null != message.getLyDo() && message.getLyDo().length() > 0) {
//                            message.setType(MOIT05Constant.MSG_TYPE.TYPE_12);
//                            message.setFunction(MOIT05Constant.MSG_FUNC.FUNC_08);
//                        }
//                    }
//                    //Gui ho so
//                    ResponseJson jsonResult = BackendRequestHelper.getInstance().doPostRequest(MOIT05Constant.getInstance().getApiUrl(environment, MOIT05Constant.API.HOSO_SEND), message);
...
//    }
    ...
    ResponseJson kqxlHoso(
        ...
        ResponseJson json = BackendRequestHelper.getInstance().doPostRequest(MOIT05Constant.getInstance().getApiUrl(environment, MOIT05Constant.API.KQXL_SEARCH), message);
        return json;
    }
    ...
    public void downloadFile(HttpServletResponse response,
        ...
        if (principal instanceof UserDetails) {
            try {
                ResponseJson json = BackendRequestHelper.getInstance().doGetRequest(MOIT05Constant.getInstance().getApiUrl(environment, MOIT05Constant.API.DINHKEM_GET_BYID) + id);
                if (json == null || json.getSuccess() == false || json.getData() == null) {
                    return;
                }

                TbdhsDinhkem5 fileInfo = GsonUtils.getInstance().transform(json.getData(), TbdhsDinhkem5.class);
        ...
        if (principal instanceof UserDetails) {
            try {
                if (file.isEmpty()) {
                    ...
                    String uri = getFullUri(environment.getRequiredProperty(MOIT05Constant.API.ATTACHMENT_UPLOAD));
    ...
    private void downloadFile(HttpServletResponse response, String fileCode,
        ...
        if (fileCodeDb.equals(fileCode)) {
            String uri = getFullUri(environment.getProperty(MOIT05Constant.API.ATTACHMENT_DOWNLOAD));
    ...
    String getFullUri(String restUri) {
        return environment.getRequiredProperty(MOIT05Constant.API.BACKEND) + restUri;
    }
}
