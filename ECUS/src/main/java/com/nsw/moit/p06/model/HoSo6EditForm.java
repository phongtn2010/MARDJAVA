...
public class HoSo6EditForm {
	...
	@JsonFormat(pattern = "dd/MM/yyyy")
	private Date ngayCapGiayPhepTCTN;
	public void setNgayCapGiayPhepTCTN(Date ngayCapGiayPhepTCTN) {
		this.ngayCapGiayPhepTCTN = ngayCapGiayPhepTCTN;
	}
	public Date getNgayCapGiayPhepTCTN() {
		return this.ngayCapGiayPhepTCTN;
	}
	...
	private List<TbdCuaKhau6> cuaKhaus = new ArrayList<>();
	private List<TbdTTPT6> phuongTiens = new ArrayList<>();
	private List<TbdDinhKem6> tepDinhKems = new ArrayList<>();
	private List<TbdHangHoa6> hangHoas = new ArrayList<>();
	private List<TbsTienChat6> tienChats = new ArrayList<>();
	
	
	public List<TbsTienChat6> getTienChats() {
		return tienChats;
	}
	public void setTienChats(List<TbsTienChat6> tienChats) {
		this.tienChats = tienChats;
	}
	public List<TbdCuaKhau6> getCuaKhaus() {
		return cuaKhaus;
	}
	public void setCuaKhaus(List<TbdCuaKhau6> cuaKhaus) {
		this.cuaKhaus = cuaKhaus;
	}
	public List<TbdTTPT6> getPhuongTiens() {
		return phuongTiens;
	}
	public void setPhuongTiens(List<TbdTTPT6> phuongTiens) {
		this.phuongTiens = phuongTiens;
	}
	
	
	public List<TbdDinhKem6> getTepDinhKems() {
		return tepDinhKems;
	}
	public void setTepDinhKems(List<TbdDinhKem6> tepDinhKems) {
		this.tepDinhKems = tepDinhKems;
	}

	
	public List<TbdHangHoa6> getHangHoas() {
		return hangHoas;
	}
	public void setHangHoas(List<TbdHangHoa6> hangHoas) {
	...
	private Integer daiDienGioiTinh;
	...
	public Integer getDaiDienGioiTinh() {
		return daiDienGioiTinh;
	}
	public void setDaiDienGioiTinh(Integer daiDienGioiTinh) {
	...
	public String toString() {
		return "HoSo6EditForm [guiHoSo=" + guiHoSo + ", trangThaiHoSo=" + trangThaiHoSo + ", idHoSo=" + idHoSo + ", idHoSoGoc=" + idHoSoGoc + ", maHoSo=" + maHoSo + ", isChinhSua=" + isChinhSua + ", maSoThue=" + maSoThue + ", tenDoanhNghiep=" + tenDoanhNghiep + ", diaChiDoanhNghiep=" + diaChiDoanhNghiep + ", dienThoai=" + dienThoai + ", fax=" + fax + ", email=" + email + ", soGiayChungNhanDKKD=" + soGiayChungNhanDKKD + ", ngayCapGiayChungNhan=" + ngayCapGiayChungNhan + ", loaiHinh=" + loaiHinh + ", diaChiSanXuat=" + diaChiSanXuat + ", soGiayPhepTCTN=" + soGiayPhepTCTN + ", ngayCapGiayPhep=" + ngayCapGiayPhep + ", ngayCapGiayPhepTCTN=" + ngayCapGiayPhepTCTN + ", loaiGiayPhep=" + loaiGiayPhep + ", isTemp=" + isTemp + ", trangThai=" + trangThai + ", nguoiTao=" + nguoiTao + ", lyDoSua="
				+ lyDoSua + ", mucDich=" + mucDich + ", ngaySua=" + ngaySua + ", ngayNop=" + ngayNop + ", xmlContent=" + xmlContent + ", xmlEnvelop=" + xmlEnvelop + ", serialNumber=" + serialNumber + ", isSign=" + isSign + ", xemHoSo=" + xemHoSo + ", ngayTao=" + ngayTao + ", xoaBo=" + xoaBo + ", soGiayPhepDaCap=" + soGiayPhepDaCap + ", lyDoGiaHan=" + lyDoGiaHan + ", cuaKhaus=" + cuaKhaus + ", phuongTiens=" + phuongTiens + ", tepDinhKems=" + tepDinhKems + ", hangHoas=" + hangHoas + ", tienChats=" + tienChats + ", xuatNhapKhauTuNgay=" + xuatNhapKhauTuNgay + ", xuatNhapKhauDenNgay=" + xuatNhapKhauDenNgay + ", soLanThucHien=" + soLanThucHien + ", saveFast=" + saveFast + ", totalFileSize=" + totalFileSize + ", provinces=" + provinces + ", maTinhTP=" + maTinhTP + ", tinhTP=" + tinhTP
				+ ", noiCapGiayChungNhanDKKD=" + noiCapGiayChungNhanDKKD + ", tenNguoiDaiDien=" + tenNguoiDaiDien + ", daiDienChucVu=" + daiDienChucVu + ", daiDienNamSinh=" + daiDienNamSinh + ", daiDienGioiTinh=" + daiDienGioiTinh + ", daiDienDiaChi=" + daiDienDiaChi + "]";
	}
