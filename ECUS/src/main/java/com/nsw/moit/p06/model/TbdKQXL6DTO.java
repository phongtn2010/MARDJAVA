...
public class TbdKQXL6DTO {
	...
	private List<ContentChange6DTO> contentChanges = new ArrayList<>();
	...
	public List<ContentChange6DTO> getContentChanges() {
		return contentChanges;
	}
	public void setContentChanges(List<ContentChange6DTO> contentChanges) {
