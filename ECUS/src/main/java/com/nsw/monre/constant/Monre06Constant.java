 ...
 * @author AnPhucNguyen
 */
public class Monre06Constant {

    static Monre06Constant instance;

    public static Monre06Constant getInstance() {
        synchronized (Monre06Constant.class) {
            return new Monre06Constant();
        }
    }
    @Autowired
    ...
    public interface FileServices {
        ...
        public static final String PROCEDURE = "06";
    }
    ...
    public interface API {
        ...
        //Ho so
        public static final String HOSO_INSERT = "monre.06.tbdhoso06.insert";
        public static final String HOSO_UPDATE = "monre.06.tbdhoso06.update";
        public static final String HOSO_STATUS = "monre.06.tbdhoso06.status";
        public static final String HOSO_SEARCH = "monre.06.tbdhoso06.search";
        public static final String HOSO_DELETE = "monre.06.tbdhoso06.delete";
        public static final String HOSO_OWNER = "monre.06.tbdhoso06.owner";
        public static final String HOSO_SEND = "monre.06.api.hoso.send";
        public static final String HOSO_GET_BYID = "monre.06.tbdhoso06.getbyid";
        public static final String HOSO_GET_BYCODE = "monre.06.tbdhoso06.getbymahoso";
        
        //Lich su
        public static final String LICHSU_SEARCH = "monre.06.tbdlichsu6.search";
        
        //Ket qua xu ly
        public static final String KQXL_SEARCH = "monre.06.tbdkqxl06.data";
        public static final String KQRUT_SEARCH = "monre.06.tbdycrut6.search";
        //Danh muc
        public static final String DANHMUC_CUAKHAU = "monre.06.danhmuc.cuakhau";
        public static final String DANHMUC_DVXL = "monre.06.danhmuc.dvxl";
        
        //Thong tin giay xac nhan thu tuc 01
        public static final String HOSO_GXN1 = "monre.06.gxn01.get";
        public static final String HOSO_THONGBAO = "monre.06.api.hoso.thongbao";
        public static final String DOWNLOAD = "monre.06.api.hoso.thongbao.download";
    ...
    public String getApiUrl(Environment environment, String key) {
        return environment.getRequiredProperty(Monre06Constant.API.BACKEND) + environment.getRequiredProperty(key);
    }
    
    public String getBackendCommonApiUrl(Environment environment, String key) {
        return environment.getRequiredProperty(Monre06Constant.API.BACKEND_COMMON) + environment.getRequiredProperty(key);
    }
    ...
    public interface Page {
        public static final String HOME = "monre.06.home";
        public static final String CREATE = "monre.06.create";
        public static final String VIEW = "monre.06.view";
    }
}
