...
import com.nsw.monre.constant.Monre07Constant;
 ...
 */
@RestController
@RequestMapping("/monre/07")
public class Monre07Api extends BaseApi {

    static final String TAG = "monre07Api";
    ...
    ResponseJson getCategory(
        ...
        try {
            switch (key) {
                case "HS_STATUS":
                    json = BackendRequestHelper.getInstance().doGetRequest(Monre07Constant.getInstance().getApiUrl(environment, Monre07Constant.API.HOSO_STATUS));
                    break;
                case "DVXL":
                    json = BackendRequestHelper.getInstance().doGetRequest(Monre07Constant.getInstance().getApiUrl(environment, Monre07Constant.API.DANHMUC_DVXL));
                    break;
                case "TINHTHANH":
                    json = BackendRequestHelper.getInstance().doGetRequest(Monre07Constant.getInstance().getApiUrl(environment, Monre07Constant.API.DANHMUC_TINH));
                    break;
                case "QUANHUYEN":
                    json = BackendRequestHelper.getInstance().doGetRequest(Monre07Constant.getInstance().getApiUrl(environment, Monre07Constant.API.DANHMUC_HUYEN) + "/" + id);
                    break;
                case "XAPHUONG":
                    json = BackendRequestHelper.getInstance().doGetRequest(Monre07Constant.getInstance().getApiUrl(environment, Monre07Constant.API.DANHMUC_XA) + "/" + id);
                    break;
                default:
                    break;
            }
    ...
    ResponseJson searchHoso(
        ...
        if (filter.getSoThongBao() != null && "".equals(filter.getSoThongBao().trim())) {
            filter.setSoThongBao(null);
        }

        ResponseJson json = BackendRequestHelper.getInstance().doPostRequest(Monre07Constant.getInstance().getApiUrl(environment, Monre07Constant.API.HOSO_SEARCH), filter);
        return json;
    }
    ...
    ResponseJson deleteHoso(
        ...
        ResponseJson json = BackendRequestHelper.getInstance().doPostRequest(Monre07Constant.getInstance().getApiUrl(environment, Monre07Constant.API.HOSO_DELETE) + "/" + fiIdHoso, map);
        return json;
    }
    ...
    ResponseJson gxn1Hoso(
        ...
        ResponseJson json = BackendRequestHelper.getInstance().doGetRequest(Monre07Constant.getInstance().getApiUrl(environment, Monre07Constant.API.HOSO_GXN1) + "/" + soGxn);
        return json;
    }
    ...
    ResponseJson lichSuXuLyHoSo(
        ...
        try {
            ...
            json = BackendRequestHelper.getInstance().doPostRequest(Monre07Constant.getInstance().getApiUrl(environment, Monre07Constant.API.LICHSU_SEARCH), filterForm);
    ...
    ResponseJson ycRutHoso(
        ...
        try {
            ...
            message.setType(Monre07Constant.MSG_TYPE.TYPE_15);
            ResponseJson hosoJson = BackendRequestHelper.getInstance().doGetRequest(Monre07Constant.getInstance().getApiUrl(environment, Monre07Constant.API.HOSO_GET_BYID) + message.getFiIdHoso());
            if (hosoJson.isSuccess()) {
                if ((LinkedHashMap) hosoJson.getData() != null) {
                    ...
                    if (Objects.equals(fiTrangthai, Monre07Constant.FILE_STATUS.CHO_TIEP_NHAN)) {
                        message.setFunction(Monre07Constant.MSG_FUNC.FUNC_03);
                    } else {
                        message.setFunction(Monre07Constant.MSG_FUNC.FUNC_11);
                    }
                    json = BackendRequestHelper.getInstance().doPostRequest(Monre07Constant.getInstance().getApiUrl(environment, Monre07Constant.API.HOSO_SEND), message);
                }
            }
    ...
    ResponseJson kqXuLyYCRutHoso(
        ...
        json = BackendRequestHelper.getInstance().doGetRequest(Monre07Constant.getInstance().getApiUrl(environment, Monre07Constant.API.KQRUT_SEARCH) + "/" + fiMaHoSo);
        return json;
    }
    ...
    ResponseJson kqxlHoso(
        ...
        ResponseJson json = BackendRequestHelper.getInstance().doPostRequest(Monre07Constant.getInstance().getApiUrl(environment, Monre07Constant.API.KQXL_SEARCH), message);
        return json;
    }
    ...
    ResponseJson getHoso(
        ...
        json.setSuccess(false);
        try {
            String url = Monre07Constant.getInstance().getApiUrl(environment, Monre07Constant.API.HOSO_GET_BYID);
    ...
    ResponseJson createHoso(
        ...
        try {
            ...
            if (tbdHoso != null) {
                ...
                tbdHoso.setFiTrangthai(Monre07Constant.FILE_STATUS.TAO_MOI);
                tbdHoso.setFiTenTt(Monre07Constant.FILE_STATUS.TAO_MOI_STR);
            }
            json = BackendRequestHelper.getInstance().doPostRequest(Monre07Constant.getInstance().getApiUrl(environment, Monre07Constant.API.HOSO_INSERT), tbdHoso);
    ...
    ResponseJson updateHoso(
        ...
        try {
            ...
            json = BackendRequestHelper.getInstance().doCustomRequest(Monre07Constant.getInstance().getApiUrl(environment, Monre07Constant.API.HOSO_UPDATE), HttpMethod.PUT, tbdHoso, new HashMap<>());
        } catch (Exception ex) {
            LogUtil.addLog(ex);
            String errorInfo = AppConstant.APP_NAME + AppConstant.MESSAGE_SEPARATOR + TAG + AppConstant.MESSAGE_SEPARATOR + Thread.currentThread().getStackTrace()[1].getMethodName() + AppConstant.MESSAGE_SEPARATOR + ex.toString();
            RabbitMQErrorHelper.pushLogToRabbitMQ(errorInfo, getRabbitMQ());
        ...
        try {
            ...
            if (json.isSuccess()) {
                if ((LinkedHashMap) json.getData() != null) {
                    ...
                    message.setType(Monre07Constant.MSG_TYPE.TYPE_10);
                    message.setFiIdHoso(fiIdHoso);

                    if (Objects.equals(fiTrangthai, Monre07Constant.FILE_STATUS.TAO_MOI)) {
                        message.setFunction(Monre07Constant.MSG_FUNC.FUNC_01);
                    } else if (Objects.equals(fiTrangthai, Monre07Constant.FILE_STATUS.CHO_TIEP_NHAN)) {
                        message.setFunction(Monre07Constant.MSG_FUNC.FUNC_02);
                    } else if (Objects.equals(fiTrangthai, Monre07Constant.FILE_STATUS.YC_BO_SUNG)) {
                        message.setFunction(Monre07Constant.MSG_FUNC.FUNC_04);
                    }
                    //Gui ho so
                    ResponseJson jsonResult = BackendRequestHelper.getInstance().doPostRequest(Monre07Constant.getInstance().getApiUrl(environment, Monre07Constant.API.HOSO_SEND), message);
    ...
    ResponseJson quyetDinhHoSo(
        ...
        json = BackendRequestHelper.getInstance().doGetRequest(Monre07Constant.getInstance().getApiUrl(environment, Monre07Constant.API.HOSO_THONGBAO) + filterForm.getFiMaHoso());
        return json;
    }
    ...
    public void downloadThongBao(HttpServletResponse response,
        ...
        try {
            ResponseJson json = BackendRequestHelper.getInstance().doGetRequest(Monre07Constant.getInstance().getApiUrl(environment, Monre07Constant.API.HOSO_THONGBAO) + fiMaHoso);
    ...
    private void downloadFile(HttpServletResponse response, String fileCode,
        ...
        if (fileCodeDb.equals(fileCode)) {
            String uri = getFullUri(environment.getProperty(Monre07Constant.API.DOWNLOAD));
    ...
    ResponseJson searchCososanxuat(
        ...
        ResponseJson json = BackendRequestHelper.getInstance().doPostRequest(Monre07Constant.getInstance().getApiUrl(environment, Monre07Constant.API.CSSX_SEARCH), filter);
        return json;
    }
    ...
    ResponseJson deleteCososanxuat(
        ...
        HashMap map = new HashMap();
        ResponseJson json = BackendRequestHelper.getInstance().doPostRequest(Monre07Constant.getInstance().getApiUrl(environment, Monre07Constant.API.CSSX_DELETE) + "?idCssx=" + idCssx + "&idHoso=" + fiIdHoso, map);
        return json;
    }
    ...
    ResponseJson createCososanxuat(
        ...
        try {
            ...
            json = BackendRequestHelper.getInstance().doPostRequest(Monre07Constant.getInstance().getApiUrl(environment, Monre07Constant.API.CSSX_SAVE), tbdCososx);
    ...
    ResponseJson updateCososanxuat(
        ...
        try {
            ...
            json = BackendRequestHelper.getInstance().doCustomRequest(Monre07Constant.getInstance().getApiUrl(environment, Monre07Constant.API.CSSX_SAVE), HttpMethod.PUT, tbdCososx, new HashMap<>());
        } catch (Exception ex) {
            LogUtil.addLog(ex);
            String errorInfo = AppConstant.APP_NAME + AppConstant.MESSAGE_SEPARATOR + TAG + AppConstant.MESSAGE_SEPARATOR + Thread.currentThread().getStackTrace()[1].getMethodName() + AppConstant.MESSAGE_SEPARATOR + ex.toString();
            RabbitMQErrorHelper.pushLogToRabbitMQ(errorInfo, getRabbitMQ());
    ...
    String getFullUri(String restUri) {
        return environment.getRequiredProperty(Monre07Constant.API.BACKEND) + restUri;
    }
...
//        ResponseJson json = BackendRequestHelper.getInstance().doGetRequest(Monre07Constant.getInstance().getApiUrl(environment, Monre07Constant.API.HOSO_OWNER) + fiHoso + "/" + getUsername());
