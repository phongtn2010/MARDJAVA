package com.nsw.monre.p05.constant;

public class AppViewThuTuc05Constant {

	public class PageView {
		
		private PageView() {
		}
		public static final String PAGE_INDEX = "nsw.monre.page.05.index";
		public static final String PAGE_TO_KHAI = "nsw.monre.page.05.khai_ho_so";
	}
	...
	public class ViewURL {
		...
		public static final String URI_THU_TUC_05 = "/monre/05";
		...
		public static final String BACKEND_SEND_MESSAGE_URL = "/monre/05/sendAll";
	...
	public class MessageKey {
		...
		public static final String THU_TUC_05_KHAI_BAO_HO_SO_ERROR = "THU_TUC_05_KHAI_BAO_HO_SO_ERROR";
		
		public static final String THU_TUC_05_KHAI_BAO_HO_SO_SUCCESS = "THU_TUC_05_KHAI_BAO_HO_SO_SUCCESS";
		
		public static final String THU_TUC_05_THONG_BAO_SUCCESS_TU_SERVICE = "THU_TUC_05_THONG_BAO_SUCCESS_TU_SERVICE";
		
		public static final String THU_TUC_05_THONG_BAO_ERROR_TU_SERVICE = "THU_TUC_05_THONG_BAO_ERROR_TU_SERVICE";
	}
