...
public class Monre09Controller extends BaseController {
...
//        }
        initData(model, null);
        return Monre09Constant.Page.HOME;
    }
...
//        }
        initData(model, null);
        return Monre09Constant.Page.CREATE;
    }
...
//        }
        initData(model, null);
        return Monre09Constant.Page.VIEW;
    }
...
//            return AppConstant.redirectPage(AppConstant.Pages.LOGOUT);
//        }
//        return Monre09Constant.Page.LICHSU;
//    }
