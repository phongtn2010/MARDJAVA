...
public class ThuTuc01Constant {
    ...
    static ThuTuc01Constant instance;

    public static ThuTuc01Constant getInstance() {
        synchronized (ThuTuc01Constant.class) {
            return new ThuTuc01Constant();
        }
    }
    
    public String getApiUrl(Environment environment, String key) {
        return environment.getRequiredProperty(ThuTuc01Constant.API.BACKEND) + environment.getRequiredProperty(key);
    }

    public String getBackendCommonApiUrl(Environment environment, String key) {
        return environment.getRequiredProperty(ThuTuc01Constant.API.BACKEND_COMMON) + environment.getRequiredProperty(key);
    }
