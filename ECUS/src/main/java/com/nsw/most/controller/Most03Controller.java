...
public class Most03Controller extends BaseController {
    ...
    public String indexPage(ModelMap model) {
        ...
        initData(model, null);
        return Most03Constant.Page.HOME;
    }
    ...
    public String create(ModelMap model) {
        ...
        initData(model, null);
        return Most03Constant.Page.CREATE;
    }
    ...
    public String viewDocument(ModelMap model) {
        ...
        initData(model, null);
        return Most03Constant.Page.VIEW;
    }
    ...
    public String viewResult(ModelMap model) {
        ...
        initData(model, null);
        return Most03Constant.Page.RESULT;
    }
...
//        model.addAttribute(AppConstant.DanhMuc.Menu, AppHelper.GetMenusForUser(user.getTabs(), environment.getRequiredProperty("nsw.fontend.url")));
        ...
        model.addAttribute(AppConstant.DanhMuc.Sign, environment.getRequiredProperty(Most03Constant.EnableSign));
