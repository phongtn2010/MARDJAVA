 ...
 */
@Controller
@RequestMapping(Most05Constant.Routes.ROOT_HOME)
public class Most05Controller extends BaseController {
    ...
    @RequestMapping(value = {Most05Constant.View.HOME, Most05Constant.View.INDEX}, method = RequestMethod.GET)
    public String indexPage(ModelMap model) {
        initData(model, null);
        return Most05Constant.Pages.HOME;
    }

    @RequestMapping(value = {Most05Constant.View.EDIT}, method = RequestMethod.GET)
    public String create(ModelMap model) {
        initData(model, null);
        return Most05Constant.Pages.EDIT;
    }

    @RequestMapping(value = {Most05Constant.View.VIEW}, method = RequestMethod.GET)
    public String view(ModelMap model) {
        initData(model, null);
        return Most05Constant.Pages.VIEW;
    }
