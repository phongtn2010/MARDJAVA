 ...
 */
@Controller
@RequestMapping(Most06Constant.Routes.ROOT_HOME)
public class Most06Controller extends BaseController {
    ...
    @RequestMapping(value = {Most06Constant.View.HOME, Most06Constant.View.INDEX}, method = RequestMethod.GET)
    public String indexPage(ModelMap model) {
        initData(model, null);
        return Most06Constant.Pages.HOME;
    }

    @RequestMapping(value = {Most06Constant.View.EDIT}, method = RequestMethod.GET)
    public String create(ModelMap model) {

        initData(model, null);
        return Most06Constant.Pages.EDIT;
    }

    @RequestMapping(value = {Most06Constant.View.VIEW}, method = RequestMethod.GET)
    public String view(ModelMap model) {
        initData(model, null);
        return Most06Constant.Pages.VIEW;
    }

    @RequestMapping(value = {Most06Constant.View.VIEWKQ}, method = RequestMethod.GET)
    public String viewkq(ModelMap model) {
        initData(model, null);
        return Most06Constant.Pages.VIEWKQ;
    }
