...
public class SearchForm {
    ...
    private Long fiLoaiTckt;// Loai to chuc kiem tra: 1 :TCKT 2:TCGD
    ...
    public Long getFiLoaiTckt() {
        return fiLoaiTckt;
    }

    public void setFiLoaiTckt(Long fiLoaiTckt) {
        this.fiLoaiTckt = fiLoaiTckt;
    }
}
