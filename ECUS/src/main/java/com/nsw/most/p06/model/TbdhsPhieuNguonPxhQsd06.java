 ...
 * @author Antsoft
 */
public class TbdhsPhieuNguonPxhQsd06 implements Serializable {
...
//    @Column(name = "FI_NGAY_XAC_DINH_HOAT_DO")
    private String fiNgayXacDinhHoatDo;
...
//    @Temporal(TemporalType.TIMESTAMP)
    ...
    public TbdhsPhieuNguonPxhQsd06() {
    }

    public TbdhsPhieuNguonPxhQsd06(Long fiIdNguonPxkPsd) {
    ...
    public String getFiNgayXacDinhHoatDo() {
        return fiNgayXacDinhHoatDo;
    }

    public void setFiNgayXacDinhHoatDo(String fiNgayXacDinhHoatDo) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof TbdhsPhieuNguonPxhQsd06)) {
            return false;
        }
        TbdhsPhieuNguonPxhQsd06 other = (TbdhsPhieuNguonPxhQsd06) object;
