/*
 * Created on 31 Mar 2019 ( Time 01:31:10 )
...
public class TbdhsThanhtoan10 implements Serializable {
    ...
    //@Column(name="FI_TONG_TIEN", length=20)
    ...
    //@Transient
    List<Tbddinhkem10> lstDinhKemThanhToans;
    ...
    //--- DATABASE MAPPING : FI_TONG_TIEN ( VARCHAR2 ) 
    ...
    public List<Tbddinhkem10> getLstDinhKemThanhToans() {
        return lstDinhKemThanhToans;
    }

    public void setLstDinhKemThanhToans(List<Tbddinhkem10> lstDinhKemThanhToans) {
