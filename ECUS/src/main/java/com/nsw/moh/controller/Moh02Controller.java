 ...
 */
@Controller
@RequestMapping(Moh02Constant.Routes.ROOT_HOME)
public class Moh02Controller extends BaseController {
    ...
    @RequestMapping(value = {Moh02Constant.View.HOME, Moh02Constant.View.INDEX}, method = RequestMethod.GET)
    public String index(ModelMap model) {
        initData(model, null);
        return Moh02Constant.Pages.HOME;
    }

    @RequestMapping(value = {Moh02Constant.View.EDIT}, method = RequestMethod.GET)
    public String addNew(ModelMap model) {
        initData(model, null);
        return Moh02Constant.Pages.EDIT;
    }

    @RequestMapping(value = {Moh02Constant.View.VIEW}, method = RequestMethod.GET)
    public String viewData(ModelMap model) {
        initData(model, null);
        return Moh02Constant.Pages.VIEW;
    }

    @RequestMapping(value = {Moh02Constant.View.VIEW_GP}, method = RequestMethod.GET)
    public String viewGP(ModelMap model) {
        initData(model, null);
        return Moh02Constant.Pages.VIEW_GP;
    }
...
//        model.addAttribute(AppConstant.DanhMuc.Applet, environment.getRequiredProperty(AppConstant.Common.APPLET));
        model.addAttribute(AppConstant.DanhMuc.Sign, environment.getRequiredProperty(Moh02Constant.EnableSign));
