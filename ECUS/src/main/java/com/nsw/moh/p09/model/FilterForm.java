...
public class FilterForm implements Serializable {
    ...
    public FilterForm(String maHoSo, String maThuTuc, String soVanBanDN, String soChungnhan, 
            Long trangThaiHoSo, Date ngayTaoTuNgay, Date ngayTaoDenNgay, Date ngayCapTuNgay, 
            Date ngayCapDenNgay, String nguoiTao, String soTiepNhan, int pageSize, int currentPage) {
        this.maHoSo = maHoSo;
    ...
    public String getSoChungnhan() {
        return soChungnhan;
    }

    public void setSoChungnhan(String soChungnhan) {
        this.soChungnhan = soChungnhan;
    }
