...
public class ExcelUtil {
    ...
    public static final String TILE18 = "Danh sách nhập thông tin thuốc Thú y";
    ...
    public static Date getDate(String string) {
            ...
            try {
                ngayNhap = DATE_FORMAT.parse(string);
    ...
    public static Date convertStringToDateExcel(String date)
            throws java.text.ParseException {
    ...
    //public static int getStt(Cell cell){
