...
*
*/
public class TbdThuoc18 implements Serializable {
	...
	private List<TbdDinhKem18> fiTepDinhKemThuocs;

	public List<TbdDinhKem18> getFiTepDinhKemThuocs() {
		return fiTepDinhKemThuocs;
	}

	public void setFiTepDinhKemThuocs(List<TbdDinhKem18> fiTepDinhKemThuocs) {
