...
public class WordUtil {
  ...
  /* private static Map<Integer, XWPFRun> getPosToRuns(XWPFParagraph paragraph) {
    ...
    //Giay Phep
    public static void createRow(XWPFDocument  document, Integer numberOfRow, List<TbdTBKetQuaThuoc18> tbdTBKetQuaThuoc18List){
        ...
        for(int i = 0; i < numberOfRow; i++){
            ...
            for(int j = 0;j < 8; j++) {
                writeToTable(tableRow.getCell(j), tbdTBKetQuaThuoc18List.get(i), j, i + 1);
            }
        }

    }
    private static void writeToTable(XWPFTableCell cell, TbdTBKetQuaThuoc18 tbdTBKetQuaThuoc18, int k, int rowCount) {
        ...
        switch (k) {
            case 0:
                ...
                break;
            case 1:
                cell.setText(tbdTBKetQuaThuoc18.getFiNameOfGoods());
                break;
            case 2:
                cell.setText(tbdTBKetQuaThuoc18.getFiCirculationNo());
                break;
            case 3:
                cell.setText(tbdTBKetQuaThuoc18.getFiSerialNo());
                break;
            case 4:
                cell.setText(tbdTBKetQuaThuoc18.getFiTypeOfPackage());
                break;
            case 5:
                cell.setText(String.format("%.1f",tbdTBKetQuaThuoc18.getFiWeight()));
                break;
            case 6:
                cell.setText(tbdTBKetQuaThuoc18.getFiManufacturerName());
                break;
            case 7:
                cell.setText(tbdTBKetQuaThuoc18.getFiWeightUnitName());
                break;
            case 8:
                cell.setText(ghiChu);
                break;
    ...
    private static void writeToTableHoSo(XWPFTableCell cell, TbdThuoc18 tbdThuoc18, int k, int rowCount) {
        ...
        switch (k) {
            ...
            case 5:
                ...
                break;
            case 6:
                cell.setText(String.format("%.1f",tbdThuoc18.getFiWeight()));
                break;
            case 7:
