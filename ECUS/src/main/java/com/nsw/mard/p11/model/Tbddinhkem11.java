...
/**
 * Persistent class for entity stored in table "TBDDINHKEM11"
 *
 * //@author Telosys Tools Generator
 *
 */
//@Entity
//@Table(name = "TBDDINHKEM11", schema = "MARD")
// Define named queries here
//@NamedQueries({
    //@NamedQuery(name = "Tbddinhkem11.countAll", query = "SELECT COUNT(x) FROM Tbddinhkem11 x")
//})
public class Tbddinhkem11 implements Serializable {
    ...
    //@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "TBDDINHKEM11_SEQ")
    //@SequenceGenerator(sequenceName = "TBDDINHKEM11_SEQ", schema = "MARD", initialValue = 1, allocationSize = 1, name = "TBDDINHKEM11_SEQ")
