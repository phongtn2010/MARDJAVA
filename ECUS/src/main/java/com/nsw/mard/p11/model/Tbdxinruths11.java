/*
 * Created on 18 Jul 2017 ( Time 08:58:03 )
...
/**
 * Persistent class for entity stored in table "TBDXINRUTHS11"
 *
 * //@author Telosys Tools Generator
 *
 */
//@Entity
//@Table(name = "TBDXINRUTHS11", schema = "MARD")
// Define named queries here
//@NamedQueries({
    //@NamedQuery(name = "Tbdxinruths11.countAll", query = "SELECT COUNT(x) FROM Tbdxinruths11 x")
//})
public class Tbdxinruths11 implements Serializable {
    ...
    //@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "TBDXINRUTHS11_SEQ")
    //@SequenceGenerator(sequenceName = "TBDXINRUTHS11_SEQ", schema = "MARD", initialValue = 1, allocationSize = 1, name = "TBDXINRUTHS11_SEQ")
    private Long fiIdYc;
