...
*
* @Model
* @class TbdKetQuaXuLy15
* Created by Nguyen Van Quang
* 04/12/2018 09:156:58
*
*/
public class TbdKetQuaXuLy15DTO implements Serializable {

	private static final long serialVersionUID = 1L;

	public TbdKetQuaXuLy15DTO() {}

	public TbdKetQuaXuLy15DTO(Long fiId, Long fiIdHoSo, Integer fiStatus, Date fiCreateDate, String fiContent, Date fiProcessDate, String fiNameOfRegistration, String fiProcessor, String fiLink, String fiFileName, String fiPath, String fiUuid) {
		this.fiId = fiId;
