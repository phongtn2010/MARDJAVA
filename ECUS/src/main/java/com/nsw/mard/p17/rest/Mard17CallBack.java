...
import com.nsw.mard.p17.model.TbdKetQuaXuLy17;
...
public abstract class Mard17CallBack {

	private static final Logger LOGGER = LoggerFactory.getLogger(Mard17CallBack.class);
	...
	public <T> T createRestTemplate(String uri, Object body, HttpMethod httpMethod, Map<String, Object> params, Class<T> clz) {
		...
		RestTemplate restTemplate = restTemplateBuilder.errorHandler(new RestTemplateResponseErrorHandler17()).build();
	...
	protected TbdKetQuaXuLy17 createHistory(Mard17TbdKetQuaXuLy17Resource fldMard17TbdKetQuaXuLy17Resource, Mard17TbdHoSo17Resource fldMard17TbdHoSo17Resource, String content, long idHoSo) {
		TbdKetQuaXuLy17 tbdKetQuaXuLy17 = new TbdKetQuaXuLy17();
		tbdKetQuaXuLy17.setFiCreateDate(new Date());
		tbdKetQuaXuLy17.setFiContent(content);
		tbdKetQuaXuLy17.setFiProcessor(SecurityUtil.getTaxCode());
		tbdKetQuaXuLy17.setFiNameOfRegistration(SecurityUtil.getTaxName());
		tbdKetQuaXuLy17.setFiIdHoSo(idHoSo);
		TbdHoSo17 tbdHoSo17 = fldMard17TbdHoSo17Resource.getTbdHoSo17(idHoSo).getBody();
		tbdKetQuaXuLy17.setFiStatus(tbdHoSo17.getFiStatus());
		tbdKetQuaXuLy17.setFiCreateDate(new Date());
		tbdKetQuaXuLy17.setFiProcessDate(new Date());
		tbdKetQuaXuLy17.setFiProcessor(SecurityUtil.getTaxCode());
		tbdKetQuaXuLy17.setFiNameOfRegistration(SecurityUtil.getTaxName());
		tbdKetQuaXuLy17.setFiDocumentType(tbdHoSo17.getFiDocumentType());
		tbdKetQuaXuLy17.setFiDocumentName(tbdHoSo17.getFiDocumentName());
		fldMard17TbdKetQuaXuLy17Resource.createTbdKetQuaXuLy17(tbdKetQuaXuLy17);

		return tbdKetQuaXuLy17;
	}
