...
public class SendMessage17 {
	...
	public String toString() {
		return "SendMessage17 [fiReason=" + fiReason + ", fiXml=" + fiXml + ", fiTaxCode=" + fiTaxCode + ", fiUserName=" + fiUserName + ", fiIdHoSo=" + fiIdHoSo + ", fiAction=" + fiAction + ", fiSign=" + fiSign +"]";
	}
