...
*
*/
public class TbdThongBaoPhi17DTO implements Serializable {

	private static final long serialVersionUID = 1L;

	public TbdThongBaoPhi17DTO() {}

	public TbdThongBaoPhi17DTO(Long fiId, Long fiIdHoSo, Double fiTotalFee, String fiTotalFeeChar, String fiNote, String fiAccountNo, String fiAccountName) {
		this.fiId = fiId;
