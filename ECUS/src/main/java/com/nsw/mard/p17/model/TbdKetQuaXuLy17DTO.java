...
*
* @Model
* @class TbdKetQuaXuLy17
* Created by Nguyen Van Quang
* 04/12/2018 09:246:58
*
*/
public class TbdKetQuaXuLy17DTO implements Serializable {

	private static final long serialVersionUID = 1L;

	public TbdKetQuaXuLy17DTO() {}

	public TbdKetQuaXuLy17DTO(Long fiId, Long fiIdHoSo, Integer fiStatus, Date fiCreateDate, String fiContent, Date fiProcessDate, String fiNameOfRegistration, String fiProcessor, String fiLink, String fiFileName, String fiPath, String fiUuid) {
		this.fiId = fiId;
