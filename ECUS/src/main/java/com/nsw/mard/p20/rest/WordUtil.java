...
public class WordUtil {
  ...
  /* private static Map<Integer, XWPFRun> getPosToRuns(XWPFParagraph paragraph) {
    ...
    //Giay Phep
    public static void createRow(XWPFDocument  document, Integer numberOfRow, List<TbdTBKetQuaThuoc20> tbdTBKetQuaThuoc20s){
        ...
        for(int i = 0; i < numberOfRow; i++){
            ...
            for(int j = 0;j < 7; j++) {
                writeToTable(tableRow.getCell(j), tbdTBKetQuaThuoc20s.get(i), j, i + 1);
            }
        }

    }
    private static void writeToTable(XWPFTableCell cell, TbdTBKetQuaThuoc20 tbdTBKetQuaThuoc20, int k, int rowCount) {
        ...
        switch (k) {
            case 0:
                ...
                break;
            case 1:
                cell.setText(tbdTBKetQuaThuoc20.getFiNameOfGoods());
                break;
            case 2:
                cell.setText(tbdTBKetQuaThuoc20.getFiDosageType());
                break;
            case 3:
                cell.setText(tbdTBKetQuaThuoc20.getFiCirculationNo());
                break;
            case 4:
                cell.setText(tbdTBKetQuaThuoc20.getFiImporterName());
                break;
            case 5:
                cell.setText(tbdTBKetQuaThuoc20.getFiManufacturerName());
                break;
            case 6:
                cell.setText(tbdTBKetQuaThuoc20.getFiTestResult());
                break;
            default:
                break;
        }
