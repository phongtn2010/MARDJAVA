...
/**
 * Persistent class for entity stored in table "TBDXINRUTHS10"
 *
 * @author Telosys Tools Generator
 *
 */
//@Entity
//@Table(name = "TBDXINRUTHS10", schema = "MARD")
//// Define named queries here
//@NamedQueries({
//    @NamedQuery(name = "Tbdxinruths10.countAll", query = "SELECT COUNT(x) FROM Tbdxinruths10 x")
//})
...
//    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "TBDXINRUTHS10_SEQ")
//    @SequenceGenerator(sequenceName = "TBDXINRUTHS10_SEQ", schema = "MARD", initialValue = 1, allocationSize = 1, name = "TBDXINRUTHS10_SEQ")
    private Long fiIdYc;
