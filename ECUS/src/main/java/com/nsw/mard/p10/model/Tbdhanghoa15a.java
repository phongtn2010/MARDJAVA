...
/**
 * Persistent class for entity stored in table "TBDHANGHOA15A"
 *
 * //@author Telosys Tools Generator
 *
 */
//@Entity
//@Table(name = "TBDHANGHOA15A", schema = "MARD")
// Define named queries here
//@NamedQueries({
    //@NamedQuery(name = "Tbdhanghoa15a.countAll", query = "SELECT COUNT(x) FROM Tbdhanghoa15a x")
//})
public class Tbdhanghoa15a implements Serializable {
    ...
    //@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "TBDHANGHOA15A_SEQ")
    //@SequenceGenerator(sequenceName = "TBDHANGHOA15A_SEQ", schema = "MARD", initialValue = 1, allocationSize = 1, name = "TBDHANGHOA15A_SEQ")
    ...
    public void setFiTinhbiet(Long fiTinhbiet) {
        this.fiTinhbiet = fiTinhbiet;
    }

    public Long getFiTinhbiet() {
