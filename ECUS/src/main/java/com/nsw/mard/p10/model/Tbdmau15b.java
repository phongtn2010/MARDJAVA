/*
 * Created on 18 Jul 2017 ( Time 08:49:09 )
...
/**
 * Persistent class for entity stored in table "TBDMAU15B"
 *
 * //@author Telosys Tools Generator
 *
 */
//@Entity
//@Table(name = "TBDMAU15B", schema = "MARD")
// Define named queries here
//@NamedQueries({
    //@NamedQuery(name = "Tbdmau15b.countAll", query = "SELECT COUNT(x) FROM Tbdmau15b x")
//})
public class Tbdmau15b implements Serializable {
    ...
    //@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "TBDMAU15B_SEQ")
    //@SequenceGenerator(sequenceName = "TBDMAU15B_SEQ", schema = "MARD", initialValue = 1, allocationSize = 1, name = "TBDMAU15B_SEQ")
    ...
    //@Column(name = "FI_NOICHUYEN", length = 255)
    private String fiNoichuyen;

    //@Column(name = "FI_PTVCCV", length = 500)
    private String fiPtvccv;

    //@Column(name = "FI_NONGDOVC", length = 50)
    private String fiNongdovc;
    
    //@Transient
    private List<Tbdhanghoa15b> lstHanghoa15b;
    ...
    public List<Tbdhanghoa15b> getLstHanghoa15b() {
        return lstHanghoa15b;
    }

    public void setLstHanghoa15b(List<Tbdhanghoa15b> lstHanghoa15b) {
        this.lstHanghoa15b = lstHanghoa15b;
    }
    ...
    public String toString() {
        ...
        sb.append(fiTongTl);
        sb.append("|");
        sb.append(fiNoichuyen);
        sb.append("|");
        sb.append(fiPtvccv);
        sb.append("|");
        sb.append(fiNongdovc);
        return sb.toString();
    }
