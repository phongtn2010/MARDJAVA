...
import com.nsw.mard.p19.model.TbdKetQuaXuLy19;
...
public abstract class Mard19CallBack {

	private static final Logger LOGGER = LoggerFactory.getLogger(Mard19CallBack.class);
	...
	public <T> T createRestTemplate(String uri, Object body, HttpMethod httpMethod, Map<String, Object> params, Class<T> clz) {
		...
		RestTemplate restTemplate = restTemplateBuilder.errorHandler(new RestTemplateResponseErrorHandler19()).build();
	...
	protected TbdKetQuaXuLy19 createHistory(Mard19TbdKetQuaXuLy19Resource fldMard19TbdKetQuaXuLy19Resource, Mard19TbdHoSo19Resource fldMard19TbdHoSo19Resource, String content, long idHoSo) {
		TbdKetQuaXuLy19 tbdKetQuaXuLy19 = new TbdKetQuaXuLy19();
		tbdKetQuaXuLy19.setFiCreateDate(new Date());
		tbdKetQuaXuLy19.setFiContent(content);
		tbdKetQuaXuLy19.setFiProcessor(SecurityUtil.getTaxCode());
		tbdKetQuaXuLy19.setFiNameOfRegistration(SecurityUtil.getTaxName());
		tbdKetQuaXuLy19.setFiIdHoSo(idHoSo);
		TbdHoSo19 tbdHoSo19 = fldMard19TbdHoSo19Resource.getTbdHoSo19(idHoSo).getBody();
		tbdKetQuaXuLy19.setFiStatus(tbdHoSo19.getFiStatus());
		tbdKetQuaXuLy19.setFiCreateDate(new Date());
		tbdKetQuaXuLy19.setFiProcessDate(new Date());
		tbdKetQuaXuLy19.setFiProcessor(SecurityUtil.getTaxCode());
		tbdKetQuaXuLy19.setFiNameOfRegistration(SecurityUtil.getTaxName());
		tbdKetQuaXuLy19.setFiDocumentType(tbdHoSo19.getFiDocumentType());
		tbdKetQuaXuLy19.setFiDocumentName(tbdHoSo19.getFiDocumentName());
		fldMard19TbdKetQuaXuLy19Resource.createTbdKetQuaXuLy19(tbdKetQuaXuLy19);

		return tbdKetQuaXuLy19;
	}
