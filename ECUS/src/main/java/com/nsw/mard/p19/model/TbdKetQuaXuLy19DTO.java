...
*
* @Model
* @class TbdKetQuaXuLy19
* Created by Nguyen Van Quang
* 04/12/2019 09:246:58
*
*/
public class TbdKetQuaXuLy19DTO implements Serializable {

	private static final long serialVersionUID = 1L;

	public TbdKetQuaXuLy19DTO() {}

	public TbdKetQuaXuLy19DTO(Long fiId, Long fiIdHoSo, Integer fiStatus, Date fiCreateDate, String fiContent, Date fiProcessDate, String fiNameOfRegistration, String fiProcessor, String fiLink, String fiFileName, String fiPath, String fiUuid) {
		this.fiId = fiId;
