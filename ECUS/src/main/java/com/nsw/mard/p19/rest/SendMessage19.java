...
public class SendMessage19 {
	...
	public String toString() {
		return "SendMessage19 [fiReason=" + fiReason + ", fiXml=" + fiXml + ", fiTaxCode=" + fiTaxCode + ", fiUserName=" + fiUserName + ", fiIdHoSo=" + fiIdHoSo + ", fiAction=" + fiAction + ", fiSign=" + fiSign +"]";
	}
