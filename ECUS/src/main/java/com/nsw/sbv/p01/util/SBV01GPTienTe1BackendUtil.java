...
public class SBV01GPTienTe1BackendUtil {
	...
	private SBV01GPTienTe1BackendUtil() {
	}

	public static GPTienTe1 createGPTienTe1(String url, GPTienTe1 pGPTienTe1) {
	...
	public static GPTienTe1 updateGPTienTe1(String url, long primaryKey, GPTienTe1 pGPTienTe1) {
	...
	public static boolean deleteGPTienTe1(String url, long primaryKey) {
	...
	public static GPTienTe1 getGPTienTe1(String url, long primaryKey) {
	...
	public static List<GPTienTe1> getByIdCapGXNHoSo(String url) {
