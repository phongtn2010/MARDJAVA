...
@Controller
@RequestMapping(value = "/mt/48")
@PropertySource("classpath:mt_api.properties")
public class MT48Controller extends BaseController {
    public static final Logger LOGGER = LoggerFactory.getLogger(MT48Controller.class);
    ...
    public String index(HttpServletRequest request, HttpServletResponse response, RedirectAttributes redirectAttributes,
        ...
        return environment.getProperty("mt.p48.home");
    }
    ...
    public String edit(ModelMap model, HttpServletRequest request, @PathVariable("id") Long id,@PathVariable("procedureId") String procedureId) {
        ...
        return environment.getProperty("mt.p48.edit");
    }
    ...
    public String viewLicense(ModelMap model, HttpServletRequest request, @PathVariable("type") Integer type, @PathVariable("procedureId") String procedureId, @PathVariable("id") Long id) {
        ...
        return environment.getProperty("mt.p48.view.license");
    }
    @ResponseBody
    ...
    public ResponseEntity<Object> getGiayPhep(HttpServletRequest request, @PathVariable("id") long id) {
        ...
        try {
            ...
            ResponseJson responseJson = callRestTemplate(environment.getRequiredProperty("mt.backend") + environment.getRequiredProperty("mt.48.xem_giay_phep"), id, HttpMethod.POST, params);
    ...
    public ResponseEntity<Object> saveWithFile(DefaultMultipartHttpServletRequest request, @PathVariable("funcType") int funcType) {
        ...
        try {
            String uri = environment.getProperty("mt.backend") + environment.getProperty("mt.48.save_with_file") + "/" + funcType;
    ...
    public ResponseEntity<Object> getProcessHistory(HttpServletRequest request, @PathVariable("idHoSo") Long fiIdHoso, @PathVariable("currentPage") Long currentPage) {
        try {
            ...
            ResponseJson responseJson = callRestTemplate(environment.getRequiredProperty("mt.backend") + environment.getRequiredProperty("mt.48.history"), params, HttpMethod.POST, null);
            List lst = (List) responseJson.getData();
            ResponseJson response = callRestTemplate(environment.getProperty("mt.backend") + environment.getRequiredProperty("mt.48.history_total"), params, HttpMethod.POST, null);
    ...
    public ResponseEntity<Object> getProcessHistoryGP(HttpServletRequest request, @PathVariable("soGiayPhep") String fiSoGiayphep, @PathVariable("currentPage") Long currentPage) {
        try {
            ...
            params.put("currentPage",currentPage);
            params.put("pageSize",10);
            ResponseJson responseJson = callRestTemplate(environment.getRequiredProperty("mt.backend") + environment.getRequiredProperty("mt.48.historyGP"), params, HttpMethod.POST, null);
            List lst = (List) responseJson.getData();
            ResponseJson response = callRestTemplate(environment.getProperty("mt.backend") + environment.getRequiredProperty("mt.48.history_totalGP"),params, HttpMethod.POST, null);
            Long total=((Integer)response.getData()).longValue();
            return createResponseEntity(lst, total, "", true, HttpStatus.OK);
        } catch (Exception e) {
            LOGGER.error("[getProcessHistory]", e);
    ...
    public ResponseEntity<Object> xinRut(HttpServletRequest request, @RequestBody Object lyDo) {
        try {
            ...
            Map<String, Object> params = new HashMap<>();
            ResponseJson responseJson = callRestTemplate(environment.getRequiredProperty("mt.backend") + environment.getRequiredProperty("mt.48.rut_ho_so"), lyDo, HttpMethod.POST, params);
            return createResponseEntity(responseJson.getData(), 1l, "", true, HttpStatus.OK);
    ...
    public ResponseEntity<Object> xinSuaGiayPhep(HttpServletRequest request, @RequestBody Object lyDo) {
        ...
        try {
            ...
            Map<String, Object> params = new HashMap<>();
            ResponseJson responseJson = callRestTemplate(environment.getRequiredProperty("mt.backend") + environment.getRequiredProperty("mt.48.xin_sua_giay_phep"), lyDo, HttpMethod.POST, params);
            return createResponseEntity(responseJson.getData(), 1l, "", true, HttpStatus.OK);
    ...
    public ResponseEntity<Object> traGiayPhep(HttpServletRequest request, @RequestBody Object lyDo) {
        ...
        try {
            ...
            Map<String, Object> params = new HashMap<>();
            ResponseJson responseJson = callRestTemplate(environment.getRequiredProperty("mt.backend") + environment.getRequiredProperty("mt.48.tra_giay_phep"), lyDo, HttpMethod.POST, params);
            return createResponseEntity(responseJson.getData(), 1l, "", true, HttpStatus.OK);
    ...
    public ResponseEntity<Object> downloadNewFile(HttpServletResponse response, @PathVariable("idDinhKem") Long idDinhKem) {
        Object principal = SecurityContextHolder.getContext().getAuthentication().getPrincipal();
            try {
                if (idDinhKem != null) {
                    String uri = environment.getProperty("mt.backend") + environment.getProperty("mt.48.download") + "/" + idDinhKem;
                    HttpHeaders headers = new HttpHeaders();
    ...
    private String getTitleLabel(String procedureId) {
        switch (procedureId) {
            ...
            case "BGTVT0600050":
                return "Cấp lại Giấy phép liên vận CLV cho phương tiện thương mại do hư hỏng";
            case "BGTVT0600051":
                return "Cấp lại Giấy phép liên vận CLV cho phương tiện thương mại do mất mát";
            default:
                return "Cấp Giấy phép liên vận CLV cho phương tiện thương mại";
        }
    }
