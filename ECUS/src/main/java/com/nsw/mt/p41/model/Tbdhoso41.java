...
public class Tbdhoso41 {
    ...
    //@Transient
    private List<TbdhsXe41> lstXe;

    //@Transient
    private List<TbdhsDinhkem41> lstDinhKem;

    //@Transient
    private TbdhsDnky41 chuKyDoanhNghiep;
    ...
    public List<TbdhsXe41> getLstXe() {
        return lstXe;
    }

    public void setLstXe(List<TbdhsXe41> lstXe) {
        this.lstXe = lstXe;
    }

    public List<TbdhsDinhkem41> getLstDinhKem() {
        return lstDinhKem;
    }

    public void setLstDinhKem(List<TbdhsDinhkem41> lstDinhKem) {
        this.lstDinhKem = lstDinhKem;
    }

    public TbdhsDnky41 getChuKyDoanhNghiep() {
        return chuKyDoanhNghiep;
    }

    public void setChuKyDoanhNghiep(TbdhsDnky41 chuKyDoanhNghiep) {
