 ...
 */
@Controller
@RequestMapping(MT36Constant.Routes.ROOT)
public class MT36Controller extends BaseController {
     ...
     * @return
     */
    @RequestMapping(value = {MT36Constant.View.HOME, MT36Constant.View.INDEX}, method = RequestMethod.GET)
...
//        }
        initData(model, null);
        return MT36Constant.Pages.HOME;
    }
     ...
     * @return
     */
    @RequestMapping(value = {MT36Constant.View.EDIT}, method = RequestMethod.GET)
...
//        }
        initData(model, null);
        return MT36Constant.Pages.EDIT;
    }
     ...
     * @return
     */
    @RequestMapping(value = {MT36Constant.View.VIEW}, method = RequestMethod.GET)
...
//        }
        initData(model, null);
        return MT36Constant.Pages.VIEW;
    }
    ...
    private void initData(ModelMap model, UserCustom user) {
        ...
        model.addAttribute(AppConstant.DanhMuc.Sign, environment.getRequiredProperty(MT36Constant.EnableSign));
