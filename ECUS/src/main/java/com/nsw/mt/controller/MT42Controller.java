 ...
 */
@Controller
@RequestMapping(MT42Constant.Routes.ROOT)
public class MT42Controller extends BaseController {
     ...
     * @return
     */
    @RequestMapping(value = {MT42Constant.View.HOME, MT42Constant.View.INDEX}, method = RequestMethod.GET)
...
//        }
        initData(model, null);
        return MT42Constant.Pages.HOME;
    }
     ...
     * @return
     */
    @RequestMapping(value = {MT42Constant.View.EDIT}, method = RequestMethod.GET)
...
//        }
        initData(model, null);
        return MT42Constant.Pages.EDIT;
    }
     ...
     * @return
     */
    @RequestMapping(value = {MT42Constant.View.VIEW}, method = RequestMethod.GET)
...
//        }
        initData(model, null);
        return MT42Constant.Pages.VIEW;
    }
    ...
    private void initData(ModelMap model, UserCustom user) {
        ...
        model.addAttribute(AppConstant.DanhMuc.Sign, environment.getRequiredProperty(MT42Constant.EnableSign));
