 ...
 */
@Controller
@RequestMapping(MTqlptConstant.Routes.ROOT)
public class MTqlptController extends BaseController {
     ...
     * @return
     */
    @RequestMapping(value = {MTqlptConstant.View.HOME, MTqlptConstant.View.INDEX}, method = RequestMethod.GET)
...
//        }
        initData(model, null);
        return MTqlptConstant.Pages.HOME;
    }
     ...
     * @return
     */
    @RequestMapping(value = {MTqlptConstant.View.EDIT}, method = RequestMethod.GET)
...
//        }
        initData(model, null);
        return MTqlptConstant.Pages.EDIT;
    }
     ...
     * @return
     */
    @RequestMapping(value = {MTqlptConstant.View.VIEW}, method = RequestMethod.GET)
...
//        }
        initData(model, null);
        return MTqlptConstant.Pages.VIEW;
    }
