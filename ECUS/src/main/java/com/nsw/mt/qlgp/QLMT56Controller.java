...
@Controller
@RequestMapping(value = "/mt/qlgp/56")
@PropertySource("classpath:mt_api.properties")
public class QLMT56Controller extends BaseController {
    public static final Logger LOGGER = LoggerFactory.getLogger(QLMT56Controller.class);
...
//            }
        ...
        return environment.getProperty("mt.qlgp.p56.home");
    }
...
//            }
        ...
        return environment.getProperty("mt.qlgp.p56.edit");
    }
...
//            }
        ...
        return "nsw.mt.qlgp.page.56.view.license";
    }
...
//            }
            ...
            ResponseJson responseJson = callRestTemplate(environment.getRequiredProperty("mt.api.backend") + environment.getRequiredProperty("mt.56.xem_giay_phep"), id, HttpMethod.POST, params);
...
//            }
    ...
    public ResponseEntity<Object> downloadNewFile(HttpServletResponse response, @PathVariable("idDinhKem") Long idDinhKem) {
        //if (principal instanceof UserDetails) {
            try {
                if (idDinhKem != null) {
                    String uri = environment.getProperty("mt.api.backend") + environment.getProperty("mt.56.download") + "/" + idDinhKem;
    ...
    private String getTitleLabel(String procedureId) {
        return "CẤP GIẤY PHÉP VẬN TẢI QUỐC TẾ ĐƯỜNG BỘ VIỆT NAM-CAMPUCHIA-LÀO";
    }
}
