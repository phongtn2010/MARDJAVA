...
@Controller
@RequestMapping(value = "/mt/qlgp/05")
@PropertySource("classpath:mt_api.properties")
public class QLMT05Controller extends BaseController {
    public static final Logger LOGGER = LoggerFactory.getLogger(QLMT05Controller.class);
...
//            }
        ...
        return environment.getProperty("mt.qlgp.p05.home");
    }
...
//            }
        ...
        return environment.getProperty("mt.qlgp.p05.edit");
    }
    ...
    public String viewLicense(ModelMap model, HttpServletRequest request, @PathVariable("procedureId") String procedureId, @PathVariable("id") Long id) {
        ...
        return "nsw.mt.qlgp.page.5.view.license";
    }
    @ResponseBody
...
//            }
            ...
            ResponseJson responseJson = callRestTemplate(environment.getRequiredProperty("mt.api.backend") + environment.getRequiredProperty("mt.05.xem_giay_phep"), id, HttpMethod.POST, params);
    ...
    public ResponseEntity<Object> downloadNewFile(HttpServletResponse response, @PathVariable("idDinhKem") Long idDinhKem) {
        //if (principal instanceof UserDetails) {
            try {
                if (idDinhKem != null) {
                    String uri = environment.getProperty("mt.api.backend") + environment.getProperty("mt.05.download") + "/" + idDinhKem;
