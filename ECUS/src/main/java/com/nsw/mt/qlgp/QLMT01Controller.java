...
@Controller
@RequestMapping(value = "/mt/qlgp/01")
@PropertySource("classpath:mt_api.properties")
public class QLMT01Controller extends BaseController {
    public static final Logger LOGGER = LoggerFactory.getLogger(QLMT01Controller.class);
...
//            }
        ...
        return environment.getProperty("mt.qlgp.p01.home");
    }
...
//            }
        ...
        return environment.getProperty("mt.qlgp.p01.edit");
    }
...
//            }
        ...
        return "nsw.mt.qlgp.page.1.view.license";
    }
...
//            }
            ...
            ResponseJson responseJson = callRestTemplate(environment.getRequiredProperty("mt.api.backend") + environment.getRequiredProperty("mt.01.xem_giay_phep"), id, HttpMethod.POST, params);
...
//        if (principal instanceof UserDetails) {
            try {
                if (idDinhKem != null) {
                    String uri = environment.getProperty("mt.api.backend") + environment.getProperty("mt.01.download") + "/" + idDinhKem;
