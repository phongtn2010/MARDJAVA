...
@Controller
@RequestMapping(value = "/mt/qlgp/52")
@PropertySource("classpath:mt_api.properties")
public class QLMT52Controller extends BaseController{

    public static final Logger LOGGER = LoggerFactory.getLogger(QLMT52Controller.class);
...
//            }
    ...
    public String viewLicense(ModelMap model, HttpServletRequest request, @PathVariable("procedureId") String procedureId, @PathVariable("id") Long id) {
        ...
        return "nsw.mt.qlgp.page.52.view.license";
    }
...
//            }
            ...
            ResponseJson responseJson = callRestTemplate(environment.getRequiredProperty("mt.api.backend") + environment.getRequiredProperty("mt.52.xem_giay_phep"), id, HttpMethod.POST, params);
    ...
    public ResponseEntity<Object> downloadNewFile(HttpServletResponse response, @PathVariable("idDinhKem") Long idDinhKem) {
        ...
        try {
            if (idDinhKem != null) {
                String uri = environment.getProperty("mt.api.backend") + environment.getProperty("mt.52.download") + "/" + idDinhKem;
    ...
    private String getTitleLabel(String procedureId) {
        switch (procedureId) {
            ...
            case "BGTVT0600053":
                return "Cấp lại Giấy phép liên vận CLV cho phương tiện phi thương mại do hết hạn";
            case "BGTVT0600054":
