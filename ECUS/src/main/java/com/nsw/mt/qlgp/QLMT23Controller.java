...
@Controller
@RequestMapping(value = "/mt/qlgp/23")
@PropertySource("classpath:mt_api.properties")
public class QLMT23Controller extends BaseController {
    public static final Logger LOGGER = LoggerFactory.getLogger(QLMT23Controller.class);
...
//            }
        ...
        return environment.getProperty("mt.qlgp.p23.home");
    }
...
//            }
        ...
        return environment.getProperty("mt.qlgp.p23.edit");
    }
    ...
    public String viewLicense(ModelMap model, HttpServletRequest request, @PathVariable("procedureId") String procedureId, @PathVariable("id") Long id) {
        ...
        return "nsw.mt.qlgp.page.23.view.license";
    }
...
//            }
            ...
            ResponseJson responseJson = callRestTemplate(environment.getRequiredProperty("mt.api.backend") + environment.getRequiredProperty("mt.23.xem_giay_phep"), id, HttpMethod.POST, params);
    ...
    public ResponseEntity<Object> downloadNewFile(HttpServletResponse response, @PathVariable("idDinhKem") Long idDinhKem) {
        //if (principal instanceof UserDetails) {
            try {
                if (idDinhKem != null) {
                    String uri = environment.getProperty("mt.api.backend") + environment.getProperty("mt.23.download") + "/" + idDinhKem;
