...
@Controller
@RequestMapping(value = "/mt/qlgp/09")
@PropertySource("classpath:mt_api.properties")
public class QLMT09Controller extends BaseController {
    public static final Logger LOGGER = LoggerFactory.getLogger(QLMT09Controller.class);
...
//            }
        ...
        return environment.getProperty("mt.qlgp.p09.home");
    }
...
//            }
        ...
        return environment.getProperty("mt.qlgp.p09.edit");
    }
    ...
    public String viewLicense(ModelMap model, HttpServletRequest request, @PathVariable("procedureId") String procedureId, @PathVariable("id") Long id) {
        ...
        return "nsw.mt.qlgp.page.9.view.license";
    }
    @ResponseBody
...
//            }
            ...
            ResponseJson responseJson = callRestTemplate(environment.getRequiredProperty("mt.api.backend") + environment.getRequiredProperty("mt.09.xem_giay_phep"), id, HttpMethod.POST, params);
    ...
    public ResponseEntity<Object> downloadNewFile(HttpServletResponse response, @PathVariable("idDinhKem") Long idDinhKem) {
        //if (principal instanceof UserDetails) {
            try {
                if (idDinhKem != null) {
                    String uri = environment.getProperty("mt.api.backend") + environment.getProperty("mt.09.download") + "/" + idDinhKem;
