...
@Controller
@RequestMapping(value = "/mt/qlgp/48")
@PropertySource("classpath:mt_api.properties")
public class QLMT48Controller extends BaseController{

    public static final Logger LOGGER = LoggerFactory.getLogger(QLMT48Controller.class);
...
//            }
    ...
    public String viewLicense(ModelMap model, HttpServletRequest request, @PathVariable("procedureId") String procedureId, @PathVariable("id") Long id) {
        ...
        return "nsw.mt.qlgp.page.48.view.license";
    }
...
//            }
            ...
            ResponseJson responseJson = callRestTemplate(environment.getRequiredProperty("mt.api.backend") + environment.getRequiredProperty("mt.48.xem_giay_phep"), id, HttpMethod.POST, params);
    ...
    public ResponseEntity<Object> downloadNewFile(HttpServletResponse response, @PathVariable("idDinhKem") Long idDinhKem) {
        ...
        try {
            if (idDinhKem != null) {
                String uri = environment.getProperty("mt.api.backend") + environment.getProperty("mt.48.download") + "/" + idDinhKem;
