...
@Controller
@RequestMapping(value = "/mt/qlgp/19")
@PropertySource("classpath:mt_api.properties")
public class QLMT19Controller extends BaseController {
    public static final Logger LOGGER = LoggerFactory.getLogger(QLMT19Controller.class);
...
//            }
        ...
        return environment.getProperty("mt.qlgp.p19.home");
    }
...
//            }
        ...
        return environment.getProperty("mt.qlgp.p19.edit");
    }
...
//            }
        ...
        return "nsw.mt.qlgp.page.19.view.license";
    }
...
//            }
            ...
            ResponseJson responseJson = callRestTemplate(environment.getRequiredProperty("mt.api.backend") + environment.getRequiredProperty("mt.19.xem_giay_phep"), id, HttpMethod.POST, params);
...
//            }
    ...
    public ResponseEntity<Object> downloadNewFile(HttpServletResponse response, @PathVariable("idDinhKem") Long idDinhKem) {
        //if (principal instanceof UserDetails) {
            try {
                if (idDinhKem != null) {
                    String uri = environment.getProperty("mt.api.backend") + environment.getProperty("mt.19.download") + "/" + idDinhKem;
