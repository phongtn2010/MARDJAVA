...
function ResultVM(options) {
    ...
    self.lstDactrungnguon06 = ko.observableArray([]);
    ...
    if (data) {
        ...
        self.lstDactrungnguon06 = ko.observableArray(data ? data.lstDactrungnguon06 : []);
    ...
    self.downloadUrl = ko.computed(function () {
        if (self.fiTenTepTin()) {
            return app.appContext + '/most/06/file/' + self.fiDuongdan() + '/' + self.fiGuiid();
        }
        return null;
    }, this);
