...
function IndexVM(params) {
    ...
    self.search = function (page, pushState) {
        if (!RAW_HS_STATUS || RAW_HS_STATUS.length <= 0) {
            app.getCategory('/bca/02/danhmuc', 'HS_TRANGTHAI', null, function (res) {
                if (res.success) {
    ...
    self.btnAddNewClick = function (e) {
        document.location = app.appContext + '/bca/02/edit?maThuTuc=BCA0100001';
        return false;
    };
    ...
    self.bXemClick = function (item, e) {
        document.location = app.appContext + '/bca/02/view?fiIdHoso=' + item.fiIdHoso() + '&maThuTuc=BCA0100001';
        return false;
    };
    /**
     * Xin sua ho so
    ...
    self.bXinSuaClick = function (item, e) {
        document.location = app.appContext + '/bca/02/edit?fiIdHoso=' + item.fiIdHoso() + '&requestedit=true&maThuTuc=BCA0100001';
        return false;
    };
    /**
     * Xem Thông báo
    ...
    self.bXemThongBaoClick = function (item, e) {
        document.location = app.appContext + '/bca/02/view?fiIdHoso=' + item.fiIdHoso() + '&fiMaHoso=' + item.fiMaHoso() + '&tab=cert&maThuTuc=BCA0100002';
        return false;
    };
    /**
     * Xem Thông tin phi
    ...
    self.bThongTinPhiClick = function (item, e) {
        document.location = app.appContext + '/bca/02/charge?fiIdHoso=' + item.fiIdHoso() + '&fiMaHoso=' + item.fiMaHoso()+ '&fiTrangthai=' + item.fiTrangthai();
        return false;
    };
    /**
     * Xem Lich su
    ...
    self.bSuaClick = function (item, e) {
        document.location = app.appContext + '/bca/02/edit?fiIdHoso=' + item.fiIdHoso() + '&maThuTuc=BCA0100001';
        return false;
    };
    /**
     * Hủy hồ sơ (xóa)
            ...
            buttons: [
                {
                    ...
                    action: function () {
                        app.makePost({
                            url: '/bca/02/hoso/xoa/' + item.fiIdHoso(),
                            data: JSON.stringify({}),
                            success: function (d) {
                                var msg = '';
                                if (d.success) {
    ...
    self.fiTrangThaiClick = function (item, e) {
        switch (item.fiTrangthai()) {
            ...
            case  DA_CAP_LAI_GIAYPHEP:
                document.location = app.appContext + '/bca/02/view?fiIdHoso=' + item.fiIdHoso() + '&fiMaHoso=' + item.fiMaHoso() + '&tab=cert&maThuTuc=' + self.maThuTuc();
                break;
...
//                break;
    ...
    self.guiYcXuly = function (message) {
        $.ajax({
            ...
            cache: false,
            crossDomain: true,
            url: app.appContext + '/bca/02/hoso/xuly',
...
$(document).ready(function () {
    var d = {};
    $('#loading10').show();
    $.when(app.getCategory('/bca/02/danhmuc', 'DM_TRANGTHAI', null, function (res) {
        if (res.success) {
