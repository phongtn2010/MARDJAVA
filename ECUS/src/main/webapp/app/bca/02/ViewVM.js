...
function ViewVM(options) {
    ...
    self.btnXinSuaCVClick = function () {
        ...
        self.yeuCauVM = new YeuCauVM('Bạn chắc chắn muốn gửi yêu cầu xin sửa Công văn:  ', self, '/bca/02/hoso/yc-suavanban');
        self.pop = app.popup({
...
$(document).ready(function () {
    ...
    var init = function () {
        if (options && options.fiIdHoso > 0) {
            ...
            var url_result = '/bca/02/hoso/vanban';
            app.makePost({
                url: url,
                data: JSON.stringify({}),
                success: function (d) {
