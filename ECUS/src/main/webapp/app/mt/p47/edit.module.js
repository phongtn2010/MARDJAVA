...
$(document).ready(function () {
        function ViewModel() {
            ...
            self.loaiGiayPhep = ko.observableArray(0);
            ...
            app.makePost({
                url: '/mt/47/call_service',
                data: JSON.stringify({
                	 URL_BACKEND: "/mt/47/loaigp/getAll",
                    METHOD: "POST",
                    REQUEST: {}
                }),
                success: function (d) {
                    ...
                    if (d.success) {
                        for (const item of d.data) {
                            var itemBind = {};
                            self.loaiGiayPhep.push(app.convertObjectToObservable(item, itemBind));
                        }
                    }
                },
                error: function (e) {
            ...
            function loadGiaHan(){
           	 app.makePost({
                    ...
                    data: JSON.stringify({
                        URL_BACKEND: "/mt/47/giaHan/getById",
                        METHOD: "POST",
                        REQUEST: hoSoId
                    }),
                    success: function (d) {
            ...
            self.dong = function () {
                location.href = app.appContext + '/mt/47/home/BGTVT0600047' ;
            }
            ...
            self.action = function (item, functionType) {
                ...
                if (self.danhSachFileCheck().length > 0) {
                    app.uploadMutipleFile({
                        url: '/mt/47/saveWithFile/' + functionType,
...
//                        pcode: "01",
                        ...
                        success: function (d) {
                            ...
                            if (d.success) {
                                ...
                                location.href = app.appContext + '/mt/47/home/' + self.hoSoChiTiet.Tbdhoso.fiLoaihoso();
                            } else {
                                msg = d.message;
                                fun = 'error';
                            }
                    ...
                    app.makePost({
                        url: '/mt/47/call_service',
                        data: JSON.stringify({
                            URL_BACKEND: "/mt/47/hoso/save/" + functionType,
                            METHOD: "POST",
            ...
            function download(item) {
                if (item.fiIdDinhkem()) {
                    $('#loading_c4e6a343-dd41-b5c5-1ef9-75eeebba032d').show();
                    app.makeGet({
                        url: "/mt/47/download/" + item.fiIdDinhkem(), // my URL
                        responseType: 'blob',
