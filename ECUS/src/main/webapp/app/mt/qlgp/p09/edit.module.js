...
$(document).ready(function () {
    function ViewModel() {
        ...
        self.dong = function () {
            location.href = app.appContext + '/mt/qlgp/09/home/' + self.hoSoChiTiet.Tbdhoso.fiLoaihoso();
        }
        ...
        self.download = function (item) {
            if (item.fiIdDinhkem()) {
                ...
                app.makeGet({
                    url: "/mt/qlgp/09/download/" + item.fiIdDinhkem(), // my URL
                    responseType: 'blob',
