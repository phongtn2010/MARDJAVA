...
var Tbdhoso = function () {
    ...
    this.fiFax = ko.observable('').extend({required: {message: 'Fax không được trống!'}});
    ...
    this.fiCoquancapphep = ko.observable().extend({required: {message: 'Cơ quan cấp phép không được trống!'}}).extend({
        validation: [{
            validator: function (val, lenght) {
                return val && val.length <= lenght;
            },
