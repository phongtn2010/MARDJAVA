...
$(document).ready(function () {
    function ViewModel() {
        ...
        self.xemGiayPhep = function (item) {
            location.href = app.appContext + '/mt/qlgp/01/view/license/' + item.fiLoaihoso() + '/' + item.fiIdGiayphep();
        }

        self.typeForm = ko.observable('search');

        self.xemHoSo = function (item) {
            location.href = app.appContext + '/mt/qlgp/01/view/' + procedureId + "/" + item.fiIdHoso();
        }
