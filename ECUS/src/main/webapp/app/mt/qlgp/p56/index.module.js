...
$(document).ready(function () {
    function ViewModel() {
        ...
        self.xemHoSo = function (item) {
            location.href = app.appContext + '/mt/qlgp/56/view/' + procedureId + "/" + item.fiIdHoSo();
        }
        ...
        self.searching = function (showMsg) {
            ...
            if (self.searchForm.fiTrangthaiSearch() == null) {
                self.searchForm.fiTrangthai = {VALUE: [7, 8, 9, 10, 11], OPERATOR: 'IN'};
            } else {
            ...
            app.makePost({
                url: '/mt/qlgp/56/call_service',
                data: JSON.stringify({
                    URL_BACKEND: "/mt/56/hoso/searchPaging",
                    URL_GET_TOTAL: "/mt/56/hoso/getTotalRecord",
                    METHOD: "POST",
        ...
        self.xemGiayPhep = function (item) {
            location.href = app.appContext + '/mt/qlgp/56/view/license/' + item.fiLoaiHoSo() + '/' + item.fiIdGiayPhep();
        }

        self.typeForm = ko.observable('search');

        self.xemGiayPhep = function (item) {
            location.href = app.appContext + '/mt/qlgp/56/view/license/' + procedureId +'/'+ item.fiIdHoSo()+'/1';
        }
