...
//            })
        ...
        self.searching = function (showMsg) {
            ...
            app.makePost({
                ...
                url: '/mt/qlgp/48/call_service',
                data: JSON.stringify({
                    URL_BACKEND: "/mt/48/hoso/fullSearchPagingFCAP",
                    URL_GET_TOTAL:"/mt/48/hoso/getTotalSearchFCAP",
                    METHOD: "POST",
        ...
        self.xemGiayPhep = function (item) {
            location.href = app.appContext + '/mt/qlgp/48/view/license/' + procedureId + '/' + item.fiIdHoSo();
        }

        self.typeForm = ko.observable('search');

        self.xemHoSo = function (item) {
            location.href = app.appContext + '/mt/qlgp/48/view/' + procedureId + "/" + item.fiIdHoSo();
        }
