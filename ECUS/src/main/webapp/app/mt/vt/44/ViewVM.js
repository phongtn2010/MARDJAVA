...
function ViewVM(options) {
    ...
    self.button = ko.observable(false);
    ...
    self.btnXinSuaCVClick = function () {
        ...
        self.yeuCauVM = new YeuCauVM('Bạn chắc chắn muốn gửi yêu cầu xin sửa Công văn:  ', self, '/mt/44/hoso/yc-suavanban');
    ...
    self.btnTraLaiCVClick = function () {
        ...
        self.yeuCauVM = new YeuCauVM('Bạn chắc chắn muốn gửi yêu cầu xin sửa Công văn:  ', self, '/mt/44/hoso/yc-tralaivanban');
...
$(document).ready(function () {
    ...
    $.when(
            app.getCategory('/mt/44/danhmuc', 'HS_DONVIXULY', options.maThuTuc, function (res) {
                if (res.success) {
            ...
            app.getCategory('/mt/44/danhmuc', 'HS_CUAKHAUXUATNHAP', options.maThuTuc, function (res) {
                if (res.success) {
            ...
            app.getCategory('/mt/44/danhmuc', 'HS_CUAKHAUDENDI', options.maThuTuc, function (res) {
                if (res.success) {
            ...
            app.getCategory('/mt/44/danhmuc', 'HS_TUYENVANTAI', null, function (res) {
                if (res.success) {
            ...
            app.getCategory('/mt/44/danhmuc', 'HS_LOAIXE', null, function (res) {
                if (res.success) {
            ...
            app.getCategory('/mt/44/danhmuc', 'HS_LOAIFILE', options.maThuTuc, function (res) {
                if (res.success) {
    ...
    var init = function () {
        if (options && options.fiIdHoso > 0) {
            var url = '/mt/44/hoso/t/' + options.fiIdHoso;
            var url_result = '/mt/44/hoso/vanban';
            app.makePost({
                url: url,
                data: JSON.stringify({}),
                success: function (d) {
