...
function XeVM(op) {
    ...
    var xeVG = [self.fiBksXe, self.fiSoGhe, self.fiDncpDenNg, self.fiDncpTuNg, self.fiMaTuyen, self.fiDiemDung, self.fiTenHieu, self.fiMaNhanhieu];
...
function FormVM(options) {
    ...
    self.fiSoGpvt = ko.observable(null);
    ...
    self.init = function (hoso) {
        ...
        if (hoso !== null) {
            ...
            self.lstXe(mapTbdhsXe42(hoso.hasOwnProperty('lstXe') ? hoso.lstXe : []));
                        ...
                        action: function () {
                            if (self.xeVM.isValid()) {
                                ...
                                if (null == xeInfo.fiIdXe) {
                                    ...
                                    var xeModel = new TbdhsXe42(xeInfo);
