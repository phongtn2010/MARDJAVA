...
function XeVM(op) {
    ...
    self.fiSoGpMat = ko.observable(xe ? xe.fiSoGpMat() : null).extend({
        required: {message: NSWLang["common_msg_formvaild_required"], params: true}
    });
...
function FormVM(options) {
    ...
    self.fiNgcapGpvt = ko.observable(null).extend({
        required: {message: NSWLang["common_msg_formvaild_required"], params: true}
    });

    self.fiCqCapGpvt = ko.observable(null);
    self.fiSoGpDkkd = ko.observable(null);
    self.fiNgcapDkkd = ko.observable(null);
    self.fiCqCapDkkd = ko.observable(null);
    ...
    var hosoVG = [self.fiMaCqxl, self.fiTenDn, self.fiDiachiDn, self.fiSdtDn,
        self.fiMstDn, self.fiTenNgKy, self.fiDiaDiem, self.fiSoGpvt, self.fiNgcapGpvt];
    ...
    self.init = function (hoso) {
        ...
        if (hoso !== null) {
            ...
            self.lstXe(mapTbdhsXe41(hoso.hasOwnProperty('lstXe') ? hoso.lstXe : []));
                        ...
                        action: function () {
                            if (self.xeVM.isValid()) {
                                ...
                                if (null == xeInfo.fiIdXe) {
                                    ...
                                    var xeModel = new TbdhsXe41(xeInfo);
