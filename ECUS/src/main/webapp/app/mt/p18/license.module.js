            ...
            app.makePost({
                ...
                success: function (d) {
                    ...
                    if (d.success) {
                    	...
                    	loadTbdDinhKem(d.data[0].fiIdGiayphep);
...
//                    });
        ...
        function loadTbdDinhKem(id){
            app.makePost({
                url: '/mt/18/call_service',
                data: JSON.stringify({
                    URL_BACKEND: "/mt/18/giayphepdinhkem/getById" ,  
                    METHOD: "POST",
                    REQUEST:id
                }),
                success: function (d) {
                   ...
                   // 
                    if (d.success) {
                    	self.Tbdgiayphepdinhkem = app.convertObjectToObservable(d.data, self.Tbdgiayphepdinhkem) ;   
                    } else {
                        msg = d.message;
                        fun = 'error';
                    }
