...
$(document).ready(function () {
    ...
    function ViewModel() {
        ...
        self.suaGiayPhep = function(id) {
            var callback = function (html) {
                var pop = app.popupWithLabel({
                    title: "Đề nghị sửa giấy phép"  + ' - Số giấy phép' + self.giayphep.fiSoVanBan(),
                    ...
                    buttons: [
                        {
                            ...
                            action: function () {
                                ...
                                var popConfirm = app.popup({
                                    title: NSWLang["common_msg_thong_bao"],
                                    html: '<i class="fa fa-3x fa-warning"></i> ' + 'Bạn có chắc chắn muốn yêu cầu sửa giấy phép ' + ' <b>' + self.giayphep.fiSoVanBan() + '</b>',
                                    width: 400,
                                    buttons: [
                                        {
                                            ...
                                            action: function () {
                                                app.makePost({
                                                    url: '/mt/56/ycsuagiayphep',
                                                    data:  JSON.stringify({fiIdGiayPhep: self.giayphep.fiIdGiayPhep(), fiLyDoSua: data,fiIdHoSo:  self.giayphep.fiIdHoSo()}),
                                                    success: function (d) {
                                                        ...
                                                        if (d.success) {
                                                            ...
                                                            location.href = app.appContext + '/mt/56/home/'+  procedureId;
                                                        } else {
                                                            self.showActionSuccess(false);
                                                            self.showActionError(true);
                                                        }
        ...
        self.traGiayPhep = function(id) {
            var callback = function (html) {
                var pop = app.popupWithLabel({
                    title: "Đề nghị trả giấy phép"   + ' - Số giấy phép' + self.giayphep.fiSoVanBan(),
                    ...
                    buttons: [
                        {
                            ...
                            action: function () {
                                ...
                                var popConfirm = app.popup({
                                    title: NSWLang["common_msg_thong_bao"],
                                    html: '<i class="fa fa-3x fa-warning"></i> ' + 'Bạn có chắc chắn muốn yêu cầu trả giấy phép ' + ' <b>' + self.giayphep.fiSoVanBan() + '</b>',
                                    width: 400,
                                    buttons: [
                                        {
                                            name: NSWLang["common_button_toi_chac_chan"],
                                            ...
                                            action: function () {
                                                app.makePost({
                                                    url: '/mt/56/yctragiayphep',
                                                    data:  JSON.stringify({fiIdGiayPhep:  self.giayphep.fiIdGiayPhep(), fiLyDoRut: data,fiIdHoSo:  self.giayphep.fiIdHoSo()}),
                                                    success: function (d) {
