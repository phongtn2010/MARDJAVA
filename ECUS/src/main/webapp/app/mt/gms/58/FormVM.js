...
function FormVM(options) {
    ...
    var hosoVG = [self.fiMaCqxl, self.fiTenDn, self.fiDiachiDn, self.fiDiachiDn, self.fiSdtDn,
        ...
        self.fiLydo, self.fiTenNgKy, self.fiDiaDiem
    ];
    ...
    self.init = function (hoso) {
        ...
        $("#fiLoaihinhDn").val(self.fiLoaihinhDn()).select2({placeholder: '-- Chọn --', width: '100%', allowClear: true});
    };
    ...
    self.isValidForm = function () {
        ...
        console.log(self.hosoErrors().length);
