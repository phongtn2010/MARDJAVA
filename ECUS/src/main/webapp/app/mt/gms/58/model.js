...
var mapTbdlichsu58 = function (dataFromServer,p) {
    return ko.utils.arrayMap(dataFromServer, function (item, index) {
        return new Tbdlichsu58(index + 1+p, item);
    });
};
var Tbdlichsu58 = function (STT, item) {
    var self = this;
...
var mapTbdhoso58 = function (d, p) {
    return ko.utils.arrayMap(d, function (item, index) {
        return new Tbdhoso58((index + p) + 1, item);
    });
};
function Tbdhoso58(STT, item) {
    var self = this;
...
var mapTbdhsXe58 = function (d) {
    return ko.utils.arrayMap(d, function (item, index) {
        item.fiStt = index + 1;
        return new TbdhsXe58(item);
    });
};