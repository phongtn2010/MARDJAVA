...
$(document).ready(function () {
    function ViewModel() {
        ...
        self.xemChiTietHoSo = function (item) {
            location.href = app.appContext + '/mard/14/view/' + item.fiIdHoSo();
        }

        self.xinSua = function (item) {
            item.xinSua = ko.observable(1);
            location.href = app.appContext + '/mard/14/ycs/' + item.fiIdHoSo();
        ...
        self.themMoiHoSo = function () {
            ...
            location.href = app.appContext + '/mard/14/edit';
        ...
        self.chinhSuaHoSo = function (item) {
            ...
            location.href = app.appContext + '/mard/14/edit/' + item.fiIdHoSo();
