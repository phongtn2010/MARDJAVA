...
$(document).ready(function () {
    function ViewModel() {
        ...
        self.xemChiTietHoSo = function (item) {
            location.href = app.appContext + '/mard/20/view/' + item.fiIdHoSo();
        }

        self.xinSua = function (item) {
            item.xinSua = ko.observable(1);
            location.href = app.appContext + '/mard/20/ycs/' + item.fiIdHoSo();
        ...
        self.themMoiHoSo = function () {
            ...
            location.href = app.appContext + '/mard/20/edit';
        ...
        self.chinhSuaHoSo = function (item) {
            ...
            location.href = app.appContext + '/mard/20/edit/' + item.fiIdHoSo();
