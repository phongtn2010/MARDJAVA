...
$(document).ready(function () {
    function ViewModel() {
        ...
        //sua giay phep
        self.suaGiayPhep = function(item) {
            var SuaGpView = new SuaGiayPhepView();
            SuaGpView.show(item , function(){
                setTimeout(function(){
                    location.reload();
                }, 1000);
            });
        }
        self.boSungToKhai = function(item) {
            var boSungToKhai = new BoSungToKhaiView();
            boSungToKhai.show(item , function(){
                setTimeout(function(){
                    location.reload();
                }, 1000);
            });
        ...
        self.xemChiTietHoSo = function (item) {
            location.href = app.appContext + '/mard/18/view/' + item.fiIdHoSo();
        }

        self.xinSua = function (item) {
            item.xinSua = ko.observable(1);
            location.href = app.appContext + '/mard/18/ycs/' + item.fiIdHoSo();
        ...
        self.themMoiHoSo = function () {
            ...
            location.href = app.appContext + '/mard/18/edit';
        ...
        self.chinhSuaHoSo = function (item) {
            ...
            location.href = app.appContext + '/mard/18/edit/' + item.fiIdHoSo();
