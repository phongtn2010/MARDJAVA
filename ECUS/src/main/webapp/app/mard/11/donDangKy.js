...
//        }
    ...
    self.toJSON = function () {
        var exclude = [ "hosoErrors", "hanghoaErrors","fiMadvSlList", "fiMaDvgsList", "fiMadvKltList", "fiMadvBiList", "fiMaqgNkList", "fiMackXkList", "fiMackNkList", "updateHanghoaClick", "bSuaHhClick", "bXoaHhClick", "chooseDocumentClick", "selectedDocumentClick", "toJSON", "fiMadvXlList"];
    ...
    var hosoVG = [self.fiMadvXl, self.fiTendvXl, self.fiDtDangky, self.fiSodt, self.fiDiachi, self.fiEmail, self.fiSocmnd, self.fiNoicmnd, self.fiDtXk, self.fiDiachidtxk, self.fiPtCc, self.fiMackXk, self.fiTenckXk, self.fiDtNk, self.fiDiachidtnk, self.fiMaqgNk, self.fiTenqgNk, self.fiMackNk, self.fiTenckNk, self.fiMucdichsd, self.fiDiadiemdk, self.fiThoigiandk, self.fiDdTgGs, self.fiSobangcn, self.fiNoiky, self.fiNgayky, self.fiNguoiky];
    self.hosoErrors = ko.validation.group(hosoVG, { deep: true, live: true, observable: true });
    var hanghoaVG = [self.fiTenHh, self.fiTenKh, self.fiCososx, self.fiMaCososx, self.fiDiachiCssx, self.fiMadvSl, self.fiTendvSl, self.fiSoluong, self.fiMadvKlt, self.fiTendvKlt, self.fiKlTinh, self.fiMadvBi, self.fiTendvBi, self.fiKlBi, self.fiMahs, self.fiSohd];
    ...
    getCategory("QUOCGIA", null, function(res){
        if(res.success){
            self.fiMaqgNkList(mapCategory(res.data,"countrycode", "countryname"));
            if(hoso.fiMaqgNk){
