...
function TbdHoSo19() {
    ...
    this.fiTaxCode = ko.observable(null).extend({required : true, maxLength : 12});
    ...
    this.fiInvoiceNo = ko.observable(null).extend({required:true, maxLength:  100});

    this.fiBillNo = ko.observable(null).extend({required:true, maxLength:  100});
...
function TbdThuoc19() {
    ...
    this.fiWeightUnitCode = ko.observable('').extend({required : true, maxLength : 10, notEqual: -1});
