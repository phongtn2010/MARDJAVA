...
NSW.prototype = {
    ...
    makePost: function (params) {
        ...
        $.ajax({
            ...
            timeout: op.timeout !== undefined ? op.timeout : 20000
        });
    },
    /**
    ...
    getChiCucTram: function (url, callback) {
        var self = this;
        return $.ajax({
            async: true,
            type: 'GET',
    ...
    getQuocgia: function (callback) {
        ...
        return $.ajax({
            ...
            cache: false,
            crossDomain: true,
            url: self.appContext + "/mard/08/danhmuc/quocgia",
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            beforeSend: function (xhr) {
                xhr.setRequestHeader(self.config.CSRF_TOKEN_NAME, self.config.CSRF_TOKEN_VALUE);
    ...
    getProfileStatus: function(systemId, callback) {
        var self = this;
        return $.ajax({
            async: true,
            type: 'GET',
            cache: false,
            crossDomain: true,
            url: self.appContext + '/mard/09/danhmuc/statusHoso' + "?systemId=" + systemId,
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            beforeSend: function (xhr) {
                xhr.setRequestHeader(self.config.CSRF_TOKEN_NAME, self.config.CSRF_TOKEN_VALUE);
...
//longph 2bs begin add thêm function 3/11/2018
...
//longph 2bs end add thêm function 3/11/2018
