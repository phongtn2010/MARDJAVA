...
function danhSachVM()
{
    ...
    self.soQuyetDinh = ko.observable(null);
    self.totalCount = ko.observable(0);
                                ...
                                if (d.success) {
                                    if (!app.requireSigning) {
                                        ...
                                        sendMessageToSign(result.fiXml,
                                                ...
                                                item.fiMaHoso(), 'MOST', item.fiIdHoso(),
                ...
                buttons: [
                    {
                        ...
                        action: function () {
                            ...
                            app.makePost({
                                url: '/most/03/hoso/yc-giahanbosung',
                                    ...
                                    if (d.success) {
                                        if (!app.requireSigning) {
                                            ...
                                            sendMessageToSign(result.fiXml,
                                                    result.fiMsgType, result.fiFunc,
                                                    item.fiMaHoso(), 'MOST', item.fiIdHoso(),
                                                    result.fiDocType, JSON.stringify(formData));
                                        }
                                    } else {
                                        msg = data.message;
                                        app.Alert(msg);
