...
DetailController.prototype = {
    ...
    init: function (obj) {
        ...
        if (this.hangHoa === null) {
            ...
            this.hangHoa.init({container: 'hanghoa-container', hangHoa1: op.hangHoa1, pager: 'hanghoa-pager', IsView: op.IsView});
        }

        if (this.hopDong === null) {
            this.hopDong = new HopDongController();

            this.hopDong.init({containerId: 'hopdong-container',
        ...
        if (this.vanDon === null) {
            ...
            this.vanDon.init({containerId: 'vandon-container',
        ...
        if (this.hoaDon === null) {
            ...
            this.hoaDon.init({containerId: 'hoadon-container',
        ...
        if (this.gcnTaiLieu === null) {
            ...
            this.gcnTaiLieu.init({containerId: 'gcn-container',
        ...
        if (this.taiLieuKhac === null) {
            ...
            this.taiLieuKhac.init({containerId: 'tlk-container',
