...
//	console.log(hoSo);
	...
	self.hinhThucXNKs.push({name: NSWLang['moit_07_hinhThucNK'], value: 2});
	self.hinhThucXNKs.push({name: NSWLang['moit_07_hinhThucXK'], value: 1});
