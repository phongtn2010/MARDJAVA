function ThongTinTepDinhKemViewModel(self) {
    ...
    self.layDanhSachTepTinTheoHS = function(d){
        ...
        if (d.hoSo.tbdDinhKem03DTOS) {
            ds.forEach(function(t, tIndex){
                $(d.hoSo.tbdDinhKem03DTOS).each(function(index, loopItem){
        ...
        uploadTo(files, function (d) {
            if (d.message === "0") {
                ...
                iDFiles.forEach(function (value, index) {
                    ...
                    if (idHoSo > 0) {
                        callApi('/mic/03/tbdDinhKem03/create', convertKnockoutToObject(tepTin, createObject(tepTin)), function (d) {
            ...
            buttons: [
                {
                    ...
                    action: function () {
                        ...
                        $(arr).each(function(index, loopItem){
                            if (idHoSo > 0) {
                                var url = '/mic/03/tbdDinhKem03/delete/' + idHoSo + "/" + loopItem.fiId();
