function LoadHoSoView(self) {
    ...
    self.titles.push({key: 'fiSignConfirmDate', value: i18nextko.t('tableHoSo.5'), align: 'center', dateFormat: 'DD/MM/YYYY HH:mm', columnType: TABLE_COLUMN_DISPLAY_DATE});
    self.titles.push({key: 'fiSendDate', value: i18nextko.t('tableHoSo.6'), align: 'center', dateFormat: 'DD/MM/YYYY HH:mm', columnType: TABLE_COLUMN_DISPLAY_DATE});
...
*/
	...
	self.load = function(page) {
        ...
        callApi('/mic/03/tbdHoSo03/page', searchItem, function (d) {
