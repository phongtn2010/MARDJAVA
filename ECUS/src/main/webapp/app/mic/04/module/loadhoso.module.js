function LoadHoSoView(self) {
    ...
    self.titles.push({key: 'fiSignConfirmDate', value: i18nextko.t('tableHoSo.5'), align: 'center', dateType: true, dateFormat: 'DD/MM/YYYY HH:mm', columnType: TABLE_COLUMN_DISPLAY_DATE});
