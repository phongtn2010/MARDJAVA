function TbdNguoiThamDinh04() {
	...
	this.fiTrinhDoNghiepVu = ko.observable(null).extend({required : true, maxLength : 255});

	this.fiTrinhDoChuyenMon = ko.observable(null).extend({required : true, maxLength : 255});

	this.fiTrinhDoNgoaiNgu = ko.observable(null).extend({required : true, maxLength : 255});

	this.fiThamNienCongTac = ko.observable(null).extend({required : true, maxLength : 255});
