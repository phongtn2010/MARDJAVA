...
function FormVM(options) {
    ...
    var hosoVG = [self.fiTenDn, self.fiChucvuNgDd, self.fiMstDn, self.fiDiachiDn, self.fiMaTinh, self.fiNguoiDd
                ,self.fiMaHang, self.fiSoLuong, self.fiMaDvtinh, self.fiTccl, 
                self.fiTenCoSoSx, self.fiMaQgSx, self.fiMucDichNk];
...
//        }
    ...
    self.toJSON = function () {
        ...
        var idxTemp = options.lstNguyenLieu.Search('fiMaNl', self.fiMaHang());
        self.fiLoaiHang(options.lstNguyenLieu[idxTemp].fiLoaiNl);
