...
function FileVM(item, idHoso, formVM) {
    ...
    var messageEvent = eventMethod === "attachEvent"
            ? "onmessage"
            : "message";
    var _domain = 'http://daotao.dav.gov.vn/';
    //var _domain = 'https://dichvucong.dav.gov.vn/';
    ...
    self.doUpload = function (item, e) {
        ...
        var url = _domain + '/haiquan/uploadfile/' + formVM.fiNguoitao() + '/' + formVM.fiMaTinh();
        var popup = app.popup({
                ...
                buttons: [
                    {
                        ...
                        action: function () {
                            ...
                            if(null == lstTemp) {
                                ...
                                item.fiGuiid(null);
                                item.fiTenTep(lstTemp[0]);
                                item.fiDuongDan(lstTemp[0]);
                                item.fiDuongDanTep(lstTemp[0]);
...
function mapTbdhsFile19(data, idHoso, formVM) {
    return ko.utils.arrayMap(data, function (item, index) {
