...
function FormVM(options) {
    ...
    var hosoVG = [self.fiTenDn, self.fiMstDn, self.fiDiachiDn, self.fiMaTinh, self.fiMucDichNk, self.fiNguoiDd,
        ...
        self.fiChucvuNgDd, self.lstCuaKhaus, self.fiBoPhanDung, self.fiMaQgCc];
    ...
    self.init = function (hoso) {
        ...
        if (hoso !== null) {
            ...
            self.fiMstDn(hoso.doanhNghiep != null && hoso.doanhNghiep.hasOwnProperty('fiMstDn') ? hoso.doanhNghiep.fiMstDn : user.username);
            self.fiTenDn(hoso.doanhNghiep != null && hoso.doanhNghiep.hasOwnProperty('fiTenDn') ? hoso.doanhNghiep.fiTenDn : user.companyName);
            self.fiDiachiDn(hoso.doanhNghiep !== null && hoso.doanhNghiep.hasOwnProperty('fiDiachiDn') ? hoso.doanhNghiep.fiDiachiDn : user.companyAddress);
