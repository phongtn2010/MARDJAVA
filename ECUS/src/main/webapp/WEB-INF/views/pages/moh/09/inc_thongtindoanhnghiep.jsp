...
<div class="form-group">
    <div class="col-md-12">
        ...
        <div class="col-md-10">
            <select class="form-control select2 fiMaTckt" id="fiMaTckt" name="fiMaTckt"  
...
<fieldset>
    ...
    <div class="form-group">
        <div class="col-md-12">
            ...
            <div class="col-md-4">
                <input class="form-control" type="text" name="fiSdtCh" data-bind="value : fiSdtCh" maxlength="50" />
            </div> 
        </div>  
    </div>            
    <div class="form-group">
        <div class="col-md-12">
            ...
            <div class="col-md-4">
                <input class="form-control" type="text" name="fiFaxCh" data-bind="value : fiFaxCh" maxlength="50" />
            </div>
            <div class="col-md-2 nsw-text-right">
                <label><spring:message code="moh.09.chuhang.email" /> <a class="nsw-require-field"> (*)</a></label>
            </div>
            <div class="col-md-4">
                <input class="form-control" type="text" name="fiEmailCh" data-bind="value : fiEmailCh" maxlength="50" />
            </div>
        </div>  
    </div>  
</fieldset>
...
<fieldset>
    ...
    <div class="form-group">
        <div class="col-md-12">
            <a class="btn green bt-center" data-bind="click: onKhaiBaoThuongNhan"><i class="fa fa-edit fa-lg"></i> Thêm mới </a>
                ...
                <tbody data-bind="foreach: lstNguoiChiuTrachNhiems">
                    <tr>
                        ...
                        <td style="text-align: center;">
                            <a class="green" data-bind="click: $parent.onEditThuongNhanTN.bind($parent)"><i class="fa fa-edit"></i> Sửa</a>
                            <br />
                            <a class="red" data-bind="click: $parent.onXoaChiTietThuongNhan.bind($parent)"><i class="fa fa-trash"></i> Xoá</a>
                        </td>
                    </tr>
                </tbody>
            </table> 
...
<fieldset>
    ...
    <div class="form-group">
        <div class="col-md-12">
            ...
            <div class="col-md-4">
                <input class="form-control" type="text" name="fiTenNgXk" data-bind="value : fiTenNgXk" maxlength="255" />
            </div> 
    ...
    <div class="form-group">
        <div class="col-md-12">
            ...
            <div class="col-md-4">                
                <input class="form-control" type="text" name="fiDiachiNgXk" data-bind="value : fiDiachiNgXk" maxlength="255" />
            </div>
            <div class="col-md-2 nsw-text-right">
                <label><spring:message code="moh.09.thuongnhanxuatkhau.sodienthoai" /></label>
            </div>
            <div class="col-md-4">
                <input class="form-control" type="text" name="fiSdtNgXk" data-bind="value : fiSdtNgXk" maxlength="50" />
            </div> 
        </div>  
    </div>            
    <div class="form-group">
        <div class="col-md-12">
            ...
            <div class="col-md-4">
                <input class="form-control" type="text" name="fiFaxNgXk" data-bind="value : fiFaxNgXk" maxlength="50" />
            </div>
            <div class="col-md-2 nsw-text-right">
                <label><spring:message code="moh.09.thuongnhanxuatkhau.email" /> </label>
            </div>
            <div class="col-md-4">
                <input class="form-control" type="text" name="fiEmailNgXk" data-bind="value : fiEmailNgXk" maxlength="50" />
            </div>
        </div>  
    </div>  
</fieldset>
