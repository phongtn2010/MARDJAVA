                                ...
                                <div class="tab-content" >
                                    <div class="tab-pane active" id="tab_mt_1" >
                                        <form role="form" class="form-horizontal" data-bind="with: formVM()">
                                            ...
                                            <%@include file="inc_view_thongtincuakhau.jsp" %>
...
<script src="<c:url value='/app/moh/03/model.js?v=${version}'/>" type="text/javascript" charset="utf-8"></script>
<script src="<c:url value='/app/moh/03/FormVM.js?v=${version}'/>" type="text/javascript" charset="utf-8"></script>
<script src="<c:url value='/app/moh/03/FileVM.js?v=${version}'/>" type="text/javascript" charset="utf-8"></script>
<script src="<c:url value='/app/moh/03/EditVM.js?v=${version}'/>" type="text/javascript" charset="utf-8"></script>
