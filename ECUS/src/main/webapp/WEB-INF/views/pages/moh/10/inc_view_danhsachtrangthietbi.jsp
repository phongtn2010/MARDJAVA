            ...
            <form role="form" class="form-horizontal" id="trangthietbi-form">
                <div class="form-group">
                    <div class="col-md-12">
                        ...
                        <div class="col-md-4">
                            <input class="form-control" type="text" readonly id="fiTenTtb" name="fiTenTtb" data-bind="value : fiTenTtb" maxlength="255" />
                        </div> 
                        <div class="col-md-2 nsw-text-right">
                ...
                <div class="form-group">
                    <div class="col-md-12">
                        ...
                        <div class="col-md-4">
                            <input class="form-control" type="text" readonly id="fiDongGoi" name="fiDongGoi" data-bind="value : fiDongGoi" maxlength="255" />
                        </div> 
                        <div class="col-md-2 nsw-text-right">
                            <label>Số lượng nhập khẩu<a class="nsw-require-field">*</a></label>
                        </div>
                        <div class="col-md-4">
                            <input class="form-control" type="text" readonly id="fiSoluongNk" name="fiSoluongNk" data-bind="value : fiSoluongNk" maxlength="255" />
                        </div> 
                    </div>
                </div>
                <div class="form-group">  
                ...
                <div class="form-group">
                    <div class="col-md-12">
                        ...
                        <div class="col-md-10">
                            <input class="form-control" type="text" readonly id="fiTenCsh" name="fiTenCsh" data-bind="value : fiTenCsh" maxlength="255" />
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-md-12">
                        ...
                        <div class="col-md-10">
                            <input class="form-control" type="text" readonly id="fiDiachiCsh" name="fiDiachiCsh" data-bind="value : fiDiachiCsh" maxlength="255" />
                        </div>
                    </div>
                </div>
            ...
            <form role="form" class="form-horizontal" id="chungloai-form">
                <div class="form-group">
                    <div class="col-md-12">
                        ...
                        <div class="col-md-9">
                            <input class="form-control" readonly type="text" id="fiMaSpCl" name="fiMaSpCl" data-bind="value : fiMaSpCl" maxlength="255" />
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-md-12">
                        ...
                        <div class="col-md-9">
                            <input class="form-control" readonly type="text" id="fiDongGoiCl" name="fiDongGoiCl" data-bind="value : fiDongGoiCl" maxlength="255" />
                        </div>
                    </div>
                </div>
                        ...
                        <table class="table table-striped table-bordered table-hover table-checkable order-column">
                            ...
                            <tbody data-bind="foreach: lstCssxHangHoas">
                                <tr>
                                    ...
                                    <td>
                                        <input class="form-control" readonly name="fiTenCssx" data-bind="value : fiTenCssx" maxlength="250"/>
                                    </td>  
                                    <td>
                                        <input class="form-control" readonly name="fiDiachiCssx" data-bind="value : fiDiachiCssx" maxlength="250"/>
                                    </td>
