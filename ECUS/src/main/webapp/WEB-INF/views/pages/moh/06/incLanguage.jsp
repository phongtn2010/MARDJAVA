...
<script type="text/javascript">
    ...
    NSWLang["moh_06_common_eror_luuhosothatbai"] = <spring:message code="moh.p06.error.luu_ho_so_that_bai" />;
    NSWLang["moh_06_common_eror_guihosothatbai"] = <spring:message code="moh.p06.error.gui_ho_so_that_bai" />;
    ...
    NSWLang["moh_06_themthietbi_theophuluc"] = "<spring:message code="moh.typea.themthietbi.theophuluc" />";        

    //tepdinhkem
    NSWLang["moh_06_tepdinhkem_thongbao_trunglap"] = "<spring:message code="moh.typea.tepdinhkem.thongbao.trunglap" />";
    NSWLang["moh_06_tepdinhkem_thongbao_thieu"] = "<spring:message code="moh.typea.tepdinhkem.thongbao.thieu" />";
    NSWLang["moh_06_tepdinhkem_banphanloaittbyte"] = "<spring:message code="moh.typea.tepdinhkem.loaitep.banphanloaittbyte" />";
    NSWLang["moh_06_tepdinhkem_phieutiepnhan"] = "<spring:message code="moh.typea.tepdinhkem.loaitep.phieutiepnhan" />";
    NSWLang["moh_06_tepdinhkem_giayuyquyen"] = "<spring:message code="moh.typea.tepdinhkem.loaitep.giayuyquyen" />";
    NSWLang["moh_06_tepdinhkem_giayxacnhandudkbaohanh"] = "<spring:message code="moh.typea.tepdinhkem.loaitep.giayxacnhandudkbaohanh" />";
    NSWLang["moh_06_tepdinhkem_tailieumotakythuat"] = "<spring:message code="moh.typea.tepdinhkem.loaitep.tailieumotakythuat" />";
    NSWLang["moh_06_tepdinhkem_giaychungnhanhopchuan"] = "<spring:message code="moh.typea.tepdinhkem.loaitep.giaychungnhanhopchuan" />";
    NSWLang["moh_06_tepdinhkem_tailieuhdsd"] = "<spring:message code="moh.typea.tepdinhkem.loaitep.tailieuhdsd" />";
    NSWLang["moh_06_tepdinhkem_maunhansudung"] = "<spring:message code="moh.typea.tepdinhkem.loaitep.maunhansudung" />";
    
    //cosobaohanh
    NSWLang["moh_typea_co_so_bao_hanh"] = "<spring:message code="moh.typea.cosobaohanh" />";        
    NSWLang["moh_typea_ten_co_so_bao_hanh"] = "<spring:message code="moh.typea.tencosobaohanh" />";        
    ...
    NSWLang["moh_typea_phuong_xa"] = "<spring:message code="moh.typea.cosobaohanh.phuongxa" />";            
    NSWLang["moh_typea_mst_co_so_bao_hanh"] = "<spring:message code="moh.typea.cosobaohanh.mst_cosobaohanh" />";
    NSWLang["moh_typea_danhsachcosobaohanh_thongbao"] = "<spring:message code="moh.typea.danhsachcosobaohanh.thongbao" />";            
    NSWLang["moh_typea_cosobaohanh_chon"] = "<spring:message code="moh.typea.cosobaohanh.button.choncosobaohanh" />";            
    NSWLang["moh_typea_cosobaohanh_nhaptay"] = "<spring:message code="moh.typea.cosobaohanh.button.nhaptay" />";            
