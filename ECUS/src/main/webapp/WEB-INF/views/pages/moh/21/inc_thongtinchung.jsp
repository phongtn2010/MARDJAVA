...
<fieldset>
    ...
    <div class="form-group">
        <div class="col-md-12">
            ...
            <div class="col-md-4">
                <input class="form-control" type="text" id="fiTenDnEn" name="fiTenDnEn" data-bind="value : fiTenDnEn " maxlength="250" />
            </div>
            <div class="col-md-2 nsw-text-right">
            ...
            <div class="col-md-4">                                        
                <input class="form-control" type="text" id="fiDiachiDnEn" name="fiDiachiDnEn" data-bind="value : fiDiachiDnEn" maxlength="13" />
            </div>
        </div> 
    </div>
    <div class="form-group">
