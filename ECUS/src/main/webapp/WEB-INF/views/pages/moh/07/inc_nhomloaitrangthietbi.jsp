...
<fieldset>
    ...
    <div class="form-group">
        <div class="col-md-12">
            ...
            <div class="col-md-4" data-bind="visible: showInvitro">
                <select class="form-control select2 fiLoaiInvitro" id="fiLoaiInvitro" name="fiLoaiInvitro"  
                        data-bind="value: fiLoaiInvitro, 
                                optionsCaption: 'Chọn...', 
                                optionsValue : 'id',
                                options : lstLoaiInvitro, 
                                optionsText : 'name',
                                event: {change: onfiLoaiInvitroChange}"></select>
            </div>
        </div>  
    </div>
    <div class="form-group" data-bind="visible: showQtxlNhanh">
        <div class="col-md-12">
            <div class="col-md-2 nsw-text-right">
                <label>Quy trình xử lý  (<a class="nsw-require-field">*</a>)</label>
            </div>
            <div class="col-md-4">
                <select class="form-control select2 fiQtxlNhanh" id="fiQtxlNhanh" name="fiQtxlNhanh"  
                        data-bind="value: fiQtxlNhanh, 
                                ...
                                optionsText : 'name',
                                event: {change: onfiQtxlNhanhChange}"></select>
            </div>
        </div>
    </div>
</fieldset>
