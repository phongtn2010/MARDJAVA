...
<page size="A4" class="a4-padding" data-bind="visible: isSecondGroup">
    ...
    <table class="w100p tb-item">
        <thead>
            <tr style="border: 1px solid #333333 !important">
                ...
                <th>Số giấy đăng ký lưu hành/ Số giấy phép nhập khẩu</th>
                <th>Tên, địa chỉ cơ sở sản xuất - Tên nước sản xuất</th>
                <th>Tên, địa chỉ cơ sở nhập khẩu - Tên nước nhập khẩu</th>
            </tr>
        </thead>
        <tbody data-bind="template: { name: 'lstNguyenLieu2Tmpl', foreach: $parent.lstHangHoa }">
        </tbody>
        <script id="lstNguyenLieu2Tmpl" type="text/html">
            <tr>
                <td>
                ...
                <td>
                    <span data-bind="text : fiTccl"></span>
                </td>
                <td>
    ...
    <table class="tb-content w100p tb-none-border">        
        <tr>
            ...
            <td class="t-center pb-long" style="border: 0px;">
                <span class="t-bold" data-bind="text: fiTenTinh"></span>, <span data-bind="text: $parent.fnNgayGuiText"></span><br/>
