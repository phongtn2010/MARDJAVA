...
<fieldset>
    ...
    <div class="form-group">
        <div class="col-md-12">
            ...
            <div class="col-md-4">
                <select class="form-control select2" id="fiMaTinh" name="fiMaTinh" disabled data-bind="optionsCaption: 'Chọn...', optionsValue : 'id', selectedText : fiTenTinh, value : fiMaTinh, options : lstTinhThanh, optionsText : 'name'"></select>
            </div> 
        </div>  
    </div>
    <div class="form-group">
        <div class="col-md-12">
            ...
            <div class="col-md-4">
                <input class="form-control form-control-inline" id="fiChucvuNgDd" readonly="readonly" name="fiChucvuNgDd" data-bind="value : fiChucvuNgDd" type="text" maxlength="100"/>
            </div>
        </div> 
    </div>
    <div class="form-group">
        <div class="col-md-12">
            <div class="col-md-2 nsw-text-right">
                <label><spring:message code="moh.19.hoso.tendoanhnghiep_en" /><a class="nsw-require-field" data-bind="visible: visibleThongTinChungTiengAnh">*</a></label>
            </div>  
            <div class="col-md-4">
                <input class="form-control" type="text" id="fiTenDnEn" name="fiTenDnEn" readonly="readonly" data-bind="value : fiTenDnEn " maxlength="250" />
            </div>
            <div class="col-md-2 nsw-text-right">
                <label><spring:message code="moh.19.hoso.diachitruso_en" /><a class="nsw-require-field" data-bind="visible: visibleThongTinChungTiengAnh">*</a></label>
            </div>
            <div class="col-md-4">                                        
                <input class="form-control" type="text" id="fiDiachiDnEn" name="fiDiachiDnEn" readonly="readonly" data-bind="value : fiDiachiDnEn" maxlength="13" />
            </div>
        </div> 
    </div>
    <div class="form-group">
        <div class="col-md-12">
            ...
            <div class="col-md-4">
                <select class="form-control select2" id="fiLoaiDon" name="fiLoaiDon" disabled data-bind="optionsCaption: 'Chọn...', optionsValue : 'id', value : fiLoaiDon, options : lstLoaiDonHang, optionsText : 'name'"></select>
            </div>
            <div class="col-md-2 nsw-text-right">
                <label><spring:message code="moh.19.hoso.cukhaududinhnhapkhau" /> <a class="nsw-require-field">*</a></label>
            </div>
            <div class="col-md-4">
                <select class="form-control select2 fiMaCuaKhau" id="fiMaCuaKhau" disabled name="fiMaCuaKhau" multiple="multiple" 
