        ...
        <div class="portlet light ">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <span class="caption-subject bold uppercase"><spring:message
                                        code="moh.02.hoso.tracuu.timkiem"/> </span>
                            </div>
                                ...
                                <form role="form" class="form-horizontal" name="searchForm">
                                    <div class="form-group" style="margin-top: 15px;">
                                        <div class="col-md-12">
                                            <div class="col-md-2 nsw-text-right">
                                                <label><spring:message code="moh.02.hoso.tracuu.mahoso"/></label>
                                            </div>
                                            <div class="col-md-4">
                                            ...
                                            <div class="col-md-2 nsw-text-right">
                                                <label><spring:message
                                                        code="moh.02.hoso.tracuu.trangthaihoso"/></label>
                                            </div>
                                            <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-12">
                                            <div class="col-md-2 nsw-text-right">
                                                <label><spring:message
                                                        code="moh.02.hoso.tracuu.ngaynoptu"/></label>
                                            </div>
                                            <div class="col-md-4">
                                            ...
                                            <div class="col-md-2 nsw-text-right">
                                                <label><spring:message
                                                        code="moh.02.hoso.tracuu.ngaynopden"/></label>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="input-group">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-12">
                                            <div class="col-md-2 nsw-text-right">
                                                <label><spring:message
                                                        code="moh.02.hoso.tracuu.ngaycaptu"/></label>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="input-group">
                                            ...
                                            <div class="col-md-2 nsw-text-right">
                                                <label><spring:message
                                                        code="moh.02.hoso.tracuu.ngaycapden"/></label>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="input-group">
            ...
            <div class="row">
                <div class="col col-md-6">
                    <spring:message code="moh.02.hoso.tracuu.ketquatimkiem"/>
                    ...
                    <div id="list-pager" class="nsw-flr">
                        ...
                        <ul data-bind="visible: true" class="flip pull-left pagination pagination-sm">
                            <li data-bind="css: { disabled: !firstPageActive() }">
                                <a data-bind="click: goToFirst"><spring:message code="moh.02.hoso.trangdau"/></a>
                            </li>
                            <li data-bind="css: { disabled: !previousPageActive() }">
                                <a data-bind="click: goToPrevious"><spring:message
                                        code="moh.02.hoso.trangtruoc"/></a>
                            </li>
                            <!-- ko foreach: getPages() -->
                            ...
                            <li data-bind="css: { disabled: !nextPageActive() }">
                                <a data-bind="click: goToNext"><spring:message code="moh.02.hoso.trangsau"/></a>
                            </li>
                            <li data-bind="css: { disabled: !lastPageActive() }">
                                <a data-bind="click: goToLast"><spring:message code="moh.02.hoso.trangcuoi"/></a>
                            </li>
                        </ul>
                        <!-- /ko -->
                    </div>
            ...
            <table class="table table-striped table-bordered table-hover table-checkable order-column"
                ...
                <tr class="nsw-tr tr-nsw1-bgcolor">
                    <th class="text-center" style="width: 1%;vertical-align: middle;"><spring:message
                            code="moh.02.hoso.danhsach.stt"/></th>
                    <th class="text-center" style="width: 5%;vertical-align: middle;"><spring:message
                            code="moh.02.hoso.danhsach.lichsuxuly"/></th>
                    <th class="text-center" style="width: 10%;vertical-align: middle;"><spring:message
                            code="moh.02.hoso.danhsach.mahoso"/></th>
                    <th class="text-center" style="width: 15%;vertical-align: middle;"><spring:message
                            code="moh.02.hoso.danhsach.tendoanhnghiep"/></th>
                    <th class="text-center" style="width: 10%;vertical-align: middle;"><spring:message
                            code="moh.02.hoso.danhsach.ngaynop"/></th>
                    <th class="text-center" style="width: 10%;vertical-align: middle;"><spring:message
                            code="moh.02.hoso.danhsach.ngaycapphep"/></th>
                    <th class="text-center" style="width: 15%;vertical-align: middle;"><spring:message
                            code="moh.02.hoso.danhsach.trangthai"/></th>
                    <th class="text-center" style="width: 7%;vertical-align: middle;"><spring:message
                            code="moh.02.hoso.danhsach.xemgiayphep"/></th>
                </tr>
                </thead>
                        ...
                        <ul data-bind="visible: true" class="flip pull-left pagination pagination-sm">
                            <li data-bind="css: { disabled: !firstPageActive() }">
                                <a data-bind="click: goToFirst">
                                    <spring:message code="moh.02.hoso.trangdau"/></a>
                            </li>
                            <li data-bind="css: { disabled: !previousPageActive() }">
                                <a data-bind="click: goToPrevious">
                                    <spring:message code="moh.02.hoso.trangtruoc"/></a>
                            </li>
                            <!-- ko foreach: getPages() -->
                            <li data-bind="css: { active: $parent.currentPage() === $data }">
                                <a data-bind="click: $parent.goToPage, text: $data"></a>
                            ...
                            <li data-bind="css: { disabled: !nextPageActive() }">
                                <a data-bind="click: goToNext">
                                    <spring:message code="moh.02.hoso.trangsau"/></a>
                            </li>
                            <li data-bind="css: { disabled: !lastPageActive() }">
                                <a data-bind="click: goToLast">
                                    <spring:message code="moh.02.hoso.trangcuoi"/></a>
                            </li>
                        </ul>
                        <!-- /ko -->
                    </div>
...
<script src="<c:url value='/app/moh/02/model.js?v=${version}'/>" type="text/javascript"></script>
<script src="<c:url value='/app/moh/02/index.js?v=${version}'/>" type="text/javascript"></script>
        ...
        <table class="table table-striped table-bordered table-hover table-checkable order-column"
            ...
            <tr>
                <th class="text-center" style="width: 5%;"><spring:message
                        code="moh.02.hoso.lichsuxuly.stt"/></th>
                <th class="text-center"><spring:message
                        code="moh.02.hoso.lichsuxuly.tendonvi"/></th>
                <th class="text-center"><spring:message
                        code="moh.02.hoso.lichsuxuly.noidung"/></th>
                <th class="text-center"><spring:message
                        code="moh.02.hoso.lichsuxuly.linkcongvan"/></th>
                <th class="text-center"><spring:message
                        code="moh.02.hoso.lichsuxuly.thoigian"/></th>
                <th class="text-center" style="max-width: 200px;"><spring:message
                        code="moh.02.hoso.lichsuxuly.trangthai"/></th>
            </tr>
            </thead>
            ...
            <script id="historyItemTmpl" type="text/html">
                <tr>
                    ...
                    <td style="word-wrap: break-word; vertical-align: middle; max-width: 200px !important;" class="text-left"
                        data-bind="text : fiTenDvgui"></td>
                    <td class="text-left"
                        style="width: 220px;text-align: left;word-wrap: break-word;max-width: 200px !important;vertical-align: middle;"
                        data-bind="text : fiNoidung"></td>
                    <td class="text-left"
                        style="width: 220px;text-align: left;word-wrap: break-word;max-width: 200px !important;vertical-align: middle;">
                        <a target="_blank" data-bind="text: fiLinkCv, attr: { href: fiLinkCv}"></a>
                    </td>
                    <td style="word-wrap: break-word; vertical-align: middle; max-width: 200px !important;" class="text-center"
...
<template id="kqxl-template">
    <form role="form" class="form-horizontal" id="kqxl-form">
        <div class="form-group">
            <div class="col-md-12">
                <div class="col-md-4">
                    <label><spring:message code="moh.02.kqxl.mahoso"/></label>
                </div>
            ...
            <div class="col-md-12">
                <div class="col-md-4">
                    <label><spring:message code="moh.02.kqxl.noidung"/></label>
                </div>
            ...
            <div class="col-md-12">
                <div class="col-md-4">
                    <label><spring:message code="moh.02.kqxl.ngayxl"/></label>
                </div>
            ...
            <div class="col-md-12">
                <div class="col-md-4">
                    <label><spring:message code="moh.02.kqxl.donvixl"/></label>
                </div>
            ...
            <div class="col-md-12">
                <div class="col-md-4">
                    <label><spring:message code="moh.02.kqxl.linkcv"/></label>
                </div>
