        ...
        <div class="portlet light ">
            <div class="portlet-title">
                <div class="caption font-dark">
                    <span class="caption-subject bold uppercase"><spring:message code="moh.39.tenthutuc" /></span>
                </div>
            </div>
...
<script src="<c:url value='/app/moh/39/FormVM.js?v=${version}'/>" type="text/javascript" charset="utf-8"></script>
