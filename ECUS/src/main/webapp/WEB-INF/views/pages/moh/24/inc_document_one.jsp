...
<page size="A4" class="a4-padding" data-bind="visible: isFirstGroup">
    <table class="tb-none-border w100p">
        <tr>
            <td class="w35p">
                <div class="left t-center t-bold">
                    <p class="content t-bold" data-bind="text : fiTenDn"></p>
                    <p class="code">
                        Số: <span data-bind="text : fiMaHoso"></span>
                    </p>
                </div>
            </td>
            <td>
    ...
    <p class="content">
        Tên cơ sở xuất khẩu (bằng tiếng Việt và tiếng Anh): <span data-bind="text : fiTenDn"></span>/<span data-bind="text : fiTenDnEn"></span>
    </p>
    <p class="content">	
        Địa chỉ (bằng tiếng Việt và tiếng Anh): <span data-bind="text : fiDiachiDn"></span>/<span data-bind="text : fiDiachiDnEn"></span>
    </p>
    <p class="content">
        <span data-bind="text : fiTenDn"></span> kính đề nghị Cục Quản lý Dược - Bộ Y tế xem xét cấp phép xuất khẩu thuốc sau vì mục đích thương mại theo quy định tại Điều 57 Nghị định số 54/2017/NĐ-CP ngày 08/05/2017
    </p>
    
    <table class="w100p tb-item">
        <thead>
            <tr style="border: 1px solid #333333 !important">
                <th>Tên thuốc, dạng bào chế, quy cách đóng gói</th>
                <th>Hoạt chất, hàm lượng/ nồng độ</th>
                <th>Số giấy đăng ký lưu hành, giấy phép nhập khẩu</th>
                <th>Đơn vị tính</th>
                <th>Số lượng</th>
                <th>Tên nguyên liệu phải kiểm soát đặc biệt</th>
                <th>Tổng số khối lượng nguyên liệu phải kiểm soát đặc biệt tính ra gam</th>
                <th>Tên, địa chỉ cơ sở sản xuất - Tên nước sản xuất</th>
                <th>Tên, địa chỉ cơ sở nhập khẩu - Tên nước nhập khẩu</th>
            </tr>
        </thead>
        <tbody data-bind="template: { name: 'lstNguyenLieuTmpl', foreach: $parent.lstHangHoa }">
        </tbody>
        <script id="lstNguyenLieuTmpl" type="text/html">
            <tr>
                <td>
                    <span data-bind="text : fiTenHang"></span>,
                    <span data-bind="text : fiBaoChe"></span>,
                    <span data-bind="text : fiDongGoi"></span>,
                </td>
                <td>
                    <span data-bind="text : fiHoatChat"></span>
                </td>
                <td>
                    <span data-bind="text : fiSoDkLh"></span>
                </td>
                <td>
                ...
                <td>
                    <span data-bind="text : fiTenNglieu"></span>
                </td>
                <td>
                    <span data-bind="text : fiTongKl"></span>
                </td>
                <td>
                    <span data-bind="text : fiTenCoSoSx"></span>,
                    <span data-bind="text : fiDiachiCssx"></span>,
                    <span data-bind="text : fiTenQgSx"></span>
                </td>
                <td>
                    <span data-bind="text : fiTenCoSoNk"></span>,
                    <span data-bind="text : fiDiachiCsNk"></span>,
                    <span data-bind="text : fiTenQgNk"></span>
                </td>                
            </tr>
        </script>
    </table>		
    <p class="content pt-10">
        Cửa khẩu dự định sẽ xuất khẩu (ghi rõ tên sân bay, hải cảng):  <span data-bind="text : $parent.portNames"></span>/<span data-bind="text : fiTenCkhauEn"></span>
    </p>
    <br/>
    <br/>
    <br/>
    <table class="tb-content w100p tb-none-border">        
        <tr>
            <td class="w50p pb-long" style="border: 0px;">
            ...
            <td class="t-center pb-long" style="border: 0px;">
                <span class="t-bold" data-bind="text: fiTenTinh"></span><span>, <span data-bind="text: $parent.fnNgayGuiText"></span><br/>
                <span class="t-bold">Người đại diện pháp luật/ Người được ủy quyền</span><br/>
                (Ghi rõ họ tên, ký, đóng dấu)<br/>
                <br/>
                <br/>
                <span data-bind="text : fiNguoiDd"></span>
            </td>
        </tr>
    </table>
</page>