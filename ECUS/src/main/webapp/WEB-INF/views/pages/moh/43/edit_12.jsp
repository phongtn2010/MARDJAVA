        ...
        <div class="portlet light ">
            <div class="portlet-title">
                <div class="caption font-dark">
                    <span class="caption-subject bold uppercase"><spring:message code="moh.43.tenthutuc" /></span>
                </div>
            </div>
                                ...
                                <div class="tab-content" >
                                    ...
                                    <div class="tab-pane active" id="tab_mt_1" >
                                        <form role="form" class="form-horizontal">
                                            ...
                                            <%@include file="inc_12_thongtinthuoc.jsp" %>
...
<script src="<c:url value='/app/moh/43/FormVM.js?v=${version}'/>" type="text/javascript" charset="utf-8"></script>
