                                    ...
                                    <form role="form" class="form-horizontal" name="searchForm">
                                        ...
                                        <div class="form-group"> 
                                            <div class="col-md-12">
                                                ...
                                                <div class="col-md-4">
                                                    <input class="form-control" name="soTiepNhan" id="soTiepNhan" data-bind="value : soTiepNhan, executeOnEnter : searchFieldEnter, valueUpdate: 'input'" placeholder="Số tiếp nhận" type="text">
                                                </div>
                                                <div class="col-md-2 nsw-text-right">
                                        ...
                                        <div class="form-group"> 
                                            <div class="col-md-12">
                                                ...
                                                <div class="col-md-4">
                                                    <input class="form-control" name="soChungnhan" id="soChungnhan" data-bind="value : soChungnhan, executeOnEnter : searchFieldEnter, valueUpdate: 'input'" placeholder="..." type="text">
                                                </div>
                                            </div>
                                        </div>
                ...
                <table class="table table-striped table-bordered table-hover table-checkable order-column" id="monre06Items">
                    ...
                    <script id="itemTmpl" type="text/html">
                        <tr>
                            ...
                            <td data-bind="text : fiSoTiepnhan"></td>
                            <td>
    ...
    <template id="history-tmpl">
        ...
        <template id="payment-tmpl">
            <form role="form" class="form-horizontal" id="payment-form">
                ...
                <div class="row" data-bind="visible: showUpload">
                    <div class="col-md-5 nsw-text-right">
                ...
                <div class="row" data-bind="visible: showUpload">   
                    ...
                    <div class="col-md-7">
                        <a style="color:red; font-size: 8pt">(Bắt buộc với Loại thanh toán là Chuyển khoản)</a>
                    </div>
                </div>
                <div class="row" data-bind="visible: showLink">    
                    <div class="col-md-5 nsw-text-right">
                        <label></label>
                    </div>
                    <div class="col-md-7">
                        <a target="_blank" data-bind="attr: { href: keypayLink} ">Link thanh toán</a>
                    </div>
                </div>
        ...
        <template id="report-tmpl">
            <form role="form" class="form-horizontal" name="ruthoso-form" id="report-form">   
                ...
                <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-4 nsw-text-right">
                            <label>Nội dung </label><a class="nsw-require-field">*</a>
                        </div>
                        <div class="col-md-8">
