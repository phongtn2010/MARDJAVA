                                ...
                                <div class="tab-content" >
                                    ...
                                    <div class="tab-pane active" id="tab_mt_1" >
                                        <form role="form" class="form-horizontal">
                                            ...
                                            <%@include file="inc_thongtinthuoc.jsp" %>
                                            <%@include file="inc_nguyenlieuthuoc.jsp" %>
...
<script src="<c:url value='/app/moh/19/model.js?v=${version}'/>" type="text/javascript" charset="utf-8"></script>
<script src="<c:url value='/app/moh/19/FormVM.js?v=${version}'/>" type="text/javascript" charset="utf-8"></script>
<script src="<c:url value='/app/moh/19/FileVM.js?v=${version}'/>" type="text/javascript" charset="utf-8"></script>
<script src="<c:url value='/app/moh/19/EditVM.js?v=${version}'/>" type="text/javascript" charset="utf-8"></script>
