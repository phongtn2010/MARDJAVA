        ...
        <div class="portlet light ">
            <div class="portlet-title">
                <div class="caption font-dark">
                    <b>GIẤY CHỨNG NHẬN</b> <span class="caption-subject bold uppercase" data-bind="text: propTitle"></span>
                </div>
            </div>
                                                ...
                                                <form role="form" class="form-horizontal" id="trangthietbi-form">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-md-12">
                                                            ...
                                                            <div class="col-md-4">
                                                                <input class="form-control" type="text" data-bind="value : fifiNgaycapText" readonly="true" />
                                                            </div> 
                                                            <div class="col-md-2 nsw-text-right">
