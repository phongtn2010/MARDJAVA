                                                ...
                                                <form role="form" class="form-horizontal" id="trangthietbi-form">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-md-12">
                                                            ...
                                                            <div class="col-md-4">
                                                                <input class="form-control" type="text" data-bind="value : fiDchiCshDklh" readonly="true" />
                                                            </div> 
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
...
<script src="<c:url value='/app/moh/11/ResultVM.js?v=${version}'/>" type="text/javascript" charset="utf-8"></script>
