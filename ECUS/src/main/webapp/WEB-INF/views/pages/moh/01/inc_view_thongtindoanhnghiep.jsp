...
<div class="form-group">
    <div class="col-md-12">
        <div class="col-md-2 nsw-text-right">
            <label><spring:message code="moh.01.thongtindon.sovanban" /></label>
        </div>
        <div class="col-md-4">
...
<fieldset>
    ...
    <div class="form-group">
        <div class="col-md-12">
            <div class="col-md-2 nsw-text-right">
                <label><spring:message code="moh.01.doanhnghiep.tinhthanh" /> </label>
            </div>
            <div class="col-md-4">
            ...
            <div class="col-md-2 nsw-text-right">
                <label><spring:message code="moh.01.doanhnghiep.quanhuyen" /> </label>
            </div>
            <div class="col-md-4">
