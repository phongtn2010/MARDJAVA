...
<div class="row" id="mt-container">
                                    ...
                                    <form role="form" class="form-horizontal" name="searchForm">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                ...
                                                <div class="col-md-4">
                                                    <input name="ngayTaoDenNgay" id="ngayTaoDenNgay" placeholder="dd/mm/yyyy"  data-bind="datepicker : ngayTaoDenNgay" 
    ...
    <script src="<c:url value='/app/moh/18/model.js?v=${version}'/>" type="text/javascript"></script>
    <script src="<c:url value='/app/moh/18/index.js?v=${version}' />" type="text/javascript"></script>
