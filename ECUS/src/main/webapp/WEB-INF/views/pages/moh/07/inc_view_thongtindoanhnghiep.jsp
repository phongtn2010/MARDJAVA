...
<fieldset data-bind="visible: showFactory">
    ...
    <div class="form-group">
        <div class="col-md-12">
            <div class="col-md-2 nsw-text-right">
                <label>Tên đơn vị sản xuất </label>
            </div>  
            <div class="col-md-4">
                <input class="form-control" type="text" id="fiFcTen" readonly="true" name="fiFcTen" data-bind="value : fiFcTen" maxlength="240" />
            </div>  
            <div class="col-md-2 nsw-text-right">
                <label>Địa chỉ trụ sở </label>
            </div>  
            <div class="col-md-4">
                <input class="form-control" type="text" id="fiFcDiachi" readonly="true" name="fiFcDiachi" data-bind="value : fiFcDiachi" maxlength="240" />
            </div>
        </div> 
        <div class="col-md-12">
            <div class="col-md-2 nsw-text-right">
            ...
            <div class="col-md-4">
                <input class="form-control" type="text" id="fiFcSdt" readonly="true" name="fiFcSdt" data-bind="value : fiFcSdt" maxlength="20" />
            </div>  
            <div class="col-md-2 nsw-text-right">
                <label>Fax </label>
            </div>  
            <div class="col-md-4">
                <input class="form-control" type="text" id="fiFcFax" readonly="true" name="fiFcFax" data-bind="value : fiFcFax" maxlength="20" />
            </div>
        </div>
    </div>    
</fieldset>
