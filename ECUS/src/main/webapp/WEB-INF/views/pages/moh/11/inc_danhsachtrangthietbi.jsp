    ...
    <div class="form-group">
        <div class="col-md-12">
            ...
            <div class="col-md-10">
                ...
                <input class="form-control" type="text" id="fiSoDklh" name="fiSoDklh" 
                       data-bind="textInput: fiSoDklh,
                            event: {
                                keypress: OnEnterEvent,
                                blur: OnBlurEvent}" maxlength="50" />
            </div>
        </div>  
    </div>
    <div class="form-group">
        <div class="col-md-12">
            ...
            <div class="col-md-10">
                <input type="checkbox" id="fiDacoSoDklh" disabled name="fiDacoSoDklh" 
