...
var mapTbdlichsu19 = function (dataFromServer) {
    return ko.utils.arrayMap(dataFromServer, function (item, index) {
        return new Tbdlichsu19(index + 1, item);
    });
};
var Tbdlichsu19 = function (STT, item) {
    var self = this;
...
var mapTbdhoso19 = function (d, p) {
    return ko.utils.arrayMap(d, function (item, index) {
        return new Tbdhoso19((index + p) + 1, item);
    });
};
function Tbdhoso19(STT, item) {
    var self = this;
    ...
    self.bXinRutHoSo = ko.dependentObservable(function () {
        //return true;
        return [CHO_TIEP_NHAN, YC_BO_SUNG, DA_BO_SUNG_HOSO].indexOf(self.fiTrangthai()) >= 0;
...
var mapTbdhsNglieu19 = function (d) {
    return ko.utils.arrayMap(d, function (item, index) {
        item.fiStt = index + 1;
        return new TbdhsNglieu19(item);
    });
};
