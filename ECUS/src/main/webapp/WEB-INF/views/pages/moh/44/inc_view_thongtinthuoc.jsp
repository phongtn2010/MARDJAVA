...
<fieldset>
    ...
    <div class="form-group">
        <div class="col-md-12">
            ...
            <div class="col-md-4">
                <input class="form-control" id="fiTenKhac" readonly="readonly" name="fiTenKhac" type="text" data-bind="value: fiTenKhac" maxlength="250"/>
            </div>
            <div class="col-md-2 nsw-text-right">
    ...
    <div class="form-group">
        <div class="col-md-12">
            ...
            <div class="col-md-10">
                <textarea class="form-control" readonly="readonly" data-bind="value : fiGhiChu" id="fiGhiChu" name="fiGhiChu" maxlength="2000"></textarea>
            </div>
        </div> 
    </div>
</fieldset>
