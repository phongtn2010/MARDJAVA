        ...
        <table class="table table-striped table-bordered table-hover table-checkable order-column">
            <thead>
                <tr class="nsw-tr tr-nsw1-bgcolor">
                    ...
                    <th class="text-center"><spring:message code="moh.01.xacnhannopphi.loaiphi" /></th>
            ...
            <tbody data-bind="foreach: lstThanhToans">
                <tr>
                    ...
                    <td class="text-center">
                       <a target="_blank" href="javascript:void(0);" data-bind="visible: canDownload, attr: { href: fileUrl}"><i class="fa fa-download fa-lg"></i></a>
                    </td>  
                </tr>
            </tbody>
        </table>
