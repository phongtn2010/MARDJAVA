...
<fieldset>
    <legend style="color: dodgerblue;">
        <b><spring:message code="moh.03.hoso.thongtindinhkem"/></b>
    </legend>
            ...
            <table class="table table-striped table-bordered table-hover table-checkable order-column"
                ...
                <tr class="nsw-tr tr-nsw1-bgcolor">
                    <th class="text-center" style="width: 1%;vertical-align: middle;"><spring:message
                            code="moh.03.hoso.thongtindinhkem.stt"/></th>
                    <th class="text-center" style="width: 30%;vertical-align: middle;"><spring:message
                            code="moh.03.hoso.thongtindinhkem.tentep"/></th>
                    <th class="text-center" style="width: 15%;vertical-align: middle;"><spring:message
                            code="moh.03.hoso.thongtindinhkem.chontep"/></th>
                </tr>
                </thead>
                <tbody data-bind="template: { name: 'dinhKemTmpl', foreach: lstDinhkem03 }">
                </tbody>
                <script id="dinhKemTmpl" type="text/html">
                    <tr>
                        ...
                        <td style="vertical-align: middle;text-align: left;word-wrap: break-word;max-width: 240px !important;">
