...
<div class="col-md-12">
	<div class="row">
		<div class="form-group">
			<label for="inputPassword" class="col-sm-2 text-right"><spring:message code="moit.06.form.thongtinhanghoa.01"></spring:message><span class="nsw-require-field">*</span></label>
			<div class="col-sm-10">
					...
					<div class="form-group">
						...
						<div class="col-sm-2">
							<div class="row" data-bind="if:(!$root.thongTinHangHoaModel.xemHoSo())">
									<span data-bind="if: ((item.idCuaKhau() > -1))"> <a data-bind="click: $root.deleteCuaKhau"><img src='<c:url value="/app/moit/06/icon/xbutton.png"  />' /></a>
									</span>
									<span data-bind="if: ($root.thongTinHangHoaModel.cuaKhaus().length - 1 == $index())"> <a data-bind="click: $root.addCuaKhau"><img src='<c:url value="/app/moit/06/icon/Add.png"  />' /></a>
									</span>
							</div>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-2">
							<div class="row"  data-bind="if:(!$root.thongTinHangHoaModel.xemHoSo())">
									...
									<span data-bind="if: ($root.thongTinHangHoaModel.phuongTiens().length - 1 == $index())"> <a data-bind="click: $root.addPhuongTien"><img src='<c:url value="/app/moit/06/icon/Add.png"  />' /></a>
									</span>
							</div>
						</div>
					</div>
