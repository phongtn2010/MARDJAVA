...
<div class="table-re">
	<table class="table table-striped table-bordered table-hover table-checkable order-column">
		<thead class="nsw-tr tr-nsw1-bgcolor">
			<th class="text-center" width="5%"><spring:message code="moit.06.form.thongtinhanghoa.danhsachhanghoa.table.th01"></spring:message></th>
			<th class="text-center" width="15%"><spring:message code="moit.06.form.thongtinhanghoa.danhsachhanghoa.table.th02"></spring:message></th>
			<th class="text-center" width="10%"><spring:message code="moit.06.form.thongtinhanghoa.danhsachhanghoa.table.th03"></spring:message></th>
			<th class="text-center" width="10%"><spring:message code="moit.06.form.thongtinhanghoa.danhsachhanghoa.table.th04"></spring:message></th>
			<th class="text-center" width="10%"><spring:message code="moit.06.form.thongtinhanghoa.danhsachhanghoa.table.th05"></spring:message></th>
			<th class="text-center" width="10%"><spring:message code="moit.06.form.thongtinhanghoa.danhsachhanghoa.table.th06"></spring:message></th>
			<th class="text-center" width="10%"><spring:message code="moit.06.form.thongtinhanghoa.danhsachhanghoa.table.th07"></spring:message></th>
			<th class="text-center" width="10%"><spring:message code="moit.06.form.thongtinhanghoa.danhsachhanghoa.table.th08"></spring:message></th>
		...
		<tbody data-bind="foreach: { data: hangHoas, as: 'item' }">
			<tr>
				...
				<td data-bind="if:(!$root.xemHoSo())">
					<span data-bind="if: (item.update())">
						<a style="padding: 16px; margin-bottom: 10px;" title="<spring:message code="moit.06.form.tiente.button.luu" />" class="btn green bt-center" data-bind="click: $root.updateHangHoa"> <i class="fa fa-save" aria-hidden="true"></i>
							</a>
					</span>
					<span data-bind="if: (!item.enable() && $root.hangHoas().length - 1 != $index() && $root.saveFast())">
						<a style="padding: 15px; margin-bottom: 10px;" title="<spring:message code="moit.06.form.tiente.button.sua" />" class="btn green bt-center" data-bind="click: $root.editHangHoa"> <i class="fa fa-edit" aria-hidden="true"></i>
							</a>
						<a style="padding: 16px; margin-bottom: 10px;" title="<spring:message code="moit.06.form.tiente.button.xoa" />" class="btn red bt-center" data-bind="click: $root.deleteHangHoa"> <i class="fa fa-trash-o" aria-hidden="true"></i>
							</a>
					</span>
					<span data-bind="if: ($root.hangHoas().length - 1 == $index())"> 
						<a style="padding: 13px; margin-bottom: 10px;" title="<spring:message code="moit.06.form.tiente.button.them" />" class="btn green bt-center" data-bind="click: $root.addHangHoa"> <i class="fa fa-plus ic-plus" aria-hidden="true"></i>
							</a>
					</span>
				</td>
			</tr>
