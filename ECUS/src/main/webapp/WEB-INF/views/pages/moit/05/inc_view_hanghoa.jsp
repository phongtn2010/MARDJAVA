            ...
            <table class="table table-striped table-bordered table-hover table-checkable order-column" id="lstHanghoa10">
                ...
                <tbody data-bind="foreach: lstNguyenlieus">
                    <tr>
                        ...
                        <td>
                            <input class="form-control" type="number" name="fiDangkyNhapkhauNamx1" data-bind="value : fiDangkyNhapkhauNamx1" minlength="3" maxlength="12" readonly/>
                        </td>
                        <td>
                            <input class="form-control" type="number" name="fiSoluongCapX1" data-bind="value : fiSoluongCapX1" minlength="3" maxlength="12" readonly/>
                        </td>
                        <td>
                            <input class="form-control" type="number" name="fiUocThuchienX1" data-bind="value : fiUocThuchienX1" minlength="3" maxlength="12" readonly/>
                        </td>
                        <td>
                            <input class="form-control" type="number" name="fiDangkyNhapkhauNamx" data-bind="value : fiDangkyNhapkhauNamx" minlength="3" maxlength="12" readonly/>
                        </td>                        
                    </tr>
                </tbody>
            </table>
