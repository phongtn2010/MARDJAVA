            ...
            <table class="table table-striped table-bordered table-hover table-checkable order-column">
                <thead>
                    <tr>
                        ...
                        <th><b><spring:message code="moit.05.lichsu.nguoixuly" /></b></th>
                        <th><b><spring:message code="moit.05.lichsu.donvixuly" /></b></th>
                        <th style="max-width: 200px;"><b><spring:message code="moit.05.lichsu.noidung" /></b></th>
                        <th class="text-center"><b><spring:message code="moit.05.lichsu.thoigian" /></b></th>
                        <th style="max-width: 200px;"><b><spring:message code="moit.05.lichsu.trangthaihoso" /></b></th>
                    </tr>
                </thead>
