            ...
            <table class="table table-striped table-bordered table-hover table-checkable order-column" style="width: 100%;table-layout: fixed;">
                <thead>
                    <tr class="nsw-tr tr-nsw1-bgcolor">
                        ...
                        <th class="text-center" style="width: 10%;"><spring:message code="mic.02.hoso.dinhkem.chucnang" /></th>
                    </tr>
                </thead>
                <tbody data-bind=" foreach: $data.formVM().lstTeptin02">
                    <tr>
                        <td data-bind="text: $index() + 1" style=" vertical-align: middle;word-wrap: break-word;">
                        </td>  
                        ...
                        <td style=" width: 30%;word-wrap: break-word;vertical-align: middle;">
                        ...
                        <td class="text-center" style="min-width: 100px !important; width: 1%;vertical-align: middle;word-wrap: break-word;">
                ...
                <style>
                    ...
                    <p id="valid-file" data-bind="text : $data.formVM().errorDinhKemMessage" style="color:red;"> </p>
