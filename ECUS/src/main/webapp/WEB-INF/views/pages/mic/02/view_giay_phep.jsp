        ...
        <form role="form" class="form-horizontal" name="suaGp-form" id="suaGp-form">
            ...
            <div class="col-md-12" style="margin-top: 10px;">
                ...
                <div class="col-md-9">
                    ...
                    <a target="_blank" data-bind="text: $data.fileDK.fiTenTepTin, attr: { href: $data.fileDK.fiDuongDan}" style="margin-top: 10px; float: left;max-width: 100%;word-wrap: break-word;"></a>
