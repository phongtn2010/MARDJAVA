                ...
                <table class="table table-striped table-bordered table-hover table-checkable order-column" id="monre06Items">
                    <thead>
                        <tr class="nsw-tr tr-nsw1-bgcolor">
                            ...
                            <th class="text-center" style="width: 100px;"> <spring:message code="mic.02.hoso.danhsach.trangthai" /> </th>
    ...
    <template id="history-tmpl">
        <form role="form" class="form-horizontal" id="history-form">
            ...
            <table class="table table-striped table-bordered table-hover table-checkable order-column" style="width: 100%;table-layout: fixed;">
                <thead>
                    <tr>
                        <th class="text-center" style="width: 5%;"><b><spring:message code="mic.02.hoso.lichsu.stt" /></b></th>
                ...
                <script id="historyItemTmpl" type="text/html">
                    <tr>
                        <td data-bind="text : STT" style=" vertical-align: middle;word-wrap: break-word;"></td>
                        <td class="text-left" style=" vertical-align: middle;word-wrap: break-word;" data-bind="text : fiDonviXuly"></td> 
                        <td class="text-left" style=" vertical-align: middle;word-wrap: break-word;" data-bind="text : fiNoidung"></td> 
                        <td class="text-left" style=" vertical-align: middle;word-wrap: break-word;"> 
                            <a target="_blank" data-bind="visible: true, attr: { href: fiLinkCv, title: fiLinkCv }"><p data-bind="text : fiLinkCv" ></p></a>
                        </td>
                        <td class="text-center" style=" vertical-align: middle;word-wrap: break-word;" data-bind="text : fiNgaytao"></td> 
                        <td class="text-left" style=" vertical-align: middle;word-wrap: break-word;" data-bind="text : fiTenTt"></td>                     
                    </tr>                      
                    </script>
                </table> 
            </form>
