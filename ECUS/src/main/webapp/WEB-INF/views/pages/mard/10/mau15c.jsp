<%-- 
    Document   : mau15c
    Created on : Aug 7, 2017, 2:26:03 PM
    Author     : hieptran
--%>
...
<page size="A4" class="a4-padding">
    ...
    <table class="tb-content w100p">
        ...
        <tbody data-bind="template: { name: 'lstHanghoa15cTmpl', foreach: lstHanghoa15c }">
        </tbody>
        <script id="lstHanghoa15cTmpl" type="text/html">
            <tr>
    ...
    <p class="content">
        5. Phương tiện vận chuyển, các vật dụng khác có liên quan kèm theo bảo đảm yêu cầu vệ sinh thú y, đã được khử trùng tiêu độc bằng <span data-bind="text : fiPptdkt"></span> nồng độ <span data-bind="text : fiNongdo"></span>
    </p>
    <table class="tb-content w100p">
        <tr>
