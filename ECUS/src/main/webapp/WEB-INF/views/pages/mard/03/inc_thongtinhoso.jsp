...
<%--                <input class="form-control" id="fiNgayTao" name="fiNgayTao" type="text" data-bind="value : fiNgayTao" readonly="readonly"/>--%>
            </div>
            <div class="col-md-2 nsw-text-left">
                <label><spring:message code="mard.03.hoso.thongtinchung.coquanxly" /><a class="nsw-require-field">*</a></label>
            </div>
            <div class="col-md-4">
    ...
    <div class="form-group" style="margin-top: 15px;">
        <div class="col-md-12">
            <div class="col-md-2 nsw-text-left">
                <label><spring:message code="mard.03.hoso.thongtinchung.noidky" /><a class="nsw-require-field">*</a></label>
            </div>
            ...
            <div class="col-md-4">
                <select class="form-control select2" id="regPlace" name="regPlace"
                        data-bind="optionsCaption: 'Chọn nơi đăng ký', optionsValue : 'id'
                            ...
                            , options : lstRegPlace
                            , optionsText : 'name'
                            ,event: {change: changeNoiDk}"></select>
            </div>

            <div class="col-md-2 nsw-text-left">
                <label><spring:message code="mard.03.hoso.thongtinchung.donkhaibaoso" /><a class="nsw-require-field">*</a></label>
            </div>
            <div class="col-md-4">
                <input class="form-control" id="fiSoDonKhaiBao" name="fiSoDonKhaiBao"  type="text" data-bind="value : fiSoDonKhaiBao" />
    ...
    <div class="form-group" style="margin-top: 15px;">
        <div class="col-md-12">
            <div class="col-md-2 nsw-text-left">
                <label><spring:message code="mard.03.hoso.thongtinchung.loaisp" /><a class="nsw-require-field">*</a></label>
            </div>
            ...
            <div class="col-md-4">
                <select class="form-control select2" id="fiMaLoaiSp" name="fiMaLoaiSp"
                        data-bind="optionsCaption: 'Chọn loại sản phẩm', optionsValue : 'id'
                            ...
                            , options : lstLoaiSp
                            , optionsText : 'name'
                            , event: {change: changeLoaiSp}">
                </select>
            </div>
            <!--ko if: isView3 -->
            <div class="col-md-2 nsw-text-left">
                <label><spring:message code="mard.03.hoso.thongtinchung.socongvancap" /><a class="nsw-require-field">*</a></label>
            </div>

            <div class="col-md-4">
                <input class="form-control" id="fiSoCongVanCap" name="fiSoCongVanCap" type="text" data-bind="value : fiSoCongVanCap" />
            </div>
            <!-- /ko -->
        </div>
    </div>
    ...
    <div class="form-group" style="margin-top: 15px;">
        <div class="col-md-12">
            <div class="col-md-2 nsw-text-left">
                <label><spring:message code="mard.03.hoso.thongtinchung.socnkiemdichnk" /><a class="nsw-require-field">*</a></label>
            </div>

            <div class="col-md-4">
                <input class="form-control" id="fiSoGcnKdNk" name="fiSoGcnKdNk" type="text"
                       data-bind="value : fiSoGcnKdNk, event: {change: fillHosoBySoGcn}" />
            </div>
        </div>
    </div>
    <!-- /ko -->
