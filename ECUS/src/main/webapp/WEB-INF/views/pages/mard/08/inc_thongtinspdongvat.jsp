...
<div data-bind="with: regAnimalProductVM">
    <fieldset data-bind="with: productVM">
        <legend><b><spring:message code="mard.08.table.title.thong_tin_sp_dong_vat"/></b>
                    ...
                    <table class="table table-striped table-bordered table-hover  order-column">
                        ...
                        <tr>
                            ...
                            <td class="text-center" data-bind="visible: $root.isEditable()">
                                <a style="margin-bottom: 5px" title="Sửa" data-target="#modal_addAnimalProduct" data-toggle="modal">
                                    <i style="color: #337ab7" class="fa fa-lg fa-edit"  aria-hidden="true" data-bind="click: function(){$parent.updateProduct($index())}"></i>
                                </a>
...
<%--            </div>--%>
    ...
    <fieldset data-bind="with: exporterVM">
        <legend><b><spring:message code="mard.08.table.title.thong_tin_cong_ty"/></b>
            <a style="margin-left: 10px" class="btn green" title=""
               data-bind="visible: $root.isEditable()"
               data-target="#modal_addAnimalProductExporter"
               data-toggle="modal"><i class="fa fa-plus"></i>
            </a>
        </legend>
        <form role="form" class="form-horizontal">
                ...
                <div class="col-md-12">
                    ...
                    <table class="table table-striped table-bordered table-hover  order-column">
                        ...
                        <tr>
                            ...
                            <td class="text-center" data-bind="visible: $root.isEditable()">
                                <a style="margin-bottom: 5px" title="Sửa" data-target="#modal_addAnimalProductExporter" data-toggle="modal" data-bind="click: function(){$parent.update($index())}">
...
<%--            </div>--%>
    ...
    <fieldset data-bind="with: productMfrVM">
        <legend><b><spring:message code="mard.08.table.title.thong_tin_nha_may_che_bien"/></b>
            <button style="margin-left: 10px" class="btn green" title=""
                    data-bind="visible: $root.isEditable()"
                    data-target="#modal_addAnimalProductMfr"
                    data-toggle="modal"><i class="fa fa-plus"></i>
            </button>
        </legend>
        <form role="form" class="form-horizontal">
                ...
                <div class="col-md-12">
                    ...
                    <table class="table table-striped table-bordered table-hover  order-column">
                        ...
                        <tr>
                            ...
                            <td class="text-center" data-bind="visible: $root.isEditable()">
                                <a style="margin-bottom: 5px" title="Sửa" data-target="#modal_addAnimalProductMfr" data-toggle="modal" data-bind="click: function(){$parent.update($index())}">
                                    <i style="color: #337ab7;" class="fa fa-lg fa-edit" aria-hidden="true"></i>
                                </a>
                                <a style="margin-bottom: 5px;" title="Xóa">
...
<%--            </div>--%>
    ...
    <form role="form" class="form-horizontal">
        ...
        <div class="form-group">
            <div class="col-md-12">
                <div class="col-md-2 nsw-text-right">
                    <label><spring:message
                            code="mard.08.tokhai.giay_to_kem_theo"/><a
                            class="nsw-require-field">*</a></label>
                </div>
                <div class="col-md-4">
                    <input
                            data-bind="trimedValue: fiProvidedDocument, enable: $root.isEditable()" class="form-control" maxlength="500"/>
                </div>
            </div>
        </div>
    </form>
    <!-- modal -->
    <div id="modal_addAnimalProduct" class="modal container in modal-overflow" tabindex="-1"
         data-backdrop="static" data-keyboard="false" data-bind="with: productVM"
    >
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
            <b class="modal-title"><spring:message code="mard.08.table.title.thong_tin_sp_dong_vat"/></b>
        </div>
    ...
    <!-- end modal -->
    <!-- modal -->
    <div id="modal_addAnimalProductExporter" class="modal container in modal-overflow" tabindex="-1"
    ...
    <!-- end modal -->
    <!-- modal -->
    <div id="modal_addAnimalProductMfr" class="modal container in modal-overflow" tabindex="-1"
