...
<div>
    <div id="modal_gcn_hk_lon" class="modal container in modal-overflow" tabindex="-1"
                ...
                <div>
                    ...
                    <table class="table table-striped table-bordered table-hover table-checkable order-column">
                        <tr class="">
                            ...
                            <th class="text-center">
                                <p>Ngày sản xuất từ ngày</p>
                                <p style="font-style:italic;">From </p>
                            </th>
                            <th class="text-center">
                                <p>Ngày sản xuất đến ngày</p>
                                <p style="font-style:italic;">To </p>
                            </th>
                            <th class="text-center">
                                <p>Số Lô hàng</p>
                                <p style="font-style:italic;">Lot identification No </p>
                            </th>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                From: <span style="font-weight: bold" data-bind="date: fiFromDateProduct"></span>
                            </td>
                            <td>
                                To: <span style="font-weight: bold" data-bind="date: fiToDateProduct"></span>
                            </td>
                            <td class="text-center">
                                <span style="font-weight: bold" data-bind="text: fiLotIndetificationNo"></span>
                            </td>
                        </tr>
                        </tbody>
                    </table>
