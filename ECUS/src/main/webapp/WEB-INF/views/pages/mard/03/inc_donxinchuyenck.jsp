    ...
    <page size="A4" class="a4-padding">
        ...
        <p class="content">
            ...
            <b data-bind="text: fiTenCuaKhauNhap"></b>. Tại thời điểm hiện tại, lô hàng đã đến cửa khẩu <b
                data-bind="text: fiTenCuaKhauNhap"></b>, dưới sự giám sát của
            quý Cơ quan <b data-bind="text: fiTenCQ"></b>. Do gặp khó khăn trong việc nhận hàng và muốn thay đổi cửa
            khẩu nhận hàng sang
            cửa khẩu <b data-bind="text: fiTenCuaKhauXuat"></b>.
        </p>
        ...
        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="lstHanghoa">
            ...
            <tr>
                ...
                <td data-bind="text : netWeight" class="text-right"></td>
                <td data-bind="text : ptVanchuyen"></td>
                <td data-bind="text : soNiemphong"></td>
                <td data-bind="text : fiCuakhauXuat"></td>
                <td data-bind="text : donviXl"></td>
            </tr>
            </tbody>
        </table>
        ...
        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="lstHanghoa3">
            ...
            <tr>
                ...
                <td data-bind="text : netWeight" class="text-right"></td>
                <td data-bind="text : ptVanchuyen"></td>
                <td data-bind="text : ptVchuyenMoi"></td>
<%--                <td>--%>
<%--                    <input class="form-control" id="ptVchuyenMoi"--%>
<%--                           data-bind="value : ptVchuyenMoi"/>--%>
<%--                </td>--%>
                <td data-bind="text : soNiemphong"></td>
                <td data-bind="text : fiCuakhauXuat"></td>
                <td data-bind="text : donviXl"></td>
...
<template id="xinchuyenck-tmpl">
    <div class="row">
        <form role="form" class="form-horizontal" name="xinchuyenck-form" id="xinchuyenck-form">
            <div class="col-md-12">
            ...
            <div class="col-md-12">
                ...
                <div class="col-md-10">
                    <textarea name="fiNoiDungCK" id="fiNoiDungCK" data-bind="value: fiNoiDungCK" require="true"
