...
<div>
    ...
    <div id="modal_xemGVCDV" class="modal container in modal-overflow" tabindex="-1"
        ...
        <div class="modal-body container" style="display: flex">
            <page size="A4" class="a4-padding col-md-12">
                ...
                <h4 class="code" style="font-weight: bold; text-align: center">
                    <p>GIẤY CHỨNG NHẬN VẬN CHUYỂN</p>
                ...
                <table class="table table-striped table-bordered table-hover table-checkable order-column">
                    ...
                    <tr>
                        ...
                        <th class="text-center" colspan="2">Giới tính</th>
                    ...
                    <tr>
                        ...
                        <td class="text-right" data-bind="text: fiAge"/>
                ...
                <p>2. Số động vật trên khỏe mạnh và không có triệu chứng lâm sàng của bệnh truyền nhiễm khi nhập khẩu.</p>
                <p>3. Phương tiện vận chuyển, các vật dụng khác có liên quan kèm theo bảo đảm yêu cầu vệ sinh thú y, đã được khử trùng tiêu độc bằng <span style="font-weight: bold" data-bind="text: fiAnimalOfAntiseptic"></span> nồng độ <span style="font-weight: bold" data-bind="text: fiAnimalOfConcentration"></span></p>
                ...
                <p>Tôi kiểm dịch viên động vật ký tên dưới đây chứng nhận:</p>
                <p>1. Số động vật trên phải được chuyển đến nơi cách ly kiểm dịch trước ngày <span style="font-weight: bold" data-bind="date: fiTransportDate"></span> để nuôi cách ky kiểm dịch tại địa điểm: <span style="font-weight: bold" data-bind="text: fiTransportPlace"></span></p>
                <p>2. Chỉ được vận chuyển theo lộ trình: <span style="font-weight: bold" data-bind="text: fiTransportStreet"/></p>
                <p>3. Nghiêm cấm vứt chất thải, rác thải, xác động vật trong quá trình vận chuyển</p>
                <p>4. Chỉ được phép đưa động vật về nơi cách ly kiểm dịch tại địa điểm nêu trên và đúng thời gian quy định để nuôi cách ly kiểm dịch.</p>
