...
<page size="A4" class="a4-padding" id="gcn11View">
    <table width="100%" >
        <thead><tr><td style="width: 6.25%;"></td><td style="width: 6.25%;"></td><td style="width: 6.25%;"></td><td style="width: 6.25%;"></td><td style="width: 6.25%;"></td><td style="width: 6.25%;"></td><td style="width: 6.25%;"></td><td style="width: 6.25%;"></td><td style="width: 6.25%;"></td><td style="width: 6.25%;"></td><td style="width: 6.25%;"></td><td style="width: 6.25%;"></td><td style="width: 6.25%;"></td><td style="width: 6.25%;"></td><td style="width: 6.25%;"></td><td style="width: 6.25%;"></td></tr></thead>
        <tbody>
            <tr>
                <td colspan="6">
            ...
            <tr>
                <td colspan="12" rowspan="2">
                    ...
                    <p class="content">
                        TO: THE PLANT PROTECTION ORGANIZATION(S) OF <span data-bind="text : fiTenNn"></span></p>
                </td>
            </tr>
            <tr>
                <td colspan="12">
            ...
            <tr>
                <td colspan="8" rowspan="2">
                    ...
                    <p class="content ">
                        ...
                        <span  data-bind="text : fiNguoiXk" ></span> <span  data-bind="text :fiDiachiXk " ></span>
                    </p>
                </td>
                <td colspan="8">
                    <p class="content t-bold">
                    ...
                    <p class="content ">
                        PLACE OF ORIGIN:
                        <span  data-bind="text : fiDiachiNsx" ></span></p>
            ...
            <tr>
                <td colspan="8">
                    ...
                    <p class="content ">
                        ...
                        <span  data-bind="text :fiDiachiNn " ></span></p>
                ...
                <td colspan="8">
                    ...
                    <p class="content ">
                        <span  data-bind="text :fiCkNhap " ></span> <span  data-bind="text :fiTennuocQc " ></span></p>
            ...
            <tr>
                <td colspan="8">
                    ...
                    <p class="content ">
                        ...
                        <span  data-bind="text : fiMakyhieu" ></span></p>
                ...
                <td colspan="8">
                    ...
                    <p class="content ">
                        ...
                        <span  data-bind="text : tkh" ></span></p>
                </td>
            </tr>
            <tr>
                <td colspan="16">
                    Nay chứng nhận rằng thực vật, sản phẩm thực vật hoặc vật thể thuộc diện kiểm dịch thực vật (KDTV) nêu trên được nhập khẩu vào Việt Nam từ nước <span  data-bind="text : fiTunuoc" ></span> (This is to certify that the plaints, plant products described above ware imported into Vietnam from) với Giấy chứng nhận KDTV số (covered by Phytosantary Certificate No) <span  data-bind="text : fiSocnkdtv" ></span>, bản gốc (original) [ <span  data-bind="text : fiBangoc" ></span> ] bản sao (certified true copy) [ <span  data-bind="text : fiBansao" ></span> ] gửi kèm theo giấy chứng nhận này (of which is attached to this certificate); rằng chúng đa được đóng gói (that they are packed) [ <span  data-bind="text : fiDadonggoi" ></span> ] đóng gói lại (repacked) [ <span  data-bind="text : fiDagoilai" ></span> ] giữ nguyên bao bì gốc (in original) [ <span  data-bind="text :fiGiunguyengoc " ></span> ] bao bì mới (new container) [ <span  data-bind="text : fiBaobimoi" ></span> ] trên cơ sở Giấy chứng nhận KDTV gốc (that based on original phytosantitary certificate) [ <span  data-bind="text : fiTrencsGoc" ></span> ] và kiểm tra bổ sung (and additional inspection) [ <span  data-bind="text : fiKtBosung" ></span> ], được coi là phù hợp với yêu cầu KDTV hiện hành của nước nhập khẩu, và trong thời gian bảo quản tại Việt Nam, lô hàng này không bị lây nhiêm sinh vật gây hại (they are considered to confirm with the current phytosanitary requirements of the importing contraction party, and that during storage in Vietnam, the consignment has not been subjected to risk of infestation or infection)
                </td>
            </tr>
            <tr>
                <td colspan="16">
            ...
            <tr>
                <td colspan="16">
                    <p class="content t-bold t-center">
                        XỬ LÝ (DISINFESTATION AND / OR DISINFECTION TEATMENT)
                    </p>
                </td>
            </tr>
            <tr>
