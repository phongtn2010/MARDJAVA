...
<div class="row" id="FoodSafetyResultVM">
    <div class="col-md-12">
                                ...
                                <div class="tab-content" >
                                    ...
                                    <div class="tab-pane active" id="tab_1">
                                        <form role="form" class="form-horizontal"  >
                                            <%@include file="mau_giay_attp.jsp" %>
                                        </form>
                                    </div>
...
<script src="<c:url value='/app/mard/04/FoodSafetyResultVM.js?v=${version}'/>" type="text/javascript"></script>
