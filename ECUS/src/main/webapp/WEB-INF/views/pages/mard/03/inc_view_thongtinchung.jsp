...
<fieldset>    
    ...
    <div class="form-group" style="margin-top: 15px;">
        <div class="col-md-12">
            ...
            <div class="col-md-4">
                <input class="form-control" id="fiFaxDn" name="fiFaxDn" type="text" data-bind="value : fiFaxDn" disabled/>
            </div>
            ...
            <div class="col-md-4">
                <input class="form-control" id="fiEmailDn" name="fiEmailDn" type="text" data-bind="value : fiEmailDn" disabled/>
            </div>
        </div>
    </div> 
</fieldset>
