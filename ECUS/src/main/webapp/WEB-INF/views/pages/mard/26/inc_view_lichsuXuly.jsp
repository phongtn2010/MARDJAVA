...
<div>
    ...
    >
        <div class="modal-header">
            ...
            <b class="modal-title">Lịch sử hồ sơ: <span data-bind="text: fiMaHoso"></span></b>
        </div>
            ...
            <div class="tab-content" id="pageView">
                <table class="table table-striped table-bordered table-hover table-checkable order-column">
                    ...
                    <tr>
                        ...
                        <th class="text-center" width="15%">Đơn vị xử lý</th>
                        ...
                        <th class="text-center" width="10%">Trạng thái hồ sơ</th>
                    </tr>
                    </thead>
                    ...
                    <tr>
                        ...
                        <td data-bind="text: fiSenderUnitCode"></td>
                        <td data-bind="text: fiSenderName"></td>
                        <td data-bind="date: fiCreatedDate"></td>
                        <td data-bind="html: fiContent"></td>
                        <td data-bind="text: $root.getTrangThai(fiStatus())"></td>
                    </tr>
                    </tbody>
                </table>
                <div class="row">
