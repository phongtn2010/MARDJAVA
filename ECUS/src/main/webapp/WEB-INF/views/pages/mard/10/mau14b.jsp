...
<page size="A4" class="a4-padding">
    ...
    <p class="content">
        1. Số sản phẩm động vật trên phải được chuyển đến nơi cách ly kiểm dịch trước ngày <span data-bind="text : fiCachlyTn"></span>. để kiểm dịch tại địa điểm: <span data-bind="text : fiNoiCachly"></span>	
    </p>
    <p class="content">
