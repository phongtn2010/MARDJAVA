...
<fieldset>
    ...
    <div class="form-group">
        <div class="col-md-12">
            <table class="table table-striped table-bordered table-hover table-checkable order-column" id="lstLichsu11">
                <thead>
                    <tr class="nsw-tr tr-nsw1-bgcolor">
                        <th class="text-center">STT</th>
                        <th class="text-center" style="width: 100px;">Ngày tạo</th>
                        <th class="text-center">Trạng thái</th>
                        <th class="text-center" style="width: 100px;">Thời hạn</th>
                ...
                <tbody data-bind="template: { name: 'lstLichsu11Tmpl', foreach: lstLichsu11 }">
                </tbody>
                <script id="lstLichsu11Tmpl" type="text/html">
                    <tr>
                        <td data-bind="text : STT">
                        </td>  
                        <td data-bind="date : fiNgaytao" style="width: 100px;">
                        </td> 
                        <td data-bind="text : fiTenTrangthai">
                        </td>
                        <td data-bind="date : fiThoihan" style="width: 100px;">
                        </td> 
