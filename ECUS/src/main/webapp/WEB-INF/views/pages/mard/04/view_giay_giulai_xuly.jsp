...
<div class="row" id="PhytosanitaryDetainVM">
    <div class="col-md-12">
                        ...
                        <div class="panel">
                            <div class="tabbable-custom ">
                                <ul class="nav nav-tabs ">
                                    <li class="active">
                                        <a href="#tab_1" data-toggle="tab" id="a-tab-1"> <b>Giấy lệnh giữ lại và xử
                                            lý</b></a>
                                    </li>
                                </ul>
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane active" id="tab_1">
                                        <form role="form" class="form-horizontal">
                                            <%@include file="mau_giay_giulai_xuly.jsp" %>
                                        </form>
                                    </div>
...
<script src="<c:url value='/app/mard/04/PhytosanitaryDetainVM.js?v=${version}'/>" type="text/javascript"></script>
