...
<!-- pagination -->
                            ...
                            <ul class="flip pull-left pagination pagination-sm">
                                <li data-bind="css: { disabled: !pagingVM.firstPageActive() }"
                                    class="previous disabled"><a href="#" aria-label="First"
                                        ...
                                        code="mard.17.trang-dau-tien"></spring:message>
                                </a></li>
                                <li data-bind="css: { disabled: !pagingVM.previousPageActive()  }"
                                    class="previous disabled"><a href="#" aria-label="Previous"
                                        ...
                                        code="mard.17.trang-truoc"></spring:message>
                                </a></li>
                                ...
                                <li data-bind="css: { disabled: !pagingVM.nextPageActive() }" class="next"><a href="#"
                                    ...
                                    <spring:message code="mard.17.trang-sau"></spring:message>
                                </a></li>
                                <li data-bind="css: { disabled: !pagingVM.lastPageActive() }" class="next"><a href="#"
                                                                                                              aria-label="Last"
                                                                                                              data-bind="click: goToLast">
                                    <spring:message code="mard.17.trang-cuoi"></spring:message>
                                </a></li>
                            </ul>
                        </div>
                    </div>
                ...
                <table class="table table-striped table-bordered table-hover table-checkable order-column"
                    ...
                    <tr class="nsw-tr tr-nsw1-bgcolor">
                        <th class="text-center"><spring:message code="mard.17.index.table.th.01"></spring:message></th>
                        <th class="text-center"><spring:message code="mard.17.index.table.th.02"></spring:message></th>
                        <th class="text-center"><spring:message
                                code="mard.17.HoSo3DTO.fiNameOfRegistration"></spring:message></th>
                        <th class="text-center"><spring:message
                                code="mard.17.HoSo3DTO.fiDocumentName"></spring:message></th>
                        <th class="text-center"><spring:message
                                code="mard.17.TbdGiayPhep17.fiDispatchNo"></spring:message></th>
                        <th class="text-center"><spring:message
                                code="mard.17.TbdGiayPhep17.fiSignConfirmDate"></spring:message></th>
                        <th class="text-center"><spring:message
                                code="mard.17.HoSo3DTO.fiCreateDate"></spring:message></th>
                        <th class="text-center"><spring:message code="mard.17.HoSo3DTO.fiStatus"></spring:message></th>
                        <th class="text-center"><spring:message code="mard.17.index.table.th.08"></spring:message></th>
                        <c:if test="${!isFcap}">
                            <th class="text-center"><spring:message
                                    code="mard.17.index.table.thongBaoPhi"></spring:message></th>
                        </c:if>
                        <th class="text-center"><spring:message
                                code="mard.17.index.table.th.13"></spring:message></th>
                        <c:if test="${!isFcap}">
                            <th class="text-center"><spring:message
                                    code="mard.17.index.table.th.09"></spring:message></th>
                            <th class="text-center"><spring:message
                                    code="mard.17.index.table.th.12"></spring:message></th>
                            <th class="text-center"><spring:message
                                    code="mard.17.index.table.th.10"></spring:message></th>
                            <th class="text-center"><spring:message
                    ...
                    <tr>
                        ...
                        <c:if test="${!isFcap}">
                            <td class="text-center" data-bind="if: (item.showButtonThongBaoPhi())"><a
                                    href="#"
                                    data-bind="attr: { 'title': item.fiDocumentName }, click: $root.thongBaoPhi"> <i
                                    class="fa fa-eye"></i>
                            </a></td>
                        </c:if>
...
<script type="text/javascript" src="<c:url value="/app/mard/17/i18n/en.js"/>"></script>
<script type="text/javascript" src="<c:url value="/app/mard/17/i18n/vi.js"/>"></script>
<script type="text/javascript" src="<c:url value="/app/mard/17/cmonFunc.js"/>"></script>
<script type="text/javascript" src="<c:url value="/app/mard/17/models.module.js?v=${version}"/>"></script>
<script type="text/javascript" src="<c:url value="/app/mard/17/docso.module.js?v=${version}"/>"></script>
<script type="text/javascript" src="<c:url value="/app/mard/17/loadhoso.module.js?v=${ version }"/>"
        charset="utf-8"></script>
<script type="text/javascript" src="<c:url value="/app/mard/17/suagiayphep.module.js?v=${ version }"/>"
        charset="utf-8"></script>
<script type="text/javascript" src="<c:url value="/app/mard/17/send.module.js?v=${ version }"/>"
        charset="utf-8"></script>
<script type="text/javascript" src="<c:url value="/app/mard/17/xoahoso.module.js?v=${ version }"/>"
        charset="utf-8"></script>
<script type="text/javascript" src="<c:url value="/app/mard/17/xinruthoso.module.js?v=${ version }"/>"
        charset="utf-8"></script>
<script type="text/javascript" src="<c:url value="/app/mard/17/history.module.js?v=${ version }"/>"
        charset="utf-8"></script>
<script type="text/javascript" src="<c:url value="/app/mard/17/xemhoso.module.js?v=${ version }"/>"
        charset="utf-8"></script>
<script type="text/javascript" src="<c:url value="/app/mard/17/xemgiayphep.module.js?v=${ version }"/>"
        charset="utf-8"></script>
<script type="text/javascript" src="<c:url value="/app/mard/17/thongbaophi.module.js?v=${ version }"/>"
        charset="utf-8"></script>
<script type="text/javascript" src="<c:url value="/app/mard/17/index.module.js?v=${ version }"/>"
        charset="utf-8"></script>
