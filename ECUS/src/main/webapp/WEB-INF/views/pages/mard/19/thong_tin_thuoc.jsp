...
<div class="table-re" style="padding-top: 15px;">
    <table class="table table-striped table-bordered table-hover table-checkable order-column">
        ...
        <th class="text-center" width="50px"><spring:message code="mard.19.TbdThuoc3.stt"></spring:message></th>
        <th class="text-center" ><spring:message code="mard.19.TbdThuoc19.fiProductType"></spring:message></th>
        <th class="text-center" ><spring:message
                code="mard.19.TbdThuoc19.fiNameOfProduct"></spring:message></th>
        <th class="text-center" width="100px"><spring:message code="mard.19.TbdThuoc19.fiWeight"></spring:message></th>
        <th class="text-center" ><spring:message
                code="mard.19.TbdThuoc19.fiWeightUnitName"></spring:message></th>
        <th class="text-center" ><spring:message code="mard.19.TbdThuoc19.fiMainUse"></spring:message></th>
        <th class="text-center" ><spring:message code="mard.19.TbdThuoc19.fiOrigin"></spring:message></th>
        <th class="text-center" width="120px"><spring:message  code="mard.19.TbdThuoc3.chucnang"></spring:message></th>
        </thead>
