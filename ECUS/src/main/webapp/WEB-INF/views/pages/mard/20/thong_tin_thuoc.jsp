...
<div class="table-re" style="padding-top: 15px;">
    <table class="table table-striped table-bordered table-hover table-checkable order-column">
        ...
        <th class="text-center" width="50px"><spring:message code="mard.20.TbdThuoc3.stt"></spring:message></th>
        <th class="text-center" ><spring:message code="mard.20.TbdThuoc20.fiProductType"></spring:message></th>
        <th class="text-center" ><spring:message
                code="mard.20.TbdThuoc20.fiNameOfProduct"></spring:message></th>
        <th class="text-center" width="100px"><spring:message code="mard.20.TbdThuoc20.fiWeight"></spring:message></th>
        <th class="text-center" ><spring:message
                code="mard.20.TbdThuoc20.fiWeightUnitName"></spring:message></th>
        <th class="text-center" ><spring:message code="mard.20.TbdThuoc20.fiMainUse"></spring:message></th>
        <th class="text-center" ><spring:message code="mard.20.TbdThuoc20.fiOrigin"></spring:message></th>
        <th class="text-center" width="120px"><spring:message  code="mard.20.TbdThuoc3.chucnang"></spring:message></th>
        </thead>
