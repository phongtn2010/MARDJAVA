    ...
    <form role="form" class="form-horizontal">
        <div class="form-group" style="margin-top: 15px">
            <div class="col-md-12">
                ...
                <div class="col-md-4">
                    <input
                            data-bind="value: fiSignName, enable: $root.isEditable()"
                            class="form-control"/>
                </div>
                <div class="col-md-2 nsw-text-right">
                ...
                <div class="col-md-4">
                    <input
                            data-bind="value : fiSignPosition, enable: $root.isEditable()"
                            class="form-control"/>
                </div>
            </div>
        </div>
        <div class="form-group">
            <div class="col-md-12">
                ...
                <div class="col-md-4">
<%--                    <select--%>
<%--                            data-bind="value : fiSignAddress, enable: $root.isEditable()"--%>
