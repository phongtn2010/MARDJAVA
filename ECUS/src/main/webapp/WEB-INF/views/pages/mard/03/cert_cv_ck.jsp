...
<div class="row" id="CvCkVM">
    <div class="col-md-12">
        <div class="portlet light ">
            <div class="portlet-title">
                <div class="caption font-dark">
                    <span class="caption-subject bold uppercase">Công văn chuyển cửa khẩu</span>
                </div>
            </div>
                                ...
                                <div class="tab-content" >
                                    <div class="tab-pane active" id="tab_mt_1">
                                        <form role="form" class="form-horizontal" >
                                            <%@include file="inc_congvancap.jsp" %>
                                        </form>
                                    </div>
...
<script src="<c:url value='/app/mard/03/CvCkVM.js?v=${version}'/>" type="text/javascript" charset="utf-8"></script>
