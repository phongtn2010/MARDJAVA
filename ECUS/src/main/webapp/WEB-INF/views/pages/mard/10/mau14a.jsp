...
<page size="A4" class="a4-padding">
    ...
    <p class="content">
        1. Số động vật trên phải được chuyển đến nơi cách ly kiểm dịch trước ngày <span data-bind="text : fiCachlyTn"></span> để nuôi cách ly kiểm dịch tại địa điểm: <span data-bind="text : fiNoicachly"></span> 
    </p>
    <p class="content">	
