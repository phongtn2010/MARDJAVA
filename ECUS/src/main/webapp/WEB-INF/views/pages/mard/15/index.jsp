            ...
            <div class="portlet-body" id="table-search">
                                            ...
                                            <ul class="flip pull-left pagination pagination-sm">
                                                <li data-bind="css: { disabled: !pagingVM.firstPageActive() }"
                                                    class="previous disabled"><a href="#" aria-label="First"
                                                        ...
                                                        code="mard.15.trang-dau-tien"></spring:message>
                                                </a></li>
                                                <li data-bind="css: { disabled: !pagingVM.previousPageActive()  }"
                                                    class="previous disabled"><a href="#" aria-label="Previous"
                                                        ...
                                                        code="mard.15.trang-truoc"></spring:message>
                                                </a></li>
                                                ...
                                                <li data-bind="css: { disabled: !pagingVM.nextPageActive() }" class="next"><a href="#"
                                                    ...
                                                    <spring:message code="mard.15.trang-sau"></spring:message>
                                                </a></li>
                                                <li data-bind="css: { disabled: !pagingVM.lastPageActive() }" class="next"><a href="#"
                                                                                                                              aria-label="Last"
                                                                                                                              data-bind="click: goToLast">
                                                    <spring:message code="mard.15.trang-cuoi"></spring:message>
                                                </a></li>
                                            </ul>
                                        </div>
                                    </div>
                ...
                <table class="table table-striped table-bordered table-hover table-checkable order-column"
                    ...
                    <tr class="nsw-tr tr-nsw1-bgcolor">
                        <th class="text-center"><spring:message code="mard.15.index.table.th.01"></spring:message></th>
                        <th class="text-center"><spring:message code="mard.15.index.table.th.02"></spring:message></th>
                        <th class="text-center"><spring:message
                                code="mard.15.HoSo3DTO.fiNameOfRegistration"></spring:message></th>
                        <th class="text-center"><spring:message
                                code="mard.15.HoSo3DTO.fiDocumentName"></spring:message></th>
                        <th class="text-center"><spring:message
                                code="mard.15.TbdGiayPhep15.fiDispatchNo"></spring:message></th>
                        <th class="text-center"><spring:message
                                code="mard.15.TbdGiayPhep15.fiSignConfirmDate"></spring:message></th>
                        <th class="text-center"><spring:message
                                code="mard.15.HoSo3DTO.fiCreateDate"></spring:message></th>
                        <th class="text-center"><spring:message code="mard.15.HoSo3DTO.fiStatus"></spring:message></th>
                        <th class="text-center"><spring:message code="mard.15.index.table.th.08"></spring:message></th>
                        <th class="text-center"><spring:message code="mard.15.index.table.th.13"></spring:message></th>
                        <c:if test="${!isFcap}">
                            <th class="text-center"><spring:message
                                    code="mard.15.index.table.xinSuaGiayPhep"></spring:message></th>
                            <th class="text-center"><spring:message
                                    code="mard.15.index.table.th.09"></spring:message></th>
                            <th class="text-center"><spring:message
                                    code="mard.15.index.table.th.12"></spring:message></th>
                            <th class="text-center"><spring:message
                                    code="mard.15.index.table.th.10"></spring:message></th>


                            <th class="text-center"><spring:message
                                    code="mard.15.index.table.th.11"></spring:message></th>
                        </c:if>
                    ...
                    <tr>
                        ...
                        <c:if test="${!isFcap}">
                            ...
                            <td class="text-center" data-bind="if: (item.showButtonDelete())"><a
                                    style="color: red; font-weight: bold;" href="#"
                                    data-bind="attr: { 'title': item.fiDocumentName }, click: $root.xoaHoSo"> <i
                                    class="fa fa-lg fa-close tooltips" aria-hidden="true"></i>
                            </a></td>
                        </c:if>
...
<script type="text/javascript" src="<c:url value="/app/mard/15/loadhoso.module.js?v=${ version }"/>"
        charset="utf-8"></script>
<script type="text/javascript" src="<c:url value="/app/mard/15/xinsuagiayphep.module.js?v=${ version }"/>"
        charset="utf-8"></script>
<script type="text/javascript" src="<c:url value="/app/mard/15/xoahoso.module.js?v=${ version }"/>"
        charset="utf-8"></script>
<script type="text/javascript" src="<c:url value="/app/mard/15/xinruthoso.module.js?v=${ version }"/>"
        charset="utf-8"></script>
<script type="text/javascript" src="<c:url value="/app/mard/15/history.module.js?v=${ version }"/>"
        charset="utf-8"></script>
<script type="text/javascript" src="<c:url value="/app/mard/15/xemhoso.module.js?v=${ version }"/>"
        charset="utf-8"></script>
<script type="text/javascript" src="<c:url value="/app/mard/15/xemgiayphep.module.js?v=${ version }"/>"
        charset="utf-8"></script>
<script type="text/javascript" src="<c:url value="/app/mard/15/index.module.js?v=${ version }"/>"
        charset="utf-8"></script>
