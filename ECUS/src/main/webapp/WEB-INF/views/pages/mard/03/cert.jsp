...
<div class="row" id="GiayCNVM">
    <div class="col-md-12">
        <div class="portlet light ">
            <div class="portlet-title">
                <div class="caption font-dark">
                    <span class="caption-subject bold uppercase">GIẤY CHỨNG NHẬN MẪU A</span>
                </div>
            </div>
                                ...
                                <div class="tab-content" >
                                    <div class="tab-pane active" id="tab_mt_1">
                                        <form role="form" class="form-horizontal" >
                                            <%@include file="inc_giaychungnhan_mau16a.jsp" %>
                                        </form>
                                    </div>
...
<script src="<c:url value='/app/mard/03/GiayCNVM.js?v=${version}'/>" type="text/javascript" charset="utf-8"></script>
