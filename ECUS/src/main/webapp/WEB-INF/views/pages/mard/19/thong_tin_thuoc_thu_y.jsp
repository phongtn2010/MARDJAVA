...
<c:if test="${isView == false}">
    ...
    <span class="caption-subject bold uppercase"><spring:message
            code="mard.19.form.thongTinThuoc"></spring:message> </span>
...
<div class="table-re" style="padding-top: 15px;">
    <table class="table table-striped table-bordered table-hover table-checkable order-column">
        ...
        <th class="text-center" width="50px"><spring:message
                code="mard.19.TbdThuoc3.stt"></spring:message></th>
        <th class="text-center" ><spring:message
                code="mard.19.TbdThuoc19.fiProductType"></spring:message></th>
        <th class="text-center" ><spring:message
                code="mard.19.TbdThuoc19.fiNameOfGoods"></spring:message></th>
        <th class="text-center" ><spring:message
                code="mard.19.TbdThuoc19.fiCirculationNo"></spring:message></th>
        <th class="text-center" ><spring:message
                code="mard.19.TbdThuoc19.fiSerialNo"></spring:message></th>
        <th class="text-center" ><spring:message
                code="mard.19.TbdThuoc19.fiManufacturerName"></spring:message></th>
        <th class="text-center" width="100px"><spring:message
                code="mard.19.TbdThuoc19.fiCountryName"></spring:message></th>
        <th class="text-center" ><spring:message
                code="mard.19.TbdThuoc19.fiTypeOfPackage"></spring:message></th>
        <th class="text-center" ><spring:message
                code="mard.19.TbdThuoc19.fiWeightUnitName"></spring:message></th>
        <th class="text-center" ><spring:message
                code="mard.19.TbdThuoc19.fiWeight"></spring:message></th>

        <th class="text-center" ><spring:message
                code="mard.19.TbdThuoc19.fiWeightKG"></spring:message></th>
        <th class="text-center" ><spring:message
                code="mard.19.TbdThuoc19.fiWeightML"></spring:message></th>
        <th class="text-center" ><spring:message
                code="mard.19.TbdThuoc19.fiDocumentNo"></spring:message></th>
        <th class="text-center" ><spring:message
                code="mard.19.TbdThuoc19.fiGate"></spring:message></th>
        <th class="text-center" ><spring:message
                code="mard.19.TbdThuoc19.fiImportTime"></spring:message></th>
        <th class ="text-center" ><spring:message
                code="mard.19.TbdThuoc19.fiLicenseFileNo"></spring:message></th>
        <th class ="text-center" ><spring:message
                code="mard.19.TbdThuoc19.tepDinhKemThuoc"></spring:message></th>
        ...
        <tr>
                ...
                <div>
                    <c:if test="${isView == false}">
                        <a style="margin-bottom: 5px;"
                           title="<spring:message code="mard.19.TbdThuoc3.buttonSua" />"
                           data-bind="click: $root.editTepDinhKemThuoc"> <i style="color: #337ab7" class="fa fa-upload" aria-hidden="true"></i>
                        </a>
                    </c:if>
                    <a style="margin-bottom: 5px;"
                       title="<spring:message code="mard.19.TbdThuoc3.buttonXem" />"
            ...
            <td align="center">
                <c:if test="${isView == false}">
                    ...
                    &nbsp;&nbsp;&nbsp;
                    <a style="margin-bottom: 5px;"
                       title="<spring:message code="mard.19.TbdThuoc3.buttonXoa" />"
...
<c:if test="${isView == false}">
    <div class="col-md-12">
        <label class="col-md-3"><spring:message code="mard.19.nhapFileExcel"/></label>
        <div class="col-md-9">
            <input id="fileUploadExcel" type="file" class="form-group form-control" data-bind=" event:{ change: $root.uploadFileChangeEvent }">
            <a style="font-style: italic;" href="<c:url value="/mard/api/19/downloadTemplate/excel" />" title="<spring:message code="mard.19.capNhatDuLieuTuFile"/>"><i class="fa fa-download" aria-hidden="true"></i>&nbsp;</span>&nbsp;<spring:message code="mard.19.capNhatDuLieuTuFile"/></a>
