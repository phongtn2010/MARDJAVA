...
<fieldset>    
    ...
    <div class="form-group">
        <div class="col-md-12">
            <div class="col-md-2 nsw-text-left">
                <label><spring:message code="mard.02.hoso.thongtinchung.mahs" /></label>
            </div>
            <div class="col-md-4">
                <input class="form-control" id="nswFilecode" name="nswFilecode" data-bind="value : nswFilecode" type="text" readonly/>
            </div>
            <div class="col-md-2 nsw-text-left">
                <label><spring:message code="mard.02.hoso.thongtinchung.ngaytao" /></label>
            </div>
            <div class="col-md-4">
    ...
    <div class="form-group">
        <div class="col-md-12">
            <div class="col-md-2 nsw-text-left">
                <label><spring:message code="mard.02.hoso.thongtinchung.trangthai" /></label>
            </div>
            <div class="col-md-4">
            ...
            <div class="col-md-2 nsw-text-left">
                <label>Số đăng kí doanh nghiệp</label>
            </div>
            <div class="col-md-4">
                <input class="form-control" id="noOfRegistration" name="noOfRegistration" maxlength="255"
                       type="text" data-bind="value : noOfRegistration" readonly="readonly" disabled/>
            </div>
        </div>  
    </div> 
        ...
        <div class="col-md-12">
            ...
            <div class="col-md-4">
                <input class="form-control" id="email" name="email" maxlength="250"  
                       type="text" data-bind="value : email" disabled readonly />
            </div>
        </div>  
    </div> 
    <div class="form-group" style="margin-top: 15px;">
        <div class="col-md-12">
            <div class="col-md-2 nsw-text-left">
                <label><spring:message code="mard.02.hoso.thongtinchung.loaisanpham" /></label>
            </div>
            <div class="col-md-4">
                <select class="form-control select2" id="typeProduct" name="typeProduct" 
                        data-bind="optionsCaption: 'Chọn...', optionsValue : 'id'
                            ...
                            , value : typeProduct
                            , options : lstLoaiSP
                            , optionsText : 'name'" disabled readonly></select>
            </div>
            <div class="col-md-2 nsw-text-left">
            ...
            <div class="col-md-4">
                <input class="form-control" id="fax" name="fax" maxlength="250"  
                       type="text" data-bind="value : fax" disabled readonly />
            </div>
        </div>  
    </div> 
    <div class="form-group" style="margin-top: 15px;">
        <div class="col-md-12">
            <div class="col-md-2 nsw-text-left">
                <label><spring:message code="mard.02.hoso.thongtinchung.loaidon" /></label>
            </div>
            <div class="col-md-4">
            ...
            <div class="col-md-2 nsw-text-left">
                <label><spring:message code="mard.02.hoso.thongtinchung.tenctyDK" /></label>
            </div>
            <div class="col-md-4">
                <input class="form-control" id="companyName" name="companyName" maxlength="250"  
                       type="text" data-bind="value : companyName" disabled readonly/>
            </div>
        </div>  
    </div> 
</fieldset>
