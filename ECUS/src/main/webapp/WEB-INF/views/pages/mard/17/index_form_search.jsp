...
<form role="form" class="form-horizontal " name="searchForm01" id="searchForm01">
	...
	<div class="form-group" style="margin-top: 15px;">
		<div class="col-md-12">
			<div class="col-md-2">
				<label><spring:message code="mard.17.formSearch.fiDocumentName"></spring:message> </label>
			</div>
			<div class="col-md-4">
				<input autocomplete="off" class="form-control form-control-inline" name="maHoSo" id="maHoSo" placeholder="<spring:message code="mard.17.formSearch.fiDocumentName" />" data-bind="value: searchForm.fiDocumentName" type="text">
			</div>
			<div class="col-md-2">
				<label><spring:message code="mard.17.formSearch.fiStatus"></spring:message></label>
			</div>
			<div class="col-md-4">
				<div>
	...
	<div class="form-group">
		<div class="col-md-12">
			<div class="col-md-2">
				<label><spring:message code="mard.17.formSearch.fromFiSendDate"></spring:message></label>
			</div>
			<div class="col-md-4">
			...
			<div class="col-md-2">
				<label><spring:message code="mard.17.formSearch.toFiSendDate"></spring:message></label>
			</div>
			<div class="col-md-4">
	...
	<div class="form-group">
		<div class="col-md-12">
			<div class="col-md-2">
				<label><spring:message code="mard.17.formSearch.fromFiSignConfirmDate"></spring:message></label>
			</div>
			<div class="col-md-4">
			...
			<div class="col-md-2">
				<label><spring:message code="mard.17.formSearch.toFiSignConfirmDate"></spring:message></label>
			</div>
			<div class="col-md-4">
	...
	<div class="form-group">
    		<div class="col-md-12">
    			...
    			<div class="col-md-2">
    				<label><spring:message code="mard.17.formSearch.fiDispatchNo"></spring:message></label>
    			</div>
    			<div class="col-md-4">
    				<input autocomplete="off" name="fiDispatchNo" id="fiDispatchNo" field="common_tracuu_ngay_tao_den" class="form-control form-control-inline " size="20" type="text" placeholder="<spring:message code="mard.17.formSearch.fiDispatchNo"></spring:message>" data-bind="value: searchForm.fiDispatchNo" />
    			</div>
    		</div>
    	</div>
