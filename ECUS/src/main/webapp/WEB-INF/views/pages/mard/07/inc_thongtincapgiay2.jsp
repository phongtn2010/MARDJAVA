...
<fieldset data-bind="with: ttnkVM2">
        ...
        <table class="table table-striped table-bordered table-hover order-column">
            ...
            <tr>
                ...
                <td class="text-center" data-bind="visible: $root.isEditable()">
                    <a href="javascript:void(0)" data-bind="click: $parent.openUpdateModal2.bind($data, $data, $index())">
    ...
    <form role="form" class="form-horizontal" style="padding-top: 10px; padding-bottom: 10px;">
        <div class="form-group">
            ...
            <div class="col-md-4">
                <textarea type="text" class="form-control"
                          data-bind="value: fiExporter, enable: $root.isEditable()"
                          rows="5"
                ></textarea>
            </div>
            <div class="col-md-2 nsw-text-right">
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <textarea class="form-control" type="text"
                       data-bind="value: fiProcessingName, enable: $root.isEditable()"
                       rows="5"
                ></textarea>
            </div>
            <div class="col-md-2 nsw-text-right">
        ...
        <div class="form-group">
            ...
            <div class="col-md-10">
                <input class="form-check-input" type="checkbox" id="checkHangTC2"
                       data-bind="checked: fiTransshipmentGoods, enable: $root.isEditable()">
                <label class="form-check-label" for="checkHangTC2">
                    <spring:message code="mard.07.select.hang_trung_chuyen"/>
                </label><br/>
                <label data-bind="visible: fiTransshipmentGoods()" class="nsw-require-field">Tất cả các trường dưới đây
                    là bắt buộc khi chọn hàng trung
    ...
    <!-- modal -->
    <div id="modal_addProduct2" class="modal container in modal-overflow" tabindex="-1"
        ...
        <div class="modal-body">
            <form role="form" class="form-horizontal">
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input data-bind="value: fiNameOfGoods"
                               class="form-control"
                               maxlength="250"
                               type="text"
                        >
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <select
                                disabled
                                class="form-control" data-bind="options: lstUOM,
                            optionsText: 'unitname',
                            optionsValue: 'unitcode',
                            optionsCaption: '<spring:message code="mard.07.select.chon"/>',
                            value: fiQuantityOrWeightUnitCode"></select>
                    </div>
                    <div class="col-md-2 nsw-text-right">
                    ...
                    <div class="col-md-4">
                        <select class="form-control" data-bind="options: lstCountry,
                            ...
                            optionsCaption: '<spring:message code="mard.07.select.chon"/>',
                            value: fiOriginationCode, enable: $root.isEditable()"></select>
                    </div>
                </div>
            </form>
    ...
    <!-- end modal -->
    <!-- modal -->
    <div id="modal_editProduct2" class="modal container in modal-overflow" tabindex="-1"
         data-backdrop="static" data-keyboard="false"
         data-bind="with: productVM"
    >
        <div class="modal-header">
        ...
        <div class="modal-body">
            <form role="form" class="form-horizontal">
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input type="text" data-bind="value: fiNameOfGoods" class="form-control" maxlength="250">
                    </div>
                    <div class="col-md-2 nsw-text-right">
                        <label><spring:message code="mard.07.table.ten_khoa_hoc"/></label>
                    </div>
