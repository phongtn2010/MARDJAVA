...
<div class="table-re" style="padding-top: 15px;">
    <table class="table table-striped table-bordered table-hover table-checkable order-column">
        ...
        <th class="text-center" ><spring:message code="mard.17.TbdThuoc17.fiMainUse"></spring:message></th>
        <th class="text-center" ><spring:message code="mard.17.TbdThuoc17.fiOrigin"></spring:message></th>
        <th class="text-center" width="120px"><spring:message  code="mard.17.TbdThuoc3.chucnang"></spring:message></th>
        </thead>
