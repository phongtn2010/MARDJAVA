<%-- 
    Document   : mau15b
    Created on : Aug 7, 2017, 2:25:51 PM
    Author     : hieptran
--%>
...
<page size="A4" class="a4-padding">
    ...
    <p class="title">
        GIẤY CHỨNG NHẬN KIỂM DỊCH SẢN PHẨM ĐỘNG VẬT NHẬP KHẨU KHÔNG DÙNG LÀM THỰC PHẨM
    </p>
    <p class="code">
    ...
    <p class="content">
        Điện thoại: <span data-bind="text : fiDtCh"></span> Fax: <span data-bind="text : fiFaxCh"></span> Email: 	<span data-bind="text : fiEmailCh"></span>
    </p>
    <p class="content">
    ...
    <table class="tb-content w100p">
        ...
        <tbody data-bind="template: { name: 'lstHanghoa15bTmpl', foreach: lstHanghoa15b }">
        </tbody>
        <script id="lstHanghoa15bTmpl" type="text/html">
            <tr>
                <td data-bind="text : fiTenHh"></td>
                <td data-bind="text : fiQuycachDg"></td>
                <td>
    ...
    <p class="content pt-10GIẤY CHỨNG NHẬN KIỂM DỊCH VÀ VỆ SINH AN TOÀN THỰC PHẨM SẢN PHẨM ĐỘNG VẬT NHẬP KHẨU DÙNG LÀM THỰC PHẨM>"
    ...
    <p class="content">
        Tên, địa chỉ cơ sở sản xuất, chế biến: 	<span data-bind="text : fiNoiSx"></span>
    </p>
    <p class="content">
    ...
    <p class="content">
        Cửa khẩu nhập vào Việt Nam: <span data-bind="text : fiTenckNhap"></span> Thời gian nhập: <span data-bind="date : fiTgNhap"></span>
    </p>
    <p class="content">
        Nơi chuyển đến: 	<span data-bind="text : fiNoichuyen"></span>
    </p>
    <p class="content">
    ...
    <p class="content">
        4. Số sản phẩm động vật trên đã được khử trùng tiêu độc bằng <span data-bind="text : fiPptdkt"></span> nồng độ <span data-bind="text : fiNongdo"></span> (nếu có).
    </p>
    <p class="content">
        5. Phương tiện vận chuyển, các vật dụng khác có liên quan kèm theo bảo đảm yêu cầu vệ sinh thú y, đã được khử trùng tiêu độc bằng <span data-bind="text : fiPtvccv"></span> nồng độ <span data-bind="text : fiNongdovc"></span>
    </p>
    <table class="tb-content w100p">
        <tr>
