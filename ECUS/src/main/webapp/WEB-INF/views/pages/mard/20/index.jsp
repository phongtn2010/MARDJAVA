...
<!-- pagination -->
                            ...
                            <ul class="flip pull-left pagination pagination-sm">
                                <li data-bind="css: { disabled: !pagingVM.firstPageActive() }"
                                    class="previous disabled"><a href="#" aria-label="First"
                                        ...
                                        code="mard.20.trang-dau-tien"></spring:message>
                                </a></li>
                                <li data-bind="css: { disabled: !pagingVM.previousPageActive()  }"
                                    class="previous disabled"><a href="#" aria-label="Previous"
                                        ...
                                        code="mard.20.trang-truoc"></spring:message>
                                </a></li>
                                ...
                                <li data-bind="css: { disabled: !pagingVM.nextPageActive() }" class="next"><a href="#"
                                    ...
                                    <spring:message code="mard.20.trang-sau"></spring:message>
                                </a></li>
                                <li data-bind="css: { disabled: !pagingVM.lastPageActive() }" class="next"><a href="#"
                                                                                                              aria-label="Last"
                                                                                                              data-bind="click: goToLast">
                                    <spring:message code="mard.20.trang-cuoi"></spring:message>
                                </a></li>
                            </ul>
                        </div>
                    </div>
                ...
                <table class="table table-striped table-bordered table-hover table-checkable order-column"
                    ...
                    <tr class="nsw-tr tr-nsw1-bgcolor">
                        <th class="text-center"><spring:message code="mard.20.index.table.th.01"></spring:message></th>
                        <th class="text-center"><spring:message code="mard.20.index.table.th.02"></spring:message></th>
                        <th class="text-center"><spring:message
                                code="mard.20.HoSo3DTO.fiNameOfRegistration"></spring:message></th>
                        <th class="text-center"><spring:message
                                code="mard.20.HoSo3DTO.fiDocumentName"></spring:message></th>
                        <th class="text-center"><spring:message
                                code="mard.20.TbdGiayPhep20.fiDispatchNo"></spring:message></th>
                        <th class="text-center"><spring:message
                                code="mard.20.TbdGiayPhep20.fiSignConfirmDate"></spring:message></th>
                        <th class="text-center"><spring:message
                                code="mard.20.HoSo3DTO.fiCreateDate"></spring:message></th>
                        <th class="text-center"><spring:message code="mard.20.HoSo3DTO.fiStatus"></spring:message></th>
                        <th class="text-center"><spring:message code="mard.20.index.table.th.08"></spring:message></th>

                        <th class="text-center"><spring:message
                                code="mard.20.index.table.th.13"></spring:message></th>
                        <c:if test="${!isFcap}">
                            <th class="text-center"><spring:message
                                    code="mard.20.index.table.th.09"></spring:message></th>
                            <th class="text-center"><spring:message
                                    code="mard.20.index.table.th.12"></spring:message></th>
                            <th class="text-center"><spring:message
                                    code="mard.20.index.table.th.14"></spring:message></th>
                            <th class="text-center"><spring:message
                                    code="mard.20.index.table.th.10"></spring:message></th>
                            <th class="text-center"><spring:message
                                    code="mard.20.index.table.th.11"></spring:message></th>
                        </c:if>
                    </tr>
                    </thead>
...
<script type="text/javascript" src="<c:url value="/app/mard/20/docso.module.js?v=${version}"/>"></script>
<script type="text/javascript" src="<c:url value="/app/mard/20/loadhoso.module.js?v=${ version }"/>"
        charset="utf-8"></script>
<script type="text/javascript" src="<c:url value="/app/mard/20/suagiayphep.module.js?v=${ version }"/>"
        charset="utf-8"></script>
<script type="text/javascript" src="<c:url value="/app/mard/20/send.module.js?v=${ version }"/>"
        charset="utf-8"></script>
<script type="text/javascript" src="<c:url value="/app/mard/20/xoahoso.module.js?v=${ version }"/>"
        charset="utf-8"></script>
<script type="text/javascript" src="<c:url value="/app/mard/20/xinruthoso.module.js?v=${ version }"/>"
        charset="utf-8"></script>
<script type="text/javascript" src="<c:url value="/app/mard/20/history.module.js?v=${ version }"/>"
        charset="utf-8"></script>
<script type="text/javascript" src="<c:url value="/app/mard/20/xemhoso.module.js?v=${ version }"/>"
        charset="utf-8"></script>
<script type="text/javascript" src="<c:url value="/app/mard/20/xemgiayphep.module.js?v=${ version }"/>"
        charset="utf-8"></script>
<script type="text/javascript" src="<c:url value="/app/mard/20/thongbaophi.module.js?v=${ version }"/>"
        charset="utf-8"></script>
<script type="text/javascript" src="<c:url value="/app/mard/20/index.module.js?v=${ version }"/>"
        charset="utf-8"></script>
