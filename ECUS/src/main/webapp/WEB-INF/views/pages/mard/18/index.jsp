...
<!-- pagination -->
                            ...
                            <ul class="flip pull-left pagination pagination-sm">
                                <li data-bind="css: { disabled: !pagingVM.firstPageActive() }"
                                    class="previous disabled"><a href="#" aria-label="First"
                                        ...
                                        code="mard.18.trang-dau-tien"></spring:message>
                                </a></li>
                                <li data-bind="css: { disabled: !pagingVM.previousPageActive()  }"
                                    class="previous disabled"><a href="#" aria-label="Previous"
                                        ...
                                        code="mard.18.trang-truoc"></spring:message>
                                </a></li>
                                ...
                                <li data-bind="css: { disabled: !pagingVM.nextPageActive() }" class="next"><a href="#"
                                    ...
                                    <spring:message code="mard.18.trang-sau"></spring:message>
                                </a></li>
                                <li data-bind="css: { disabled: !pagingVM.lastPageActive() }" class="next"><a href="#"
                                                                                                              aria-label="Last"
                                                                                                              data-bind="click: goToLast">
                                    <spring:message code="mard.18.trang-cuoi"></spring:message>
                                </a></li>
                            </ul>
                        </div>
                    </div>
                ...
                <table class="table table-striped table-bordered table-hover table-checkable order-column"
                    ...
                    <tr class="nsw-tr tr-nsw1-bgcolor">
                        <th class="text-center"><spring:message code="mard.18.index.table.th.01"></spring:message></th>
                        <th class="text-center"><spring:message code="mard.18.index.table.th.02"></spring:message></th>
                        <th class="text-center"><spring:message
                                code="mard.18.HoSo3DTO.fiNameOfRegistration"></spring:message></th>
                        <th class="text-center"><spring:message
                                code="mard.18.HoSo3DTO.fiDocumentName"></spring:message></th>
                        <th class="text-center"><spring:message
                                code="mard.18.TbdGiayPhep18.fiDispatchNo"></spring:message></th>
                        <th class="text-center"><spring:message
                                code="mard.18.TbdGiayPhep18.fiSignConfirmDate"></spring:message></th>
                        <th class="text-center"><spring:message
                                code="mard.18.HoSo3DTO.fiCreateDate"></spring:message></th>
                        <th class="text-center"><spring:message code="mard.18.HoSo3DTO.fiStatus"></spring:message></th>
                        <th class="text-center"><spring:message code="mard.18.index.table.th.08"></spring:message></th>

                        <th class="text-center"><spring:message
                                code="mard.18.index.table.th.13"></spring:message></th>
                        <c:if test="${!isFcap}">
                            <th class="text-center"><spring:message
                                    code="mard.18.index.table.th.09"></spring:message></th>
                            <th class="text-center"><spring:message
                                    code="mard.18.index.table.th.12"></spring:message></th>
                            <th class="text-center"><spring:message
                                    code="mard.18.index.table.th.10"></spring:message></th>
                            <th class="text-center"><spring:message
                                    code="mard.17.index.table.th.14"></spring:message></th>
                            <th class="text-center"><spring:message
                                    code="mard.18.index.table.th.15"></spring:message></th>
                            <th class="text-center"><spring:message
                                    code="mard.17.index.table.th.11"></spring:message></th>
                    ...
                    <tr>
                        ...
                        <c:if test="${!isFcap}">
                            <td class="text-center" data-bind="if: (item.showButtonXinSuaHoSo())"><a href="#"
                                ...
                                <i class="fa fa-lg fa-edit request-cancel tooltips" aria-hidden="true"></i>
                            </a></td>
                            ...
                            <td class="text-center" data-bind="if: (item.showButtonEdit())">
                                <a href="#"
                                                                                               data-bind=" attr: { 'title': item.fiDocumentName }, click: $root.chinhSuaHoSo">
                                <i class="fa fa-lg fa-edit request-cancel tooltips"></i>
                            </a></td>
                            <td class="text-center" data-bind="if: (item.showButtonXinSuaGP()) "><a href="#"
                                                                                                    data-bind="attr: { 'title': item.fiDocumentName }, click: $root.suaGiayPhep">
                                <i class="fa fa-lg fa-edit request-cancel tooltips"></i>
                            </a></td>
                            <td class="text-center" data-bind="if: (item.showButtonBoSungToKhai())">
                                <a href="#"
                                   data-bind=" attr: { 'title': item.fiDocumentName }, click: $root.boSungToKhai">
                                    <i class="fa fa-lg fa-edit request-cancel tooltips"></i>
                                </a></td>
                            <td class="text-center" data-bind="if: (item.showButtonDelete())"><a style="color: red; font-weight: bold;" href="#"
...
<script type="text/javascript" src="<c:url value="/app/mard/18/i18n/en.js"/>"></script>
<script type="text/javascript" src="<c:url value="/app/mard/18/i18n/vi.js"/>"></script>
<script type="text/javascript" src="<c:url value="/app/mard/18/cmonFunc.js"/>"></script>
<script type="text/javascript" src="<c:url value="/app/mard/18/models.module.js?v=${version}"/>"></script>
<script type="text/javascript" src="<c:url value="/app/mard/18/docso.module.js?v=${version}"/>"></script>
<script type="text/javascript" src="<c:url value="/app/mard/18/loadhoso.module.js?v=${ version }"/>"
        charset="utf-8"></script>
<script type="text/javascript" src="<c:url value="/app/mard/18/suagiayphep.module.js?v=${ version }"/>"
        charset="utf-8"></script>
<script type="text/javascript" src="<c:url value="/app/mard/18/send.module.js?v=${ version }"/>"
        charset="utf-8"></script>
<script type="text/javascript" src="<c:url value="/app/mard/18/xoahoso.module.js?v=${ version }"/>"
        charset="utf-8"></script>
<script type="text/javascript" src="<c:url value="/app/mard/18/xinruthoso.module.js?v=${ version }"/>"
        charset="utf-8"></script>
<script type="text/javascript" src="<c:url value="/app/mard/18/history.module.js?v=${ version }"/>"
        charset="utf-8"></script>
<script type="text/javascript" src="<c:url value="/app/mard/18/xemhoso.module.js?v=${ version }"/>"
        charset="utf-8"></script>
<script type="text/javascript" src="<c:url value="/app/mard/18/xemgiayphep.module.js?v=${ version }"/>"
        charset="utf-8"></script>
<script type="text/javascript" src="<c:url value="/app/mard/18/thongbaophi.module.js?v=${ version }"/>"
        charset="utf-8"></script>
<script type="text/javascript" src="<c:url value="/app/mard/18/index.module.js?v=${ version }"/>"
        charset="utf-8"></script>
<script type="text/javascript" src="<c:url value="/app/mard/18/bosungtokhai.module.js?v=${ version }"/>"
        charset="utf-8"></script>
