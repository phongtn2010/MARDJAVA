        ...
        <div class="portlet light ">
            <div class="portlet-title">
                <div class="caption font-dark">
                    <span class="caption-subject bold uppercase">Mẫu 03 – Đơn khai báo kiểm dịch</span>
                </div>
            </div>
                                ...
                                <div class="tab-content" >
                                    <div class="tab-pane active" id="tab_mt_1">
                                        <form role="form" class="form-horizontal" data-bind="with: formVM()">
                                            <%@include file="inc_maukiemdich.jsp" %>
                                        </form>
                                        <form role="form" class="form-horizontal" data-bind="visible: showResult, with: resultVM()">
                                            <%@include file="inc_mauXNDonkiemdich.jsp" %>
                                        </form>
                                    </div>
