...
<script type="text/javascript" src="<c:url value="/app/mt/qlgp/p48/index.module.js?v=${ version }"/>"
        charset="utf-8"></script>
<script type="text/javascript" src="<c:url value="/app/mt/qlgp/p48/model.js?v=${ version }"/>"
        charset="utf-8"></script>
