...
<div class="row">
    ...
    <div class="form-group nsw-text-center">
        <a class="btn green bt-center btwidth" id="btSua"
           data-bind="click: $root.suaGiayPhep"> <i
                class="fa fa-edit" aria-hidden="true"></i> &nbsp;
            Xin sửa giấy phép </a>
        <a class="btn blue bt-center btwidth" id="btTra"
           data-bind="click: $root.traGiayPhep"> <i
...
<script type="text/javascript"
        src="<c:url value="/app/mt/p56/license.module.js?v=${ version }"/>"
        charset="utf-8"></script>
<script type="text/javascript"
        src="<c:url value="/app/mt/p56/model.js?v=${ version }"/>"
        charset="utf-8"></script>
<script>
