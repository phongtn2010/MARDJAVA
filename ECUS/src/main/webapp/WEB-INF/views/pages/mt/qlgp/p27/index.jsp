                                ...
                                <div class="panel-body">
                                    <table class="table table-striped table-bordered table-hover table-checkable order-column"
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center" data-bind="if: item.fiTrangthai()==7 || item.fiTrangthai()==8 || item.fiTrangthai()==9 || item.fiTrangthai()==11">
                                                <a
                                                    href="javascript:;"
...
<script type="text/javascript" src="<c:url value="/app/mt/qlgp/p27/index.module.js?v=${ version }"/>"
