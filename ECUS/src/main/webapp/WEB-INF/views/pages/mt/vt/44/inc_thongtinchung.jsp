...
<fieldset>
    ...
    <div class="form-group">
        <div class="col-md-12">            
            <div class="col-md-2 nsw-text-right">
                <label><spring:message code="mt.hoso.sogiayphep_vt" /> <a class="nsw-require-field">*</a></label>
            </div>
            <div class="col-md-4">
            ...
            <div class="col-md-4">
                <input class="form-control date-picker" id="fiNgaycapGp" name="fiNgaycapGp" data-bind="datepicker : fiNgaycapGp" type="text" data-date-format="dd/mm/yyyy" />
