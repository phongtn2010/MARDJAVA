...
<page size="A4" class="a4-padding">
    ...
    <p class="title">
        CHẤP THUẬN THAY THẾ PHƯƠNG TIỆN KHAI THÁC TUYẾN VẬN TẢI HÀNH KHÁCH TUYẾN CỐ ĐỊNH BẰNG XE Ô TÔ GIỮA VIỆT NAM VÀ LÀO
    </p>
    <p class="t-center">
    ...
    <p class="content">
        ...
        <b data-bind="vnDateText: fiNgayCvDn"></b> và hồ sơ kèm theo của doanh nghiệp (hợp tác xã) về việc về việc đăng ký bổ sung (thay thế) phương tiện khai thác tuyến vận tải hành khách tuyến cố định bằng xe ô tô giữa Việt Nam và Lào;
    </p>
    <p class="content">	
        Tổng cục Đường bộ Việt Nam thông báo như sau:
    </p>
    <p class="content">
        Chấp thuận cho phép doanh nghiệp (hợp tác xã)<b data-bind="text : fiTenDn"></b> được bổ sung (thay thế) phương tiện khai thác tuyến vận tải hành khách tuyến cố định bằng xe ô tô giữa Việt Nam và Lào.
    </p>
    <p class="content">
    ...
    <p class="content">
        Số xe bổ sung: <b data-bind="text : fiHanhtrinh"></b>
    </p>
    <p class="content">
        Số xe ngừng khai thác: <b data-bind="text : fiHanhtrinh"></b>
    </p>
    <p class="content">
    ...
    <p class="content pt-10">
        Tổng cục Đường bộ Việt Nam trân trọng đề nghị Cục Vận tải Lào bố trí cho phương tiện của doanh nghiệp (hợp tác xã) được hoạt động tại Bến xe <b data-bind="text : fiBenXe"></b> (tỉnh <b data-bind="text : fiTentinhLao"></b>, nước CHDCND Lào).
    </p>
    <p class="content">
