						...
						<div class="col-md-12">
							<div class="panel panel-default">
								<div class="panel-heading">
									<span class="caption-subject bold uppercase">Tìm kiếm hồ
										sơ</span>
								</div>
										...
										<div class="form-group" style="margin-top: 15px;">
											<div class="col-md-12">
												<div class="col-md-2 label-text-right">
													<label><spring:message code="sbv.01.mahoso"></spring:message>
													</label>
												</div>
												<div class="col-md-4">
											...
											<div class="col-md-12">
												...
												<div class="col-md-4">
													<input name="ngayNopTuNgay" id="ngayNopTuNgay"
														...
														data-bind="datepicker: searchForm.fiNgaygui.FROM" />
												</div>
												<div class="col-md-2 label-text-right">
												...
												<div class="col-md-4">
													<input name="ngayNopDenNgay" id="ngayNopDenNgay"
														...
														data-date-format="dd/mm/yyyy" size="16" type="text"
														placeholder="dd/mm/yyyy"
														data-bind="datepicker: searchForm.fiNgaygui.TO" />
												</div>
											</div>
										</div>
										<div class="form-group">
									...
									<table
										...
										<tbody id="list-container"
											...
											<tr>
												...
												<td class="text-center"
													data-bind="if: item.fiTrangthai()==7"><a
													href="javascript:;" data-bind="click:$root.xemGiayPhep"><i
														class="fa fa-list-alt" aria-hidden="true"></i> </a></td>
											...
											<div class="nsw-flr" data-bind="if: totalData() > 10">
												<ul class="flip pull-left pagination pagination-sm">
													<li
														...
														aria-label="First" data-bind="click: goToFirst"> <spring:message
...
<script type="text/javascript"
	src="<c:url value="/app/mt/p18/index.module.js?v=${ version }"/>"
	charset="utf-8"></script>
<script type="text/javascript"
	src="<c:url value="/app/mt/p18/model.js?v=${ version }"/>"
	charset="utf-8"></script>
