            ...
            <table class="table table-striped table-bordered table-hover table-checkable order-column" id="lstHanghoa10">
                ...
                <tbody data-bind="foreach: lstXe">
                    <tr>
                        ...
                        <td>
                            <input class="form-control" readonly name="fiBksXe" data-bind="value : fiBksXe" maxlength="250"></input>
                        </td> 
                        <td>
                            <input class="form-control" readonly name="fiTenChuxe" data-bind="value : fiTenChuxe" maxlength="250"></input>
                        </td>
                        ...
                        <td>
                            <input class="form-control" readonly name="fiSoGhe" data-bind="value : fiSoGhe" maxlength="250"></input>
                        </td>
                        <td>
                            <input class="form-control" readonly name="fiNamSx" data-bind="value : fiNamSx" maxlength="250"></input>
                        </td>
                        <td style="width: 220px">
                ...
                <div class="form-group">
                    <div class="col-md-12">
                        ...
                        <div class="col-md-4"> 
                            ...
                            <input type="hidden" id="fiTenLoaixe" name="fiTenLoaixe" data-bind="value : fiTenLoaixe"/>
                        </div>
                    </div>  
                </div>
            </form>
