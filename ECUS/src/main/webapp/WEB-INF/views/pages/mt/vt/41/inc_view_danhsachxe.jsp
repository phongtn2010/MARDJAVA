            ...
            <table class="table table-striped table-bordered table-hover table-checkable order-column">
                ...
                <tbody data-bind="foreach: lstXe">
                    <tr>
                        ...
                        <td style="width: 220px">
                            <input class="form-control" readonly name="fiSoGpMat" data-bind="value : fiSoGpMat" maxlength="250"></input>
                        </td>
                        <td style="width: 220px">
                        ...
                        <td>
                            <input class="form-control" readonly name="fiDiemDung" data-bind="value : fiDiemDung" maxlength="250"></input>
                        </td>
                    </tr>
                </tbody>
            </table>
