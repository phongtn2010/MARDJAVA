...
<div class="table-responsive">
    <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
        ...
        <tr>
            ...
            <td>Báo cáo tài chính của doanh nghiệp, hợp tác xã trong 3 năm liên tiếp gần nhất (được cơ quan tài chính
                địa phương hoặc đơn vị kiểm toán xác nhận)
            ...
            <td>
                <div>
                    <input type="file" id="VC_03" class="form-group form-control input-file-margin" multiple="multiple"
                           data-bind="event:{ change: $root.uploadFileChangeEvent.bind($data, 1, 'VC_03') }, visible: editMode">
                    <div>
            ...
            <td>
                <div>
                    ...
                    <input type="file" id="CNDKDN" class="form-group form-control input-file-margin" multiple="multiple"
                           data-bind="event:{ change: $root.uploadFileChangeEvent.bind($data, 4, 'CNDKDN') }, visible: editMode">
                    <div>
            ...
            <td>
                <div>
                    ...
                    <input type="file" id="DKCLVT" class="form-group form-control input-file-margin" multiple="multiple"
                           data-bind="event:{ change: $root.uploadFileChangeEvent.bind($data, 5, 'DKCLVT') }, visible: editMode">
                    <div>
            ...
            <td>
                <div>
                    ...
                    <input type="file" id="VBCC" class="form-group form-control input-file-margin" multiple="multiple"
                           data-bind="event:{ change: $root.uploadFileChangeEvent.bind($data, 6, 'VBCC') }, visible: editMode">
                    <div>
        ...
        <tr>
            ...
            <td>Giấy phép vận tải đường bộ quốc tế Việt Nam - Campuchia hết hạn (nộp lại)<span
                    class="nsw-require-field">*</span>
            </td>
            <td>
                <div>
                    <input type="file" id="GPKDVTHH" class="form-group form-control input-file-margin"
                           multiple="multiple"
