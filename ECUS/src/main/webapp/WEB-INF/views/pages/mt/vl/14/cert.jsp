...
<page size="A4" class="a4-padding">
    ...
    <p class="title">
        CHẤP THUẬN BỔ SUNG PHƯƠNG TIỆN KHAI THÁC TUYẾN VẬN TẢI HÀNH KHÁCH TUYẾN CỐ ĐỊNH BẰNG XE Ô TÔ GIỮA VIỆT NAM VÀ LÀO
    </p>
    <p class="t-center">
    ...
    <p class="content">
        ...
        <b data-bind="vnDateText: fiNgayCvDn"></b>
        và hồ sơ kèm theo của doanh nghiệp (hợp tác xã) về việc về việc đăng ký bổ sung (thay thế) phương tiện khai thác tuyến vận tải hành khách tuyến cố định bằng xe ô tô giữa Việt Nam và Lào;
    </p>
    <p class="content">	
