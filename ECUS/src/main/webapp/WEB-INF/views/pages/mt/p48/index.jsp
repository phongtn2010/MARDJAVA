...
<script type="text/javascript" src="<c:url value="/app/mt/p48/index.module.js?v=${ version }"/>"></script>
<script type="text/javascript" src="<c:url value="/app/mt/p48/model.js?v=${ version }"/>"></script>
