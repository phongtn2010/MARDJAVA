    ...
    <div class="col-md-12">
        <div class="portlet light " id="contentBody">
            ...
            <form role="form" class="form-horizontal" id="detailForm">
                ...
                <div class="panel panel-default" id="loaihinhvantai">
                    <div class="panel-heading">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group" style="margin-top: 15px;">
                            <div class="col-md-12">
                                ...
                                <div class="col-md-4"
                                    ...
                                    <select  name="tuyenvantai" required
                                            class="form-control select2" data-bind="options: $root.danhSachTuyen,
                                            optionsText: 'fiTenTuyen',
                                            optionsValue: 'fiMaTuyen',
                                            value: hoSoChiTiet.Tbdhoso.fiMatuyen ,optionsCaption: '--Chọn tuyến--',
                                            valueAllowUnset: true,
                                            event: { 'change': $root.chonTuyenVanTai }" disabled>
                                    </select>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group" style="margin-top: 15px;">
                            <div class="col-md-12">
                                ...
                                <div class="col-md-4">
                                    <input type="text" data-bind="value: hoSoChiTiet.Tbdhoso.fiMotatuyen"
                                           class="form-control">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group" style="margin-top: 15px;">
                            <div class="col-md-12">
                                ...
                                <div class="col-md-4">
                                    <input type="text" data-bind="value: hoSoChiTiet.Tbdhoso.fiSogiaytochapthuan"
                                           class="form-control">
                                </div>
                                <div class="col-md-2  label-text-right">
                                    <label>Ngày cấp<span class="nsw-require-field">*</span></label>
                                ...
                                <div class="col-md-4" data-bind="validationElement: hoSoChiTiet.Tbdhoso.fiNgaycapphep ">
                                    <input name="ngaycap"
                                           ...
                                           data-date-format="dd/mm/yyyy" size="16" type="text"
                                           placeholder="dd/mm/yyyy"
                                           data-bind="datepicker: hoSoChiTiet.Tbdhoso.fiNgaychapthuan"/>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script type="text/javascript" src="<c:url value="/app/mt/qlgp/p05/edit.module.js?v=${ version }"/>"
