			...
			<div class="portlet-body" id="table-search">
				<div class="table-toolbar">
					<div class="row">
										...
										<div class="form-group" style="margin-top: 15px;">
											<div class="col-md-12">
												<div class="col-md-2 label-text-right">
													<label><spring:message code="mt.search.mahoso"></spring:message>
													</label>
												</div>
												<div class="col-md-4">
												...
												<div class="col-md-2 label-text-right">
													<label><spring:message code="mt.search.trangthai"></spring:message></label>
												</div>
												<div class="col-md-4">
                       ...
                       value: searchForm.fiTrangthaiSearch">
													</select>
												</div>
											</div>
										</div>
										...
										<div class="form-group">
											<div class="col-md-12">
												...
												<div class="col-md-4">
													<input class="form-control" name="maHoSo" id="masothue"
														placeholder="Mã số thuế"
														data-bind="value: searchForm.fiManguoitao.VALUE"
														type="text">
												</div>
											</div>
										</div>
										<div class="form-group nsw-text-center">
											<a href="javascript:;" class="btn green" id="searchHoSo"
												data-bind="click: $root.searchHoSo"><i
				...
				<div class="table-toolbar">
					<div class="row">
						<div class="col-md-12">
							<div class="panel panel-default">
								<div class="panel-heading">
									<span class="caption-subject bold uppercase">Kết quả tìm
										kiếm</span>
								</div>
								<div class="panel-body">
									<table
										...
										<tbody id="list-container"
											...
											<tr>
												...
												<td class="text-center"
													data-bind="text: item.fiTendoanhnghiep"></td>
												<td class="text-center"
												...
												<td class="text-center"
													data-bind="if: item.fiTrangthai()==7 || item.fiTrangthai()==8 || item.fiTrangthai()==9 || item.fiTrangthai()==11"><a
													href="javascript:;" data-bind="click: $root.xemGiayPhep">
										...
										<div class="col-md-12 nsw-text-right">
											<div class="nsw-flr" data-bind="if: totalData() > 10">
												<ul class="flip pull-left pagination pagination-sm">
													<li
														data-bind="css: { disabled: !pagingVM.firstPageActive() }"
														class="previous disabled"><a href="#"
														aria-label="First" data-bind="click: goToFirst"> Trang
															đầu tiên </a></li>
													<li
														data-bind="css: { disabled: !pagingVM.previousPageActive()  }"
														class="previous disabled"><a href="#"
														aria-label="Previous" data-bind="click: goToPrevious">
															Trang trước </a></li>
													...
													<!-- /ko -->
													<li
														data-bind="css: { disabled: !pagingVM.nextPageActive() }"
														class="next"><a href="#" aria-label="Next"
														data-bind="click: goToNext"> Trang sau </a></li>
													<li
														data-bind="css: { disabled: !pagingVM.lastPageActive() }"
														class="next"><a href="#" aria-label="Last"
														data-bind="click: goToLast"> Trang cuối </a></li>
												</ul>
											</div>
										</div>
									</div>
...
<script type="text/javascript"
	src="<c:url value="/app/mt/qlgp/p09/index.module.js?v=${ version }"/>"
	charset="utf-8"></script>
<script type="text/javascript"
	src="<c:url value="/app/mt/qlgp/p09/model.js?v=${ version }"/>"
	charset="utf-8"></script>
