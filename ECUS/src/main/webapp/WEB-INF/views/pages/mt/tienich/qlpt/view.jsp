                                ...
                                <div class="tab-content" >
                                    ...
                                    <div class="tab-pane active" id="tab_mt_1" >
                                        <form role="form" class="form-horizontal">
                                            <!-- ko with: formVM() -->
                                            <%@include file="inc_view_thongtinphuongtien.jsp" %>
                                            <!-- /ko -->
                                        </form>
                                    </div>
...
<script src="<c:url value='/app/mt/tienich/qlpt/model.js?v=${version}'/>" type="text/javascript" charset="utf-8"></script>
<script src="<c:url value='/app/mt/tienich/qlpt/FormVM.js?v=${version}'/>" type="text/javascript" charset="utf-8"></script>
<script src="<c:url value='/app/mt/tienich/qlpt/EditVM.js?v=${version}'/>" type="text/javascript" charset="utf-8"></script>
