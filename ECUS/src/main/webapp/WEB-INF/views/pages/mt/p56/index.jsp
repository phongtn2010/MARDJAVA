...
<script type="text/javascript" src="<c:url value="/app/mt/lib/cmonfunc.js?v=${ version }"/>"></script>
<script type="text/javascript" src="<c:url value="/app/mt/p56/index.module.js?v=${ version }"/>"></script>
<script type="text/javascript" src="<c:url value="/app/mt/p56/model.js?v=${ version }"/>"></script>
