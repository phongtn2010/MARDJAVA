...
<fieldset>
    ...
    <div class="form-group">
        <div class="col-md-12">
            ...
            <div class="col-md-4">
                <input class="form-control date-picker" id="fiNgayGpvtVn" name="fiNgayGpvtVn"  data-bind="datepicker : fiNgayGpvtVn" type="text" data-date-format="dd/mm/yyyy" />
            </div>
        </div>  
    </div>  
    ...
    <div class="form-group">
        <div class="col-md-12">
            ...
            <div class="col-md-4">
                <input class="form-control date-picker" id="fiNgayGpvtTq" name="fiNgayGpvtTq"  data-bind="datepicker : fiNgayGpvtTq" type="text" data-date-format="dd/mm/yyyy" />
            </div>
        </div>  
    </div>  
