    ...
    <div class="col-md-12">
        <div class="portlet light " id="contentBody">
            <div class="panel-heading">
                <span class="caption-subject bold uppercase">Cấp Giấy phép liên vận Việt Nam - Campuchia cho phương tiện phi thương mại</span>
            </div>
            ...
            <table class="table table-striped table-bordered table-hover table-checkable order-column"
                ...
                <tr>
                    ...
                    <td class="text-center"
                        data-bind="text:  item?item.fiSoDangKy:''"></td>
                    <td class="text-center"
