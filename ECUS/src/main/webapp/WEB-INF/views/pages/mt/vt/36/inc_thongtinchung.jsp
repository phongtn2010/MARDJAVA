...
<fieldset>
    ...
    <div class="form-group">
        <div class="col-md-12">
            ...
            <div class="col-md-10">
                <textarea name="fiMucdich" id="fiMucdich" data-bind="value: fiMucdich" require="true" placeholder="<spring:message code="mt.36.hoso.mucdichxincapphep" />" style="width: 100%; height: 150px;" maxlength="969"></textarea>
            </div>                
        </div>  
    </div>
    <div class="form-group">
