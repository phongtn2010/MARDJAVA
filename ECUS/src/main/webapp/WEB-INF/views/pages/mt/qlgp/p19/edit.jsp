                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group" style="margin-top: 15px;">
                            <div class="col-md-12">
                                ...
                                <div class="col-md-4">
                                    <select data-bind="value:hoSoChiTiet.Tbdhoso.fiLoaihinh" disabled="true"  class="form-control select2">
                                        <option>---Chọn---</option>
                        ...
                        <div class="form-group" style="margin-top: 15px;" data-bind="visible: hoSoChiTiet.Tbdhoso.fiLoaihoso()!='BGTVT0600019'">
                            <div class="col-md-12">
                                <div class="col-md-2 label-text-right">
...
<script type="text/javascript" src="<c:url value="/app/mt/qlgp/p19/edit.module.js?v=${ version }"/>"
