            ...
            <table class="table table-striped table-bordered table-hover table-checkable order-column" id="lstHanghoa10">
                ...
                <tbody data-bind="foreach: lstXe">
                    <tr>
                        ...
                        <td>
                            <input class="form-control" name="fiBksXe" data-bind="value : fiBksXe" maxlength="250" readonly></input>
                        </td> 
                        <td>
                            <input class="form-control" name="fiTenChuxe" data-bind="value : fiTenChuxe" maxlength="250" readonly></input>
                        </td>
                        ...
                        <td>
                            <input class="form-control" name="fiSoGhe" data-bind="value : fiSoGhe" maxlength="250" readonly></input>
                        </td>
                        <td>
                            <input class="form-control" name="fiNamSx" data-bind="value : fiNamSx" maxlength="250" readonly></input>
                        </td>
                        <td style="width: 220px">
                        ...
                        <td>
                            <input class="form-control" name="fiBksXeKoHd" data-bind="value : fiBksXeKoHd" maxlength="50" readonly></input>
                        </td>
