    ...
    <div class="form-group">
        <div class="col-md-12">
            ...
            <div class="col-md-4">                                        
                ...
                <input type="hidden" id="fiTenQgia" name="fiTenQgia" data-bind="value : fiTenQgia" readonly="readonly"/>
            </div>
        </div>  
    </div> 
    <div class="form-group">
        <div class="col-md-12">
            ...
            <div class="col-md-4">                                        
                ...
                <input type="hidden" id="fiTenNhanhieu" name="fiTenQgia" data-bind="value : fiTenNhanhieu" readonly="readonly"/>
            </div>
            <div class="col-md-2 nsw-text-right">
            ...
            <div class="col-md-4">                                        
                ...
                <input type="hidden" id="fiTenLoaixe" name="fiTenQgia" data-bind="value : fiTenLoaixe" readonly="readonly"/>
            </div>
        </div>  
    </div> 
    <div class="form-group">
        <div class="col-md-12">
            ...
            <div class="col-md-4">                                        
                ...
                <input type="hidden" id="fiTenMauson" name="fiTenMauson" data-bind="value : fiTenMauson" readonly="readonly"/>
            </div>
        </div>  
    </div> 
    <div class="form-group">
