            ...
            <table class="table table-striped table-bordered table-hover table-checkable order-column" id="lstHanghoa10">
                ...
                <tbody data-bind="foreach: lstXe">
                    <tr>
                        ...
                        <td>
                            <input class="form-control" name="fiBksXe" readonly="readonly" data-bind="value : fiBksXe" maxlength="250"></input>
                        </td> 
                        <td>
                            <input class="form-control" name="fiTenChuxe" readonly="readonly" data-bind="value : fiTenChuxe" maxlength="250"></input>
                        </td>
                        ...
                        <td>
                            <input class="form-control" name="fiSoGhe" readonly="readonly" data-bind="value : fiSoGhe" maxlength="250"></input>
                        </td>
                        <td>
                            <input class="form-control" name="fiNamSx" readonly="readonly" data-bind="value : fiNamSx" maxlength="250"></input>
                        </td>
                        <td style="width: 220px">
