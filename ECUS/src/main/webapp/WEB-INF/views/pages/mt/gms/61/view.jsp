                                ...
                                <div class="tab-content" >
                                    ...
                                    <div class="tab-pane active" id="tab_mt_1" >
                                        <form role="form" class="form-horizontal">
                                            ...
                                            <%@include file="inc_view_loaihinhkinhdoanhvantai.jsp" %>
...
<script src="<c:url value='/app/mt/gms/61/model.js?v=${version}'/>" type="text/javascript" charset="utf-8"></script>
<script src="<c:url value='/app/mt/gms/61/FormVM.js?v=${version}'/>" type="text/javascript" charset="utf-8"></script>
<script src="<c:url value='/app/mt/gms/61/FileVM.js?v=${version}'/>" type="text/javascript" charset="utf-8"></script>
<script src="<c:url value='/app/mt/gms/61/ResultVM.js?v=${version}'/>" type="text/javascript" charset="utf-8"></script>
<script src="<c:url value='/app/mt/gms/61/ViewVM.js?v=${version}'/>" type="text/javascript" charset="utf-8"></script>
