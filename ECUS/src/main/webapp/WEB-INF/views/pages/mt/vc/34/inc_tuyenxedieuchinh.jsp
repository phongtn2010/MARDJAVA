...
<fieldset>
    ...
    <div class="form-group">
        <div class="col-md-12">
            ...
            <div class="col-md-8">                                        
                <select class="form-control select2" id="fiMaTuyen" name="fiMaTuyen" data-bind="optionsCaption: 'Chọn...', optionsValue : 'id', selectedText : fiTenTuyen, value : fiMaTuyen, options : lstTuyen, optionsText : 'name'"></select>
    ...
    <div class="form-group">
        <div class="col-md-12">
            ...
            <div class="col-md-4">
                <input class="form-control date-picker" id="fiNgayDchinh" name="fiNgayDchinh" data-bind="datepicker : fiNgayDchinh" type="text" data-date-format="dd/mm/yyyy" />
            </div>
        </div>  
    </div>  
    <div class="form-group">
