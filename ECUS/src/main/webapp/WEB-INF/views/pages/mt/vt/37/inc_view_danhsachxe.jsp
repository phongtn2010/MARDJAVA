            ...
            <table class="table table-striped table-bordered table-hover table-checkable order-column">
                ...
                <tbody data-bind="foreach: lstXe">
                    <tr>
                        ...
                        <td>
                            <input readonly class="form-control" name="fiBksXe" data-bind="value : fiBksXe" maxlength="250"></input>
                        </td>
                        <td>
                            <input readonly class="form-control" name="fiSoGhe" data-bind="value : fiSoGhe" maxlength="250"></input>
                        </td>
                        ...
                        <td>
                            <input readonly class="form-control" name="fiDiemDung" data-bind="value : fiDiemDung" maxlength="250"></input>
                        </td>
                    </tr>
                </tbody>
            </table>
