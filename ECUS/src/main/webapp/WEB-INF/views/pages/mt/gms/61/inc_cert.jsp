            ...
            <div class="form-group">
                ...
                <div class="form-group">
                    <div class="col-md-12">
                        ...
                        <div class="col-md-4">
                            <input class="form-control" type="text" data-bind="value : fiGpTuNgay" readonly="readonly"/>
                        </div>
                        <div class="col-md-2 nsw-text-right">
                            <label><spring:message code="mt.61.giayphep.gpdenngay" />: </label>
                        </div>
                        <div class="col-md-4">  
                            <input class="form-control" type="text" data-bind="value : fiGpDenNgay" readonly="readonly"/>
                        </div>
                    </div>
                </div>
                <div class="form-group">
