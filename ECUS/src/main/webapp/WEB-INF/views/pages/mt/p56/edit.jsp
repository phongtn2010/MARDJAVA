                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group" style="margin-top: 15px;">
                            <div class="col-md-12">
                                ...
                                <div class="col-md-4"
                                     data-bind="validationElement: hoSoChiTiet.Tbdhoso.fiIdCqxl ">
                                    <select name="trangThaiHoSo"
                                            class="form-control select2" data-bind="options: $root.danhSachDonVi,
                                             ...
                                             value: hoSoChiTiet.Tbdhoso.fiIdCqxl ,
                        ...
                        <div class="form-group" style="margin-top: 15px;">
                            <div class="col-md-12">
                                ...
                                <div class="col-md-4"
                                 ...
                                 <div class="col-md-2 label-text-right">
                                    <label>Địa điểm đăng ký<span class="nsw-require-field">*</span></label>
                                </div>
                                <div class="col-md-4">
                                    <input class="form-control" data-bind="value: hoSoChiTiet.Tbdhoso.fiDiaDiem"
                                           placeholder="Địa điểm đăng ký "
                                           type="text">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group" style="margin-top: 15px;">
                            <div class="col-md-12">
                                ...
                                <div class="col-md-4"
                                    ...
                                    <select id="tuyenvantai" name="tuyenvantai"
...
<script type="text/javascript" src="<c:url value="/app/mt/p56/edit.module.js?v=${ version }"/>"
        charset="utf-8"></script>
