...
<%@include file="../p01/incLanguage.jsp" %>

<div class="row">
    <div class="col-md-12">
        <div class="portlet light " id="contentBody">
            <div class="panel-heading">
                <span class="caption-subject bold uppercase">Danh sách Giấy phép liên vận Việt Nam - Campuchia</span>
            </div>
            ...
            <table class="table table-striped table-bordered table-hover table-checkable order-column"
                ...
                <tr class="nsw-tr tr-nsw1-bgcolor">
                    ...
                    <th class="text-center">Lịch sử giấy phép</th>
    ...
    <div class="form-group nsw-text-center">
        <a class="btn green bt-center btwidth" id="btSua" data-bind="click: $root.suaGiayPhep"> <i
                class="fa fa-edit" aria-hidden="true"></i> &nbsp;
            Xin sửa giấy phép </a>
        <a class="btn blue bt-center btwidth" id="btTra" data-bind="click: $root.traGiayPhep"> <i
...
<script type="text/javascript" src="<c:url value="/app/mt/qlgp/p27/license.module.js?v=${ version }"/>"
