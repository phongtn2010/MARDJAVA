                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="col-md-4">
                                                    <input class="form-control" name="maHoSo" id="masothue"
                                                           ...
                                                           data-bind="value: searchForm.fiManguoitao.VALUE" type="text">
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="panel-body">
                                    <table class="table table-striped table-bordered table-hover table-checkable order-column"
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center" data-bind="if: item.fiTrangthai()==7 || item.fiTrangthai()==8 || item.fiTrangthai()==9 || item.fiTrangthai()==11"><a
                                                    href="javascript:;"
                                                    data-bind="click: $root.xemGiayPhep,text: item.fiSogiayphep">
                                            </a></td>
                                        </tr>
                                        </tbody>
                                                ...
                                                <ul class="flip pull-left pagination pagination-sm">
                                                    ...
                                                    <li data-bind="css: { disabled: !pagingVM.nextPageActive() }"
                                                        class="next"><a href="#" aria-label="Next"
                                                                        data-bind="click: goToNext"> Trang sau
                                                    </a></li>
...
<script type="text/javascript" src="<c:url value="/app/mt/qlgp/p19/index.module.js?v=${ version }"/>"
        charset="utf-8"></script>
<script type="text/javascript" src="<c:url value="/app/mt/qlgp/p19/model.js?v=${ version }"/>"
        charset="utf-8"></script>
