                                    ...
                                    <form role="form" class="form-horizontal" name="searchForm07" id="searchForm07">
                                        ...
                                        <div class="form-group"> 
                                            <div class="col-md-12">
                                                ...
                                                <div class="col-md-4">
                                                    <input class="form-control" name="soThongBao" id="soThongBao" data-bind="value : soThongBao, executeOnEnter : searchFieldEnter, valueUpdate: 'input'" placeholder="Số giấy phép được cấp" type="text">
                                                </div>
                                                <div class="col-md-2 nsw-text-right">
