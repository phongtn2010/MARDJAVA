...
<div class="col-md-12 ">
	<div class="row">
		<div class="col-md-6">
			<div class="row">
				<div class="form-group">
					<label style="text-align: right;" for="inputPassword" class="col-sm-4 "><spring:message code="sbv.01.form.32"></spring:message></label>
					<div class="col-sm-8">
		...
		<div class="col-md-6">
			<div class="row">
				<div class="form-group">
					<label style="text-align: right;" for="inputPassword" class="col-sm-4 "></label>
					<div class="col-sm-8">
...
<div class="col-md-12">
	<div class="row">
		<div class="form-group">
			<label style="text-align: right;" for="inputPassword" class="col-sm-2 "><spring:message code="sbv.01.form.33"></spring:message><span class="nsw-require-field">*</span></label>
			<div class="col-sm-10">
...
<div class="col-md-12">
	<div class="row">
		<div class="col-md-6">
			<div class="row">
				<div class="form-group">
					<label style="text-align: right;" for="inputPassword" class="col-sm-4 "><spring:message code="sbv.01.form.34"></spring:message></label>
					<div class="col-sm-8">
						<input id="xuatNhapKhauTuNgay" class="form-control form-control-inline  date-picker" data-date-format="dd/mm/yyyy" size="16" type="text" placeholder="dd/mm/yyyy" data-bind="value: thongTinNgoaiTeModel.xuatNhapKhauTuNgay" />
					</div>
				</div>
			</div>
		</div>
		<div class="col-md-6">
			<div class="row">
				<div class="form-group">
					<label style="text-align: right;" for="inputPassword" class="col-sm-4"><spring:message code="sbv.01.form.44"></spring:message><span class="nsw-require-field">*</span></label>
					<div class="col-sm-8">
						<input id="xuatNhapKhauDenNgay" class="form-control form-control-inline  date-picker" data-date-format="dd/mm/yyyy" size="16" type="text" placeholder="dd/mm/yyyy" data-bind="value: thongTinNgoaiTeModel.xuatNhapKhauDenNgay" />
					</div>
				</div>
			</div>
		</div>
...
<div class="col-md-12">
	<div class="row">
		<div class="col-md-6">
			<div class="row">
				<div class="form-group">
					...
					<div class="col-sm-8">
						<div class="checkbox">
							<label><input id="capGiayPhepLanDau" type="checkbox" data-bind="checked: thongTinNgoaiTeModel.capGiayPhepLanDau, value: thongTinNgoaiTeModel.capGiayPhepLanDau, event:{ change: $root.capGiayPhepLanDauClick}"> <spring:message code="sbv.01.form.35"></spring:message></label>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="col-md-6">
			<div class="row">
				<div class="form-group">
					<label style="text-align: right;" for="inputPassword" class="col-sm-4 "><spring:message code="sbv.01.form.36"></spring:message></label>
					<div class="col-sm-8">
							<input id="soGiayPhepDaCap" class="form-control form-control-inline input-medium " type="text" data-bind="value: thongTinNgoaiTeModel.soGiayPhepDaCap, enable: !thongTinNgoaiTeModel.capGiayPhepLanDau()" />
					</div>
				</div>
			</div>
		</div>
...
<div class="col-md-12">
	<div class="row">
		<div class="form-group">
			<label style="text-align: right;" for="inputPassword" class="col-sm-2 "><spring:message code="sbv.01.form.37"></spring:message><span class="nsw-require-field">*</span></label>
			<div class="col-sm-10">
				<input id="doiTacXuatNhapKhau" 
					class="form-control form-control-inline" data-bind="value: thongTinNgoaiTeModel.doiTacXuatNhapKhau" />
			</div>
		</div>
	</div>
</div>
		...
		<table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
			<thead>
				<tr class="nsw-tr tr-nsw1-bgcolor">
					...
					<th class="text-center" width="200px"><spring:message code="sbv.01.form.41"></spring:message></th>
