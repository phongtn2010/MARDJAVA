                ...
                <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                    <thead>
                        <tr class="nsw-tr tr-nsw1-bgcolor">
                            ...
                            <th class="text-center"><spring:message code="sbv.01.formTimKiem.soGiayPhep"></spring:message></th>
                            <th class="text-center"><spring:message code="sbv.01.formTimKiem.ngayCapGiayPhep"></spring:message></th>
                        ...
                        <tbody id="list-container" data-bind="foreach: { data: $root.danhSachHoSo, as: 'item'}">
                            <tr>
                                ...
                                <td class="text-center" data-bind="text: item.soGiayPhep"></td>
