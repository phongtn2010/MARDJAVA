            ...
            <table class="table table-striped table-bordered table-hover table-checkable order-column" id="lstHanghoa10">
                <thead>
                    <tr class="nsw-tr tr-nsw1-bgcolor">
                        ...
                        <th class="text-center"><spring:message code="bca.02.hoso.thongtinhanghoa.danhsach.loai" /><a class="nsw-require-field">*</a></th>
                        <th class="text-center"><spring:message code="bca.02.hoso.thongtinhanghoa.danhsach.hoten" /><a class="nsw-require-field">*</a></th>
                        <th class="text-center"><spring:message code="bca.02.hoso.thongtinhanghoa.danhsach.so" /><a class="nsw-require-field">*</a></th>
