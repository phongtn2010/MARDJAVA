                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <form role="form" class="form-horizontal">
                                <fieldset>
                                    <legend><b><spring:message code="bca.01.hoso.thongbaophi" /></b></legend>
                                    <div class="form-group">
                                        <div class="col-md-12">
                                            <div class="col-md-4 nsw-text-right">
                                                <label><spring:message code="bca.01.hoso.thongbaophi.tongsotien" /></label>
                                            </div>
                                            <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-12">
                                            <div class="col-md-4 nsw-text-right">
                                                <label><spring:message code="bca.01.hoso.thongbaophi.noidung" /></label>
                                            </div>
                                            <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-12">
                                            <div class="col-md-4 nsw-text-right">
                                                <label><spring:message code="bca.01.hoso.thongbaophi.ngaythongbao" /></label>
                                            </div>
                                            <div class="col-md-6">
                                ...
                                <fieldset>
                                    <legend><b><spring:message code="bca.01.thanhtoanphi" /></b></legend>
                                    <div class="form-group">
                                        <div class="col-md-12">
                                            <div class="col-md-4 nsw-text-right">
                                                <label><spring:message code="bca.01.thanhtoanphi.nguoinop" /><a class="nsw-require-field">*</a></label>
                                            </div>
                                            <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-12">
                                            <div class="col-md-4 nsw-text-right">
                                                <label><spring:message code="bca.01.thanhtoanphi.ngaynop" /><a class="nsw-require-field">*</a></label>
                                            </div>
                                            <div class="col-md-6">
                                                <input class="form-control date-picker" placeholder="dd/mm/yyyy" id="fiNgaynop" name="fiNgaynop" 
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-12">
                                            <div class="col-md-4 nsw-text-right">
                                                <label><spring:message code="bca.01.thanhtoanphi.sotienthanhtoan" /><a class="nsw-require-field">*</a></label>
                                            </div>
                                            <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-12">
                                            <div class="col-md-4 nsw-text-right">
                                                <label><spring:message code="bca.01.thanhtoanphi.noidung" /></label>
                                            </div>
                                            <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-12">
                                            <div class="col-md-4 nsw-text-right">
                                                <label><spring:message code="bca.01.thanhtoanphi.filedinhkem" /></label>
                                            </div>
                                            <div class="col-md-6">
...
<script src="<c:url value='/app/bca/01/ChargeVM.js?v=${version}'/>" type="text/javascript" charset="utf-8"></script>
