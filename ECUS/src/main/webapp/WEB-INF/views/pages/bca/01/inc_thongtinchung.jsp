    ...
    <div class="form-group">
        <div class="col-md-12">
            ...
            <div class="col-md-2 nsw-text-right">
                ...
                <div class="col-md-4">
                    <input class="form-control form-control-inline" id="fiSoluongDoan" name="fiSoluongDoan" data-bind="value : fiSoluongDoan" type="number" maxlength="50" oninput="validity.valid||(value='');"/>
                </div>
            </div> 
        </div>
        <div class="form-group">
