...
<fieldset>
    ...
    <div class="form-group">
        <div class="col-md-12">
            ...
            <div class="col-md-4">
                <input class="form-control date-picker" placeholder="dd/mm/yyyy" id="fiThoigianvcTu" name="fiThoigianvcTu"  data-bind="datepicker : fiThoigianvcTu" type="text" data-date-format="dd/mm/yyyy" readonly style="background-color: #fff"/>
            </div>
            <div class="col-md-2 nsw-text-right">
                <label><spring:message code="bca.02.hoso.thongtinhanghoa.denngay" /><a class="nsw-require-field">*</a></label>
            </div>
            <div class="col-md-4">
                <input class="form-control date-picker" placeholder="dd/mm/yyyy" id="fiThoigianvcDen" name="fiThoigianvcDen"  data-bind="datepicker : fiThoigianvcDen" type="text" data-date-format="dd/mm/yyyy" readonly style="background-color: #fff"/>
            </div>
        </div>
    </div>
            ...
            <table class="table table-striped table-bordered table-hover table-checkable order-column" id="lstHanghoa10">
                ...
                <tbody data-bind="foreach: lstNguoiDieukhien">
                    <tr>
                        ...
                        <td>
                            <input  class="form-control" name="fiSocmndNguoidk" data-bind="value : fiSocmndNguoidk,event:{change:changeValidData}" maxlength="2000">
                            <span class="validationMessage" data-bind="attr: {'id': 'fiSocmndNguoidk_lbl_' + STT()}" style="display: none">Thông tin bắt buộc nhập</span>
                        </td>
                        <td>
                            <input class="form-control" name="fiBksPhuongtien" data-bind="value : fiBksPhuongtien,event:{change:changeValidData}" maxlength="2000">
                        ...
                        <td>
                            <input class="form-control" name="fiKhoiluongVc" data-bind="value : fiKhoiluongVc,event:{change:changeValidData}" maxlength="2000" type="number">
