...
<fieldset>
    ...
    <div class="form-group">
        <div class="col-md-12">
            ...
            <div class="col-md-4">                                        
                <input disabled class="form-control" id="fiNguoiky" name="fiNguoiky" data-bind="value : $data.formVM().fiNguoiky" maxlength="250"/>
            </div>
            <div class="col-md-2 nsw-text-right">
                <label><spring:message code="bca.01.hoso.thongtinkydon.diadiemky" /> <a class="nsw-require-field">*</a></label>
            </div>
            <div class="col-md-4">     
                <input disabled class="form-control" id="fiDiadiemky" name="fiDiadiemky" data-bind="value : $data.formVM().fiDiadiemky" maxlength="250"/>
            </div>
        </div>  
    </div> 
</fieldset>