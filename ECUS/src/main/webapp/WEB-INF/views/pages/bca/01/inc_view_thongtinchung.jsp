...
<fieldset>    
    ...
    <div class="form-group">
        <div class="col-md-12">
            ...
            <div class="col-md-2 nsw-text-right">
                <label><spring:message code="bca.01.hoso.thongtinchung.donvixuly" /></label>
            </div>
            <div class="col-md-4">
    ...
    <div class="form-group">
        <div class="col-md-12">
            ...
            <div class="col-md-2 nsw-text-right">
                ...
                <div class="col-md-4">
                    <input disabled class="form-control form-control-inline" id="fiSoluongDoan" name="fiSoluongDoan" data-bind="value : fiSoluongDoan" type="text" maxlength="50"/>
                </div>
            </div> 
        </div>
        <div class="form-group">
            <div class="col-md-12">
                ...
                <div class="col-md-10">
                    <input disabled class="form-control" id="fiThongtinDoan" name="fiThongtinDoan" type="text" data-bind="value: fiThongtinDoan" maxlength="250"/>
                </div>                
            </div>  
        </div>
    </fieldset>
