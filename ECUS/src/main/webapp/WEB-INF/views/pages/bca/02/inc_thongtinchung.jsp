...
<fieldset>    
    ...
    <div class="form-group">
        <div class="col-md-12">
            ...
            <div class="col-md-4">
                <input class="form-control" id="fiChucvuDaidien" name="fiChucvuDaidien" type="text" data-bind="value: fiChucvuDaidien" maxlength="250"/>
            </div> 
        </div>  
    </div>
    <div class="form-group">
        <div class="col-md-12">
            ...
            <div class="col-md-4">
                <input class="form-control" id="fiSoCmnd" name="fiSoCmnd" type="text" data-bind="value: fiSoCmnd" maxlength="250"/>
            </div>     
            <div class="col-md-2 nsw-text-right">
                <label><spring:message code="bca.02.hoso.thongtinchung.ngaycap" /> <a class="nsw-require-field">*</a></label>
            </div>
            <div class="col-md-4">
                <input class="form-control date-picker" placeholder="dd/mm/yyyy" id="fiNgaycapCmnd" name="fiNgaycapCmnd"  data-bind="datepicker : fiNgaycapCmnd" type="text" data-date-format="dd/mm/yyyy" readonly style="background-color: #fff"/>
            </div> 
        </div>  
    </div>
    ...
    <div class="form-group">
        <div class="col-md-12">
            ...
            <div class="col-md-4">
                <input class="form-control" id="fiHoadonSo" name="fiHoadonSo" type="text" data-bind="value: fiHoadonSo" maxlength="500"/>
            </div>     
            <div class="col-md-2 nsw-text-right">
                <label><spring:message code="bca.02.hoso.thongtinchung.ngayhoadon" /> <a class="nsw-require-field">*</a></label>
            </div>
            <div class="col-md-4">
                <input class="form-control date-picker" placeholder="dd/mm/yyyy" id="fiHoadonNgay" name="fiHoadonNgay"  data-bind="datepicker : fiHoadonNgay" type="text" data-date-format="dd/mm/yyyy" readonly style="background-color: #fff"/>
            </div> 
        </div>  
    </div>
    <div class="form-group">
