...
<form role="form" class="form-horizontal" id="form-ddk">
    ...
    <div class="form-group">
        <div class="col-md-12">
            <div class="col-md-2">
                <label><spring:message code="most.01.dondk.thoigian_dukien_lohangnhapkhau_tungay" /><a class="nsw-require-field">*</a></label>
            </div>
            <div class="col-md-4">                                        
                <input class="form-control form-control-inline input-medium date-picker" value="<fmt:formatDate value="${hoso.fiTuNgay}" pattern="dd/MM/yyyy" />" 
                       require="true" field="most_01_dondk_thoigian_dukien_lohangnhapkhau_tungay" id="fiTuNgay" name="fiTuNgay" data-date-format="dd/mm/yyyy" size="16" type="text" />
                <label class="input-invaild-text" id="message-fiTuNgay"></label>
            </div>

            <div class="col-md-2">
                <label><spring:message code="most.01.dondk.thoigian_dukien_lohangnhapkhau_denngay" /><a class="nsw-require-field">*</a></label>
            </div>
            <div class="col-md-4">
                <input class="form-control form-control-inline input-medium date-picker" 
                       ...
                       data-date-format="dd/mm/yyyy" size="16" type="text" require="true" field="most_01_dondk_thoigian_dukien_lohangnhapkhau_denngay"/>
