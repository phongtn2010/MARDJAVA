                                ...
                                <div class="panel-body">
                                    <form role="form" class="form-horizontal" name="searchForm01" id="searchForm01">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                <div class="col-md-2">
                                                    <label>Ngày thông báo: từ</label>
                                                </div>
                                                <div class="col-md-4">   
                                                    <input name="thongBaoTuNgay" id="thongBaoTuNgay" placeholder="Thông báo từ ngày" class="form-control form-control-inline input-medium date-picker" data-date-format="dd/mm/yyyy" size="16" type="text" value="" />
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    <input name="thongBaoDenNgay" id="thongBaoDenNgay" placeholder="Thông báo đến ngày" class="form-control form-control-inline input-medium date-picker" data-date-format="dd/mm/yyyy" size="16" type="text" value="" />
                                                </div>
                                            </div>  
                                        </div>                
                                        <div class="form-group"> 
