...
<fieldset>    
    ...
    <div class="form-group">
        <div class="col-md-12">
            ...
            <div class="col-md-4">
                <input class="form-control" id="fiTtTiepNhanTen" name="fiTtTiepNhanTen" maxlength="255"  
            ...
            <div class="col-md-4">
                <input class="form-control" id="fiTtTiepNhanDiaChi" name="fiTtTiepNhanDiaChi" data-bind="value : fiTtTiepNhanDiaChi" />
    ...
    <div class="form-group">
        <div class="col-md-12">
            ...
            <div class="col-md-4">
                <input class="form-control" id="fiTtTiepNhanDienThoai" name="fiTtTiepNhanDienThoai" data-bind="value : fiTtTiepNhanDienThoai" type="text" />
            </div>
            <div class="col-md-2 nsw-text-right">
