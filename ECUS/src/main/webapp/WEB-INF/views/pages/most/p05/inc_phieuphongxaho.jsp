        ...
        <form role="form" class="form-horizontal" id="addPhongXaHo-form">
            ...
            <div class="form-group" style="margin-top: 15px;">
                <div class="col-md-12">
                    ...
                    <div class="col-md-2">
                        <input class="form-control" id="fiTongHoatDoTrongNam" name="fiTongHoatDoTrongNam" data-bind="value: fiTongHoatDoTrongNam" type="number"/> 
                    </div>
                    <div class="col-md-2">
            ...
            <div class="form-group" style="margin-top: 15px;">
                <div class="col-md-12">
                    ...
                    <div class="col-md-4 nsw-text-right fiMucDichSuDungKhac" style="display: none">
                        <input class="form-control" id="fiMucDichSuDungKhac" name="fiMucDichSuDungKhac"  type="text" data-bind="value: fiMucDichSuDungKhac"/>
                    </div><br/>
