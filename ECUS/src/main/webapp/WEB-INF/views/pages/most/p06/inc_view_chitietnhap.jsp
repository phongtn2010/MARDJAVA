...
<fieldset>    
    ...
    <div class="form-group">
        <div class="col-md-12">
            ...
            <div class="col-md-4">
                <input disabled class="form-control date-picker" placeholder="dd/mm/yyyy" id="fiNgaycapDk" name="fiNgayTiepnhan" data-bind="datepicker : fiNgayTiepnhan" type="text" data-date-format="dd/mm/yyyy" />
            </div>
        </div>  
    </div> 
</fieldset>
