        ...
        <form role="form" class="" id="addPhongXaKin-form">
            ...
            <div class="form-group" style="margin-top: 15px;">
                <div class="col-md-12">
                    ...
                    <div class="col-md-4">
                        <input class="form-control" id="fiMaHieu" name="fiMaHieu" data-bind="value: fiMaHieu"/>
                    </div>
                    <div class="col-md-2 nsw-text-right">
                        <label><spring:message code="most.05.hoso.phongXakin.soSeri" /></label>
                    </div>
                    <div class="col-md-4">
                        <input class="form-control" id="fiSoSeri" name="fiSoSeri" data-bind="value: fiSoSeri"/>
                    </div>
                </div>
            </div>    
            <div class="form-group" style="margin-top: 15px;">
                <div class="col-md-12">
                    ...
                    <div class="col-md-4">
                        <input class="form-control" id="fiHangSanXuat" name="fiHangSanXuat" data-bind="value: fiHangSanXuat "/>
                    </div>
                </div>
            </div>    
            <div class="form-group" style="margin-top: 15px;">
                <div class="col-md-12">
                    ...
                    <div class="col-md-2">
                        <input class="form-control" id="fiHoatDo" name="fiHoatDo" data-bind="value: fiHoatDo " type="number" /> 
                    </div>
                    <div class="col-md-2">
                    ...
                    <div class="col-md-4">
                        <input name="fiNgayXacDinhHoatDo" id="NgayXacDinhHoatDo" data-bind="datepicker : fiNgayXacDinhHoatDo" 
                ...
                <div class="col-md-12">
                    ...
                    <div class="col-md-4">
                        <select class="form-control select2" id="fiMaMucDichSuDung" name="fiMaMucDichSuDung" multiple
                            ...
                            <span data-bind="text : errormucdicpxkMessage" style="color:red ; font-size: 12px"> </span>
                    </div>
                    ...
                    <div class="col-md-4 nsw-text-right fiMucDichSuDungKhac" style="display: none">
                        <input class="form-control" id="fiMucDichSuDungKhac" name="fiMucDichSuDungKhac" 
            ...
            <div class="form-group" style="margin-top: 15px;">
                ...
                <div class="col-md-4">
                    ...
                    <span data-bind="text : errorradiopxkMessage" style="color:red;float: left;margin-left: 16px;"> </span>
                </div>
            </div>
                <div class="form-group" style="margin-top: 15px;">
                    <label style="float: left;width: 100%; margin-left: 15px;"><b><spring:message code="most.05.hoso.phongXakin.label"/></b></label>
                </div>
            <div class="form-group" style="margin-top: 15px;">
                <div class="col-md-12">
                    <div class="col-md-2 nsw-text-right">
                    ...
                    <div class="col-md-4">
                        <input class="form-control" id="fiTbMaHieu" name="fiTbMaHieu" data-bind="value : fiTbMaHieu" type="text" />
                    </div>
                    <div class="col-md-2 nsw-text-right">
                        <label><spring:message code="most.05.hoso.phongXakin.soSeri" /></label>
                    </div>
                    <div class="col-md-4 nsw-text-right">
                        <input class="form-control" id="fiTbSoSeri" name="fiTbSoSeri" data-bind="value : fiTbSoSeri" type="text" />
                    </div>
                </div>
            </div>
            <div class="form-group" style="margin-top: 15px;">
                <div class="col-md-12">
                    ...
                    <div class="col-md-4">
                        <input class="form-control" id="fiTbHangNuocSanXuat" name="fiTbHangNuocSanXuat" data-bind="value : fiTbHangNuocSanXuat" type="text" />
                    </div>
                    <div class="col-md-2 nsw-text-right">
            ...
            <div class="form-group" style="margin-top: 15px;">
                <div class="col-md-12">
                    ...
                    <div class="col-md-9">
                        <input class="form-control" id="fiTbNoiDat" name="fiTbNoiDat"
            ...
            <div class="form-group" style="margin-top: 15px;">
                <div class="col-md-12">
                    ...
                    <div class="col-md-9">
                        <input class="form-control" id="fiTbKhoiLuongUrani" name="fiTbKhoiLuongUrani" data-bind="value : fiTbKhoiLuongUrani" type="text" />
                    </div>
                </div>
            </div>
    </div>
