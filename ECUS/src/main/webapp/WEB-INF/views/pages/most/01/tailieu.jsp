            ...
            <table class="table table-striped table-bordered table-hover order-column">
                ...
                <tfoot style="display: ${IsView}">
                    <tr class="odd gradeX" id="hopdong-tmpl">
                        <td> </td>
                        <td class="w150"> 
                            <input class="form-control" name="fiSoVb" id="txtSohopdong" require="true" field="most_01_hopdong_sohopdong" maxlength="50" placeholder="<spring:message code="most.01.hopdong.sohopdong" />" type="text">
                        </td>
                        <td class="w150">
            ...
            <table class="table table-striped table-bordered table-hover order-column">
                ...
                <tfoot style="display: ${IsView}">
                    <tr class="odd gradeX" id="vandon-tmpl">
                        <td> </td>
                        <td class="w150"> 
                            <input name="fiSoVb" id="txtSoVanDon" require="true" field="most_01_vandon_sovandon" 
            ...
            <table class="table table-striped table-bordered table-hover order-column">
                ...
                <tfoot style="display: ${IsView}">
                    <tr class="odd gradeX" id="hoadon-tmpl">
                        <td></td>
                        <td class="w150"> 
                            <input name="fiSoVb" id="txtSoHoaDon" require="true" field="most_01_hoadon_sohoadon" 
            ...
            <table class="table table-striped table-bordered table-hover order-column">
                ...
                <tfoot style="display: ${IsView}">
                    <tr class="odd gradeX" id="dmhanghoa-tmpl">
                        <td></td>
                        <td class="w150"> 
                            <input name="fiSoVb" id="txtTenDM" require="true" field="most_01_dmhanghoa_tendanhmuc" class="form-control" placeholder="<spring:message code="most.01.dmhanghoa.tendanhmuc" />" maxlength="50" type="text">
                        </td>
                        <td class="w150">
            ...
            <table class="table table-striped table-bordered table-hover order-column">
                ...
                <tfoot style="display: ${IsView}">
                    <tr id="gcn-tmpl">
                        ...
                        <td class="w150"> 
                            <input name="fiSoVb" id="txtSoGCN" require="true" maxlength="50" field="most_01_gcn_sogcn" value="" class="form-control" placeholder="<spring:message code="most.01.gcn.sogcn" />" type="text">
                        </td>
                        <td class="w150">
