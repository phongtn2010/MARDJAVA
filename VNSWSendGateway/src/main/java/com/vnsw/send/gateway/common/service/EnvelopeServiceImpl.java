...
import com.vnsw.send.gateway.common.bo.From;
import com.vnsw.send.gateway.common.bo.Header;
import com.vnsw.send.gateway.common.bo.Reference;
import com.vnsw.send.gateway.common.bo.Subject;
...
public class EnvelopeServiceImpl implements EnvelopeService {
    ...
    public Error createError(String code, String name) {
        try {
            com.vnsw.send.gateway.common.bo.Error error = new Error();
            error.setErrorCode(code);
            error.setErrorName(name);
            return error;
        } catch (Exception ex2) {
