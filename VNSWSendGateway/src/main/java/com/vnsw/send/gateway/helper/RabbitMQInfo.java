...
public class RabbitMQInfo {
    ...
    public String toString() {
        return "RabbitMQInfo{" + "host=" + host + ", virtualHost=" + virtualHost + ", userName=" + userName + ", password=" + password + ", exchangeName=" + exchangeName + ", queueName=" + queueName + ", routingKey=" + routingKey + ", port=" + port + '}';
    }
}
