...
public class Send1Controller {
	...
	@RequestMapping(value = "/sendAll", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
	public ResponseEntity<ResponseJson> sendAll(@RequestBody SendMessage sendMessage) {
		...
		try {
			...
			String uri = environment.getRequiredProperty(SERVICE_URL_01);
