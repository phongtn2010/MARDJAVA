...
public class HoSoNgoaiTe1SearchItem {
	...
	public String toString() {
		return "HoSoNgoaiTe1SearchItem [maSoThue=" + maSoThue + ", maHoSo=" + maHoSo + ", trangThai=" + trangThai + ", hinhThucXNK=" + hinhThucXNK + ", maCuaKhau=" + maCuaKhau + ", fromNgayTao=" + fromNgayTao + ", toNgayTao=" + toNgayTao + ", xoaHoSo=" + xoaHoSo + ", pageIndex=" + pageIndex + ", pageSize=" + pageSize + ", fromNgayPhep=" + fromNgayPhep + ", toNgayPhep=" + toNgayPhep + ", soGiayPhep=" + soGiayPhep + "]";
	}
