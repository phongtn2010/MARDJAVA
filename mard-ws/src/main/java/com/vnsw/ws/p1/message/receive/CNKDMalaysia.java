...
import com.vnsw.ws.p1.entity.receive.AnimailProductM;
...
@XmlType(name = "CertificateMalaysia")
@XmlAccessorType(XmlAccessType.FIELD)
@Data
public class CNKDMalaysia {
    ...
    private List<AnimailProductM> fiAnimalProductList;
}
