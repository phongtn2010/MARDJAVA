...
public class Soap26Helper {
    ...
    private static String replaceExtraTag(String content) {
        ...
        try {
            int firstIndex;
            int lastIndex;
            String openTag = Constants26.ENVELOP_TAG_ENCODE.OPEN_TAG;
            String closeTag = Constants26.ENVELOP_TAG_ENCODE.CLOSE_TAG;
        ...
        result = result.replace(Constants26.TAG_ENCODE.OPEN_TAG, Constants26.TAG_NO_ENCODE.OPEN_TAG)
                .replace(Constants26.TAG_ENCODE.CLOSE_TAG, Constants26.TAG_NO_ENCODE.CLOSE_TAG)
                .replace(Constants26.TAG_ENCODE.AND_TAG, Constants26.TAG_NO_ENCODE.AND_TAG)
                .replace(Constants26.TAG_ENCODE.UNKNOW_TAG, "").trim();
