 ...
 */
package com.vnsw.ws.p10.common;

public class Constants10 {

    public interface MARD10_TYPE {
    ...
    public interface MARD10_FUNCTION {
    ...
    public interface RES_URI {
        ...
        public static final String URI_UPDATE_STATUS_HOSO = "/mard/10/ws/updateTrangthaiHS/";
        public static final String URI_UPDATE_LICHSU = "/mard/10/ws/logSend/";
        public static final String URI_UPDATE_KQTD = "/mard/10/ws/updateKqtd/";
        public static final String URI_UPDATE_XAC_ND= "/mard/10/ws/updateXacnhandon/";
        public static final String URI_KQ_XIN_RUT_HS = "/mard/10/ws/updateKQXinRutHS/";
        public static final String URI_KQ_XIN_SUA_HS = "/mard/10/ws/updateKQXinSuaHS/";
        public static final String URI_TB_AP_PHI = "/mard/10/ws/tbApPhi/";
        public static final String URI_TB_AP_PHI_BS = "/mard/10/ws/tbApPhiBoSung/";
        public static final String URI_TB_LOHANG_CAN_XL = "/mard/10/ws/tblohangcanXL/";
        public static final String URI_XL_MAU_9 = "/mard/10/ws/xlMau9/";
        public static final String URI_XL_MAU_14A = "/mard/10/ws/xlMau14A/";
        public static final String URI_XL_MAU_14B = "/mard/10/ws/xlMau14B/";
        public static final String URI_XL_MAU_15A = "/mard/10/ws/xlMau15A/";
        public static final String URI_XL_MAU_15B = "/mard/10/ws/xlMau15B/";
        public static final String URI_XL_MAU_15C = "/mard/10/ws/xlMau15C/";
        public static final String URI_KQ_XIN_SUA_GCN = "/mard/10/ws/updateKQXinSuaGCN/";
        public static final String URL_GET_HOSO = "/mard/10/ws/getHoSo/";
    }
