...
public class QuarantineCancelResponse {
    ...
    public QuarantineCancelResponse() {
    }

    public QuarantineCancelResponse(String fiMaHoso, String fiLydoBnn, Date fiNgayXl, String fiDonviXl, String fiNguoiXl) {
