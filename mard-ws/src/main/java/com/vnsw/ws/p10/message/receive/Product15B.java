...
public class Product15B {
    ...
    public Product15B(Long fiStt, Long fiIdHanghoa, String fiTenHh, String fiQuycachDg, BigDecimal fiSoluong, String fiDvSl, String fiTenSl, BigDecimal fiKhoiluong, String fiMucdich) {
        this.fiStt = fiStt;
