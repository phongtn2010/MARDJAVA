...
@XmlType(name = "FoodAnimalQuarantine")
public class FoodAnimalQuarantine {
    ...
    private List<Product15C> product;
    ...
    public FoodAnimalQuarantine() {
    }

    public FoodAnimalQuarantine(String fiLydoSua, String fiMaHoso, String fiTenCqkddv, String fiSocv, String fiTenCh, String fiDiachiCh, String fiDtCh, String fiFaxCh, String fiEmailCh, String fiSovandon, String fiSotokhai, List<Product15C> product, BigDecimal fiTongSl, BigDecimal fiTongTl, String fiNdTongso, String fiDtXk, String fiNoiSx, String fiTenqgXk, String fiMaqgXk, String fiQgQc, String fiTenckNhap, String fiMackNhap, Date fiTgNhap, String fiNoiDen, String fiVdLq, String fiHosoLq, String fiPtVc, String fiPptdkt, String fiNongdo, Date fiCachlyDn, String fiKddv, Date fiNgayky, String fiNguoiky, String fiNoiky) {
    ...
    public List<Product15C> getProduct() {
        return product;
    }

    public void setProduct(List<Product15C> product) {
        this.product = product;
    }
