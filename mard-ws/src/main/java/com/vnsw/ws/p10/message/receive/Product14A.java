...
public class Product14A {
    ...
    public Product14A(Long fiStt, Long fiIdHanghoa, String fiTenHh, String fiTuoi, BigDecimal fiTinhbiet, BigDecimal fiSoluong, String fiDvSl, String fiTenSl, String fiMucdich) {
        this.fiStt = fiStt;
