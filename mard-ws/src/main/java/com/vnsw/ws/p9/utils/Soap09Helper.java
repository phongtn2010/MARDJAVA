...
public class Soap09Helper {
    ...
    private static String replaceExtraTag(String content) {
        ...
        try {
            int firstIndex;
            int lastIndex;
            String openTag = Constants09.ENVELOP_TAG_ENCODE.OPEN_TAG;
            String closeTag = Constants09.ENVELOP_TAG_ENCODE.CLOSE_TAG;
        ...
        result = result.replace(Constants09.TAG_ENCODE.OPEN_TAG, Constants09.TAG_NO_ENCODE.OPEN_TAG)
                .replace(Constants09.TAG_ENCODE.CLOSE_TAG, Constants09.TAG_NO_ENCODE.CLOSE_TAG)
                .replace(Constants09.TAG_ENCODE.AND_TAG, Constants09.TAG_NO_ENCODE.AND_TAG)
                .replace(Constants09.TAG_ENCODE.UNKNOW_TAG, "").trim();
