...
import com.vnsw.ws.p9.entity.Immunes;
import lombok.Data;
...
@XmlType(name = "AnimalQuarantineResult")
@XmlAccessorType(XmlAccessType.FIELD)
@Data
public class GiayCNKD {
    ...
    @XmlElementWrapper(name = "ImmunesList")
    @XmlElement(name = "Immunes")
    private List<Immunes> fiImmunesList;
