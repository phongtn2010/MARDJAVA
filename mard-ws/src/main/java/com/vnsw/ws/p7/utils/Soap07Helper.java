...
public class Soap07Helper {
    ...
    private static String replaceExtraTag(String content) {
        ...
        try {
            int firstIndex;
            int lastIndex;
            String openTag = Constants07.ENVELOP_TAG_ENCODE.OPEN_TAG;
            String closeTag = Constants07.ENVELOP_TAG_ENCODE.CLOSE_TAG;
        ...
        result = result.replace(Constants07.TAG_ENCODE.OPEN_TAG, Constants07.TAG_NO_ENCODE.OPEN_TAG)
                .replace(Constants07.TAG_ENCODE.CLOSE_TAG, Constants07.TAG_NO_ENCODE.CLOSE_TAG)
                .replace(Constants07.TAG_ENCODE.AND_TAG, Constants07.TAG_NO_ENCODE.AND_TAG)
                .replace(Constants07.TAG_ENCODE.UNKNOW_TAG, "").trim();
