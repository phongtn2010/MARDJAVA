 ...
 */
package com.vnsw.ws.p7.common;

public class Constants07 {

    public interface MARD07_TYPE {
    ...
    public interface MARD07_FUNCTION {
    ...
    public interface RES_URI {
        public static final String URI_UPDATE_STATUS_HOSO = "/mard/07/ws/updateTrangthaiHS";
        public static final String URI_UPDATE_LICHSU = "/mard/07/ws/updateLichsuHS";
        public static final String URI_UPDATE_KQTD = "/mard/07/ws/updateKQTD";
        public static final String URI_UPDATE_XACNHANDON = "/mard/07/ws/updateXacnhanDon";
        public static final String URI_UPDATE_KETQUA_XIN_SUA_HS = "/mard/07/ws/updateKQXinSuaHS";
        public static final String URI_UPDATE_KETQUA_XIN_RUT_HS = "/mard/07/ws/updateKQXinRutHS";
        public static final String URI_UPDATE_TB_APPHI = "/mard/07/ws/updateTBAP";
        public static final String URI_UPDATE_XACNHAN_PHI = "/mard/07/ws/updateXNPHI";
        public static final String URI_UPDATE_GIAY_CNVC = "/mard/07/ws/updateCNVC";
        public static final String URI_UPDATE_GIAY_CNKD = "/mard/07/ws/updateCNKD";
        public static final String URI_UPDATE_TB_LOHANG_KHONGDAT = "/mard/07/ws/updateLohangFail";
        public static final String URI_UPDATE_TUCHOI_XINSUA_GCN = "/mard/07/ws/updateTuchoiXinsuaGCN";
        public static final String URI_GET_HS_BY_ID = "/mard/07/ws/hoso/";
    }
