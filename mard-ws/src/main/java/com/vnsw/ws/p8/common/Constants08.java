 ...
 */
package com.vnsw.ws.p8.common;

public class Constants08 {

    public interface MARD08_TYPE {
    ...
    public interface MARD08_FUNCTION {
    ...
    public interface RES_URI {
        ...
        public static final String URI_UPDATE_STATUS_HOSO = "/mard/08/ws/updateTrangthaiHS";
        public static final String URI_UPDATE_LICHSU = "/mard/08/ws/updateLichsuHS";
        public static final String URI_UPDATE_KQTD = "/mard/08/ws/updateKetQuaThamDinh";
        public static final String URI_UPDATE_XAC_NHAN_DON_DANG_KY = "/mard/08/ws/updateXacNhanDonDangKy";
        public static final String URI_UPDATE_KETQUA_XIN_SUA_HS = "/mard/08/ws/updateKQXinSuaHS";
        public static final String URI_UPDATE_KETQUA_XIN_RUT_HS = "/mard/08/ws/updateKQXinRutHS";
        public static final String URI_UPDATE_GIAY_CNKD = "/mard/08/ws/updateGiayCNKD";
        public static final String URI_UPDATE_GIAY_VAN_CHUYEN = "/mard/08/ws/updateGiayVanChuyen";
        public static final String URI_UPDATE_GIAY_XNCL = "/mard/08/ws/updateGiayXNCL";
        public static final String URI_THONGBAO_APPHI = "/mard/08/ws/thongbaoApphi";
        public static final String URI_THONGBAO_APPHI_BOSUNG = "/mard/08/ws/thongbaoApphiBosung";
        public static final String URI_XACNHAN_PHI = "/mard/08/ws/xacnhanPhi/";
        public static final String URI_NHAN_CV_XNCL_KHONGDAT = "/mard/08/ws/congvanXNCLKhongdat";
        public static final String URI_TB_KHONGCAP_CNKD = "/mard/08/ws/thongbaoKhongcapCNKD";
        public static final String URI_GET_HS_BY_ID = "/mard/08/ws/hoso/";
        public static final String URI_UPDATE_VSTY = "/mard/08/ws/xlCVVSTY";
        public static final String URI_UPDATE_KDNK = "/mard/08/ws/xlCVKDNK";
        public static final String URI_UPDATE_PHANHOI_YEUCAU_SUAHS = "/mard/08/ws/updateKQXinSuaHS";
        public static final String URI_UPDATE_PHANHOI_YEUCAU_RUTHS = "/mard/08/ws/updateKQXinRutHS";
        public static final String URI_UPDATE_KQVSTY = "/mard/08/ws/xlKQVSTY";
    }
