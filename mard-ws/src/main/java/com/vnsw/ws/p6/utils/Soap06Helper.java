...
public class Soap06Helper {
    ...
    private static String replaceExtraTag(String content) {
        ...
        try {
            int firstIndex;
            int lastIndex;
            String openTag = Constants06.ENVELOP_TAG_ENCODE.OPEN_TAG;
            String closeTag = Constants06.ENVELOP_TAG_ENCODE.CLOSE_TAG;
        ...
        result = result.replace(Constants06.TAG_ENCODE.OPEN_TAG, Constants06.TAG_NO_ENCODE.OPEN_TAG)
                .replace(Constants06.TAG_ENCODE.CLOSE_TAG, Constants06.TAG_NO_ENCODE.CLOSE_TAG)
                .replace(Constants06.TAG_ENCODE.AND_TAG, Constants06.TAG_NO_ENCODE.AND_TAG)
                .replace(Constants06.TAG_ENCODE.UNKNOW_TAG, "").trim();
