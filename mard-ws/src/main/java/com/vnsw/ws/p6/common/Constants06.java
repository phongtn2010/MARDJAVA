 ...
 */
package com.vnsw.ws.p6.common;

public class Constants06 {

    public interface MARD06_TYPE {
    ...
    public interface MARD06_FUNCTION {
    ...
    public interface RES_URI {
        ...
        public static final String URI_GET_HS_BY_ID = "/mard/06/ws/hoso/";
    }
