...
*
* @Model
* @class CapGiayPhepNhapKhau
* Created by Nguyen Van Quang
* 05/12/2018 17:57:08
*
*/
@XmlRootElement(name = "MedicinePPLicense")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(propOrder = { "fiDispatchNo", "fiOrganization", "fiAddress", "fiApplicationNo", "fiSignDate", "fiGoods", "fiPurposes", "fiPurposeOtherNote", "fiToxicityUsed", "fiTestingUsed", "fiGates", "fiTimeOfImportation", "fiNote", "fiSignConfirmDate", "fiSignConfirmName", "fiSignConfirmPosition", "fiSignConfirmAddress"})
public class CapGiayPhepNhapKhau {

	public CapGiayPhepNhapKhau() {}
