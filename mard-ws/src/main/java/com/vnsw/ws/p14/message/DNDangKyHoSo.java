...
* 05/12/2018 17:149:59
*
*/
@XmlRootElement(name = "MedicinePP")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(propOrder = { "fiApplicationNo", "fiNameOfRegistration", "fiAddressOfRegistration", "fiPhone", "fiEmail", "fiFax", "fiTaxCode", "fiGoods", "fiPurposes", "fiPurposeOtherNote", "fiToxicityUsed", "fiTestingUsed", "fiGates", "fiImportTimeFrom", "fiImportTimeTo", "fiAttachment"})
