...
@Component
public class Mard16DownloadFile {

    private static final Logger LOGGER = LoggerFactory.getLogger(Mard16DownloadFile.class);
    private static final String CLASS_NAME = "File16ResourceController";
    ...
    @Autowired
    public Mard16DownloadFile(Environment environment) {
