...
@XmlType(propOrder = { "fiOrganization", "fiAddress", "fiApplicationNo", "fiSignDate","fiBase","fiPurposes", "fiGoods", "fiTotalQuantity", "fiScale", "fiLocation", "fiNote", "fiLawBase", "fiReport", "fiDealineImport", "fiRecipients","fiDispatchNo", "fiSignConfirmDate", "fiSignConfirmName", "fiSignConfirmPosition", "fiSignConfirmAddress"})
