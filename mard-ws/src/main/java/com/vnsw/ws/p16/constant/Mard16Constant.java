package com.vnsw.ws.p16.constant;


import java.text.SimpleDateFormat;

public class Mard16Constant {

    public static final String MARD = "BNN";
    ...
    public static final String TO_MINISTRY_CODE = "BNN";
    ...
    public static final String MARD1_PRO = "BNN0500003";
