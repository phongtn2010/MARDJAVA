...
@XmlType(name = "PhytosanitaryCer")
public class PhytosanitaryCer {
    @XmlTransient
    private Long fiIdDcn;
    ...
    private List<Tbdhhgcn11> product;
    ...
    public PhytosanitaryCer() {
    }

    public Long getFiIdDcn() {
        return fiIdDcn;
    }

    public void setFiIdDcn(Long fiIdDcn) {
        this.fiIdDcn = fiIdDcn;
    }
    ...
    public List<Tbdhhgcn11> getProduct() {
        return product;
    }

    public void setProduct(List<Tbdhhgcn11> product) {
