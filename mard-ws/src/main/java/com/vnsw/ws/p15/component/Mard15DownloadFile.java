...
@Component
public class Mard15DownloadFile {

    private static final Logger LOGGER = LoggerFactory.getLogger(Mard15DownloadFile.class);
    private static final String CLASS_NAME = "File15ResourceController";
    ...
    @Autowired
    public Mard15DownloadFile(Environment environment) {
