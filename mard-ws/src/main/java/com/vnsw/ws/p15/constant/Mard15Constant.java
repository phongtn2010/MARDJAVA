package com.vnsw.ws.p15.constant;


import java.text.SimpleDateFormat;

public class Mard15Constant {

    public static final String MARD = "MARD";
    ...
    public static final String TO_NAME = "MARD";
    public static final String TO_IDENTITY = "MARD";
    public static final String TO_COUNTRY_CODE = "VN";
    public static final String TO_MINISTRY_CODE = "MARD";
    public static final String TO_ORAGANIZATION_CODE = "MARD";
    public static final String TO_UNIT_CODE = "MARD";

    public static final String SEND_VERSION = "01";
    public static final String RECEIVE_VERSION = "01";

    public static final String MARD1_PRO = "BNN0500004";
