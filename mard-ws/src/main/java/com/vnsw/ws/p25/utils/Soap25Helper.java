...
public class Soap25Helper {
    ...
    private static String replaceExtraTag(String content) {
        ...
        try {
            int firstIndex;
            int lastIndex;
            String openTag = Constants25.ENVELOP_TAG_ENCODE.OPEN_TAG;
            String closeTag = Constants25.ENVELOP_TAG_ENCODE.CLOSE_TAG;
        ...
        result = result.replace(Constants25.TAG_ENCODE.OPEN_TAG, Constants25.TAG_NO_ENCODE.OPEN_TAG)
                .replace(Constants25.TAG_ENCODE.CLOSE_TAG, Constants25.TAG_NO_ENCODE.CLOSE_TAG)
                .replace(Constants25.TAG_ENCODE.AND_TAG, Constants25.TAG_NO_ENCODE.AND_TAG)
                .replace(Constants25.TAG_ENCODE.UNKNOW_TAG, "").trim();
