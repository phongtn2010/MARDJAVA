...
public class Subject {
    ...
    public Subject(String documentType, String type, String function, String reference, String documentYear, String sendDate, String preReference, String preDocumentYear) {
     ...
     public Subject(String documentType, String type, String function, String reference, String documentYear, String sendDate, String preReference) {
        this.documentType = documentType;
        this.type = type;
        this.function = function;
        this.reference = reference;
