...
@Entity
@Data
@Table(name = "TBDDKTBXNCL09", schema = "MARD")
public class TbdDkTbXncl09 extends CmonBaseEntity implements Serializable {

    private static final long serialVersionUID = 1L;

    private static final String SEQUENCE_NAME = "TBDDKTBXNCL09_SEQ";
    ...
    public boolean equals(Object o) {
        ...
        TbdDkTbXncl09 that = (TbdDkTbXncl09) o;
