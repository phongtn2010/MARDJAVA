...
/**
 * Persistent class for entity stored in table "TBDYCPK09" - Yêu cầu rút Hồ Sơ
 *
 * @author Telosys Tools Generator
 */
@Entity
@Data
@Table(name = "TBDYCPK09", schema = "MARD")
public class Tbdycpk09 extends CmonBaseEntity implements Serializable {
    ...
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "TBDYCPK09_SEQ")
    @SequenceGenerator(sequenceName = "TBDYCPK09_SEQ", schema = "MARD", initialValue = 10000, allocationSize = 1, name = "TBDYCPK09_SEQ")
