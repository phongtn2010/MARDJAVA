...
@Entity
@Data
@Table(name = "TBDCNKDHKP01", schema = "MARD")
public class TbdcnkdHKP01 extends BaseCert01 implements Serializable {
    private static final long serialVersionUID = 1L;
    public static final String SEQUENCE_NAME = "TBDCNKDHKP01_SEQ";
    //----------------------------------------------------------------------
    // ENTITY PRIMARY KEY ( BASED ON A SINGLE FIELD )
    //----------------------------------------------------------------------

    @Id
    @Column(name = "FI_ID_CNKD_HKP", nullable = false)
    ...
    @JoinColumn(name = "FI_ANIMAL_PRODUCT_HKP")
