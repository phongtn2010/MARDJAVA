...
@Table(name = "TBDCVCNKDHH07", schema = "MARD")
public class TbdCvCnkdHh07 extends CmonHangHoa07 implements Serializable {
    private static final long serialVersionUID = 1L;

    private static final String SEQUENCE_NAME = "TBDCVCNKDHH07_SEQ";
    ...
    @Column(name = "FI_NOTE", length = 500)
    private String fiNote;

    @Column(name = "FI_REMEDIAL_MEASURE", length = 500)
