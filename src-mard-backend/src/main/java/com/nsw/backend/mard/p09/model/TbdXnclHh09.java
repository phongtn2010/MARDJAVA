...
@Entity
@Data
@Table(name = "TBDXNCLHH09", schema = "MARD")
public class TbdXnclHh09 extends CmonHh09 implements Serializable {
    private static final long serialVersionUID = 1L;

    private static final String SEQUENCE_NAME = "TBDXNCLHH09_SEQ";
    //----------------------------------------------------------------------
