...
/**
 * Persistent class for entity stored in table "TBDYCRUT08" - Yêu cầu rút Hồ Sơ
 *
...
@Data
@Table(name = "TBDYCRUT08", schema = "MARD")
public class Tbdycrut08 extends CmonBaseEntity implements Serializable {
    ...
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "TBDYCRUT08_SEQ")
    @SequenceGenerator(sequenceName = "TBDYCRUT08_SEQ", schema = "MARD", initialValue = 10000, allocationSize = 1, name = "TBDYCRUT08_SEQ")
