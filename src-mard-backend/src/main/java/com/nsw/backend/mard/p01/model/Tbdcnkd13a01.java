...
@Entity
@Data
@Table(name = "TBDCNKD13A01", schema = "MARD")
public class Tbdcnkd13a01 extends BaseCert01 implements Serializable {
    private static final long serialVersionUID = 1L;
    public static final String SEQUENCE_NAME = "TBDCNKD13A01_SEQ";
    //----------------------------------------------------------------------
    // ENTITY PRIMARY KEY ( BASED ON A SINGLE FIELD )
    //----------------------------------------------------------------------

    @Id
    @Column(name = "FI_ID_CNKD_13A", nullable = false)
    ...
    @Column(name = "FI_HEALTH_CERTIFICATE_NO", length = 50, nullable = false)
    private String fiHealthCertificateNo;

    @Column(name = "FI_DEPARTMENT_PARENT_CODE", length = 50, nullable = false)
    private String fiDepartmentParentCode;

    @Column(name = "FI_DEPARTMENT_PARENT_NAME_VNI", length = 250, nullable = false)
    private String fiDepartmentParentNameVni;

    @Column(name = "FI_DEPARTMENT_PARENT_NAME", length = 250, nullable = false)
    private String fiDepartmentParentName;

    @Column(name = "FI_DEPARTMENT_CHILD_CODE", length = 50, nullable = false)
    private String fiDepartmentChildCode;

    @Column(name = "FI_DEPARTMENT_CHILD_NAME_VNI", length = 250, nullable = false)
    private String fiDepartmentChildNameVni;

    @Column(name = "FI_DEPARTMENT_CHILD_NAME", length = 250, nullable = false)
    private String fiDepartmentChildName;

    @Column(name = "FI_HEALTH_CERTIFICATE_FORM", length = 12, nullable = false)
    ...
    @Column(name = "FI_EXPORTERFAX", length = 50, nullable = false)
    private String fiExporterFax;

    @Column(name = "FI_EXPORTER_EMAIL", length = 250, nullable = false)
    private String fiExporterEmail;

    @Column(name = "FI_DEPARTURE_PLACE_VNI", length = 250)
    private String fiDeparturePlaceVni;

    @Column(name = "FI_DEPARTURE_PLACE", length = 250, nullable = false)
    private String fiDeparturePlace;

    @Column(name = "FI_TOTAL_VNI", length = 1000)
    private String fiTotalVni;

    @Column(name = "FI_TOTAL", length = 1000, nullable = false)
    private String fiTotal;

    @Column(name = "FI_DESTINATION_COUNTRY_CODE", length = 50, nullable = false)
    private String fiDestinationCountryCode;

    @Column(name = "FI_DES_COUNTRY_NAME_VNI", length = 250)
    private String fiDestinationCountryNameVni;

    @Column(name = "FI_DES_COUNTRY_NAME", length = 250, nullable = false)
    ...
    @JoinColumn(name = "FI_ANIMAL_LIST")
