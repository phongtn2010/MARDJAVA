...
/**
 * Persistent class for entity stored in table "TBDYCSUA07" - Yêu cầu sửa Hồ Sơ
 *
...
@Table(name = "TBDYCSUA07", schema = "MARD")
public class TbdYcsua07 extends CmonBaseEntity implements Serializable {
    private static final long serialVersionUID = 1L;

    public static final String SEQUENCE_NAME = "TBDYCSUA07_SEQ";
