package com.nsw.backend.mard.p07.exception;
...
@ControllerAdvice
public class Mard07ExceptionHandler {
    private static final Logger log = LoggerFactory.getLogger(Mard07ExceptionHandler.class);
