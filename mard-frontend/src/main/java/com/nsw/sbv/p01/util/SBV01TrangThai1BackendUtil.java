...
public class SBV01TrangThai1BackendUtil {

	private static final Logger LOGGER = LoggerFactory.getLogger(SBV01TrangThai1BackendUtil.class);

	private SBV01TrangThai1BackendUtil() {
	}

	public static TrangThai1 getTrangThai1(String url, long primaryKey) {
		...
		try {
			...
			if (responseJson.getData() != null) {
				return mapper.readValue(mapper.writeValueAsString(responseJson.getData()), TrangThai1.class);
			}
		} catch (Exception e) {
	...
	public static TrangThai1 findByGiaTri(String url, int giaTri) {
	...
	public static List<TrangThai1> getAllTrangThai1s(String url) {
		...
		try {
			...
			ObjectMapper mapper = new ObjectMapper();
			if (responseJson.getData() != null) {
				return mapper.readValue(mapper.writeValueAsString(responseJson.getData()), new TypeReference<List<TrangThai1>>(){});
			}
		} catch (Exception e) {
			LOGGER.error(e.getMessage(), e);
		}
	...
	private static final String GIATRI = "giaTri";
