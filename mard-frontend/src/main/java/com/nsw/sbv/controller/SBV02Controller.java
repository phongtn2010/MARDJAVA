...
public class SBV02Controller {
    ...
    public String indexPage(ModelMap model) {
        ...
        return SBV02Constant.Page.HOME;
    }
    ...
    public String create(ModelMap model) {
        ...
        return SBV02Constant.Page.CREATE;
    }
    ...
    private void initData(ModelMap model, UserCustom user) {
        ...
        model.addAttribute(AppConstant.DanhMuc.Sign, environment.getRequiredProperty(SBV02Constant.EnableSign));
