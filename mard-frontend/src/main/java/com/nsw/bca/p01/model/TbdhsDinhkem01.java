 ...
 *
 */
public class TbdhsDinhkem01 {

    private Long fiIdDk;
    private Long fiIdHoso;
    private Long fiIdTailieu;
    private Integer fiMaTailieu;
    ...
    public TbdhsDinhkem01() {
    }

    public TbdhsDinhkem01(Long fiIdDk) {
        this.fiIdDk = fiIdDk;
    }
    ...
    public Integer getFiMaTailieu() {
        return fiMaTailieu;
    }

    public void setFiMaTailieu(Integer fiMaTailieu) {
