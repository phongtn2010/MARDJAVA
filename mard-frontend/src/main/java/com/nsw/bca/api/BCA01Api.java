...
import com.nsw.bca.p01.model.FilterFormGp01;
import com.nsw.bca.p01.model.HistoryFilterForm;
import com.nsw.bca.p01.model.ResultFilterForm;
import com.nsw.bca.p01.model.SearchFormKqxl;
import com.nsw.bca.p01.model.SendMessage;
import com.nsw.bca.p01.model.Tbdhoso01;
import com.nsw.bca.p01.model.TbdhsDinhkem01;
import com.nsw.bca.p01.model.Tbdthanhtoanphi01;
...
@RestController
@RequestMapping("/bca/01")
public class BCA01Api extends BaseApi {

    static final String TAG = "BCA01Api";
    ...
    ResponseJson getCategory(
        ...
        try {
            switch (key) {
                case BCA01Constant.DANHMUC.DM_TRANGTHAI:
                    json = BackendRequestHelper.getInstance().doGetRequest(BCA01Constant.getInstance().getApiUrl(environment, BCA01Constant.API.DANHMUC_TRANGTHAI));
                    break;
                case BCA01Constant.DANHMUC.DM_LOAIFILE:
                    json = BackendRequestHelper.getInstance().doGetRequest(BCA01Constant.getInstance().getApiUrl(environment, BCA01Constant.API.DANHMUC_LOAIFILE));
                    break;
                case BCA01Constant.DANHMUC.DM_CQXL:
                    json = BackendRequestHelper.getInstance().doGetRequest(BCA01Constant.getInstance().getApiUrl(environment, BCA01Constant.API.DANHMUC_CQXL) + id);
                    break;
                case BCA01Constant.DANHMUC.DM_HINHTHUC:
                    json = BackendRequestHelper.getInstance().doGetRequest(BCA01Constant.getInstance().getApiUrl(environment, BCA01Constant.API.DANHMUC_HINHTHUC));
                    break;
                default:
                    break;
            }
    ...
    ResponseJson searchHoso(
        ...
        try {
            ...
            ResponseJson json = BackendRequestHelper.getInstance().doPostRequest(BCA01Constant.getInstance().getApiUrl(environment, BCA01Constant.API.HOSO_SEARCH), filter);
            return json;
        } catch (Exception ex) {
            LogUtil.addLog(ex);
            String errorInfo = AppConstant.APP_NAME + AppConstant.MESSAGE_SEPARATOR + TAG + AppConstant.MESSAGE_SEPARATOR + Thread.currentThread().getStackTrace()[1].getMethodName() + AppConstant.MESSAGE_SEPARATOR + ex.toString();
    ...
    private boolean isOwner(Object fiHoso) {
        ResponseJson json = BackendRequestHelper.getInstance().doGetRequest(BCA01Constant.getInstance().getApiUrl(environment, BCA01Constant.API.HOSO_OWNER) + fiHoso + "/" + getUsername());
    ...
    ResponseJson deleteHoso(
        ...
        ResponseJson json = BackendRequestHelper.getInstance().doPostRequest(BCA01Constant.getInstance().getApiUrl(environment, BCA01Constant.API.HOSO_DELETE) + "/" + fiIdHoso, map);
        return json;
    }
    ...
    ResponseJson lichSuXuLyHoSo(
        ...
        try {
            ...
            json = BackendRequestHelper.getInstance().doPostRequest(BCA01Constant.getInstance().getApiUrl(environment, BCA01Constant.API.LICHSU_SEARCH), filterForm);
    ...
    ResponseJson ycRutHoso(
        ...
        try {
            ...
            message.setType(BCA01Constant.MSG_TYPE.TYPE_15);
            ResponseJson hosoJson = BackendRequestHelper.getInstance().doGetRequest(BCA01Constant.getInstance().getApiUrl(environment, BCA01Constant.API.HOSO_GET_BYID) + message.getFiIdHoso());
            if (hosoJson.isSuccess()) {
                if ((LinkedHashMap) hosoJson.getData() != null) {
                    ...
                    if (Objects.equals(fiTrangthai, BCA01Constant.FILE_STATUS.CHO_TIEP_NHAN)
                            || Objects.equals(fiTrangthai, BCA01Constant.FILE_STATUS.YC_BO_SUNG)) {
                        message.setFunction(BCA01Constant.MSG_FUNC.FUNCTION_03);
                    } else {
                        message.setFunction(BCA01Constant.MSG_FUNC.FUNCTION_12);
                    }
                    json = BackendRequestHelper.getInstance().doPostRequest(BCA01Constant.getInstance().getApiUrl(environment, BCA01Constant.API.HOSO_SEND), message);
                }
            }
    ...
    ResponseJson getHoso(
        ...
        json.setSuccess(false);
        try {
            String url = BCA01Constant.getInstance().getApiUrl(environment, BCA01Constant.API.HOSO_GET_BYID);
     ...
     * @return
     */
    @RequestMapping(value = "/hoso/giayphep", method = RequestMethod.POST, headers = {"content-type=application/json"})
    public @ResponseBody
    ResponseJson quyetDinhHoSo(
        ...
        json = BackendRequestHelper.getInstance().doGetRequest(BCA01Constant.getInstance().getApiUrl(environment, BCA01Constant.API.HOSO_THONGBAO) + filterForm.getFiMaHoso());
        return json;
    }
     ...
     * @return
     */
    @RequestMapping(value = "/hoso/giayphep/chitiet", method = RequestMethod.POST, headers = {"content-type=application/json"})
    public @ResponseBody
    ResponseJson getHoSochiTiet(
            @RequestBody FilterFormGp01 filterForm
    ) {
        ResponseJson json = new ResponseJson();
        json.setSuccess(false);
//        if (filterForm == null || !isOwner(filterForm.getFiIdGp())) {
//            return json;
//        }
        json = BackendRequestHelper.getInstance().doGetRequest(BCA01Constant.getInstance().getApiUrl(environment, BCA01Constant.API.HOSO_THONGBAO_CHITIET) + filterForm.getFiIdGp());
        return json;
    }
    ...
    ResponseJson createHoso(
        ...
        try {
            ...
            if (tbdHoso != null) {
                ...
                tbdHoso.setFiTrangthai(BCA01Constant.FILE_STATUS.TAO_MOI);
                tbdHoso.setFiTenTt(BCA01Constant.FILE_STATUS.TAO_MOI_STR);
            }
            json = BackendRequestHelper.getInstance().doPostRequest(BCA01Constant.getInstance().getApiUrl(environment, BCA01Constant.API.HOSO_INSERT), tbdHoso);
    ...
    ResponseJson updateHoso(
        ...
        try {
            ...
            json = BackendRequestHelper.getInstance().doCustomRequest(BCA01Constant.getInstance().getApiUrl(environment, BCA01Constant.API.HOSO_UPDATE), HttpMethod.PUT, tbdHoso, new HashMap<>());
        } catch (Exception ex) {
            LogUtil.addLog(ex);
            String errorInfo = AppConstant.APP_NAME + AppConstant.MESSAGE_SEPARATOR + TAG + AppConstant.MESSAGE_SEPARATOR + Thread.currentThread().getStackTrace()[1].getMethodName() + AppConstant.MESSAGE_SEPARATOR + ex.toString();
            RabbitMQErrorHelper.pushLogToRabbitMQ(errorInfo, getRabbitMQ());
        ...
        try {
            ...
            if (fiIdHoso == 0L) {
                ...
                json = BackendRequestHelper.getInstance().doPostRequest(
                        BCA01Constant.getInstance().getApiUrl(environment, BCA01Constant.API.HOSO_INSERT), tbdHoso);
            } else {
                if (!isOwner(fiIdHoso)) {
                    return json;
                }
                ...
                json = BackendRequestHelper.getInstance().doCustomRequest(
                        BCA01Constant.getInstance().getApiUrl(environment, BCA01Constant.API.HOSO_UPDATE), HttpMethod.PUT, tbdHoso, new HashMap<>());
            }
            ...
            if (json.isSuccess()) {
                if ((LinkedHashMap) json.getData() != null) {
                    ...
                    message.setType(BCA01Constant.MSG_TYPE.TYPE_10);
                    message.setFiIdHoso(fiIdHoso);
                    message.setReason(tbdHoso.getFiLydo());

                    if (Objects.equals(fiTrangthai, BCA01Constant.FILE_STATUS.TAO_MOI)) {
                        message.setFunction(BCA01Constant.MSG_FUNC.FUNCTION_01);
                    } else if (Objects.equals(fiTrangthai, BCA01Constant.FILE_STATUS.CHO_TIEP_NHAN)
                            || Objects.equals(fiTrangthai, BCA01Constant.FILE_STATUS.DA_BO_SUNG_HOSO)) {
                        //Doanh nghiep gui cap nhat ho so khi Bo chua tiep nhan
                        message.setFunction(BCA01Constant.MSG_FUNC.FUNCTION_02);
                    } else if (Objects.equals(fiTrangthai, BCA01Constant.FILE_STATUS.YC_BO_SUNG)) {
                        //Doanh nghiep gui bo sung theo yeu cau cua ben Bo
                        message.setFunction(BCA01Constant.MSG_FUNC.FUNCTION_04);
                    } else {
                        //Doanh nghiep xin sua ho so
                        if (null != message.getReason() && message.getReason().length() > 0) {
                            message.setType(BCA01Constant.MSG_TYPE.TYPE_12);
                            message.setFunction(BCA01Constant.MSG_FUNC.FUNCTION_08);
                        }
                    }
                    //Gui ho so
                    ResponseJson jsonResult = BackendRequestHelper.getInstance().doPostRequest(BCA01Constant.getInstance().getApiUrl(environment, BCA01Constant.API.HOSO_SEND), message);
    ...
    * @return
    ...
    ResponseJson sendThanhToanphi(
            @RequestBody Tbdthanhtoanphi01 thanhtoanphi01
    ) {
        ResponseJson json = new ResponseJson();
        json.setSuccess(false);
        try {
            if (thanhtoanphi01 != null) {
                if (!isOwner(thanhtoanphi01.getFiIdHoso())) {
                    return json;
                }
                json = BackendRequestHelper.getInstance().doPostRequest(
                        BCA01Constant.getInstance().getApiUrl(environment, BCA01Constant.API.HOSO_THANHTOAN_PHI), thanhtoanphi01);

                if (json.isSuccess()) {
                    if ((LinkedHashMap) json.getData() != null) {
                        SendMessage message = new SendMessage();
                        message.setType(BCA01Constant.MSG_TYPE.TYPE_18);
                        message.setFiIdHoso(thanhtoanphi01.getFiIdHoso());
                        message.setFunction(BCA01Constant.MSG_FUNC.FUNCTION_16);
                        //Gui ho so
                        ResponseJson jsonResult = BackendRequestHelper.getInstance().doPostRequest(BCA01Constant.getInstance().getApiUrl(environment, BCA01Constant.API.HOSO_SEND), message);
                        json.setSuccess(jsonResult.isSuccess());
                    }
    ...
    ResponseJson ycSuaVanBan(
        ...
        try {
            ...
            message.setType(BCA01Constant.MSG_TYPE.TYPE_22);
            message.setFunction(BCA01Constant.MSG_FUNC.FUNCTION_23);
            ResponseJson hosoJson = BackendRequestHelper.getInstance().doGetRequest(BCA01Constant.getInstance().getApiUrl(environment, BCA01Constant.API.HOSO_GET_BYID) + message.getFiIdHoso());
            if (hosoJson.isSuccess()) {
                if ((LinkedHashMap) hosoJson.getData() != null) {
                    json = BackendRequestHelper.getInstance().doPostRequest(BCA01Constant.getInstance().getApiUrl(environment, BCA01Constant.API.HOSO_SEND), message);
    ...
    ResponseJson kqxlHoso(
        ...
        ResponseJson json = BackendRequestHelper.getInstance().doPostRequest(BCA01Constant.getInstance().getApiUrl(environment, BCA01Constant.API.KQXL_SEARCH), message);
        return json;
    }
    ...
    public void downloadFile(HttpServletResponse response,
        ...
        if (principal instanceof UserDetails) {
            try {
                ResponseJson json = BackendRequestHelper.getInstance().doGetRequest(BCA01Constant.getInstance().getApiUrl(environment, BCA01Constant.API.DINHKEM_GET_BYID) + id);
                if (json == null || json.getSuccess() == false || json.getData() == null) {
                    return;
                }

                TbdhsDinhkem01 fileInfo = GsonUtils.getInstance().transform(json.getData(), TbdhsDinhkem01.class);
     ...
     * @param day
     */
    @RequestMapping(value = "/file/bca/01/{year}/{month}/{day}/{filename}", method = RequestMethod.GET)
    public void downloadFileAttach(HttpServletResponse response,
        ...
        if (principal instanceof UserDetails) {
            try {
                if (filename != null) {
                    String filepath = "bca/01/" + year + '/' + month + '/' + day;
        ...
        if (principal instanceof UserDetails) {
            try {
                if (file.isEmpty()) {
                    ...
                    String uri = getFullUri(environment.getRequiredProperty(BCA01Constant.API.ATTACHMENT_UPLOAD));
    ...
    private void downloadFile(HttpServletResponse response, String fileCode,
        ...
        if (fileCodeDb.equals(fileCode)) {
            String uri = getFullUri(environment.getProperty(BCA01Constant.API.ATTACHMENT_DOWNLOAD));
    ...
    String getFullUri(String restUri) {
        return environment.getRequiredProperty(BCA01Constant.API.BACKEND) + restUri;
    }
}
