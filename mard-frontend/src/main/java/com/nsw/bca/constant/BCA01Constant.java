...
public class BCA01Constant {

    static BCA01Constant instance;
    public static final String EnableSign = "nsw.bca.01.sign";

    public static BCA01Constant getInstance() {
        synchronized (BCA01Constant.class) {
            return new BCA01Constant();
        }
    }

    public String getApiUrl(Environment environment, String key) {
        return environment.getRequiredProperty(BCA01Constant.API.BACKEND) + environment.getRequiredProperty(key);
    }

    public String getBackendCommonApiUrl(Environment environment, String key) {
        return environment.getRequiredProperty(BCA01Constant.API.BACKEND_COMMON) + environment.getRequiredProperty(key);
    }
    ...
    public interface API {
        ...
        //Ho so
        public static final String HOSO_INSERT = "bca.01.tbdhoso.create";
        public static final String HOSO_UPDATE = "bca.01.tbdhoso.update";
        public static final String HOSO_STATUS = "bca.01.tbdhoso.status";
        public static final String HOSO_SEARCH = "bca.01.tbdhoso.search";
        public static final String HOSO_DELETE = "bca.01.tbdhoso.delete";
        public static final String HOSO_OWNER = "bca.01.tbdhoso.owner";
        public static final String HOSO_SEND = "bca.01.hoso.send";
        public static final String HOSO_GET_BYID = "bca.01.tbdhoso.getbyidhoso";
        public static final String HOSO_GET_BYCODE = "bca.01.tbdhoso.getbymahoso";
        public static final String HOSO_THONGBAO = "bca.01.tbdgiayphep.getbymahoso";
        public static final String HOSO_THONGBAO_CHITIET = "bca.01.tbdgiayphep.getbyidgp";
        public static final String HOSO_THANHTOAN_PHI = "bca.01.tbdthanhtoanphi.create";

        //Lich su
        public static final String LICHSU_SEARCH = "bca.01.tbdlichsu.search";

        //Ket qua xu ly
        public static final String KQXL_SEARCH = "bca.01.tbdkqxl.getbyMaHoso";
        //Ket qua yeu cau sua hoso
        public static final String KQYCS_HOSO = "bca.01.tbdhsycsua.getbyMaHoso";
        //Ket qua yeu cau rut hoso
        public static final String KQYCR_HOSO = "bca.01.tbdhsycrut.getbyMaHoso";
        //Ket qua yeu cau sua giay phep
        public static final String KQYCS_GIAYPHEP = "bca.01.tbdgiayphep.getbymahoso";

        //Danh muc
        public static final String DANHMUC_CQXL = "bca.01.danhmuc.cqxl";
        public static final String DANHMUC_LOAIFILE = "bca.01.danhmuc.tailieu";
        public static final String DANHMUC_TRANGTHAI = "bca.01.danhmuc.trangthai";
        public static final String DANHMUC_HINHTHUC = "bca.01.danhmuc.hinhthuc";

        //Upload and download file
        public static final String ATTACHMENT_DOWNLOAD = "bca.01.hoso.dowload";
        public static final String ATTACHMENT_UPLOAD = "bca.01.hoso.upload";

        public static final String DINHKEM_GET_BYID = "bca.01.tbdhoso.dinhkem";
    ...
    public interface FILE_STATUS {
        ...
        public static final String YC_BS_PHI_STR = "Yêu cầu bổ xung thanh toán phí";
    ...
    public class Pages {
        ...
        public static final String HOME = "bca.01.home";
        public static final String EDIT = "bca.01.edit";
        public static final String VIEW = "bca.01.view";
        public static final String CHARGE = "bca.01.charge";
    }

    public class Routes {

        public static final String ROOT_HOME = "/bca/01";
    }
