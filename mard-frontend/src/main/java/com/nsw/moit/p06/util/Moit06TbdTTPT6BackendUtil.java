...
public class Moit06TbdTTPT6BackendUtil {

	private static final Logger LOGGER = LoggerFactory.getLogger(Moit06TbdTTPT6BackendUtil.class);

	private Moit06TbdTTPT6BackendUtil() {
	}

	public static TbdTTPT6 createTbdTTPT6(String url, TbdTTPT6 pTbdTTPT6) {

		try {
			Map<String, Object> params = new HashMap<>();
			ResponseJson responseJson = createRestTemplate(url, pTbdTTPT6, HttpMethod.POST, params);
			ObjectMapper mapper = new ObjectMapper();
			if (responseJson.getData() != null) {
				return mapper.readValue(mapper.writeValueAsString(responseJson.getData()), TbdTTPT6.class);
			}
		} catch (Exception e) {
	...
	public static TbdTTPT6 updateTbdTTPT6(String url, Long primaryKey, TbdTTPT6 pTbdTTPT6) {

		try {
			Map<String, Object> params = new HashMap<>();
			ResponseJson responseJson = createRestTemplate(url + "/" + primaryKey, pTbdTTPT6, HttpMethod.POST, params);
			ObjectMapper mapper = new ObjectMapper();
			if (responseJson.getData() != null) {
				return mapper.readValue(mapper.writeValueAsString(responseJson.getData()), TbdTTPT6.class);
			}
	...
	public static boolean deleteTbdTTPT6(String url, Long primaryKey) {
	...
	public static TbdTTPT6 getTbdTTPT6(String url, Long primaryKey) {
	...
	public static List<TbdTTPT6> findByIdHoSoAndLoaiPhuongTien(String url, Long idHoSo, Integer loaiPhuongTien) {
		...
		try {
			...
			ObjectMapper mapper = new ObjectMapper();
			if (responseJson.getData() != null) {
				return mapper.readValue(mapper.writeValueAsString(responseJson.getData()), new TypeReference<List<TbdTTPT6>>(){});
			}
		} catch (Exception e) {
			LOGGER.error(e.getMessage(), e);
		}
	...
	public static List<TbdTTPT6> findByIdHoSoAndHoatDongOrderByIdPhuongTienAsc(String url, Long idHoSo, Integer hoatDong) {
