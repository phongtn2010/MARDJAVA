...
public class MOIT06CallBackUtil {

	private static final Logger LOGGER = LoggerFactory.getLogger(MOIT06CallBackUtil.class);
	...
	protected String getURL(String uriKey) {
		return environment.getRequiredProperty("moit.06.backend") + environment.getRequiredProperty(uriKey);
	}
}