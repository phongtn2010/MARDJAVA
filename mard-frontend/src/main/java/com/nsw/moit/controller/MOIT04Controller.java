 ...
 */
@Controller
@RequestMapping(MOIT04Constant.Routes.ROOT_HOME)
public class MOIT04Controller extends BaseController {
     ...
     * @return
     */
    @RequestMapping(value = {MOIT04Constant.View.HOME, MOIT04Constant.View.INDEX}, method = RequestMethod.GET)
    public String indexPage(ModelMap model) {
        ...
        return MOIT04Constant.Pages.HOME;
    }
     ...
     * @return
     */
    @RequestMapping(value = {MOIT04Constant.View.EDIT}, method = RequestMethod.GET)
    public String create(ModelMap model) {
        ...
        return MOIT04Constant.Pages.EDIT;
    }
     ...
     * @return
     */
    @RequestMapping(value = {MOIT04Constant.View.VIEW}, method = RequestMethod.GET)
    public String view(ModelMap model) {
        ...
        return MOIT04Constant.Pages.VIEW;
    }
    ...
    private void initData(ModelMap model, UserCustom user) {
        ...
        model.addAttribute(AppConstant.DanhMuc.Sign, environment.getRequiredProperty(MOIT04Constant.EnableSign));
