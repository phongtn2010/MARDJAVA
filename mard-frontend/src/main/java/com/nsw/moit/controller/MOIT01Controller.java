 ...
 */
@Controller
@RequestMapping(MOIT01Constant.Routes.ROOT_HOME)
public class MOIT01Controller extends BaseController {
     ...
     * @return
     */
    @RequestMapping(value = {MOIT01Constant.View.HOME, MOIT01Constant.View.INDEX}, method = RequestMethod.GET)
    public String indexPage(ModelMap model) {
        ...
        return MOIT01Constant.Pages.HOME;
    }
     ...
     * @return
     */
    @RequestMapping(value = {MOIT01Constant.View.EDIT}, method = RequestMethod.GET)
    public String create(ModelMap model) {
        ...
        return MOIT01Constant.Pages.EDIT;
    }
     ...
     * @return
     */
    @RequestMapping(value = {MOIT01Constant.View.VIEW}, method = RequestMethod.GET)
    public String view(ModelMap model) {
        ...
        return MOIT01Constant.Pages.VIEW;
    }
