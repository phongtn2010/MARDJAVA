...
public class Moit07TbsCuaKhau7BackendUtil {

	private static final Logger LOGGER = LoggerFactory.getLogger(Moit07TbsCuaKhau7BackendUtil.class);

	private Moit07TbsCuaKhau7BackendUtil() {
	}

	public static TbsCuaKhau7 getTbsCuaKhau7(String url, Long primaryKey) {
		...
		try {
			...
			if (responseJson.getData() != null) {
				return mapper.readValue(mapper.writeValueAsString(responseJson.getData()), TbsCuaKhau7.class);
			}
		} catch (Exception e) {
	...
	public static TbsCuaKhau7 findByIdCuaKhau(String url, Long idCuaKhau) {
	...
	public static List<TbsCuaKhau7> findByIdCuaKhauIsNotNullOrderByTenCuaKhauAsc(String url) {
		...
		try {
			...
			ObjectMapper mapper = new ObjectMapper();
			if (responseJson.getData() != null) {
				return mapper.readValue(mapper.writeValueAsString(responseJson.getData()), new TypeReference<List<TbsCuaKhau7>>(){});
			}
		} catch (Exception e) {
			LOGGER.error(e.getMessage(), e);
		}
	...
	public static List<TbsCuaKhau7> getAll(String url) {
