...
public class Moit07TbdTTPT7BackendUtil {

	private static final Logger LOGGER = LoggerFactory.getLogger(Moit07TbdTTPT7BackendUtil.class);

	private Moit07TbdTTPT7BackendUtil() {
	}

	public static TbdTTPT7 createTbdTTPT7(String url, TbdTTPT7 pTbdTTPT7) {

		try {
			Map<String, Object> params = new HashMap<>();
			ResponseJson responseJson = createRestTemplate(url, pTbdTTPT7, HttpMethod.POST, params);
			ObjectMapper mapper = new ObjectMapper();
			if (responseJson.getData() != null) {
				return mapper.readValue(mapper.writeValueAsString(responseJson.getData()), TbdTTPT7.class);
			}
		} catch (Exception e) {
	...
	public static TbdTTPT7 updateTbdTTPT7(String url, Long primaryKey, TbdTTPT7 pTbdTTPT7) {

		try {
			Map<String, Object> params = new HashMap<>();
			ResponseJson responseJson = createRestTemplate(url + "/" + primaryKey, pTbdTTPT7, HttpMethod.POST, params);
			ObjectMapper mapper = new ObjectMapper();
			if (responseJson.getData() != null) {
				return mapper.readValue(mapper.writeValueAsString(responseJson.getData()), TbdTTPT7.class);
			}
	...
	public static boolean deleteTbdTTPT7(String url, Long primaryKey) {
	...
	public static TbdTTPT7 getTbdTTPT7(String url, Long primaryKey) {
	...
	public static List<TbdTTPT7> findByIdHoSoAndLoaiPhuongTien(String url, Long idHoSo, Integer loaiPhuongTien) {
		...
		try {
			...
			ObjectMapper mapper = new ObjectMapper();
			if (responseJson.getData() != null) {
				return mapper.readValue(mapper.writeValueAsString(responseJson.getData()), new TypeReference<List<TbdTTPT7>>(){});
			}
		} catch (Exception e) {
			LOGGER.error(e.getMessage(), e);
		}
	...
	public static List<TbdTTPT7> findByIdHoSoAndHoatDongOrderByIdPhuongTienAsc(String url, Long idHoSo, Integer hoatDong) {
