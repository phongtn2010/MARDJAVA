...
public class Moit07Constants {

	public final class PAGE {
		private PAGE() {
		}

		public static final String INDEX = "nsw.moit.page.07.index";
		public static final String EDIT = "nsw.moit.page.07.edit";
	}
	...
	public final class PROPERTIES {
		...
		public static final String BACKEND = "moit.07.backend";
	}


	public static final String URL_MOIT_01 = "/moit/07";
	...
	public class ApiUrls {
		...
		public static final String ROOT = "/moit/api/07";
		public static final String LAY_DANH_SACH_TRANG_THAI = "/layDsTrangThai";
		public static final String LAY_DANH_SACH_HAI_QUAN = "/layDsHaiQuan";
		...
		public static final String DELETE_HAI_QUAN_THEO_HO_SO = "/deleteHaiQuan";
		...
		public static final String ADD_HAI_QUAN = "/addHaiQuan";
	}
	...
	public class MessageKeys {
		...
		public static final String ACTION_SUCCESS = "moit.07.action.success";
		public static final String ACTION_SEND_SUCCESS = "moit.07.action.send.success";
		public static final String ACTION_SEND_EROROR = "moit.07.action.send.error";
		public static final String ACTION_SEND_EROROR_VALID = "moit.07.action.send.error.valid";
		public static final String ACTION_ERROR = "moit.07.action.error";
		public static final String ACTION_SEND_ERROR = "moit.07.guihoso.error.3";
		public static final String MESSAGE_DEFAULT_KEY = "moit.07.message.chon";
		public static final String TOKEN_ERROR = "moit.07.guihoso.token";
	}
	...
	public enum MessageFunction {
		...
		private final int statusAfterSend;
