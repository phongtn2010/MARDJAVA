...
public class MOIT04Constant {

    static MOIT04Constant instance;
    public static final String EnableSign = "nsw.moit.04.sign";

    public static MOIT04Constant getInstance() {
        synchronized (MOIT04Constant.class) {
            return new MOIT04Constant();
        }
    }

    public String getApiUrl(Environment environment, String key) {
        return environment.getRequiredProperty(MOIT04Constant.API.BACKEND) + environment.getRequiredProperty(key);
    }

    public String getBackendCommonApiUrl(Environment environment, String key) {
        return environment.getRequiredProperty(MOIT04Constant.API.BACKEND_COMMON) + environment.getRequiredProperty(key);
    }
    ...
    public interface API {
        ...
        //Ho so
        public static final String HOSO_INSERT = "moit.04.tbdhoso4.insert";
        public static final String HOSO_UPDATE = "moit.04.tbdhoso4.update";
        public static final String HOSO_STATUS = "moit.04.tbdhoso4.status";
        public static final String HOSO_SEARCH = "moit.04.tbdhoso4.search";
        public static final String HOSO_DELETE = "moit.04.tbdhoso4.delete";
        public static final String HOSO_OWNER = "moit.04.tbdhoso4.owner";
        public static final String HOSO_SEND = "moit.04.api.hoso.send";
        public static final String HOSO_GET_BYID = "moit.04.tbdhoso4.getbyid";
        public static final String HOSO_GET_BYCODE = "moit.04.tbdhoso4.getbymahoso";
        public static final String HOSO_THONGBAO = "moit.04.api.vanban";

        //Lich su
        public static final String LICHSU_SEARCH = "moit.04.tbdlichsu4.search";

        //Ket qua xu ly
        public static final String KQXL_SEARCH = "moit.04.tbdkqxl4.data";

        //Danh muc
        public static final String DANHMUC_HS = "moit.04.danhmuc.hs";
        public static final String DANHMUC_LOAIFILE = "moit.04.danhmuc.tailieu";
        public static final String DANHMUC_TRANGTHAI = "moit.04.danhmuc.trangthai";

        //Upload and download file
        public static final String ATTACHMENT_DOWNLOAD = "moit.04.api.hoso.download";
        public static final String ATTACHMENT_UPLOAD = "moit.04.api.hoso.upload";
        
        public static final String DINHKEM_GET_BYID = "moit.04.tbdhoso4.dinhkem";
    ...
    public class Pages {
        ...
        public static final String HOME = "moit.04.home";
        public static final String EDIT = "moit.04.edit";
        public static final String VIEW = "moit.04.view";
    }

    public class Routes {

        public static final String ROOT_HOME = "/moit/04";
    }
