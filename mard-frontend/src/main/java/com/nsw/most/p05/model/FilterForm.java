...
public class FilterForm implements Serializable {
    ...
    public FilterForm(String maHoSo, String soGiayPhep, Long trangThaiHoSo,Long trangThaiLePhi, Date ngayTaoTuNgay, Date ngayTaoDenNgay, Date ngayCapTuNgay, Date ngayCapDenNgay, String nguoiTao, int pageSize, int currentPage) {
        this.maHoSo = maHoSo;
        this.soGiayPhep = soGiayPhep;
        this.trangThaiHoSo = trangThaiHoSo;
        this.trangThaiLePhi = trangThaiLePhi;
    ...
    public Long getTrangThaiLePhi() {
        return trangThaiLePhi;
    }

    public void setTrangThaiLePhi(Long trangThaiLePhi) {
        this.trangThaiLePhi = trangThaiLePhi;
    }
