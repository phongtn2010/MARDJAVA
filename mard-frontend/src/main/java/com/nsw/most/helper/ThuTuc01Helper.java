...
public class ThuTuc01Helper {
     ...
     * @return
     */
    public ResponseJson searchHoSo(String restUri, SearchForm01 searchForm, RabbitMQInfo mqInfo) {
        ...
        try {
            ...
            HttpEntity<SearchForm01> entity = new HttpEntity<>(searchForm, headers);
    ...
    public ResponseJson importExcel(String restUri, MultipartFile multipartfile, String tempFolder, RabbitMQInfo mqInfo) {
        ...
        try {
            ...
            String fileName = FileNameUtils.toSafeFileName(multipartfile.getOriginalFilename(), 100);
            File uploadFile = new File(tempFolder + fileName);
...
//            String filePath = tempFolder + code + "." + FilenameUtils.getExtension(fileName);
            if (!".xlsx".equalsIgnoreCase(FilenameUtils.getExtension(fileName))) {
