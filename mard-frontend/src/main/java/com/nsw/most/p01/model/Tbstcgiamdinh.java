...
public class Tbstcgiamdinh {
    ...
    public Tbstcgiamdinh() {
    }

    public Tbstcgiamdinh(Long fiId, String fiMa, String fiViettat, String fiTen, Date fiNgaytao, Long fiHoatdong, String fiNguoitao) {
        this.fiId = fiId;
        this.fiMa = fiMa;
    ...
    public Tbstcgiamdinh(Long fiId, String fiMa, String fiViettat, String fiTen, Date fiNgaytao, Long fiHoatdong, String fiNguoitao, Long fiOrderId) {
        this.fiId = fiId;
        this.fiMa = fiMa;
        this.fiViettat = fiViettat;
        this.fiTen = fiTen;
