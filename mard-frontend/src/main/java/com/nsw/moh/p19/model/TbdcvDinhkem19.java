/*
 * Created on 22 Dec 2018 ( Time 00:26:20 )
...
public class TbdcvDinhkem19 implements Serializable {
...
//	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "TBDCV_DINHKEM19_SEQ")
//    @SequenceGenerator(sequenceName = "TBDCV_DINHKEM19_SEQ", schema = "MOH", initialValue = 1, allocationSize = 1, name = "TBDCV_DINHKEM19_SEQ")
    private Long fiIdDk;
