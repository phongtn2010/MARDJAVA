/*
 * Created on 21 Dec 2018 ( Time 23:45:58 )
...
public class Tbdhoso19 implements Serializable {
    ...
    //@Transient
    private TbdhsDn19 doanhNghiep;

    //@Transient
    private TbdhsDonhang19 donHang;

    //@Transient
    private List<TbdhsCuakhau19> lstCuaKhaus;

    //@Transient
    private List<TbdhsDinhkem19> lstDinhKems;
    ...
    public TbdhsDn19 getDoanhNghiep() {
        return doanhNghiep;
    }

    public void setDoanhNghiep(TbdhsDn19 doanhNghiep) {
        this.doanhNghiep = doanhNghiep;
    }

    public TbdhsDonhang19 getDonHang() {
        return donHang;
    }

    public void setDonHang(TbdhsDonhang19 donHang) {
        this.donHang = donHang;
    }

    public List<TbdhsCuakhau19> getLstCuaKhaus() {
        return lstCuaKhaus;
    }

    public void setLstCuaKhaus(List<TbdhsCuakhau19> lstCuaKhaus) {
        this.lstCuaKhaus = lstCuaKhaus;
    }

    public List<TbdhsDinhkem19> getLstDinhKems() {
        return lstDinhKems;
    }

    public void setLstDinhKems(List<TbdhsDinhkem19> lstDinhKems) {
