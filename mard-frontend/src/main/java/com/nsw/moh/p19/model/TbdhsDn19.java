/*
 * Created on 21 Dec 2018 ( Time 23:46:31 )
...
public class TbdhsDn19 implements Serializable {
    ...
    //@Column(name="FI_TEN_DN_EN", length=255)
    private String fiTenDnEn;

    //@Column(name="FI_DIACHI_DN_EN", length=255)
    private String fiDiachiDnEn;
    ...
    //--- DATABASE MAPPING : FI_DIACHI_DN_EN ( VARCHAR2 ) 
    public void setFiDiachiDnEn(String fiDiachiDnEn) {
        this.fiDiachiDnEn = fiDiachiDnEn;
    }

    public String getFiDiachiDnEn() {
        return this.fiDiachiDnEn;
    }
