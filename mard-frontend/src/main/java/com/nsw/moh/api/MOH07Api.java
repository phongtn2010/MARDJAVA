...
import static com.nsw.moh.api.MOH01Api.TAG;
            ...
            switch (key) {
                ...
                case MOH07Constant.DANHMUC.DANHMUC_QUANHUYEN:
                    json = BackendRequestHelper.getInstance()
                            ...
                            //.doGetRequest(MOH07Constant.getInstance().getApiUrl(environment, MOH07Constant.API.DANHMUC_QUANHUYEN));
                    break;
        ...
        try {
            ...
            if (json.isSuccess()) {
                if ((LinkedHashMap) json.getData() != null) {
                    ...
                    if (Objects.equals(fiTrangthai, MOH07Constant.FILE_STATUS.TAO_MOI)) {
                        message.setFunction(MOH07Constant.MSG_FUNC.FUNC_01);
                    } else if (Objects.equals(fiTrangthai, MOH07Constant.FILE_STATUS.YC_BO_SUNG)) {
                        message.setFunction(MOH07Constant.MSG_FUNC.FUNC_07);
                    } else if (Objects.equals(fiTrangthai, MOH07Constant.FILE_STATUS.TU_CHOI_HOSO)) {
                        message.setFunction(MOH07Constant.MSG_FUNC.FUNC_10);
                    }
                    ...
                    if (jsonResult.isSuccess()
                            && Constants.SIGN.ON.equals(environment.getRequiredProperty(MOH07Constant.EnableSign))) {
