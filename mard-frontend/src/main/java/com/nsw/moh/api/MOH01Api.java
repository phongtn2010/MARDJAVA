...
public class MOH01Api extends BaseApi {

    static final String TAG = "MOH01Api";
    ...
    ResponseJson getCategory(
        ...
        try {
            switch (key) {
                case MOH01Constant.DANHMUC.DANHMUC_TINHTHANH:
                    json = BackendRequestHelper.getInstance()
                            .doGetRequest(MOH01Constant.getInstance().getApiUrl(environment, MOH01Constant.API.DANHMUC_TINHTHANH));
                    break;
                case MOH01Constant.DANHMUC.DANHMUC_QUANHUYEN:
                    json = BackendRequestHelper.getInstance()
                            .doGetRequest(MOH01Constant.getInstance().getApiUrl(environment, MOH01Constant.API.DANHMUC_QUANHUYEN) + "/" + id);
                    //.doGetRequest(MOH01Constant.getInstance().getApiUrl(environment, MOH01Constant.API.DANHMUC_QUANHUYEN));
                    break;
                case MOH01Constant.DANHMUC.DANHMUC_QUOCGIA:
                    json = BackendRequestHelper.getInstance()
                            .doGetRequest(MOH01Constant.getInstance().getApiUrl(environment, MOH01Constant.API.DANHMUC_QUOCGIA));
                    break;
                case MOH01Constant.DANHMUC.DANHMUC_DONVINHAN:
                    json = BackendRequestHelper.getInstance()
                            .doGetRequest(MOH01Constant.getInstance().getApiUrl(environment, MOH01Constant.API.DANHMUC_DONVINHAN));
                    break;
                case MOH01Constant.DANHMUC.DANHMUC_TAILIEU:
                    json = BackendRequestHelper.getInstance()
                            .doGetRequest(MOH01Constant.getInstance().getApiUrl(environment, MOH01Constant.API.DANHMUC_TAILIEU) + id + "/");
                    break;
                case MOH01Constant.DANHMUC.DANHMUC_TRANGTHAI:
                    json = BackendRequestHelper.getInstance()
                            .doGetRequest(MOH01Constant.getInstance().getApiUrl(environment, MOH01Constant.API.DANHMUC_TRANGTHAI));
                    break;
                case MOH01Constant.DANHMUC.DANHMUC_MUCDICHNHAPKHAU:
                    json = BackendRequestHelper.getInstance()
                            .doGetRequest(MOH01Constant.getInstance().getApiUrl(environment, MOH01Constant.API.DANHMUC_MUCDICHNHAPKHAU));
                    break;
                case MOH01Constant.DANHMUC.DANHMUC_LOAITHANHTOAN:
                    json = BackendRequestHelper.getInstance()
                            .doGetRequest(MOH01Constant.getInstance().getApiUrl(environment, MOH01Constant.API.DANHMUC_LOAITHANHTOAN));
                    break;
                default:
                    break;
            }
    ...
    ResponseJson searchHoso(
        ...
        try {
            ...
            ResponseJson json = BackendRequestHelper
                    .getInstance()
                    .doPostRequest(MOH01Constant
                            .getInstance()
                            .getApiUrl(environment, MOH01Constant.API.HOSO_SEARCH), filter);
            return json;
        } catch (Exception ex) {
            LogUtil.addLog(ex);
            String errorInfo = AppConstant.APP_NAME + AppConstant.MESSAGE_SEPARATOR + TAG + AppConstant.MESSAGE_SEPARATOR + Thread.currentThread().getStackTrace()[1].getMethodName() + AppConstant.MESSAGE_SEPARATOR + ex.toString();
    ...
    private boolean isOwner(Object fiHoso) {
        ResponseJson json = BackendRequestHelper.getInstance()
                .doGetRequest(MOH01Constant
                        .getInstance()
                        .getApiUrl(environment, MOH01Constant.API.HOSO_OWNER) + fiHoso + "/" + getUsername());
    ...
    ResponseJson deleteHoso(
        ...
        ResponseJson json = BackendRequestHelper.getInstance()
                .doPostRequest(MOH01Constant
                        .getInstance()
                        .getApiUrl(environment, MOH01Constant.API.HOSO_DELETE) + "/" + fiIdHoso, map);
        return json;
    }
    ...
    ResponseJson lichSuXuLyHoSo(
        ...
        try {
            ...
            json = BackendRequestHelper.getInstance()
                    .doPostRequest(MOH01Constant
                            .getInstance()
                            .getApiUrl(environment, MOH01Constant.API.LICHSU_SEARCH), filterForm);
    ...
    ResponseJson ycRutHoso(
        ...
        try {
            ...
            message.setType(MOH01Constant.MSG_TYPE.TYPE_102);
            message.setFunction(MOH01Constant.MSG_FUNC.FUNC_03);
            json = BackendRequestHelper.getInstance()
                    .doPostRequest(MOH01Constant
                            .getInstance()
                            .getApiUrl(environment, MOH01Constant.API.HOSO_SEND), message);
    ...
    ResponseJson getHoso(
        ...
        json.setSuccess(false);
        try {
            String url = MOH01Constant.getInstance().getApiUrl(environment, MOH01Constant.API.HOSO_GET_BYID);
    ...
    ResponseJson quyetDinhHoSo(
        ...
        json = BackendRequestHelper.getInstance()
                .doGetRequest(MOH01Constant.getInstance()
                        .getApiUrl(environment, MOH01Constant.API.HOSO_THONGBAO) + filterForm.getFiMaHoso());
        return json;
    }
    ...
    ResponseJson createHoso(
        ...
        try {
            ...
            if (tbdHoso != null) {
                ...
                tbdHoso.setFiTrangthai(MOH01Constant.FILE_STATUS.TAO_MOI);
                tbdHoso.setFiTenTt(MOH01Constant.FILE_STATUS.TAO_MOI_STR);
            }
            json = BackendRequestHelper.getInstance()
                    .doPostRequest(MOH01Constant
                            .getInstance()
                            .getApiUrl(environment, MOH01Constant.API.HOSO_INSERT), tbdHoso);
    ...
    ResponseJson updateHoso(
        ...
        try {
            ...
            json = BackendRequestHelper.getInstance()
                    .doCustomRequest(MOH01Constant
                            .getInstance()
                            .getApiUrl(environment, MOH01Constant.API.HOSO_UPDATE), HttpMethod.PUT, tbdHoso, new HashMap<>());
        } catch (Exception ex) {
            LogUtil.addLog(ex);
            String errorInfo = AppConstant.APP_NAME + AppConstant.MESSAGE_SEPARATOR + TAG + AppConstant.MESSAGE_SEPARATOR + Thread.currentThread().getStackTrace()[1].getMethodName() + AppConstant.MESSAGE_SEPARATOR + ex.toString();
            RabbitMQErrorHelper.pushLogToRabbitMQ(errorInfo, getRabbitMQ());
        ...
        try {
            ...
            if (json.isSuccess()) {
                if ((LinkedHashMap) json.getData() != null) {
                    ...
                    message.setType(MOH01Constant.MSG_TYPE.TYPE_101);
                    message.setFiIdHoso(fiIdHoso);

                    if (Objects.equals(fiTrangthai, MOH01Constant.FILE_STATUS.TAO_MOI)) {
                        message.setFunction(MOH01Constant.MSG_FUNC.FUNC_01);
                    } else if (Objects.equals(fiTrangthai, MOH01Constant.FILE_STATUS.YC_BO_SUNG)) {
                        message.setFunction(MOH01Constant.MSG_FUNC.FUNC_07);
                    } else if (Objects.equals(fiTrangthai, MOH01Constant.FILE_STATUS.YC_THANH_TOAN_PHI)) {
                        message.setFunction(MOH01Constant.MSG_FUNC.FUNC_05);
                    }
                    
                    //Thiet lap cau hinh ky so
                    if (Constants.SIGN.ON.equals(environment.getRequiredProperty(MOH01Constant.EnableSign))) {
                        message.setGetXmlNotSend(Constants.SIGN.ON);
                    }
                    
                    //Gui ho so
                    ResponseJson jsonResult = BackendRequestHelper
                            .getInstance().doPostRequest(MOH01Constant
                                    .getInstance()
                                    .getApiUrl(environment, MOH01Constant.API.HOSO_SEND), message);
                    ...
                    if (jsonResult.isSuccess()
                            && Constants.SIGN.ON.equals(environment.getRequiredProperty(MOH01Constant.EnableSign))) {
    ...
    ResponseJson sendWithoutSave(
        ...
        try {
            ...
            if (Objects.equals(tbdHoso.getFiTrangthai(), MOH01Constant.FILE_STATUS.TAO_MOI)) {
                message.setFunction(MOH01Constant.MSG_FUNC.FUNC_01);
            } else if (Objects.equals(tbdHoso.getFiTrangthai(), MOH01Constant.FILE_STATUS.YC_BO_SUNG)) {
                message.setFunction(MOH01Constant.MSG_FUNC.FUNC_07);
            } else if (Objects.equals(tbdHoso.getFiTrangthai(), MOH01Constant.FILE_STATUS.YC_THANH_TOAN_PHI)) {
                message.setFunction(MOH01Constant.MSG_FUNC.FUNC_05);
            }
    ...
    ResponseJson kqxlHoso(
        ...
        ResponseJson json = BackendRequestHelper.getInstance()
                .doPostRequest(MOH01Constant
                        .getInstance()
                        .getApiUrl(environment, MOH01Constant.API.KQXL_SEARCH), message);
        return json;
    }
            ...
            try {
                if (null != idHoso
                    ...
                    json = BackendRequestHelper.getInstance()
                            .doGetRequest(MOH01Constant
                                    .getInstance()
                                    .getApiUrl(environment, MOH01Constant.API.HOSO_THONGBAO) + maHoso);

                    ObjectMapper mapper = new ObjectMapper();
                    mapper.enable(SerializationFeature.INDENT_OUTPUT);
                    String jsonData = mapper.writeValueAsString(json.getData());
                    Tbdgiayphep1 tdbCongVan = mapper.readValue(jsonData, Tbdgiayphep1.class);

                    String fileDbPath = null;
                    String uiidFileDb = null;

                    if (null != tdbCongVan && Long.parseLong(idCongVan) == tdbCongVan.getFiIdGp()
    ...
    private void downloadFile(HttpServletResponse response, String fileCode,
        ...
        if (fileCodeDb.equals(fileCode)) {
            String uri = getFullUri(environment.getProperty(MOH01Constant.API.ATTACHMENT_DOWNLOAD));
    ...
    String getFullUri(String restUri) {
        return environment.getRequiredProperty(MOH01Constant.API.BACKEND) + restUri;
    }
    ...
    String gegeneratekey(@RequestBody UploadSecretKey data) {
        ...
        String user = environment.getRequiredProperty(MOH01Constant.UploadAccount.USER);
        String userKey = environment.getRequiredProperty(MOH01Constant.UploadAccount.KEY);
    ...
    ResponseJson verify(@RequestBody TokenInfo token) {
        ...
        token.setMinistryCode(MOH01Constant.PROCEDUCE_INFO.MINISTRY_CODE);
