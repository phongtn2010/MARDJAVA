        ...
        try {
            ...
            if (json.isSuccess()) {
                if ((LinkedHashMap) json.getData() != null) {
                    ...
                    if (Objects.equals(fiTrangthai, MOH09Constant.FILE_STATUS.TAO_MOI)) {
                        message.setFunction(MOH09Constant.MSG_FUNC.FUNC_01);
                    } else if (Objects.equals(fiTrangthai, MOH09Constant.FILE_STATUS.YC_BO_SUNG)) {
                        message.setFunction(MOH09Constant.MSG_FUNC.FUNC_03);
                    } else if (Objects.equals(fiTrangthai, MOH09Constant.FILE_STATUS.THONG_BAO_AP_PHI)
                            || Objects.equals(fiTrangthai, MOH09Constant.FILE_STATUS.CHO_THONG_BAO_PHI)
                            || Objects.equals(fiTrangthai, MOH09Constant.FILE_STATUS.CHO_XAC_NHAN_PHI)
                            || Objects.equals(fiTrangthai, MOH09Constant.FILE_STATUS.YC_NOP_LAI_PHI)) {
                        message.setFunction(MOH09Constant.MSG_FUNC.FUNC_02);
                    }

                    //Thiet lap cau hinh ky so
                    if (Constants.SIGN.ON.equals(environment.getRequiredProperty(MOH09Constant.EnableSign))) {
                    ...
                    if (jsonResult.isSuccess()
                            && Constants.SIGN.ON.equals(environment.getRequiredProperty(MOH09Constant.EnableSign))) {
