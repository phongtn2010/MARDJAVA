...
@RestController
@RequestMapping("/moh/11")
public class MOH11Api extends BaseApi {

    static final String TAG = "MOH11Api";
    ...
    ResponseJson getCategory(
        ...
        try {
            switch (key) {
                case MOH11Constant.DANHMUC.DANHMUC_TINHTHANH:
                    json = BackendRequestHelper.getInstance()
                            .doGetRequest(MOH11Constant.getInstance().getApiUrl(environment, MOH11Constant.API.DANHMUC_TINHTHANH));
                    break;
                case MOH11Constant.DANHMUC.DANHMUC_QUANHUYEN:
                    json = BackendRequestHelper.getInstance()
                            .doGetRequest(MOH11Constant.getInstance().getApiUrl(environment, MOH11Constant.API.DANHMUC_QUANHUYEN) + "/" + id);
                            //.doGetRequest(MOH11Constant.getInstance().getApiUrl(environment, MOH11Constant.API.DANHMUC_QUANHUYEN));
                    break;
                case MOH11Constant.DANHMUC.DANHMUC_QUOCGIA:
                    json = BackendRequestHelper.getInstance()
                            .doGetRequest(MOH11Constant.getInstance().getApiUrl(environment, MOH11Constant.API.DANHMUC_QUOCGIA));
                    break;
                case MOH11Constant.DANHMUC.DANHMUC_DONVINHAN:
                    json = BackendRequestHelper.getInstance()
                            .doGetRequest(MOH11Constant.getInstance().getApiUrl(environment, MOH11Constant.API.DANHMUC_DONVINHAN));
                    break;
                case MOH11Constant.DANHMUC.DANHMUC_TAILIEU:
                    json = BackendRequestHelper.getInstance()
                            .doGetRequest(MOH11Constant.getInstance().getApiUrl(environment, MOH11Constant.API.DANHMUC_TAILIEU) + id + "/");
                    break;
                case MOH11Constant.DANHMUC.DANHMUC_TRANGTHAI:
                    json = BackendRequestHelper.getInstance()
                            .doGetRequest(MOH11Constant.getInstance().getApiUrl(environment, MOH11Constant.API.DANHMUC_TRANGTHAI));
                    break;
                case MOH11Constant.DANHMUC.DANHMUC_MUCDICHNHAPKHAU:
                    json = BackendRequestHelper.getInstance()
                            .doGetRequest(MOH11Constant.getInstance().getApiUrl(environment, MOH11Constant.API.DANHMUC_MUCDICHNHAPKHAU));
                    break;
                default:
                    break;
            }
    ...
    ResponseJson searchHoso(
        ...
        try {
            ...
            ResponseJson json = BackendRequestHelper
                    .getInstance()
                    .doPostRequest(MOH11Constant
                            .getInstance()
                            .getApiUrl(environment, MOH11Constant.API.HOSO_SEARCH), filter);
            return json;
        } catch (Exception ex) {
            LogUtil.addLog(ex);
            String errorInfo = AppConstant.APP_NAME + AppConstant.MESSAGE_SEPARATOR + TAG + AppConstant.MESSAGE_SEPARATOR + Thread.currentThread().getStackTrace()[1].getMethodName() + AppConstant.MESSAGE_SEPARATOR + ex.toString();
    ...
    private boolean isOwner(Object fiHoso) {
        ResponseJson json = BackendRequestHelper.getInstance()
                .doGetRequest(MOH11Constant
                        .getInstance()
                        .getApiUrl(environment, MOH11Constant.API.HOSO_OWNER) + fiHoso + "/" + getUsername());
    ...
    ResponseJson deleteHoso(
        ...
        ResponseJson json = BackendRequestHelper.getInstance()
                .doPostRequest(MOH11Constant
                        .getInstance()
                        .getApiUrl(environment, MOH11Constant.API.HOSO_DELETE) + "/" + fiIdHoso, map);
        return json;
    }
    ...
    ResponseJson lichSuXuLyHoSo(
        ...
        try {
            ...
            json = BackendRequestHelper.getInstance()
                    .doPostRequest(MOH11Constant
                            .getInstance()
                            .getApiUrl(environment, MOH11Constant.API.LICHSU_SEARCH), filterForm);
    ...
    ResponseJson ycRutHoso(
        ...
        try {
            ...
            message.setType(MOH11Constant.MSG_TYPE.TYPE_102);
            message.setFunction(MOH11Constant.MSG_FUNC.FUNC_03);
            
            json = BackendRequestHelper.getInstance()
                    .doPostRequest(MOH11Constant
                            .getInstance()
                            .getApiUrl(environment, MOH11Constant.API.HOSO_SEND), message);
    ...
    ResponseJson getHoso(
        ...
        json.setSuccess(false);
        try {
            String url = MOH11Constant.getInstance().getApiUrl(environment, MOH11Constant.API.HOSO_GET_BYID);
    ...
    ResponseJson quyetDinhHoSo(
        ...
        json = BackendRequestHelper.getInstance()
                .doGetRequest(MOH11Constant.getInstance()
                        .getApiUrl(environment, MOH11Constant.API.HOSO_THONGBAO) + filterForm.getFiMaHoso());
        return json;
    }
    ...
    ResponseJson createHoso(
        ...
        try {
            ...
            if (tbdHoso != null) {
                ...
                tbdHoso.setFiTrangthai(MOH11Constant.FILE_STATUS.TAO_MOI);
                tbdHoso.setFiTenTt(MOH11Constant.FILE_STATUS.TAO_MOI_STR);
            }
            json = BackendRequestHelper.getInstance()
                    .doPostRequest(MOH11Constant
                            .getInstance()
                            .getApiUrl(environment, MOH11Constant.API.HOSO_INSERT), tbdHoso);
    ...
    ResponseJson updateHoso(
        ...
        try {
            ...
            json = BackendRequestHelper.getInstance()
                    .doCustomRequest(MOH11Constant
                            .getInstance()
                            .getApiUrl(environment, MOH11Constant.API.HOSO_UPDATE), HttpMethod.PUT, tbdHoso, new HashMap<>());
        } catch (Exception ex) {
            LogUtil.addLog(ex);
            String errorInfo = AppConstant.APP_NAME + AppConstant.MESSAGE_SEPARATOR + TAG + AppConstant.MESSAGE_SEPARATOR + Thread.currentThread().getStackTrace()[1].getMethodName() + AppConstant.MESSAGE_SEPARATOR + ex.toString();
            RabbitMQErrorHelper.pushLogToRabbitMQ(errorInfo, getRabbitMQ());
        ...
        try {
            ...
            if (json.isSuccess()) {
                if ((LinkedHashMap) json.getData() != null) {
                    ...
                    message.setType(MOH11Constant.MSG_TYPE.TYPE_101);
                    message.setFiIdHoso(fiIdHoso);

                    if (Objects.equals(fiTrangthai, MOH11Constant.FILE_STATUS.TAO_MOI)) {
                        message.setFunction(MOH11Constant.MSG_FUNC.FUNC_01);
                    } else if (Objects.equals(fiTrangthai, MOH11Constant.FILE_STATUS.YC_BO_SUNG)) {
                        message.setFunction(MOH11Constant.MSG_FUNC.FUNC_07);
                    }
                    
                    //Thiet lap cau hinh ky so
                    if (Constants.SIGN.ON.equals(environment.getRequiredProperty(MOH11Constant.EnableSign))) {
                        message.setGetXmlNotSend(Constants.SIGN.ON);
                    }
            
                    //Gui ho so
                    ResponseJson jsonResult = BackendRequestHelper
                            .getInstance().doPostRequest(MOH11Constant
                                    .getInstance()
                                    .getApiUrl(environment, MOH11Constant.API.HOSO_SEND), message);
                    ...
                    if (jsonResult.isSuccess()
                            && Constants.SIGN.ON.equals(environment.getRequiredProperty(MOH11Constant.EnableSign))) {
    ...
    ResponseJson sendWithoutSave(
        ...
        try {
            ...
            if (Objects.equals(tbdHoso.getFiTrangthai(), MOH11Constant.FILE_STATUS.TAO_MOI)) {
                message.setFunction(MOH11Constant.MSG_FUNC.FUNC_01);
            } else if (Objects.equals(tbdHoso.getFiTrangthai(), MOH11Constant.FILE_STATUS.YC_BO_SUNG)) {
                message.setFunction(MOH11Constant.MSG_FUNC.FUNC_07);
            }
    ...
    ResponseJson kqxlHoso(
        ...
        ResponseJson json = BackendRequestHelper.getInstance()
                .doPostRequest(MOH11Constant
                        .getInstance()
                        .getApiUrl(environment, MOH11Constant.API.KQXL_SEARCH), message);
        return json;
    }

    String getFullUri(String restUri) {
        return environment.getRequiredProperty(MOH11Constant.API.BACKEND) + restUri;
    }
    ...
    private void downloadFile(HttpServletResponse response, String fileCode,
        ...
        if (fileCodeDb.equals(fileCode)) {
            String uri = getFullUri(environment.getProperty(MOH11Constant.API.ATTACHMENT_DOWNLOAD));
            ...
            try {
                if (null != idHoso
                    ...
                    json = BackendRequestHelper.getInstance()
                            .doGetRequest(MOH11Constant
                                    .getInstance()
                                    .getApiUrl(environment, MOH11Constant.API.HOSO_THONGBAO) + maHoso);

                    ObjectMapper mapper = new ObjectMapper();
                    mapper.enable(SerializationFeature.INDENT_OUTPUT);
                    String jsonData = mapper.writeValueAsString(json.getData());
                    Tbdgcn11 tdbCongVan = mapper.readValue(jsonData, Tbdgcn11.class);
    ...
    @RequestMapping(value = "/dklh/check/{fiSoDklh}", method = RequestMethod.POST, headers = {"content-type=application/json"})
    public @ResponseBody
    ResponseJson checkDKLH(
            @PathVariable("fiSoDklh") String fiSoDklh
    ) {
        ResponseJson json = new ResponseJson();
        json.setSuccess(false);
        Object principal = SecurityContextHolder.getContext().getAuthentication().getPrincipal();
        if (principal instanceof UserDetails) {
            try {            
                json = BackendRequestHelper.getInstance()
                            .doGetRequest(MOH11Constant.getInstance().getApiUrl(environment, MOH11Constant.API.DKLH_CHECK) + fiSoDklh);
    ...
    String gegeneratekey(@RequestBody UploadSecretKey data) {
        ...
        String user = environment.getRequiredProperty(MOH11Constant.UploadAccount.USER);
        String userKey = environment.getRequiredProperty(MOH11Constant.UploadAccount.KEY);
