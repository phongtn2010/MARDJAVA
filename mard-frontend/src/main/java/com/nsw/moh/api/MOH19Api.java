...
public class MOH19Api extends BaseApi {
    public static final Logger LOGGER = LoggerFactory.getLogger(MOH19Api.class);
        ...
        try {
            ...
            if (json.isSuccess()) {
                if ((LinkedHashMap) json.getData() != null) {
                    ...
                    if (Constants.SIGN.ON.equals(environment.getRequiredProperty(MOH19Constant.EnableSign))) {
                    ...
                    if (jsonResult.isSuccess()
                            && Constants.SIGN.ON.equals(environment.getRequiredProperty(MOH19Constant.EnableSign))) {
    ...
    public @ResponseBody
    ResponseJson sendWithoutUpdate(@RequestBody Tbdhoso19 tbdHoso) {
        ResponseJson json = new ResponseJson();
        json.setSuccess(false);
        try {
