...
@RestController
@RequestMapping("/moh/36")
public class MOH36Api extends BaseApi {
    public static final Logger LOGGER = LoggerFactory.getLogger(MOH36Api.class);
    static final String TAG = "MOH36Api";
    ...
    ResponseJson getCategory(
        ...
        try {
            switch (key) {
                case MOH36Constant.DANHMUC.DANHMUC_TRANGTHAI:
                    json = BackendRequestHelper.getInstance()
                            .doGetRequest(MOH36Constant.getInstance().getApiUrl(environment, MOH36Constant.API.DANHMUC_TRANGTHAI));
                    break;
                case MOH36Constant.DANHMUC.DANHMUC_DONVITINH:
                    json = BackendRequestHelper.getInstance()
                            .doGetRequest(MOH36Constant.getInstance().getApiUrl(environment, MOH36Constant.API.DANHMUC_DONVITINH));
                    break;
                case MOH36Constant.DANHMUC.DANHMUC_TINHTHANH:
                    json = BackendRequestHelper.getInstance()
                            .doGetRequest(MOH36Constant.getInstance().getApiUrl(environment, MOH36Constant.API.DANHMUC_TINHTHANH));
                    break;
                case MOH36Constant.DANHMUC.DANHMUC_CUAKHAU_NHAPKHAU:
                    json = BackendRequestHelper.getInstance()
                            .doGetRequest(MOH36Constant.getInstance().getApiUrl(environment, MOH36Constant.API.DANHMUC_CUAKHAU_NHAPKHAU));
                    break;
                case MOH36Constant.DANHMUC.DANHMUC_NUOCSANXUAT:
                    json = BackendRequestHelper.getInstance()
                            .doGetRequest(MOH36Constant.getInstance().getApiUrl(environment, MOH36Constant.API.DANHMUC_NUOCSANXUAT));
                    break;
                case MOH36Constant.DANHMUC.DANHMUC_LOAIDONHANG:
                    json = BackendRequestHelper.getInstance()
                            .doGetRequest(MOH36Constant.getInstance().getApiUrl(environment, MOH36Constant.API.DANHMUC_LOAIDONHANG));
                    break;
                case MOH36Constant.DANHMUC.DANHMUC_NUOCCUNGCAP:
                    json = BackendRequestHelper.getInstance()
                            .doGetRequest(MOH36Constant.getInstance().getApiUrl(environment, MOH36Constant.API.DANHMUC_NUOCCUNGCAP));
                    break;
                case MOH36Constant.DANHMUC.DANHMUC_LOAIFILE:
                    json = BackendRequestHelper.getInstance()
                            .doGetRequest(MOH36Constant.getInstance().getApiUrl(environment, MOH36Constant.API.DANHMUC_LOAIFILE));
                    break;
                case MOH36Constant.DANHMUC.DANHMUC_NGUYENLIEU:
                    json = BackendRequestHelper.getInstance()
                            .doGetRequest(MOH36Constant.getInstance().getApiUrl(environment, MOH36Constant.API.DANHMUC_NGUYENLIEU));
                    break;
                case MOH36Constant.DANHMUC.DANHMUC_MUCDICHNHAPKHAU:
                    json = BackendRequestHelper.getInstance()
                            .doGetRequest(MOH36Constant.getInstance().getApiUrl(environment, MOH36Constant.API.DANHMUC_MUCDICHNHAPKHAU));
                    break;
                default:
                    break;
            }
    ...
    ResponseJson searchHoso(
        ...
        try {
            ...
            ResponseJson json = BackendRequestHelper
                    .getInstance()
                    .doPostRequest(MOH36Constant
                            .getInstance()
                            .getApiUrl(environment, MOH36Constant.API.HOSO_SEARCH), filter);
            return json;
        } catch (Exception ex) {
            LogUtil.addLog(ex);
            String errorInfo = AppConstant.APP_NAME + AppConstant.MESSAGE_SEPARATOR + TAG + AppConstant.MESSAGE_SEPARATOR + Thread.currentThread().getStackTrace()[1].getMethodName() + AppConstant.MESSAGE_SEPARATOR + ex.toString();
    ...
    private boolean isOwner(Object fiHoso) {
        ResponseJson json = BackendRequestHelper.getInstance()
                .doGetRequest(MOH36Constant
                        .getInstance()
                        .getApiUrl(environment, MOH36Constant.API.HOSO_OWNER) + fiHoso + "/" + getUsername());
    ...
    ResponseJson deleteHoso(
        ...
        ResponseJson json = BackendRequestHelper.getInstance()
                .doPostRequest(MOH36Constant
                        .getInstance()
                        .getApiUrl(environment, MOH36Constant.API.HOSO_DELETE) + "/" + fiIdHoso, map);
        return json;
    }
    ...
    ResponseJson lichSuXuLyHoSo(
        ...
        try {
            ...
            json = BackendRequestHelper.getInstance()
                    .doPostRequest(MOH36Constant
                            .getInstance()
                            .getApiUrl(environment, MOH36Constant.API.LICHSU_SEARCH), filterForm);
    ...
    ResponseJson ycRutHoso(
        ...
        try {
            ...
            message.setType(MOH36Constant.MSG_TYPE.TYPE_12);
            ResponseJson hosoJson = BackendRequestHelper.getInstance()
                    .doGetRequest(MOH36Constant
                            .getInstance()
                            .getApiUrl(environment, MOH36Constant.API.HOSO_GET_BYID) + message.getFiIdHoso());
            if (hosoJson.isSuccess()) {
                if ((LinkedHashMap) hosoJson.getData() != null) {
                    message.setFunction(MOH36Constant.MSG_FUNC.FUNC_03);
                    json = BackendRequestHelper.getInstance()
                            .doPostRequest(MOH36Constant
                                    .getInstance()
                                    .getApiUrl(environment, MOH36Constant.API.HOSO_SEND), message);
                }
            }
    ...
    ResponseJson getHoso(
        ...
        json.setSuccess(false);
        try {
            String url = MOH36Constant.getInstance().getApiUrl(environment, MOH36Constant.API.HOSO_GET_BYID);
    ...
    ResponseJson quyetDinhHoSo(
        ...
        json = BackendRequestHelper.getInstance().doGetRequest(MOH36Constant.getInstance().getApiUrl(environment, MOH36Constant.API.HOSO_THONGBAO) + filterForm.getFiMaHoso());
        return json;
    }
    ...
    ResponseJson createHoso(
        ...
        try {
            ...
            if (tbdHoso != null) {
                ...
                tbdHoso.setFiTrangthai(MOH36Constant.FILE_STATUS.TAO_MOI);
                tbdHoso.setFiTenTt(MOH36Constant.FILE_STATUS.TAO_MOI_STR);
            }
            json = BackendRequestHelper.getInstance()
                    .doPostRequest(MOH36Constant
                            .getInstance()
                            .getApiUrl(environment, MOH36Constant.API.HOSO_INSERT), tbdHoso);
    ...
    ResponseJson updateHoso(
        ...
        try {
            ...
            json = BackendRequestHelper.getInstance()
                    .doCustomRequest(MOH36Constant
                            .getInstance()
                            .getApiUrl(environment, MOH36Constant.API.HOSO_UPDATE), HttpMethod.PUT, tbdHoso, new HashMap<>());
        } catch (Exception ex) {
            LogUtil.addLog(ex);
            String errorInfo = AppConstant.APP_NAME + AppConstant.MESSAGE_SEPARATOR + TAG + AppConstant.MESSAGE_SEPARATOR + Thread.currentThread().getStackTrace()[1].getMethodName() + AppConstant.MESSAGE_SEPARATOR + ex.toString();
            RabbitMQErrorHelper.pushLogToRabbitMQ(errorInfo, getRabbitMQ());
        ...
        try {
            ...
            if (json.isSuccess()) {
                if ((LinkedHashMap) json.getData() != null) {
                    ...
                    message.setType(MOH36Constant.MSG_TYPE.TYPE_10);
                    message.setFiIdHoso(fiIdHoso);

                    if (Objects.equals(fiTrangthai, MOH36Constant.FILE_STATUS.TAO_MOI)) {
                        message.setFunction(MOH36Constant.MSG_FUNC.FUNC_01);
                    } else if (Objects.equals(fiTrangthai, MOH36Constant.FILE_STATUS.CHO_TIEP_NHAN)
                            || Objects.equals(fiTrangthai, MOH36Constant.FILE_STATUS.TU_CHOI_HOSO)) {
                        message.setFunction(MOH36Constant.MSG_FUNC.FUNC_02);
                    } else if (Objects.equals(fiTrangthai, MOH36Constant.FILE_STATUS.YC_BO_SUNG)) {
                        message.setFunction(MOH36Constant.MSG_FUNC.FUNC_04);
                    }
                    
                    //Thiet lap cau hinh ky so
                    if (Constants.SIGN.ON.equals(environment.getRequiredProperty(MOH36Constant.EnableSign))) {
                        message.setGetXmlNotSend(Constants.SIGN.ON);
                    }
                    //Gui ho so
                    ResponseJson jsonResult = BackendRequestHelper
                            .getInstance().doPostRequest(MOH36Constant
                                    .getInstance()
                                    .getApiUrl(environment, MOH36Constant.API.HOSO_SEND), message);
                    ...
                    if (jsonResult.isSuccess()
                            && Constants.SIGN.ON.equals(environment.getRequiredProperty(MOH36Constant.EnableSign))) {
    ...
    ResponseJson kqxlHoso(
        ...
        ResponseJson json = BackendRequestHelper.getInstance()
                .doPostRequest(MOH36Constant
                        .getInstance()
                        .getApiUrl(environment, MOH36Constant.API.KQXL_SEARCH), message);
        return json;
    }
    ...
    public void downloadFile(HttpServletResponse response,
        ...
        if (principal instanceof UserDetails) {
            try {
                ResponseJson json = BackendRequestHelper.getInstance().doGetRequest(MOH36Constant.getInstance().getApiUrl(environment, MOH36Constant.API.HOSO_GET_BYID) + id);
            ...
            try {
                if (null != idHoso
                    ...
                    json = BackendRequestHelper.getInstance()
                            .doGetRequest(MOH36Constant
                                    .getInstance()
                                    .getApiUrl(environment, MOH36Constant.API.HOSO_THONGBAO) + maHoso);

                    ObjectMapper mapper = new ObjectMapper();
                    mapper.enable(SerializationFeature.INDENT_OUTPUT);
                    String jsonData = mapper.writeValueAsString(json.getData());
                    Tbdcongvan36 tdbCongVan = mapper.readValue(jsonData, Tbdcongvan36.class);
        ...
        if (principal instanceof UserDetails) {
            try {
                if (file.isEmpty()) {
                    ...
                    String uri = getFullUri(environment.getRequiredProperty(MOH36Constant.API.ATTACHMENT_UPLOAD));
    ...
    private void downloadFile(HttpServletResponse response, String fileCode,
        ...
        if (fileCodeDb.equals(fileCode)) {
            String uri = getFullUri(environment.getProperty(MOH36Constant.API.ATTACHMENT_DOWNLOAD));
    ...
    String getFullUri(String restUri) {
        return environment.getRequiredProperty(MOH36Constant.API.BACKEND) + restUri;
    }
