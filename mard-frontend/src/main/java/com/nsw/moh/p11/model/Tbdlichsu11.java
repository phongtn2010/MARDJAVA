/*
 * Created on 30 Mar 2019 ( Time 15:02:59 )
...
public class Tbdlichsu11 implements Serializable {
    ...
    //@Column(name=name="FI_TEN_NGGUI", length=250)
    private String     fiTenNggui   ;

    //@Column(name=name="FI_TEN_DVGUI", length=250)
    private String     fiTenDvgui   ;

    //@Column(name=name="FI_TEN_NGNHAN", length=250)
    private String     fiTenNgnhan  ;

    //@Column(name=name="FI_TEN_DVNHAN", length=250)
    private String     fiTenDvnhan  ;

    //@Column(name=name="FI_NOIDUNG", length=4000)
    private String     fiNoidung    ;

    //@Column(name=name="FI_DUONG_DAN_CV", length=4000)
