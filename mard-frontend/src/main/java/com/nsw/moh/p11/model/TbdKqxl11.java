/*
 * Created on 30 Mar 2019 ( Time 15:03:15 )
...
public class TbdKqxl11 implements Serializable {
    ...
    //@Column(name=name="FI_DONVI_XL", length=250)
    private String     fiDonviXl    ;

    //@Column(name=name="FI_NGUOI_XL", length=100)
    private String     fiNguoiXl    ;

    //@Column(name=name="FI_NOIDUNG_XL", length=2000)
    private String     fiNoidungXl  ;

    //@Temporal(TemporalType.TIMESTAMP)
    //@Column(name=name="FI_NGAY_XL")
    private Date       fiNgayXl     ;

    //@Temporal(TemporalType.TIMESTAMP)
    //@Column(name=name="FI_HAN_BS")
    private Date       fiHanBs      ;

    //@Column(name=name="FI_SO_TIEPNHAN", length=250)
