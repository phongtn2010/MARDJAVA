/*
 * Created on 30 Mar 2019 ( Time 15:01:55 )
...
public class Tbddinhkem11 implements Serializable {
    ...
    // ENTITY DATA FIELDS 
    //----------------------------------------------------------------------    
    //@Column(name=name="FI_ID_DT")
    private Long fiIdDt       ;

    //@Column(name=name="FI_LOAI_DT")
    private Long fiLoaiDt     ;

    //@Column(name=name="FI_MA_TEP", length=250)
    private String     fiMaTep      ;

    //@Column(name=name="FI_LOAI_TEP", length=9)
    private String     fiLoaiTep    ;

    //@Column(name=name="FI_TEN_TEP", length=50)
    private String     fiTenTep     ;

    //@Column(name=name="FI_TEN_LOAI_TEP", length=500)
    private String     fiTenLoaiTep ;

    //@Column(name=name="FI_DUONG_DAN", length=1000)
    ...
    //@Column(name=name="FI_PATH_LOCAL", length=2000)
    private String     fiPathLocal  ;

    //@Column(name=name="FI_GUI_ID", length=2000)
