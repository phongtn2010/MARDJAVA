/*
 * Created on 30 Mar 2019 ( Time 15:08:34 )
...
public class Tbstailieu11 implements Serializable {
    ...
    // ENTITY DATA FIELDS 
    //----------------------------------------------------------------------    
    //@Column(name=name="FI_MA_TAILIEU", length=50)
    private String     fiMaTailieu  ;

    //@Column(name=name="FI_TEN_TAILIEU", length=2000)
