 ...
 */
public class MOH11Constant {

    static MOH11Constant instance;
    public static final String EnableSign = "nsw.moh.11.sign";

    public static MOH11Constant getInstance() {
        synchronized (MOH11Constant.class) {
            return new MOH11Constant();
        }
    }
    
    public interface UploadAccount {
        public static final String USER = "moh.11.upload_user_account";
        public static final String KEY = "moh.11.upload_user_pass";
    }

    public String getApiUrl(Environment environment, String key) {
        return environment.getRequiredProperty(MOH11Constant.API.BACKEND) + environment.getRequiredProperty(key);
    }

    public String getBackendCommonApiUrl(Environment environment, String key) {
        return environment.getRequiredProperty(MOH11Constant.API.BACKEND_COMMON) + environment.getRequiredProperty(key);
    }
    ...
    public interface API {
        ...
        //Ho so
        public static final String HOSO_INSERT = "moh.11.tbdhoso11.insert";
        public static final String HOSO_UPDATE = "moh.11.tbdhoso11.update";
        public static final String HOSO_STATUS = "moh.11.tbdhoso11.status";
        public static final String HOSO_SEARCH = "moh.11.tbdhoso11.search";
        public static final String HOSO_DELETE = "moh.11.tbdhoso11.delete";
        public static final String HOSO_OWNER = "moh.11.tbdhoso11.owner";
        public static final String HOSO_GET_BYID = "moh.11.tbdhoso11.getbyid";
        public static final String HOSO_GET_BYCODE = "moh.11.tbdhoso11.getbymahoso";
        
        public static final String HOSO_SEND = "moh.11.api.hoso.send";        
        public static final String HOSO_THONGBAO = "moh.11.api.vanban";

        //Lich su
        public static final String LICHSU_SEARCH = "moh.11.tbdlichsu11.search";

        //Ket qua xu ly
        public static final String KQXL_SEARCH = "moh.11.tbdkqxl11.data";

        //Danh muc
        public static final String DANHMUC_TINHTHANH = "moh.11.danhmuc.tinhthanh";
        public static final String DANHMUC_QUANHUYEN = "moh.11.danhmuc.quanhuyen";        
        public static final String DANHMUC_QUOCGIA = "moh.11.danhmuc.quocgia";
        public static final String DANHMUC_DONVINHAN = "moh.11.danhmuc.donvinhan";
        public static final String DANHMUC_TAILIEU = "moh.11.danhmuc.loaifile";
        public static final String DANHMUC_TRANGTHAI = "moh.11.danhmuc.trangthai";
        public static final String DANHMUC_MUCDICHNHAPKHAU = "moh.11.danhmuc.mucdichnhapkhau";

        //Upload and download file
        public static final String ATTACHMENT_DOWNLOAD = "moh.11.api.hoso.download";
        public static final String ATTACHMENT_UPLOAD = "moh.11.api.hoso.upload";
        
        public static final String DKLH_CHECK = "moh.11.api.dklh.check";
    ...
    public class DANHMUC {
        ...
        public static final String DKLH_CHECK = "DKLH_CHECK";
