...
/**
 * Persistent class for entity stored in table "TBDHS_HANGHOA1"
 *
 * @author Telosys Tools Generator
 *
 */
@Entity
@Table(name = "TBDHS_HANGHOA1", schema = "MOH")
// Define named queries here
@NamedQueries({
    @NamedQuery(name = "TbdhsHanghoa1.countAll", query = "SELECT COUNT(x) FROM TbdhsHanghoa1 x")
})
