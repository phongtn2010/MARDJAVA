...
public class Mard06Helper {
    ...
    public static List<TbdHanghoa06> readAnimalFromExcel(InputStream is) throws IOException, InvalidFormatException, ParseException {
        ...
        for (int i = 1; i <= listRow; i++) {
            ...
            for (int k = 1; k < 7; k++) {
                ...
                makeValueAnimal(cellValue, tbdHangHoa6, k);
            }
    ...
    private static void makeValueAnimal(String cellValue, TbdHanghoa06 tbdHangHoa6, int k) throws ParseException {
        switch (k) {
            case 1:
    ...
    private static void makeValueProduct(String cellValue, TbdHanghoa06 tbdHangHoa6, int k) throws ParseException {
        switch (k) {
            ...
            case 4:
                ...
                break;
            case 5:
                if (!cellValue.equals("Kilogram")) {
                    throw new ParseException(String.format("Đơn vị tính không phù hợp: %s", cellValue), 0);
                }
                tbdHangHoa6.setFiPackageUnitName(cellValue);
                break;
            case 6:
