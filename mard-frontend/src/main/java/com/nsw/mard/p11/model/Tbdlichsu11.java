 ...
 */
//@Entity
//@Table(name = "TBDLICHSU11", schema = "MARD")
// Define named queries here
//@NamedQueries({
    //@NamedQuery(name = "Tbdlichsu11.countAll", query = "SELECT COUNT(x) FROM Tbdlichsu11 x")
//})
public class Tbdlichsu11 implements Serializable {
    ...
    //@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "TBDLICHSU11_SEQ")
    //@SequenceGenerator(sequenceName = "TBDLICHSU11_SEQ", schema = "MARD", initialValue = 1, allocationSize = 1, name = "TBDLICHSU11_SEQ")
