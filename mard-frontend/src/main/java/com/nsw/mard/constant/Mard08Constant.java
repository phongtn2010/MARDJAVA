...
public class Mard08Constant {
    ...
    public static final String EnableSign = "nsw.mard.08.sign";
    ...
    public interface API {
        ...
        public static final String ROLL_BACK = "mard.08.hoso.rollback";
        ...
        public static final String UPDATE_ONLY = "mard.08.hoso.update_only";
        public static final String SAVE_BEFORE_UPDATE = "mard.08.hoso.save_before_update";
        public static final String GET_XML = "mard.08.getXml";
    }
