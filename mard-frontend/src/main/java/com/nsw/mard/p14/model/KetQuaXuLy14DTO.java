...
* 04/12/2018 09:14:214
*
*/
public class KetQuaXuLy14DTO implements Serializable {

	private static final long serialVersionUID = 1L;

	public KetQuaXuLy14DTO() {}

	public KetQuaXuLy14DTO(Long fiId, Long fiIdHoSo, Integer fiStatus, Date fiCreateDate, String fiContent, String fiNameOfRegistration, String fiProcessor, Date fiProcessDate, String fiLink, String fiPath, String fiUuid, String fiStatusName) {
		this.fiId = fiId;
