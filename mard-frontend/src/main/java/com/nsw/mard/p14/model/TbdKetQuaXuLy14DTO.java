...
*
* @Model
* @class TbdKetQuaXuLy14
* Created by Nguyen Van Quang
* 04/12/2018 09:146:58
*
*/
public class TbdKetQuaXuLy14DTO implements Serializable {

	private static final long serialVersionUID = 1L;

	public TbdKetQuaXuLy14DTO() {}

	public TbdKetQuaXuLy14DTO(Long fiId, Long fiIdHoSo, Integer fiStatus, Date fiCreateDate, String fiContent, Date fiProcessDate, String fiNameOfRegistration, String fiProcessor, String fiLink, String fiFileName, String fiPath, String fiUuid) {
		this.fiId = fiId;
