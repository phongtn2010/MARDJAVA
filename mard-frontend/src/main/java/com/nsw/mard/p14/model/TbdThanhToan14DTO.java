...
*
*/
public class TbdThanhToan14DTO implements Serializable {

	private static final long serialVersionUID = 1L;

	public TbdThanhToan14DTO() {}

	public TbdThanhToan14DTO(Long fiId, Long fiIdHoSo, Double fiTotalFee, String fiTotalFeeChar, String fiNote, String fiPaymentName, Date fiPaymentDate, String fiAttachedDocName, String fiFileName, String fiPath, String fiUuid) {
		this.fiId = fiId;
