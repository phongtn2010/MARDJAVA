...
*
* @Model
* @class TbdKetQuaXuLy16
* Created by Nguyen Van Quang
* 04/12/2018 09:166:58
*
*/
public class TbdKetQuaXuLy16DTO implements Serializable {

	private static final long serialVersionUID = 1L;

	public TbdKetQuaXuLy16DTO() {}

	public TbdKetQuaXuLy16DTO(Long fiId, Long fiIdHoSo, Integer fiStatus, Date fiCreateDate, String fiContent, Date fiProcessDate, String fiNameOfRegistration, String fiProcessor, String fiLink, String fiFileName, String fiPath, String fiUuid) {
		this.fiId = fiId;
