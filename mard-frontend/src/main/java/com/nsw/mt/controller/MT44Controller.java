...
@RequestMapping(value = {
    MT44Constant.Routes.URI_THU_TUC_44,
    MT44Constant.Routes.URI_THU_TUC_46,
    MT44Constant.Routes.URI_THU_TUC_45
})
public class MT44Controller extends BaseController {
     ...
     * @return
     */
    @RequestMapping(value = {MT44Constant.View.HOME, MT44Constant.View.INDEX}, method = RequestMethod.GET)
    public String indexPage(@PathVariable String code, ModelMap model) {
        ...
        return MT44Constant.Pages.HOME;
    }
     ...
     * @return
     */
    @RequestMapping(value = {MT44Constant.View.EDIT}, method = RequestMethod.GET)
    public String create(@PathVariable String code, ModelMap model) {
        ...
        return MT44Constant.Pages.EDIT;
    }
     ...
     * @return
     */
    @RequestMapping(value = {MT44Constant.View.VIEW}, method = RequestMethod.GET)
    public String view(@PathVariable String code, ModelMap model) {
        ...
        return MT44Constant.Pages.VIEW;
    }
    ...
    private void initData(ModelMap model, UserCustom user) {
        ...
        model.addAttribute(AppConstant.DanhMuc.Sign, environment.getRequiredProperty(MT44Constant.EnableSign));
