...
@RequestMapping(value = {
    MT61Constant.Routes.URI_THU_TUC_61,
    MT61Constant.Routes.URI_THU_TUC_62,
    MT61Constant.Routes.URI_THU_TUC_63,
    MT61Constant.Routes.URI_THU_TUC_64
})
public class MT61Controller extends BaseController {
     ...
     * @return
     */
    @RequestMapping(value = {MT61Constant.View.HOME, MT61Constant.View.INDEX}, method = RequestMethod.GET)
    public String indexPage(@PathVariable String code, ModelMap model) {
        ...
        return MT61Constant.Pages.HOME;
    }
     ...
     * @return
     */
    @RequestMapping(value = {MT61Constant.View.EDIT}, method = RequestMethod.GET)
    public String create(@PathVariable String code, ModelMap model) {
        ...
        return MT61Constant.Pages.EDIT;
    }
     ...
     * @return
     */
    @RequestMapping(value = {MT61Constant.View.VIEW}, method = RequestMethod.GET)
    public String view(@PathVariable String code, ModelMap model) {
        ...
        return MT61Constant.Pages.VIEW;
    }
    ...
    private void initData(ModelMap model, UserCustom user) {
        ...
        model.addAttribute(AppConstant.DanhMuc.Sign, environment.getRequiredProperty(MT61Constant.EnableSign));
