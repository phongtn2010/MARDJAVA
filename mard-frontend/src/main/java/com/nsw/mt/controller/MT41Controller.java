 ...
 */
@Controller
@RequestMapping(MT41Constant.Routes.ROOT)
public class MT41Controller extends BaseController {
     ...
     * @return
     */
    @RequestMapping(value = {MT41Constant.View.HOME, MT41Constant.View.INDEX}, method = RequestMethod.GET)
    public String indexPage(ModelMap model) {
        ...
        return MT41Constant.Pages.HOME;
    }
     ...
     * @return
     */
    @RequestMapping(value = {MT41Constant.View.EDIT}, method = RequestMethod.GET)
    public String create(ModelMap model) {
        ...
        return MT41Constant.Pages.EDIT;
    }
     ...
     * @return
     */
    @RequestMapping(value = {MT41Constant.View.VIEW}, method = RequestMethod.GET)
    public String view(ModelMap model) {
        ...
        return MT41Constant.Pages.VIEW;
    }
    ...
    private void initData(ModelMap model, UserCustom user) {
        ...
        model.addAttribute(AppConstant.DanhMuc.Sign, environment.getRequiredProperty(MT41Constant.EnableSign));
