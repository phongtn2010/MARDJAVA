...
@Controller
@RequestMapping(value = "/mt/19")
@PropertySource("classpath:mt_api.properties")
public class MT19Controller extends BaseController {
    public static final Logger LOGGER = LoggerFactory.getLogger(MT19Controller.class);
    ...
    public String index(HttpServletRequest request, HttpServletResponse response, RedirectAttributes redirectAttributes,
        ...
        return environment.getProperty("mt.p19.home");
    }
    ...
    public String edit(ModelMap model, HttpServletRequest request, @PathVariable("id") Long id,@PathVariable("procedureId") String procedureId) {
        ...
        return environment.getProperty("mt.p19.edit");
    }
    ...
    public String viewLicense(ModelMap model, HttpServletRequest request, @PathVariable("type") Integer type, @PathVariable("procedureId") String procedureId, @PathVariable("id") Long id) {
        ...
        return "nsw.mt.page.19.view.license";
    }
    ...
    public ResponseEntity<Object> getGiayPhep(HttpServletRequest request, @PathVariable("id") long id) {
        ...
        try {
            ...
            ResponseJson responseJson = callRestTemplate(environment.getRequiredProperty("mt.backend") + environment.getRequiredProperty("mt.19.xem_giay_phep"), id, HttpMethod.POST, params);
    ...
    public ResponseEntity<Object> saveWithFile(DefaultMultipartHttpServletRequest request, @PathVariable("funcType") int funcType) {
        ...
        try {
            String uri = environment.getProperty("mt.backend") + environment.getProperty("mt.19.save_with_file") + "/" + funcType;
    ...
    public ResponseEntity<Object> getProcessHistory(HttpServletRequest request, @PathVariable("idHoSo") Long fiIdHoso,@PathVariable("currentPage") Long currentPage) {
        try {
            ...
            ResponseJson responseJson = callRestTemplate(environment.getRequiredProperty("mt.backend") + environment.getRequiredProperty("mt.19.history"), params, HttpMethod.POST, null);
            List lst = (List) responseJson.getData();
            ResponseJson response = callRestTemplate(environment.getProperty("mt.backend") + environment.getRequiredProperty("mt.19.history_total"),params, HttpMethod.POST, null);
    ...
    public ResponseEntity<Object> xinRut(HttpServletRequest request, @RequestBody Object lyDo) {
        try {
            ...
            Map<String, Object> params = new HashMap<>();
            ResponseJson responseJson = callRestTemplate(environment.getRequiredProperty("mt.backend") + environment.getRequiredProperty("mt.19.rut_ho_so"), lyDo, HttpMethod.POST, params);
            return createResponseEntity(responseJson.getData(), 1l, "", true, HttpStatus.OK);
    ...
    public ResponseEntity<Object> xinSuaGiayPhep(HttpServletRequest request, @RequestBody Object lyDo) {
        ...
        try {
            ...
            Map<String, Object> params = new HashMap<>();
            ResponseJson responseJson = callRestTemplate(environment.getRequiredProperty("mt.backend") + environment.getRequiredProperty("mt.19.xin_sua_giay_phep"), lyDo, HttpMethod.POST, params);
            return createResponseEntity(responseJson.getData(), 1l, "", true, HttpStatus.OK);
    ...
    public ResponseEntity<Object> traGiayPhep(HttpServletRequest request, @RequestBody Object lyDo) {
        ...
        try {
            ...
            Map<String, Object> params = new HashMap<>();
            ResponseJson responseJson = callRestTemplate(environment.getRequiredProperty("mt.backend") + environment.getRequiredProperty("mt.19.tra_giay_phep"), lyDo, HttpMethod.POST, params);
            return createResponseEntity(responseJson.getData(), 1l, "", true, HttpStatus.OK);
    ...
    public ResponseEntity<Object> downloadNewFile(HttpServletResponse response, @PathVariable("idDinhKem") Long idDinhKem) {
        ...
        if (principal instanceof UserDetails) {
            try {
                if (idDinhKem != null) {
                    String uri = environment.getProperty("mt.backend") + environment.getProperty("mt.19.download") + "/" + idDinhKem;
                    HttpHeaders headers = new HttpHeaders();
    ...
    private String getTitleLabel(String procedureId) {
        switch (procedureId) {
            case "BGTVT0600019":
                return "CẤP GIẤY PHÉP VẬN TẢI QUỐC TẾ ĐƯỜNG BỘ VIỆT NAM-CAMPUCHIA";
            case "BGTVT0600020":
                return "CẤP LẠI GIẤY PHÉP HOẠT ĐỘNG VẬN TẢI QUỐC TẾ ĐƯỜNG BỘ VIỆT NAM-CAMPUCHIA  DO HẾT HẠN";
            case "BGTVT0600021":
                return "CẤP LẠI GIẤY PHÉP HOẠT ĐỘNG VẬN TẢI QUỐC TẾ ĐƯỜNG BỘ VIỆT NAM-CAMPUCHIA  DO HƯ HỎNG";
            case "BGTVT0600022":
                return "CẤP LẠI GIẤY PHÉP HOẠT ĐỘNG VẬN TẢI QUỐC TẾ ĐƯỜNG BỘ VIỆT NAM-CAMPUCHIA DO MẤT MÁT";
            default:
                return "CẤP GIẤY PHÉP VẬN TẢI QUỐC TẾ ĐƯỜNG BỘ VIỆT NAM-CAMPUCHIA";
        }
    }
