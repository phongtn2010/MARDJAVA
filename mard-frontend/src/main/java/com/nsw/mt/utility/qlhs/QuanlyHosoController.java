package com.nsw.mt.utility.qlhs;
...
@Controller
@RequestMapping(value = "/mt/qlhs")
@PropertySource("classpath:mt_api.properties")
public class QuanlyHosoController extends BaseController {
    ...
    public String index(HttpServletRequest request, HttpServletResponse response, RedirectAttributes redirectAttributes,
        ...
        return "nsw.mt.page.utility.qlhs";
    }
    ...
    public ResponseEntity<Object> callBackendService(HttpServletRequest request, @RequestBody Map<String, Object> form) {
        try {
            ...
            responseJson.setMessage(getMessage(MTConstants.MessageKeys.ACTION_SUCCESS, null, request.getLocale()));
    ...
    @ResponseBody
    @RequestMapping(value = "/call_service2", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
    public ResponseEntity<Object> callBackendService2(HttpServletRequest request, @RequestBody Map<String, Object> form) {
