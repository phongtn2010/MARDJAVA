...
public class SearchForm58 {
    ...
    public SearchForm58(String maHoSo, String maThuTuc, String soVanBan, Long trangThaiHoSo, Date ngayTaoTuNgay, Date ngayTaoDenNgay, Date ngayCapTuNgay, Date ngayCapDenNgay, String nguoiTao, int pageSize, int currentPage) {
        this.maHoSo = maHoSo;
