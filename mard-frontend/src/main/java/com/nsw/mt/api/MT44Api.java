...
import com.nsw.mt.p44.model.TbdhsDinhkem44;
import com.nsw.mt.p44.model.SearchFormKqxl44;
import com.nsw.mt.p44.model.HistoryFilterForm;
import com.nsw.mt.p44.model.Tbstuyencodinh;
import com.nsw.mt.p44.model.FilterForm;
import com.nsw.mt.p44.model.Tbdhoso44;
import com.nsw.mt.p44.model.ResultFilterForm;
import com.nsw.mt.p44.model.SendMessage;
...
import com.nsw.mt.constant.MT44Constant;
...
@RestController
@RequestMapping("/mt/44")
public class MT44Api extends BaseApi {
    
    static final String TAG = "MT44Api";
    ...
    ResponseJson getCategory(
        ...
        try {
            switch (key) {
                case MT44Constant.DANHMUC.HS_TRANGTHAI:
                    json = BackendRequestHelper.getInstance().doGetRequest(MT44Constant.getInstance().getApiUrl(environment, MT44Constant.API.DANHMUC_TRANGTHAI));
                    break;
                case MT44Constant.DANHMUC.HS_DONVIXULY:
                    json = BackendRequestHelper.getInstance().doGetRequest(MT44Constant.getInstance().getApiUrl(environment, MT44Constant.API.DANHMUC_DONVIXULY)+id);
                    break;
                case MT44Constant.DANHMUC.HS_CUAKHAUXUATNHAP:
                    json = BackendRequestHelper.getInstance().doGetRequest(MT44Constant.getInstance().getApiUrl(environment, MT44Constant.API.DANHMUC_CUAKHAUNHAPXUAT) + id);
                    break;
                case MT44Constant.DANHMUC.HS_CUAKHAUDENDI:
                    json = BackendRequestHelper.getInstance().doGetRequest(MT44Constant.getInstance().getApiUrl(environment, MT44Constant.API.DANHMUC_CUAKHAUDENDI) + id);
                    break;
                case MT44Constant.DANHMUC.HS_TUYENVANTAI:
                    json = BackendRequestHelper.getInstance().doGetRequest(MT44Constant.getInstance().getApiUrl(environment, MT44Constant.API.DANHMUC_TUYENVANTAI));
                    break;
                case MT44Constant.DANHMUC.HS_TUYENVANTAI_CHITIET:
                    json = BackendRequestHelper.getInstance().doGetRequest(MT44Constant.getInstance().getApiUrl(environment, MT44Constant.API.DANHMUC_TUYENVANTAI_CHITIET) + "?fiMaTuyen=" + id );
                    break;
                case MT44Constant.DANHMUC.HS_LOAIXE:
                    json = BackendRequestHelper.getInstance().doGetRequest(MT44Constant.getInstance().getApiUrl(environment, MT44Constant.API.DANHMUC_LOAIXE));
                    break;
                case MT44Constant.DANHMUC.HS_LOAIFILE:
                    json = BackendRequestHelper.getInstance().doGetRequest(MT44Constant.getInstance().getApiUrl(environment, MT44Constant.API.DANHMUC_LOAIFILE) + id);
                    break;
                default:
                    break;
            }
    ...
    ResponseJson searchHoso(
        ...
        try {
            ...
            ResponseJson json = BackendRequestHelper.getInstance().doPostRequest(MT44Constant.getInstance().getApiUrl(environment, MT44Constant.API.HOSO_SEARCH), filter);
            return json;
        } catch (Exception ex) {
            LogUtil.addLog(ex);
            String errorInfo = AppConstant.APP_NAME + AppConstant.MESSAGE_SEPARATOR + TAG + AppConstant.MESSAGE_SEPARATOR + Thread.currentThread().getStackTrace()[1].getMethodName() + AppConstant.MESSAGE_SEPARATOR + ex.toString();
    ...
    private boolean isOwner(Object fiHoso) {
        ResponseJson json = BackendRequestHelper.getInstance().doGetRequest(MT44Constant.getInstance().getApiUrl(environment, MT44Constant.API.HOSO_OWNER) + fiHoso + "/" + getUsername());
    ...
    ResponseJson deleteHoso(
        ...
        ResponseJson json = BackendRequestHelper.getInstance().doPostRequest(MT44Constant.getInstance().getApiUrl(environment, MT44Constant.API.HOSO_DELETE) + "/" + fiIdHoso, map);
        return json;
    }
    ...
    ResponseJson lichSuXuLyHoSo(
        ...
        try {
            ...
            json = BackendRequestHelper.getInstance().doPostRequest(MT44Constant.getInstance().getApiUrl(environment, MT44Constant.API.LICHSU_SEARCH), filterForm);
    ...
    ResponseJson ycRutHoso(
        ...
        try {
            ...
            message.setType(MT44Constant.MSG_TYPE.TYPE_15);
            ResponseJson hosoJson = BackendRequestHelper.getInstance().doGetRequest(MT44Constant.getInstance().getApiUrl(environment, MT44Constant.API.HOSO_GET_BYID) + message.getFiIdHoso());
            if (hosoJson.isSuccess()) {
                if ((LinkedHashMap) hosoJson.getData() != null) {                    
                        message.setFunction(MT44Constant.MSG_FUNC.FUNC_11);                    
                    json = BackendRequestHelper.getInstance().doPostRequest(MT44Constant.getInstance().getApiUrl(environment, MT44Constant.API.HOSO_SEND), message);
                }
            }
    ...
    ResponseJson getHoso(
        ...
        json.setSuccess(false);
        try {
            String url = MT44Constant.getInstance().getApiUrl(environment, MT44Constant.API.HOSO_GET_BYID);
    ...
    ResponseJson quyetDinhHoSo(
        ...
        json = BackendRequestHelper.getInstance().doGetRequest(MT44Constant.getInstance().getApiUrl(environment, MT44Constant.API.HOSO_THONGBAO) + filterForm.getFiMaHoso());
        return json;
    }
    ...
    ResponseJson createHoso(
        ...
        try {
            ...
            if (tbdHoso != null) {
                ...
                tbdHoso.setFiTrangthai(MT44Constant.FILE_STATUS.TAO_MOI);
                tbdHoso.setFiTenTt(MT44Constant.FILE_STATUS.TAO_MOI_STR);
            }
            json = BackendRequestHelper.getInstance().doPostRequest(MT44Constant.getInstance().getApiUrl(environment, MT44Constant.API.HOSO_INSERT), tbdHoso);
    ...
    ResponseJson updateHoso(
        ...
        try {
            ...
            json = BackendRequestHelper.getInstance().doCustomRequest(MT44Constant.getInstance().getApiUrl(environment, MT44Constant.API.HOSO_UPDATE), HttpMethod.PUT, tbdHoso, new HashMap<>());
        } catch (Exception ex) {
            LogUtil.addLog(ex);
            String errorInfo = AppConstant.APP_NAME + AppConstant.MESSAGE_SEPARATOR + TAG + AppConstant.MESSAGE_SEPARATOR + Thread.currentThread().getStackTrace()[1].getMethodName() + AppConstant.MESSAGE_SEPARATOR + ex.toString();
            RabbitMQErrorHelper.pushLogToRabbitMQ(errorInfo, getRabbitMQ());
        ...
        try {
            ...
            if (json.isSuccess()) {
                if ((LinkedHashMap) json.getData() != null) {
                    ...
                    message.setType(MT44Constant.MSG_TYPE.TYPE_10);
                    message.setFiIdHoso(fiIdHoso);
                    
                    if (Objects.equals(fiTrangthai, MT44Constant.FILE_STATUS.TAO_MOI)) {
                        message.setFunction(MT44Constant.MSG_FUNC.FUNC_01);
                    } else if (Objects.equals(fiTrangthai, MT44Constant.FILE_STATUS.CHO_TIEP_NHAN)) {
                        message.setFunction(MT44Constant.MSG_FUNC.FUNC_02);
                    } else if (Objects.equals(fiTrangthai, MT44Constant.FILE_STATUS.YC_BO_SUNG)) {
                        message.setFunction(MT44Constant.MSG_FUNC.FUNC_04);
                    }
                    //Gui ho so
                    ResponseJson jsonResult = BackendRequestHelper.getInstance().doPostRequest(MT44Constant.getInstance().getApiUrl(environment, MT44Constant.API.HOSO_SEND), message);
    ...
    ResponseJson kqxlHoso(
            @RequestBody SearchFormKqxl44 message
    ) {
        if (message == null || !isOwner(message.getFiIdHoso())) {
            return new ResponseJson();
        }
        ResponseJson json = BackendRequestHelper.getInstance().doPostRequest(MT44Constant.getInstance().getApiUrl(environment, MT44Constant.API.KQXL_SEARCH), message);
        return json;
    }
    ...
    ResponseJson ycSuaVanBan(
        ...
        try {
            ...
            message.setType(MT44Constant.MSG_TYPE.TYPE_12);
            message.setFunction(MT44Constant.MSG_FUNC.FUNC_08);
            ResponseJson hosoJson = BackendRequestHelper.getInstance().doGetRequest(MT44Constant.getInstance().getApiUrl(environment, MT44Constant.API.HOSO_GET_BYID) + message.getFiIdHoso());
            if (hosoJson.isSuccess()) {
                if ((LinkedHashMap) hosoJson.getData() != null) {
...
//                    }
    ...
    ResponseJson kqYeuCauSuaVanBan(
        ...
        ResponseJson json = BackendRequestHelper.getInstance().doGetRequest(MT44Constant.getInstance().getApiUrl(environment, MT44Constant.API.KQYCS_VB) + message.getFiMaHoso());
        return json;
    }
    ...
    ResponseJson ycTraLaiVanBan(
        ...
        try {
            ...
            message.setType(MT44Constant.MSG_TYPE.TYPE_16);
            message.setFunction(MT44Constant.MSG_FUNC.FUNC_13);
            ResponseJson hosoJson = BackendRequestHelper.getInstance().doGetRequest(MT44Constant.getInstance().getApiUrl(environment, MT44Constant.API.HOSO_GET_BYID) + message.getFiIdHoso());
            if (hosoJson.isSuccess()) {
                if ((LinkedHashMap) hosoJson.getData() != null) {
//                    Long fiTrangthai = Long.valueOf(((LinkedHashMap) hosoJson.getData()).get("fiTrangthai").toString());
...
//                    }
    ...
    ResponseJson kqYeuCauTraLaiVanBan(
        ...
        ResponseJson json = BackendRequestHelper.getInstance().doGetRequest(MT44Constant.getInstance().getApiUrl(environment, MT44Constant.API.KQYCTL_VB) + message.getFiMaHoso());
        return json;
    }
    ...
    public void downloadFile(HttpServletResponse response,
        ...
        if (principal instanceof UserDetails) {
            try {
                ResponseJson json = BackendRequestHelper.getInstance().doGetRequest(MT44Constant.getInstance().getApiUrl(environment, MT44Constant.API.DINHKEM_GET_BYID) + id);
                if (json == null || json.getSuccess() == false || json.getData() == null) {
                    return;
                }
                TbdhsDinhkem44 fileInfo = GsonUtils.getInstance().transform(json.getData(), TbdhsDinhkem44.class);
        ...
        if (principal instanceof UserDetails) {
            try {
                if (file.isEmpty()) {
                    ...
                    String uri = getFullUri(environment.getRequiredProperty(MT44Constant.API.ATTACHMENT_UPLOAD));
    ...
    private void downloadFile(HttpServletResponse response, String fileCode,
        ...
        if (fileCodeDb.equals(fileCode)) {
            String uri = getFullUri(environment.getProperty(MT44Constant.API.ATTACHMENT_DOWNLOAD));
    ...
    String getFullUri(String restUri) {
        return environment.getRequiredProperty(MT44Constant.API.BACKEND) + restUri;
    }
}
