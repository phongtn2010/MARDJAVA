...
import com.nsw.mt.p13.model.TbdhsDinhkem2;
import com.nsw.mt.p13.model.SearchFormKqxl02;
import com.nsw.mt.p13.model.HistoryFilterForm;
import com.nsw.mt.p13.model.FilterForm;
import com.nsw.mt.p13.model.Tbdhoso2;
import com.nsw.mt.p13.model.ResultFilterForm;
import com.nsw.mt.p13.model.SendMessage;
...
import com.nsw.mt.p13.model.SearchFormQlpt;
...
@RestController
@RequestMapping("/mt/13")
public class MT13Api extends BaseApi {

    static final String TAG = "MT13Api";
    ...
    ResponseJson getCategory(
        ...
        try {
            switch (key) {
                case MT13Constant.DANHMUC.HS_TRANGTHAI:
                    json = BackendRequestHelper.getInstance().doGetRequest(MT13Constant.getInstance().getApiUrl(environment, MT13Constant.API.DANHMUC_TRANGTHAI));
                    break;
                case MT13Constant.DANHMUC.HS_DONVIXULY:
                    json = BackendRequestHelper.getInstance().doGetRequest(MT13Constant.getInstance().getApiUrl(environment, MT13Constant.API.DANHMUC_DONVIXULY) + id);
                    break;
                case MT13Constant.DANHMUC.HS_CUAKHAUXUATNHAP:
                    json = BackendRequestHelper.getInstance().doGetRequest(MT13Constant.getInstance().getApiUrl(environment, MT13Constant.API.DANHMUC_CUAKHAUNHAPXUAT) + id);
                    break;
                case MT13Constant.DANHMUC.HS_CUAKHAUDENDI:
                    json = BackendRequestHelper.getInstance().doGetRequest(MT13Constant.getInstance().getApiUrl(environment, MT13Constant.API.DANHMUC_CUAKHAUDENDI) + id);
                    break;
                case MT13Constant.DANHMUC.HS_TUYENVANTAI:
                    json = BackendRequestHelper.getInstance().doGetRequest(MT13Constant.getInstance().getApiUrl(environment, MT13Constant.API.DANHMUC_TUYENVANTAI));
                    break;
                case MT13Constant.DANHMUC.HS_TUYENVANTAI_CHITIET:
                    json = BackendRequestHelper.getInstance().doGetRequest(MT13Constant.getInstance().getApiUrl(environment, MT13Constant.API.DANHMUC_TUYENVANTAI_CHITIET) + "?fiMaTuyen=" + id);
                    break;
                case MT13Constant.DANHMUC.HS_LOAIXE:
                    json = BackendRequestHelper.getInstance().doGetRequest(MT13Constant.getInstance().getApiUrl(environment, MT13Constant.API.DANHMUC_LOAIXE));
                    break;
                case MT13Constant.DANHMUC.HS_LOAIFILE:
                    json = BackendRequestHelper.getInstance().doGetRequest(MT13Constant.getInstance().getApiUrl(environment, MT13Constant.API.DANHMUC_LOAIFILE) + id);
                    break;
                case MT13Constant.DANHMUC.HS_XE_CHITIET:
                    json = BackendRequestHelper.getInstance().doGetRequest(MT13Constant.getInstance().getApiUrl(environment, MT13Constant.API.DANHMUC_XE_CHI_TIET) + id);
                    break;
                default:
                    break;
            }
    ...
    ResponseJson searchHoso(
        ...
        try {
            ...
            ResponseJson json = BackendRequestHelper.getInstance().doPostRequest(MT13Constant.getInstance().getApiUrl(environment, MT13Constant.API.HOSO_SEARCH), filter);
            return json;
        } catch (Exception ex) {
            LogUtil.addLog(ex);
            String errorInfo = AppConstant.APP_NAME + AppConstant.MESSAGE_SEPARATOR + TAG + AppConstant.MESSAGE_SEPARATOR + Thread.currentThread().getStackTrace()[1].getMethodName() + AppConstant.MESSAGE_SEPARATOR + ex.toString();
    ...
    private boolean isOwner(Object fiHoso) {
        ResponseJson json = BackendRequestHelper.getInstance().doGetRequest(MT13Constant.getInstance().getApiUrl(environment, MT13Constant.API.HOSO_OWNER) + fiHoso + "/" + getUsername());
    ...
    ResponseJson deleteHoso(
        ...
        ResponseJson json = BackendRequestHelper.getInstance().doPostRequest(MT13Constant.getInstance().getApiUrl(environment, MT13Constant.API.HOSO_DELETE) + "/" + fiIdHoso, map);
        return json;
    }
    ...
    ResponseJson lichSuXuLyHoSo(
        ...
        try {
            ...
            json = BackendRequestHelper.getInstance().doPostRequest(MT13Constant.getInstance().getApiUrl(environment, MT13Constant.API.LICHSU_SEARCH), filterForm);
    ...
    ResponseJson ycRutHoso(
        ...
        try {
            ...
            message.setType(MT13Constant.MSG_TYPE.TYPE_15);
            ResponseJson hosoJson = BackendRequestHelper.getInstance().doGetRequest(MT13Constant.getInstance().getApiUrl(environment, MT13Constant.API.HOSO_GET_BYID) + message.getFiIdHoso());
            if (hosoJson.isSuccess()) {
                if ((LinkedHashMap) hosoJson.getData() != null) {
                    message.setFunction(MT13Constant.MSG_FUNC.FUNC_11);
                    json = BackendRequestHelper.getInstance().doPostRequest(MT13Constant.getInstance().getApiUrl(environment, MT13Constant.API.HOSO_SEND), message);
                }
            }
    ...
    ResponseJson getHoso(
        ...
        json.setSuccess(false);
        try {
            String url = MT13Constant.getInstance().getApiUrl(environment, MT13Constant.API.HOSO_GET_BYID);
    ...
    ResponseJson quyetDinhHoSo(
        ...
        json = BackendRequestHelper.getInstance().doGetRequest(MT13Constant.getInstance().getApiUrl(environment, MT13Constant.API.HOSO_THONGBAO) + filterForm.getFiMaHoso());
        return json;
    }
    ...
    ResponseJson createHoso(
        ...
        try {
            ...
            if (tbdHoso != null) {
                ...
                tbdHoso.setFiTrangthai(MT13Constant.FILE_STATUS.TAO_MOI);
                tbdHoso.setFiTenTt(MT13Constant.FILE_STATUS.TAO_MOI_STR);
            }
            json = BackendRequestHelper.getInstance().doPostRequest(MT13Constant.getInstance().getApiUrl(environment, MT13Constant.API.HOSO_INSERT), tbdHoso);
    ...
    ResponseJson updateHoso(
        ...
        try {
            ...
            json = BackendRequestHelper.getInstance().doCustomRequest(MT13Constant.getInstance().getApiUrl(environment, MT13Constant.API.HOSO_UPDATE), HttpMethod.PUT, tbdHoso, new HashMap<>());
        } catch (Exception ex) {
            LogUtil.addLog(ex);
            String errorInfo = AppConstant.APP_NAME + AppConstant.MESSAGE_SEPARATOR + TAG + AppConstant.MESSAGE_SEPARATOR + Thread.currentThread().getStackTrace()[1].getMethodName() + AppConstant.MESSAGE_SEPARATOR + ex.toString();
            RabbitMQErrorHelper.pushLogToRabbitMQ(errorInfo, getRabbitMQ());
        ...
        try {
            ...
            if (json.isSuccess()) {
                if ((LinkedHashMap) json.getData() != null) {
                    ...
                    message.setType(MT13Constant.MSG_TYPE.TYPE_10);
                    message.setFiIdHoso(fiIdHoso);

                    if (Objects.equals(fiTrangthai, MT13Constant.FILE_STATUS.TAO_MOI)) {
                        message.setFunction(MT13Constant.MSG_FUNC.FUNC_01);
                    } else if (Objects.equals(fiTrangthai, MT13Constant.FILE_STATUS.CHO_TIEP_NHAN)) {
                        message.setFunction(MT13Constant.MSG_FUNC.FUNC_02);
                    } else if (Objects.equals(fiTrangthai, MT13Constant.FILE_STATUS.YC_BO_SUNG)) {
                        message.setFunction(MT13Constant.MSG_FUNC.FUNC_04);
                    }
                    //Gui ho so
                    ResponseJson jsonResult = BackendRequestHelper.getInstance().doPostRequest(MT13Constant.getInstance().getApiUrl(environment, MT13Constant.API.HOSO_SEND), message);
    ...
    ResponseJson kqxlHoso(
        ...
        ResponseJson json = BackendRequestHelper.getInstance().doPostRequest(MT13Constant.getInstance().getApiUrl(environment, MT13Constant.API.KQXL_SEARCH), message);
        return json;
    }
    ...
    ResponseJson ycSuaVanBan(
        ...
        try {
            ...
            message.setType(MT13Constant.MSG_TYPE.TYPE_12);
            message.setFunction(MT13Constant.MSG_FUNC.FUNC_08);
            ResponseJson hosoJson = BackendRequestHelper.getInstance().doGetRequest(MT13Constant.getInstance().getApiUrl(environment, MT13Constant.API.HOSO_GET_BYID) + message.getFiIdHoso());
            if (hosoJson.isSuccess()) {
                if ((LinkedHashMap) hosoJson.getData() != null) {
...
//                    }
    ...
    ResponseJson kqYeuCauSuaVanBan(
        ...
        ResponseJson json = BackendRequestHelper.getInstance().doGetRequest(MT13Constant.getInstance().getApiUrl(environment, MT13Constant.API.KQYCS_VB) + message.getFiMaHoso());
        return json;
    }
    ...
    ResponseJson ycTraLaiVanBan(
        ...
        try {
            ...
            message.setType(MT13Constant.MSG_TYPE.TYPE_16);
            message.setFunction(MT13Constant.MSG_FUNC.FUNC_13);
            ResponseJson hosoJson = BackendRequestHelper.getInstance().doGetRequest(MT13Constant.getInstance().getApiUrl(environment, MT13Constant.API.HOSO_GET_BYID) + message.getFiIdHoso());
            if (hosoJson.isSuccess()) {
                if ((LinkedHashMap) hosoJson.getData() != null) {
//                    Long fiTrangthai = Long.valueOf(((LinkedHashMap) hosoJson.getData()).get("fiTrangthai").toString());
...
//                    }
    ...
    ResponseJson kqYeuCauTraLaiVanBan(
        ...
        ResponseJson json = BackendRequestHelper.getInstance().doGetRequest(MT13Constant.getInstance().getApiUrl(environment, MT13Constant.API.KQYCTL_VB) + message.getFiMaHoso());
        return json;
    }
    ...
    public void downloadFile(HttpServletResponse response,
        ...
        if (principal instanceof UserDetails) {
            try {
                ...
                ResponseJson json = BackendRequestHelper.getInstance().doGetRequest(MT13Constant.getInstance().getApiUrl(environment, MT13Constant.API.DINHKEM_GET_BYID) + id);
                if (json == null || json.getSuccess() == false) {
                    return;
                }
                TbdhsDinhkem2 fileInfo = GsonUtils.getInstance().transform(json.getData(), TbdhsDinhkem2.class);
        ...
        if (principal instanceof UserDetails) {
            try {
                if (file.isEmpty()) {
                    ...
                    String uri = getFullUri(environment.getRequiredProperty(MT13Constant.API.ATTACHMENT_UPLOAD));
    ...
    private void downloadFile(HttpServletResponse response, String fileCode,
        ...
        if (fileCodeDb.equals(fileCode)) {
            String uri = getFullUri(environment.getProperty(MT13Constant.API.ATTACHMENT_DOWNLOAD));
    ...
    String getFullUri(String restUri) {
        return environment.getRequiredProperty(MT13Constant.API.BACKEND) + restUri;
    }

    @RequestMapping(value = "/xe/findall", method = RequestMethod.POST, headers = {"content-type=application/json"})
    public @ResponseBody
    ResponseJson getAllXe(
            @RequestBody SearchFormQlpt message
    ) {
        message.setNguoiTao(getUsername());
        ResponseJson json = BackendRequestHelper.getInstance().doPostRequest(MT13Constant.getInstance().getApiUrl(environment, MT13Constant.API.DANHMUC_XE), message);
        return json;
    }
