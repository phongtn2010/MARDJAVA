...
@Controller
@RequestMapping(value = "/mt/01")
@PropertySource("classpath:mt_api.properties")
public class MT01Controller extends BaseController {
    ...
    public String index(HttpServletRequest request, HttpServletResponse response, RedirectAttributes redirectAttributes,
        ...
        return environment.getProperty("mt.p01.home");
    }
    ...
    public String edit(ModelMap model, HttpServletRequest request, @PathVariable("id") Long id,@PathVariable("procedureId") String procedureId) {
        ...
        return environment.getProperty("mt.p01.edit");
    }
    ...
    public String viewLicense(ModelMap model, HttpServletRequest request, @PathVariable("type") Integer type, @PathVariable("procedureId") String procedureId, @PathVariable("id") Long id) {
        ...
        return "nsw.mt.page.1.view.license";
    }
    ...
    public ResponseEntity<Object> getGiayPhep(HttpServletRequest request, @PathVariable("id") long id) {
        ...
        try {
            ...
            ResponseJson responseJson = callRestTemplate(environment.getRequiredProperty("mt.backend") + environment.getRequiredProperty("mt.01.xem_giay_phep"), id, HttpMethod.POST, params);
    ...
    public ResponseEntity<Object> saveWithFile(DefaultMultipartHttpServletRequest request, @PathVariable("funcType") int funcType) {
        ...
        try {
            String uri = environment.getProperty("mt.backend") + environment.getProperty("mt.01.save_with_file") + "/" + funcType;
    ...
    public ResponseEntity<Object> getProcessHistory(HttpServletRequest request, @PathVariable("idHoSo") Long fiIdHoso, @PathVariable("currentPage") Long currentPage) {
        try {
            ...
            ResponseJson responseJson = callRestTemplate(environment.getRequiredProperty("mt.backend") + environment.getRequiredProperty("mt.01.history"), params, HttpMethod.POST, null);
            List lst = (List) responseJson.getData();
            ResponseJson response = callRestTemplate(environment.getProperty("mt.backend") + environment.getRequiredProperty("mt.01.history_total"), params, HttpMethod.POST, null);
    ...
    public ResponseEntity<Object> xinRut(HttpServletRequest request, @RequestBody Object lyDo) {
        try {
            ...
            Map<String, Object> params = new HashMap<>();
            ResponseJson responseJson = callRestTemplate(environment.getRequiredProperty("mt.backend") + environment.getRequiredProperty("mt.01.rut_ho_so"), lyDo, HttpMethod.POST, params);
            return createResponseEntity(responseJson.getData(), 1l, "", true, HttpStatus.OK);
    ...
    public ResponseEntity<Object> xinSuaGiayPhep(HttpServletRequest request, @RequestBody Object lyDo) {
        ...
        try {
            ...
            Map<String, Object> params = new HashMap<>();
            ResponseJson responseJson = callRestTemplate(environment.getRequiredProperty("mt.backend") + environment.getRequiredProperty("mt.01.xin_sua_giay_phep"), lyDo, HttpMethod.POST, params);
            return createResponseEntity(responseJson.getData(), 1l, "", true, HttpStatus.OK);
    ...
    public ResponseEntity<Object> traGiayPhep(HttpServletRequest request, @RequestBody Object lyDo) {
        ...
        try {
            ...
            Map<String, Object> params = new HashMap<>();
            ResponseJson responseJson = callRestTemplate(environment.getRequiredProperty("mt.backend") + environment.getRequiredProperty("mt.01.tra_giay_phep"), lyDo, HttpMethod.POST, params);
            return createResponseEntity(responseJson.getData(), 1l, "", true, HttpStatus.OK);
    ...
    public ResponseEntity<Object> downloadNewFile(HttpServletResponse response, @PathVariable("idDinhKem") Long idDinhKem) {
        ...
        if (principal instanceof UserDetails) {
            try {
                if (idDinhKem != null) {
                    String uri = environment.getProperty("mt.backend") + environment.getProperty("mt.01.download") + "/" + idDinhKem;
                    HttpHeaders headers = new HttpHeaders();
    ...
    private String getTitleLabel(String procedureId) {
        switch (procedureId) {
            case "BGTVT0600001":
                return "Cấp Giấy phép vận tải đường bộ quốc tế Việt - Lào cho doanh nghiệp, hợp tác xã của Việt Nam";
            case "BGTVT0600002":
                return "Cấp lại Giấy phép hoạt động vận tải đường bộ quốc tế Việt - Lào cho doanh nghiệp, hợp tác xã của Việt Nam do hết hạn";
            case "BGTVT0600003":
                return "Cấp lại Giấy phép hoạt động vận tải đường bộ quốc tế Việt - Lào cho doanh nghiệp, hợp tác xã của Việt Nam do hư hỏng";
            case "BGTVT0600004":
                return "Cấp lại Giấy phép hoạt động vận tải đường bộ quốc tế Việt - Lào cho doanh nghiệp, hợp tác xã của Việt Nam do mất mát";
            default:
                return "Cấp Giấy phép vận tải đường bộ quốc tế Việt - Lào cho doanh nghiệp, hợp tác xã của Việt Nam";
        }
    }
