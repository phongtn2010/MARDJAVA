...
public class TbdhsXe41 {
    ...
    //@Column(name="FI_SO_GP_MAT", length=255)
    private String fiSoGpMat;
    ...
    public void setFiSoGpMat(String fiSoGpMat) {
        this.fiSoGpMat = fiSoGpMat;
    }

    public String getFiSoGpMat() {
        return this.fiSoGpMat;
    }
