...
public class Tbdhoso8 implements Serializable {
    ...
    private List<TbdhsdsPhelieu8> lstPheLieu;

    
    private List<Tbddinhkem8> lstDinhKem;
    ...
    public String getFiCoquancapGxn() {
        return fiCoquancapGxn;
    }

    public void setFiCoquancapGxn(String fiCoquancapGxn) {
        this.fiCoquancapGxn = fiCoquancapGxn;
    }
    ...
    public Date getFiCapnhat() {
        return fiCapnhat;
    }

    public void setFiCapnhat(Date fiCapnhat) {
    ...
    public List<TbdhsdsPhelieu8> getLstPheLieu() {
        return lstPheLieu;
    }

    public void setLstPheLieu(List<TbdhsdsPhelieu8> lstPheLieu) {
        this.lstPheLieu = lstPheLieu;
    }

    public List<Tbddinhkem8> getLstDinhKem() {
        return lstDinhKem;
    }

    public void setLstDinhKem(List<Tbddinhkem8> lstDinhKem) {
    ...
    public String toString() {
        ...
        sb.append(fiMaHoso);
        sb.append("|");
        sb.append(fiMaCoQuan);
        sb.append("|");
        sb.append(fiTenCoQuan);
        sb.append("|");
        sb.append(fiMaSoThue);
        sb.append("|");
        sb.append(fiTenDn);
        sb.append("|");
        sb.append(fiSoGcnDkkd);
        sb.append("|");
        sb.append(fiNgaycapGcnDkkd);
        sb.append("|");
        sb.append(fiNoicapGcnDkkd);
        sb.append("|");
        sb.append(fiTruSoChinh);
        sb.append("|");
        sb.append(fiNguoiDaiDien);
        sb.append("|");
        sb.append(fiCoquancapGxn);
        sb.append("|");
