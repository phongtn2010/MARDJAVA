...
public class PheLieuEditForm {
	...
	public String toString() {
		return "PheLieuEditForm [idPL=" + idPL + ", idHS=" + idHS + ", tenPheLieu=" + tenPheLieu + ", maHS=" + maHS + ", moTa=" + moTa + ", khoiLuong6=" + khoiLuong6 + ", khoiLuong=" + khoiLuong + ", donViUyThac=" + donViUyThac + ", khoiLuong6Input=" + khoiLuong6Input + ", khoiLuongInput=" + khoiLuongInput + "]";
	}
