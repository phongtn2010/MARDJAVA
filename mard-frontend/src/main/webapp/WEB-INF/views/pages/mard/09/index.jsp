                                ...
                                <div class="panel-body">
                                    <form role="form" class="form-horizontal" name="searchForm">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="col-md-4">
                                                    <select id="cqkd"
                                                            ...
                                                            data-bind="value : fiQuarantineDepartmentCode, options : fiListCoquan, optionsValue : 'fiPUCode', optionsCaption: 'Tất cả...', optionsText : 'fiPUDesc'"
                                                    >
                                                    </select>
                                                </div>
                                                <div class="col-md-2 nsw-text-right">
                                                ...
                                                <div class="col-md-4">
                                                    <select id="cqgs"
                                                            class="form-control select2"
                                                            data-bind="value : fiMonitoringDepartmentCode, options : fiListCoquan, optionsValue : 'fiPUCode', optionsCaption: 'Tất cả...', optionsText : 'fiPUDesc'"
                                                    >
                                                    </select>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group nsw-text-center">
                                            ...
                                            <a href="/mard/09/create" class="btn green" id="btnAddNew" ><i class="fa fa-edit"></i> Thêm mới</a>
                                        </div>
                                    </form>
                                </div>
                            </div>
                ...
                <table class="table table-striped table-bordered table-hover table-checkable order-column" id="monre06Items">
                    <thead>
                        <tr class="nsw-tr tr-nsw1-bgcolor">
                            ...
                            <th class="text-center" width="10%"> <spring:message code="mard.danhsach.sogiayphep" /> </th>
                            ...
                            <th class="text-center" width="5%"> <spring:message code="mard.danhsach.xinsua" /> </th>
                            <th class="text-center" width="5%"> <spring:message code="mard.danhsach.xinrut" /> </th>
                            <th class="text-center" width="5%"> <spring:message code="mard.danhsach.sua" /> </th>
                            <th class="text-center" width="5%"> <spring:message code="mard.danhsach.xoa" /> </th>
                        </tr>
                    </thead>
                    ...
                    <script id="itemTmpl" type="text/html">
                        <tr>
                            ...
                            <td class="text-center" data-bind="text : fiCertNo"></td>
                            ...
                            <td class="text-center">
                                <a href="javascript:void(0)" data-bind="visible: isShowXinsua"><i class="fa fa-edit" data-bind="visible: true, click: $parent.bXinsua.bind($parent)" src="" alt=""/></a>
                            </td>
                            <td class="text-center">
                                <a href="javascript:void(0)" data-bind="visible: isShowXinrut"><i class="fa fa-download" data-bind="visible: true, click: $parent.bXinrut.bind($parent)" src="" alt=""/></a>
                            </td>
                            <td class="text-center">
                                <a href="javascript:void(0)" data-bind="visible: isShowSua"><i class="fa fa-lg fa-edit tooltips" data-bind="visible: true, click: $parent.bSuaHoso.bind($parent)" data-original-title="Sửa hồ sơ" src="" alt=""/></a>
                            </td>
                            <td class="text-center">
                                <a href="javascript:void(0)" data-bind="visible: isShowXoa"><i class="fa fa-lg fa-close tooltips" data-bind="click: $parent.bXoaHoso.bind($parent)" style="color:red" data-original-title="Xoá hồ sơ" src="" alt=""/></a>
                            </td>
                        </tr>
                        </script>
                    </table>
