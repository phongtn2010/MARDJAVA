                ...
                <tr>
                    ...
                    <td class="text-center">
                        ...
                        <table style="border: 0px !important; width: 100%;">
                            ...
                            <td>
                                <a target="_blank" data-bind="text: 'Tệp ' + ($index() + 1), click: downloadFile, attr: {title: fiTenTep}"></a>
                            </td>
                            </tbody>
                        </table>
                    </td>
    ...
    >
        ...
        <div class="modal-body">
            ...
            <label class="btn blue">
                <input type="file" id="btnfile20a" style="display: none" data-bind="event: { change: fileChange}" accept=".pdf, .jpg, .jpeg, .tif, .doc, .xls, .zip"/>
