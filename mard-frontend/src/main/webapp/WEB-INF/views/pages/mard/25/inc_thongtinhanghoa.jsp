            ...
            <div class="panel-heading" style="font-weight: bold;">
                 <span class="btn-group pull-right">
                      <a style="margin-left: 10px" class="btn green" title=""
                         data-bind="visible: $root.isEditable(),click: openAddHangHoa"
                        ...
                        <div class="col-md-12">
                            ...
                            <table class="table table-striped table-bordered table-hover order-column">
                                ...
                                <tr class="nsw-tr tr-nsw1-bgcolor">
                                    <th style="width: 3%" class="text-center"><spring:message
                                            code="mard.25.tokhai.hang_hoa_grid_stt"/></th>
                                    <th class="text-center"><spring:message
                                            code="mard.25.tokhai.hang_hoa_grid_ten"/></th>
                                    <th class="text-center"><spring:message
                                            code="mard.25.tokhai.hang_hoa_grid_soluong"/></th>
                                    <th class="text-center"><spring:message
                                            code="mard.25.tokhai.hang_hoa_grid_khoiluong"/></th>
                                    <th class="text-center"><spring:message
                                            code="mard.25.tokhai.hang_hoa_grid_thanhphan"/></th>
                                    <th class="text-center"><spring:message
                                            code="mard.25.tokhai.hang_hoa_grid_nhomtacn"/></th>
                                    <th class="text-center"><spring:message
                                            code="mard.25.tokhai.hang_hoa_grid_macongnhan"/></th>
                                    <th class="text-center"><spring:message
                                            code="mard.25.tokhai.hang_hoa_grid_hangsanxuat"/></th>
                                    <th class="text-center"><spring:message
                                            code="mard.25.tokhai.hang_hoa_grid_nuocsanxuat"/></th>
                                    <th class="text-center"><spring:message
                                            code="mard.25.tokhai.hang_hoa_grid_giatri"/></th>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center" data-bind="visible: $root.isEditable()">
                                        ...
                                        <a href="javascript:void(0)"
                                           data-bind="click: $parent.removeProduct.bind($data, $index())">
    ...
    >
        <div class="modal-header" style="background: #337ab7; color: #fff;">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true"
                    data-bind="click: closeHangHoa"></button>
            <b class="modal-title"><spring:message code="mard.25.tokhai.hang_hoa"/></b>
        </div>
        <div class="modal-body">

            <div class="panel panel-primary">
                <div class="panel-heading" style="font-weight: bold;"><spring:message
                        code="mard.25.tokhai.hang_hoa.title"/></div>
                <div class="panel-body">
                    <form role="form" class="form-horizontal">
                        <div class="form-group">
                            <div class="col-md-2 nsw-text-right">
                                <label><spring:message code="mard.25.tokhai.hang_hoa.name"/><a
                                        class="nsw-require-field">*</a></label>
                            </div>
                            <div class="col-md-4">
                                <input data-bind="trimedValue: fiProName, visible: fiHSType()!=4" class="form-control"
                                       value=""/>
                                <select data-bind="options : lstDSHosoMK, optionsValue : 'fiIdProduct',
                                optionsText : 'fiProName', event : {click : eventChangeHangHoa}, selectedText:fiProNameSelect,
                                optionsCaption: '<spring:message code="mard.25.chonhang"/>',
                                                    value: fiIdProduct25, visible: fiHSType()==4"
                                        class="form-control"></select>
                            </div>
                            <div class="col-md-2 nsw-text-right">
                                <label><spring:message code="mard.25.tokhai.hang_hoa.nhom"/><a
                                        class="nsw-require-field">*</a></label>
                            </div>
                            <div class="col-md-4">
...
<%--                                       value="" disabled/>--%>
                        ...
                        <div class="form-group">
                            <div class="col-md-2 nsw-text-right">
                                <label><spring:message code="mard.25.tokhai.hang_hoa.phan_nhom"/><a
                                        class="nsw-require-field">*</a></label>
                            </div>
                            <div class="col-md-4">
...
<%--                                       value="" disabled/>--%>
                        ...
                        <div class="form-group">
                            <div class="col-md-2 nsw-text-right">
                                <label><spring:message code="mard.25.tokhai.hang_hoa.phan_loai"/><a
                                        class="nsw-require-field">*</a></label>
                            </div>
                            <div class="col-md-4">
                                <select
...
<%--                                       class="form-control" value="" disabled/>--%>
                            ...
                            <div class="col-md-4">
                                <input data-bind="trimedValue: fiProCode, enable: fiHSType()!=4" class="form-control"
                                       value=""/>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-md-2 nsw-text-right">
                                <label><spring:message code="mard.25.tokhai.hang_hoa.hang_san_xuat"/><a
                                        class="nsw-require-field">*</a></label>
                            </div>
                            <div class="col-md-4">
                                <input data-bind="trimedValue: fiProMadeIn, enable: fiHSType()!=4" class="form-control"
                                       value=""/>
                            </div>
                            <div class="col-md-2 nsw-text-right">
                                <label><spring:message code="mard.25.tokhai.hang_hoa.nuoc_san_xuat"/><a
                                        class="nsw-require-field">*</a></label>
                            </div>
                            <div class="col-md-4">
                                <select
                                        data-bind="options: lstCountry,
                                                    ...
                                                    value: fiProCountryCode, enable: fiHSType()!=4"
                                        class="form-control"></select>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-md-2 nsw-text-right">
                                <label><spring:message code="mard.25.tokhai.hang_hoa.thanh_phan"/><a
                                        class="nsw-require-field">*</a></label>
                            </div>
                            <div class="col-md-4">
                                <input data-bind="trimedValue: fiProThanhPhan, enable: fiHSType()!=4"
                            ...
                            <div class="col-md-4">
                                <input data-bind="trimedValue: fiProColor, enable: fiHSType()!=4" class="form-control"
                                       value=""/>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-md-2 nsw-text-right">
                                <label><spring:message code="mard.25.tokhai.hang_hoa.so_hieu"/><a
                                        class="nsw-require-field">*</a></label>
                            </div>
                            <div class="col-md-4">
                                <input data-bind="trimedValue: fiProSoHieu, enable: fiHSType()!=4" class="form-control"
                                       value=""/>
                            </div>
                            <div class="col-md-2 nsw-text-right">
                                <label><spring:message code="mard.25.tokhai.hang_hoa.quy_chuan"/><a
                                        class="nsw-require-field">*</a></label>
                            </div>
                            <div class="col-md-4">
                                <select class="form-control" data-bind="value: fiProQuyChuan, enable: fiHSType()!=4">
                                    <option value="1">
            ...
            <div class="panel panel-primary" id="model-congvan" data-bind="visible: fiHSType()==4">
                <div class="panel-heading" style="font-weight: bold;"><spring:message
                        code="mard.25.tokhai.hang_hoa.congvan.title"/></div>
                <div class="panel-body">
                    <form role="form" class="form-horizontal">
                        <div class="form-group">
                            <div class="col-md-2 nsw-text-right">
                                <label><spring:message code="mard.25.tokhai.hang_hoa.congvan.so"/><a
                                        class="nsw-require-field">*</a></label>
                            </div>
                            <div class="col-md-4">
                                <input data-bind="trimedValue: fiProCVMienGiam" class="form-control" disabled/>
                            </div>
                            <div class="col-md-2 nsw-text-right">
                                <label><spring:message code="mard.25.tokhai.hang_hoa.congvan.ngay"/><a
                                        class="nsw-require-field">*</a></label>
                            </div>
                            <div class="col-md-4">
                                <input
                                        type="text" class="form-control"
                                        data-bind="value: fiProCVMienGiamNgayText" disabled
                                />
                            </div>
                        </div>
                    </form>
            ...
            <div class="panel panel-primary">
                <div class="panel-heading" style="font-weight: bold;"><spring:message
                        code="mard.25.tokhai.hang_hoa.gia_tri"/></div>
                <div class="panel-body">
                    <form role="form" class="form-horizontal">
                        <div class="form-group">
                            <div class="col-md-2 nsw-text-right">
                                <label><spring:message code="mard.25.tokhai.hang_hoa.gia_tri.name"/><a
                                        class="nsw-require-field">*</a></label>
                            </div>
                            <div class="col-md-4">
                            ...
                            <div class="col-md-2 nsw-text-right">
                                <label><spring:message code="mard.25.tokhai.hang_hoa.gia_tri.dvt"/><a
                                        class="nsw-require-field">*</a></label>
                            </div>
                            <div class="col-md-4">
    ...
    <%--                            </div>--%>
    <%--                            <div class="col-md-4" >--%>
    <%--                                <input data-bind="trimedValue: fiProName, visible: fiHSType()!=4" class="form-control" value=""/>--%>
    <%--                                <select data-bind="options : lstDSHosoMK, optionsValue : 'fiMaHoso',--%>
    <%--                                optionsText : 'fiMaHoso', event : {change : eventChangeNhom},--%>
    <%--                                                    value: fiProName, visible: fiHSType()==4" class="form-control"></select>--%>
    <%--                            </div>--%>
    <%--                            <div class="col-md-2 nsw-text-right">--%>
    ...
    <%--                                                    value: fiProIdNhom, enable: fiHSType()!=4" class="form-control"></select>--%>
    <%--                            </div>--%>
    <%--                        </div>--%>
    <%--                        <div class="form-group">--%>
    <%--                            <div class="col-md-2 nsw-text-right">--%>
    ...
    <%--                                                    value: fiProIdPhanNhom, enable: fiHSType()!=4" class="form-control"></select>--%>
    <%--                            </div>--%>
    <%--                            <div class="col-md-2 nsw-text-right">--%>
    ...
    <%--                                                    value: fiProIdLoai, enable: fiHSType()!=4" class="form-control"></select>--%>
    <%--                            </div>--%>
    <%--                        </div>--%>
    <%--                        <div class="form-group">--%>
    <%--                            <div class="col-md-2 nsw-text-right">--%>
    ...
    <%--                            </div>--%>
    <%--                            <div class="col-md-4">--%>
    <%--                                <input data-bind="trimedValue: fiProCode, enable: fiHSType()!=4" class="form-control" value=""/>--%>
    <%--                            </div>--%>
    <%--                        </div>--%>
    <%--                        <div class="form-group">--%>
    <%--                            <div class="col-md-2 nsw-text-right">--%>
    ...
    <%--                            </div>--%>
    <%--                            <div class="col-md-4">--%>
    <%--                                <input data-bind="trimedValue: fiProMadeIn, enable: fiHSType()!=4" class="form-control" value=""/>--%>
    <%--                            </div>--%>
    <%--                            <div class="col-md-2 nsw-text-right">--%>
    ...
    <%--                                                    optionsValue: 'countryid',--%>
    <%--                                                    value: fiProCountryCode, enable: fiHSType()!=4" class="form-control"></select>--%>
    <%--                            </div>--%>
    <%--                        </div>--%>
    <%--                        <div class="form-group">--%>
    <%--                            <div class="col-md-2 nsw-text-right">--%>
    ...
    <%--                            </div>--%>
    <%--                            <div class="col-md-4">--%>
    <%--                                <input data-bind="trimedValue: fiProThanhPhan, enable: fiHSType()!=4" class="form-control" value=""/>--%>
    <%--                            </div>--%>
    <%--                            <div class="col-md-2 nsw-text-right">--%>
    <%--                                <label><spring:message code="mard.25.tokhai.hang_hoa.mau"/><a class="nsw-require-field">*</a></label>--%>
    <%--                            </div>--%>
    <%--                            <div class="col-md-4">--%>
    <%--                                <input data-bind="trimedValue: fiProColor, enable: fiHSType()!=4" class="form-control" value=""/>--%>
    <%--                            </div>--%>
    <%--                        </div>--%>
    <%--                        <div class="form-group">--%>
    <%--                            <div class="col-md-2 nsw-text-right">--%>
    ...
    <%--                            </div>--%>
    <%--                            <div class="col-md-4">--%>
    <%--                                <input data-bind="trimedValue: fiProSoHieu, enable: fiHSType()!=4" class="form-control" value=""/>--%>
    <%--                            </div>--%>
    <%--                            <div class="col-md-2 nsw-text-right">--%>
    ...
    <%--                            </div>--%>
    <%--                            <div class="col-md-4">--%>
    <%--                                <input data-bind="trimedValue: fiProCVMienGiamNgay" class="form-control" disabled/>--%>
    <%--                            </div>--%>
    <%--                        </div>--%>
    <%--                    </form>--%>
    <%--                </div>--%>
    ...
    <%--                            </div>--%>
    <%--                            <div class="col-md-4">--%>
    <%--                                <input data-bind="trimedValue: fiProName, visible: fiHSType()!=4" class="form-control" value="" disabled />--%>
    <%--                                <select data-bind="options : lstDSHosoMK, optionsValue : 'fiMaHoso',--%>
    <%--                                optionsText : 'fiMaHoso', event : {change : eventChangeNhom},--%>
    <%--                                                    value: fiProName, visible: fiHSType()==4" class="form-control"></select>--%>
    <%--                            </div>--%>
