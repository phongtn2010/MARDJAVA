        ...
        <tbody>
            ...
            <tr>
                <td colspan="8" rowspan="2">
                    ...
                    <p class="content ">
                        ...
                        <span  data-bind="text : fiNguoiXk" ></span> <br /> 
                        ADD: <span  data-bind="text :fiDiachiXk" style="text-transform: uppercase"></span>
                    </p>
                </td>
                <td colspan="8">
                    <p class="content t-bold">
            ...
            <tr>
                <td colspan="8">
                    ...
                    <p class="content ">
                        DECLARED NAME AND ADDRESS OF THE CONSIGNEE:<br /> 
                        <span  data-bind="text : fiTenNn" ></span><br /> 
                        ADD: <span  data-bind="text :fiDiachiNn " ></span></p>
