                ...
                <div class="table-toolbar">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <span class="caption-subject bold uppercase">Tìm kiếm</span>
                        </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <table class="table table-striped table-bordered table-hover table-checkable order-column"
                            ...
                            <tr class="nsw-tr tr-nsw1-bgcolor">
                                ...
                                <td class="text-center">Mã Cơ sở</td>
                                <td class="text-center">Tên Cơ sở (Tiếng Việt)</td>
                                <td class="text-center">Địa chỉ (Tiếng Việt)</td>
                                <td class="text-center">Tên Cơ sở (Tiếng Anh)</td>
                                <td class="text-center">Địa chỉ (Tiếng Anh)</td>
                                <td class="text-center">Thao tác</td>
                            </tr>
                            </thead>
                            <tbody data-bind="foreach: cssxItems">
                            <tr>
                                <td class="text-center" data-bind="text: $index() + 1"></td>
                                <td class="text-center" data-bind="text: seafoodprocessorscode"></td>
                                <td class="text-center" data-bind="text: seafoodprocessorsname"></td>
                                <td class="text-center" data-bind="text: seafoodprocessorsadress"></td>
                                <td class="text-center" data-bind="text: commercialnameofestablishments"></td>
