...
<fieldset>
    <legend><b><spring:message code="mard.hoso.lydosua" /></b><a class="nsw-require-field">*</a></legend>
    <div class="form-group">
        <div class="col-md-12">
            ...
            <span class="nsw-require-field validate" id="fiModifyReason-validate"></span>
        </div>
    </div>
</fieldset>
