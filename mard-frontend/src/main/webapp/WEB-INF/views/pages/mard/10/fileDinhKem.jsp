...
<form role="form" class="form-horizontal" id="mard10Files">
    <fieldset>
        ...
        <div class="form-group">
            <div class="col-md-12">
                <div class="col-md-2">
                    <label>Loại file đính kèm <a class="nsw-require-field">*</a></label>
                </div>
                <div class="col-md-4">
                    <select class="form-control" data-bind="optionsCaption: 'Chọn...', 
                        options: fiMaLoaiList,
                        optionsText : 'name',
                        optionsValue : 'id',
                        selectedText : fiTenLoai,
                        value: fiMaLoai,
                        event:{change:fiMaloaiChange}"></select>
                </div>
                <div class="col-md-2">
                    <label>Tên tệp đính kèm <a class="nsw-require-field">*</a></label>
                </div>
                <div class="col-md-4">
                    <input class="form-control" id="fiTenTep" name="fiTenTep" data-bind="value : fiTenTep" type="text" readonly="true"/>
                </div>
            </div>  
        </div> 
        <div class="form-group">
        ...
        <div class="form-group">
            <div class="col-md-12">
                <table class="table table-striped table-bordered table-hover table-checkable order-column" id="lstDinhkem10">
                    ...
                    <tbody id="file-container" data-bind="template: { name: 'lstDinhkem10Tmpl', foreach: lstDinhkem10 }">
                    </tbody>
