                                        ...
                                        <div class="col-md-12" style="padding-top: 10px;">
                                            <div class="text-center">
                                                ...
                                                <button class="btn green"
                                                        data-bind="click: $root.saveRegProfile, visible: thongtinChungVM().fiHSStatus() == 0"
                                                >
                                                    <i class="fa fa-save"></i> <spring:message
                                                        code="common.button.luu"/>
                                                </button>
                                                <button class="btn green"
...
<script type="text/javascript" src="<c:url value='/app/mard/07/edit.js?v=${version}'/>"></script>
