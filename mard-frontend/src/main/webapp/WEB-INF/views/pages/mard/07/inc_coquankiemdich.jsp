            ...
            <div class="col-md-12">
                ...
                <div class="col-md-10">
                    <select data-bind="options: lstDepartment,
                                        ...
                                        value: fiDepartmentofQuarantineCode, enable: thongtinChungVM().fiHSStatus() == 0 && $root.isEditable()"
                            class="form-control">
                    </select>
                </div>
            </div>
            ...
            <div class="col-md-12">
                ...
                <div class="col-md-10">
                    <select data-bind="options: lstDepartment,
                                        ...
                                        optionsValue: 'id',
                                        optionsCaption: '<spring:message code="mard.07.select.co_quan_kd"/>',
                                        value: fiDepartmentofMonitorCode, enable: thongtinChungVM().fiHSStatus() == 0 && $root.isEditable()"
                            class="form-control">
                    </select>
                </div>
            </div>
