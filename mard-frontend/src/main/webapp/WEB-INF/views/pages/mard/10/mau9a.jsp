...
<page size="A4" class="a4-padding">
    ...
    <p class="content">
        Căn cứ Biên bản ghi nhận tình trạng vệ sinh thú y hàng động vật, sản phẩm động vật số <span data-bind="text: foSoBb"></span> ngày <span data-bind="date : fiNgayBb"></span> của <span data-bind="text : fiDonviBb"></span>
    </p>	
