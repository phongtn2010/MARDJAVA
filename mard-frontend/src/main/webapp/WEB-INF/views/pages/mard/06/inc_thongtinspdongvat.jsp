...
<div data-bind="with: regAnimalProductVM">
        ...
        <form role="form" class="form-horizontal">
                ...
                <div class="col-md-12">
                    ...
                    <table class="table table-striped table-bordered table-hover order-column">
                        ...
                        <tr class="nsw-tr tr-nsw1-bgcolor">
                            <th style="width: 5%" class="text-center"><spring:message code="common.tokhai.hanghoa.stt"/></th>
                            ...
                            <th style="width: 8%" class="text-center" data-bind="visible: $root.isEditable()"><spring:message code="mard.table.chuc_nang"/></th>
                        </tr>
                        </thead>
                        <tbody
                        ...
                        <tr>
                            ...
                            <td data-bind="text : $parent.getUnitName(fiPackageUnitCode, 1)"></td>
                            <td data-bind="text : $parent.getCountryName(fiOriginCountryCode)"></td>
            ...
            <div class="form-group" data-bind="visible: $root.isEditable()">
                <div class="col-md-12">
                    ...
                    <div class="col-md-10">
                        <input
                                data-bind="event: { change: function(data, event){ addProductFromExcel(data, event, 'product') } }"
                                type="file"
                                class="form-control"
                                accept=".xlsx"
                        />
                ...
                <div class="col-md-12">
                    ...
                    <table class="table table-striped table-bordered table-hover table-checkable order-column">
                        ...
                        <tr>
                            ...
                            <td class="text-center" data-bind="visible: $root.isEditable()">
                                <a href="javascript:void(0)"
                                   data-bind="click: $parent.openUpdateExporter.bind($data, $data, $index(), 2)">
                                    <i class="fa fa-lg fa-edit"></i>
                                </a>
                ...
                <div class="col-md-12">
                    ...
                    <table class="table table-striped table-bordered table-hover order-column">
                        ...
                        <tr>
                            ...
                            <td class="text-center" data-bind="visible: $root.isEditable()">
                                <a href="javascript:void(0)"
                                   data-bind="click: $parent.openUpdateProdMfr.bind($data, $data, $index(), 2)">
                                    <i class="fa fa-lg fa-edit"></i>
                                </a>
    ...
    <!-- modal -->
    <div data-bind="with: productVM" id="modal_addAnimalProduct" class="modal container in modal-overflow"
         tabindex="-1"
         data-backdrop="static" data-keyboard="false"
    >
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
            <b class="modal-title"><spring:message code="mard.06.tokhai.thong_tin_hang_hoa"/></b>
        </div>
        <div class="modal-body">
            <form role="form" class="form-horizontal">
                <div class="form-group">
                    ...
                    <div class="col-md-2 nsw-text-right">
                        <label><spring:message code="mard.06.table.ten_khoa_hoc"/>
                    </div>
                    <div class="col-md-4">
                        <input
    ...
    <!-- end modal -->
    <!-- modal -->
    <div data-bind="with: productVM" id="modal_editProduct2" class="modal container in modal-overflow"
         tabindex="-1"
         data-backdrop="static" data-keyboard="false"
    >
        <div class="modal-header">
    ...
    <!-- end modal -->
    <!-- modal -->
    <div id="modal_editExporter2" class="modal container in modal-overflow" tabindex="-1"
         data-backdrop="static" data-keyboard="false"
         data-bind="with: exporterVM"
    >
        <div class="modal-header">
    ...
    <!-- end modal -->
    <!-- modal -->
    <div id="modal_addProdMfr" class="modal container in modal-overflow" tabindex="-1"
         data-backdrop="static" data-keyboard="false"
    ...
    >
        ...
        <div class="modal-body">
            <form role="form" class="form-horizontal">
                ...
                <div class="form-group">
                    <div class="col-md-2 nsw-text-right" style="color: red">
                        <label style="font-weight: bold"><spring:message code="mard.06.table.ma_so"/>(bắt buộc đối với mục đích sử dụng "Kinh doanh thực phẩm")</label>
                    </div>
                    <div class="col-md-4">
                        <input
    ...
    <!-- end modal -->
    <!-- modal -->
    <div id="modal_editProdMfr2" class="modal container in modal-overflow" tabindex="-1"
         data-backdrop="static" data-keyboard="false"
         data-bind="with: productMfrVM"
    >
        <div class="modal-header">
        ...
        <div class="modal-body">
            <form role="form" class="form-horizontal">
                ...
                <div class="form-group">
                    <div class="col-md-2 nsw-text-right">
                        <label style="font-weight: bold; color: red"><spring:message code="mard.06.table.ma_so"/>(bắt buộc đối với mục đích sử dụng "Kinh doanh thực phẩm")</label>
                    </div>
                    <div class="col-md-4">
                        <input
                                data-bind="trimedValue: fiProcessingApprovalNumber"
