            ...
            <div id="gvc">
                <table class="table table-striped table-bordered table-hover table-checkable order-column">
                    ...
                    <tr>
                        ...
                        <th class="text-center" width="10%"><spring:message code="mard.xemgiayphep.xinsua" /></th>
                    </tr>
                    </thead>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="javascript:void(0)" class="fa fa-lg fa-edit tooltips" style="text-decoration: none;" data-bind="click: $parent.xinSua.bind($data), visible: isShowXinSua && fiEditable"></a>
                        </td>
                    </tr>
                    </tbody>
                </table>
