...
<fieldset data-bind="with: uploadFileVM">
        ...
        <div class="col-md-12">
            <table class="table table-striped table-bordered table-hover table-checkable order-column">
                ...
                <tr class="nsw-tr tr-nsw1-bgcolor">
                    <th class="text-center" style="width: 5%"><spring:message code="mt.hoso.dinhkem.stt"/></th>
                    <th class="text-center"><spring:message code="mt.hoso.dinhkem.tentep"/></th>
                    <th class="text-center" style="width: 5%"><spring:message code="mt.hoso.dinhkem.tepdinhkem"/></th>
                    <th class="text-center" style="width: 5%"><spring:message code="mt.hoso.dinhkem.chucnang"/></th>
                </tr>
                </thead>
                ...
                <tr>
                    ...
                    <td style="width: 5%" class="text-center">
                        <a class="btn btn-info btn-xs" data-bind="click: $parent.addFiles, visible: !isUploaded(), visible: $root.isEnableEdit"
                           data-target="#modal_addFile20A" data-toggle="modal">Đính kèm</a>
                        <table style="border: 0px !important; width: 100%;">
                            <tbody data-bind="foreach: lstFiles">
                            <td>
                                <a target="_blank" data-bind="text: 'Tệp ' + ($index() + 1), attr: { href: fiDuongDan(), title: fiTenTep }"></a>
                            </td>
                            </tbody>
                        </table>
                    </td>
                    <td class="text-center" style="width: 5%">
                        <a href="#" data-bind="click: $parent.doDelete, visible: $root.isEnableEdit"><i class="fa fa-lg fa-trash"></i></a>
                    </td>
                </tr>
                </tbody>
            </table>
    ...
    <div id="modal_addFile20A" class="modal container in modal-overflow" tabindex="-1"
    ...
    >
        ...
        <div class="modal-body">
            ...
            <label class="btn blue">
                <input id="btnfile20a" type="file" accept=".jpg, .jpeg, .pdf, .tif" style="display: none" data-bind="event: { change: fileChange}"/>
                <i class="fa fa-plus"></i> <spring:message code="mard.button.them_moi"/>
            </label>
        </div>
