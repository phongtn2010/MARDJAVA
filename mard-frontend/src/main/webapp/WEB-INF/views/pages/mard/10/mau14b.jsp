<%-- 
    Document   : mau14b
    Created on : Aug 7, 2017, 2:25:11 PM
    Author     : hieptran
--%>
...
<page size="A4" class="a4-padding">
    ...
    <table class="tb-content w100p">
        ...
        <tbody data-bind="template: { name: 'lstHanghoa14bTmpl', foreach: lstHanghoa14b }">
        </tbody>
        <script id="lstHanghoa14bTmpl" type="text/html">
            <tr>
    ...
    <p class="content">
        Các vật dụng khác có liên quan: <span data-bind=""></span>	
    </p>
    <p class="content">
    ...
    <p class="content">
        1. Số sản phẩm động vật trên phải được chuyển đến nơi cách ly kiểm dịch trước ngày <span data-bind="date : fiCachlyTn"></span>. để kiểm dịch tại địa điểm: <span data-bind="text : fiNoiCachly"></span>	
    </p>
    <p class="content">
