...
<script src="<c:url value='/app/mard/26/ResultVM.js?v=${version}'/>" type="text/javascript" charset="utf-8"></script>
<script src="<c:url value='/app/mard/26/ViewVM.js?v=${version}'/>" type="text/javascript" charset="utf-8"></script>
