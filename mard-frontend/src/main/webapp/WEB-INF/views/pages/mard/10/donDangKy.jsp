    ...
    <fieldset>
        ...
        <div class="form-group">
            <div class="col-md-12">
                ...
                <div class="col-md-2" data-bind="visible: showFiMaQgxk2">Quốc gia</div>
                <div class="col-md-2" data-bind="visible: showFiMaQgxk2">
                    <select style="width:100%;" class="form-control" id="fiMaQgxk2" name="fiMaQgxk2" data-bind="optionsCaption: 'Chọn...', optionsValue : 'id', value : fiMaQgxk2, options : fiMaQgxkList, optionsText : 'name', event : {change : fiMaQgxk2Change}"></select>
                </div>
                <div class="col-md-2" data-bind="visible: showFiMaQgxk2">Cửa khẩu</div>
                <div class="col-md-2">   
                    <select style="width:100%;"  class="form-control" id="fiMaCkxk" name="fiMaCkxk" data-bind="optionsCaption: 'Chọn...', optionsValue : 'id', selectedText : fiTenCkxk, value : fiMaCkxk, options : fiMaCkxkList, optionsText : 'name'"></select>
                </div>
                <div class="col-md-2" style="font-size:95%;">Nếu cửa khẩu không thuộc nước xuất khẩu: <a href="javascript:void(0);" data-bind="event :{click : showFiMaQgxk2Click}">Bấm vào đây để chọn lại</a></div>
            </div>  
        </div> 
        <div class="form-group">
            <div class="col-md-12">
