...
<div class="panel-heading" style="margin-left:-15px;margin-top:-15px;margin-right:-15px">
    <span class="caption-subject bold uppercase"><spring:message
                                                code="mard.16.form.thongTinThuoc"></spring:message> </span>
    <a
...
<div class="table-re" style="padding-top: 15px;">
    <table class="table table-striped table-bordered table-hover table-checkable order-column small-table">
        ...
        <th class="text-center" ><spring:message code="mard.16.TbdThuoc16.fiNameOfGoods"></spring:message></th>
        <th class="text-center" ><spring:message code="mard.16.TbdThuoc16.fiNameSicenceOfGoods"></spring:message></th>
         <th class="text-center" ><spring:message  code="mard.16.TbdThuoc16.fiType"></spring:message></th>
        <th class="text-center"  width="100px"><spring:message code="mard.16.TbdThuoc16.fiQuantity"></spring:message></th>
        <th class="text-center"><spring:message code="mard.16.TbdThuoc16.fiQuantityUnitName"></spring:message></th>
        <th class="text-center"  ><spring:message code="mard.16.TbdThuoc16.fiOrganization"></spring:message></th>
        <th class="text-center" ><spring:message code="mard.16.TbdThuoc16.fiGateOfImportationName"></spring:message></th>
        ...
        <tr>
            ...
            <td align="right" data-bind="text: item.fiQuantity()"></td>

            <td data-bind="text: item.fiQuantityUnitName()"></td>

            <td data-bind="text: item.fiExporterName()"></td>

            <td data-bind="text: item.fiGateOfImportation()"></td>
...
<c:if test="${isView == false}">
    <div class="col-md-12" style="padding-bottom: 15px;">
       <div class="row">
           <label class="col-md-3"><spring:message code="mard.16.nhapFileExcel"/></label>
           <div class="col-md-9">
               <input id="fileUploadExcel" type="file" class="form-group form-control" data-bind=" event:{ change: $root.uploadFileChangeEvent }">
               <a style="font-style: italic;" href="<c:url value="/mard/api/16/downloadTemplate/excel/thuoc" />" title="<spring:message code="mard.14.capNhatDuLieuTuFile"/>"><i class="fa fa-download" aria-hidden="true"></i>&nbsp;</span>&nbsp;<spring:message code="mard.14.capNhatDuLieuTuFile"/></a>
           </div>
       </div>
    </div>
</c:if>
