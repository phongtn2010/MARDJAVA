                ...
                <div class="portlet-title">
                    <div class="caption font-dark">
                        <i class="icon-settings font-dark"></i> <span
                            class="caption-subject bold uppercase"><spring:message code="mard.14.title"/></span>
                    </div>
                </div>
                ...
                <div class="portlet-body" id="table-search">
                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-heading">
                                            <span class="caption-subject bold uppercase"><spring:message
                                                    code="mard.14.form.lydoxinsua"></spring:message> </span>
                                        </div>
                                        <div class="panel-body">
                                            <div class="col-md-12">
                                                <div class="row form-group">
                                                    <label class="col-md-1"><spring:message
                                                            code="mard.14.form.lydoxinsua"/><span
                                                            class="nsw-require-field">*</span></label>
                                                    <div class="col-md-11">
                                                        <input id="fiReasonCorrection" class="form-control"
                                                               placeholder="<spring:message code="mard.14.form.lydoxinsua" />"
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="panel panel-default">
                                        <div class="panel-heading">
                                            <span class="caption-subject bold uppercase"><spring:message
                                                    code="mard.14.form.thongTinHoSo"></spring:message> </span>
                                        </div>
                                        <div class="panel-body">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="panel panel-default">
                                        <div class="panel-heading">
                                            <span class="caption-subject bold uppercase"><spring:message
                                                    code="mard.14.form.thongTinChung"></spring:message> </span>
                                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="panel panel-default" id="ChiTietThuocViewModel">
                                    ...
                                    <div class="panel-body">
                                        <jsp:include page="muc_dich_thuoc.jsp"></jsp:include>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <span class="caption-subject bold uppercase"><spring:message
                                                code="mard.14.form.thongTinDinhKem"></spring:message> </span>
                                    </div>
                    ...
                    <div class="row table-responsive" id="GhiHoSoViewModel">
                        <div class="col-md-12" align="center">
                            ...
                            <a href="<c:url value="/mard/14/home" />" class="btn green" id="btDong">
...
<script type="text/javascript" src="<c:url value="/app/mard/14/thongtinchung.module.js?v=${version}"/>"></script>
<script type="text/javascript" src="<c:url value="/app/mard/14/chitietthuoc.module.js?v=${version}"/>"></script>
<script type="text/javascript" src="<c:url value="/app/mard/14/tokhaithuoc.module.js?v=${version}"/>"></script>
<script type="text/javascript" src="<c:url value="/app/mard/14/tepdinhkem.module.js?v=${version}"/>"></script>
<script type="text/javascript" src="<c:url value="/app/mard/14/send.module.js?v=${ version }"/>"
        charset="utf-8"></script>
<script type="text/javascript" src="<c:url value="/app/mard/14/ghihoso.module.js?v=${version}"/>"></script>
