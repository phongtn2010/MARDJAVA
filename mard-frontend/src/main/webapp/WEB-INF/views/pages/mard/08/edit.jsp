                                        ...
                                        <div class="row">
                                            <div class="col-md-12" style="padding-top: 10px;">
                                                <div class="text-center">
                                                    ...
                                                    <button class="btn green" data-bind="visible: thongtinChungVM().fiHSStatus() == 0, click: $root.saveRegProfile">
...
<script type="text/javascript" src="<c:url value='/app/mard/08/edit.js?v=${version}'/>"></script>
