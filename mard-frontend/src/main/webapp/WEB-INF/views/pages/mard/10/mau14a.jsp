<%-- 
    Document   : mau14a
    Created on : Aug 7, 2017, 2:24:49 PM
    Author     : hieptran
--%>
...
<page size="A4" class="a4-padding">
    ...
    <p class="content">
        Chứng minh nhân dân số: <span data-bind="text : fiCmndCh"></span>. Cấp ngày <span data-bind="date: fiNgaycapCmnd"></span> tại <span data-bind="text : fiNoicapCmnd"></span>
    </p>
    <p class="content">
        Điên thoại: <span data-bind="text : fiDtCh"></span> Fax: <span data-bind="text : fiFaxCh"></span>. Email: <span data-bind="text : fiEmailCh"></span>
    </p>	
    <p class="content">
    ...
    <table class="tb-content w100p">
        ...
        <tbody data-bind="template: { name: 'lstHanghoa14aTmpl', foreach: lstHanghoa14a }">
        </tbody>
        <script id="lstHanghoa14aTmpl" type="text/html">
            <tr>
       	...
       	<tfoot>
            <tr>
                ...
                <td></td>
                <td></td>
                <td data-bind="text : fiTongSl"></td>
                <td></td>
            </tr>
        </tfoot>	
    </table>		
    <p class="content pt-10">
        Tổng số (viết bằng chữ): <span data-bind="text : fiNdTongso"></span>	
    </p>
    <p class="content">
    ...
    <p class="content">
        ...
        Nước xuất khẩu: <span data-bind="text : fiTenqgXk"></span>. Nước quá cảnh (nếu có) <span data-bind="text : fiTenqgQc"></span>
    </p>
    <p class="content">
        Cửa khẩu nhập vào Việt Nam: <span data-bind="text : fiTenckNc"></span>. Thời gian nhập: ngày <span data-bind="date : fiTgNk"></span>
    </p>
    <p class="content">	
        Các vật dụng khác có liên quan: <span data-bind="text : fiVdLq"></span> 	
    </p>
    <p class="content">
        Hồ sơ giấy tờ có liên quan: <span data-bind="text : fiHosoLq"></span> 	
    </p>
    <p class="content">
        Phương tiện vận chuyển: <span data-bind="text : fiPtVc"></span> Biển kiểm soát: <span data-bind="text : fiBienks"></span> 	
    </p>
    ...
    <p class="content">
        3. Phương tiện vận chuyển, các vật dụng khác có liên quan kèm theo bảo đảm yêu cầu vệ sinh thú y, đã được khử trùng tiêu độc bằng  <span data-bind="text : fiPptdkt"></span> nồng độ <span data-bind="text : fiNongdo"></span>
    </p>
    <p class="content t-bold t-center">
        YÊU CẦU KHI VẬN CHUYỂN
    </p>
    <p class="content">
        1. Số động vật trên phải được chuyển đến nơi cách ly kiểm dịch trước ngày <span data-bind="date : fiCachlyTn"></span> để nuôi cách ly kiểm dịch tại địa điểm: <span data-bind="text : fiNoicachly"></span> 
    </p>
    <p class="content">	
        2. Chỉ được vận chuyển theo lộ trình: <span data-bind="text : fiLtCachly"></span>  	
    </p>
    <p class="content">
    ...
    <table class="tb-content w100p">
        <tr>
            <td class="t-center w50p t-italic">Giấy có giá trị đến: <span data-bind="date : fiCachlyDn"></span> </td>
