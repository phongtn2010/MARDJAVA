                            ...
                            <div class="tabbable-custom ">
                                ...
                                <div class="tab-content">
                                    ...
                                    <p class="nsw-text-center" id="mard10CreateFn">
                                        ...
                                        <a data-bind="attr: { href: exportMauHref}, visible: exportMauVisible"  target="_blank" class="btn grey" id="btnTai"><i class="fa fa-download"></i> <span data-bind="text: mauBtnText"></span></a>
