                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default" id="pnl-import" style="display: ${hideImport}">
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-md-4">
                                        <p><a href="<c:url value='/templates/mard/bm_mard_11.xlsx'/>"><spring:message code="common.ban_khai_ho_so_mau" /></a></p>
                                    </div>
                                    <div class="col-md-8 ">
                        ...
                        <div class="panel">
                            <div class="tabbable-custom ">
                                <ul class="nav nav-tabs ">
                                    <li class="active">
                                        <a href="#tab_mard11_1" data-toggle="tab" id="a-tab-mard11-1"> <b>Đơn đăng ký </b></a>
                                    </li>
                                    <li>
                                        <a href="#tab_mard11_2" data-toggle="tab" id="a-tab-mard11-2"> <b>Tệp đính kèm</b></a>
                                    </li>
                                    <li  data-bind="visible: tabFiLydoSua">
                                        <a href="#tab_mard11_3" data-toggle="tab" id="a-tab-mard11-3"> <b>Đơn xin sửa hồ sơ</b></a>
                                    </li>
                                    <li  data-bind="visible: tabFiLydoHuy">
                                        <a href="#tab_mard11_4" data-toggle="tab"> <b>Đơn xin hủy hồ sơ</b></a>
                                    </li>
                                </ul>

                                <div class="tab-content" >
                                    <!-- ko with: mard11FormVM() -->
                                    <div class="tab-pane active" id="tab_mard11_1" >
                                        <%@include file="donDangKy.jsp" %>
                                    </div>
                                    <!-- /ko -->
                                    <!-- ko with: mard11FilesVM() -->
                                    <div class="tab-pane" id="tab_mard11_2">
                                        <%@include file="fileDinhKem.jsp" %>
                                    </div>
                                    <!-- /ko -->
                                    <div class="tab-pane" id="tab_mard11_3" data-bind="visible: tabFiLydoSua">
                                        <fieldset>
                                    ...
                                    <div class="tab-pane" id="tab_mard11_4" data-bind="visible: tabFiLydoHuy">
                                        <fieldset>
...
<script src="<c:url value='/app/mard/11/donDangKy.js?v=${version}' />" type="text/javascript" charset="utf-8"></script>
<script src="<c:url value='/app/mard/11/fileDinhKem.js?v=${version}' />" type="text/javascript" charset="utf-8"></script>
<script src="<c:url value='/app/mard/11/create.js?v=${version}' />" type="text/javascript" charset="utf-8"></script>