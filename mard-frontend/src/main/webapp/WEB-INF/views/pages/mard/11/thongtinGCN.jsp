                                        ...
                                        <fieldset>
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="col-md-4">
                                                        <select class="form-control" id="fiManuocSx" name="fiManuocSx" data-bind="optionsCaption: 'Chọn...', optionsValue : 'id', selectedText : fiTennuocSx, value : fiManuocSx, options : fiManuocSxList, optionsText : 'name'"></select>
                                                    </div>
                                                    <div class="col-md-2">
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="form-group" style="">
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="col-md-10">
                                                        <textarea class="form-control" id="" name=""  type="text" data-bind="value : fiKbBosung" maxlength="2000"></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </fieldset>
