...
<form role="form" class="form-horizontal" id="mard10Form">
    ...
    <fieldset>
        ...
        <div class="form-group">
            <div class="col-md-12">
                ...
                <div class="col-md-2 nsw-text-right">
                    <label>Mã sản phẩm <a class="nsw-require-field">(*)</a></label>
                </div>
                <div class="col-md-4">                                        
                    <input class="form-control" id="fiMasp" name="fiMasp" data-bind="value : fiMasp" maxlength="12"></input>
                </div>
            </div>  
        </div> 
        <div class="form-group">
    ...
    <fieldset>
        ...
        <div class="form-group">
            <div class="col-md-12">
                <div class="col-md-2 nsw-text-right">
                    <label>Mục đích sử dụng <a class="nsw-require-field">(*)</a> </label>
                </div>
                <div class="col-md-10">                                        
