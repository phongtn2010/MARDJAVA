...
<fieldset>
    ...
    <div class="form-group">
        <div class="col-md-12">
            ...
            <div class="col-md-4">
                <input class="form-control date-picker" placeholder="dd/mm/yyy" id="fiNgaycap" name="fiNgaycap" data-bind="datepicker : fiNgaycap" type="text" data-date-format="dd/mm/yyyy"/>
            </div>
        </div>  
    </div>    
</fieldset>
