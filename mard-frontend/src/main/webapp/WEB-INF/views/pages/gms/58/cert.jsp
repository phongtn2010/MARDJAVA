                            ...
                            <script id="itemTmpl" type="text/html">
                                <tr>
                                    <td class="text-center" style="padding: 8px">
                                        <input class="form-control" readonly name="fiOrder" data-bind="value : fiOrder"></input>
                                    </td>
                                    <td>
                                        <input class="form-control" readonly name="fiVehicleType" data-bind="value : fiVehicleType"></input>
                                    </td>
                                    <td>
                                        <input class="form-control" readonly name="fiAllocatedNo" data-bind="value : fiAllocatedNo"></input>
                                    </td>
                                </tr>
                                </script>
                            </table>
