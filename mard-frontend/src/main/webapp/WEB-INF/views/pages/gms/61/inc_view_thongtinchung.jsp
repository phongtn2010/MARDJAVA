...
<fieldset>
    ...
    <div class="form-group">
        <div class="col-md-12">
            ...
            <div class="col-md-4">
                <input class="form-control date-picker" placeholder="dd/mm/yyy" id="fiNgaytao" name="fiNgaytao"  data-bind="datepicker : fiNgaytao" type="text" data-date-format="dd/mm/yyyy" readonly/>
            </div>
            <div class="col-md-2 nsw-text-right">
    ...
    <div class="form-group">
        <div class="col-md-12">
            ...
            <div class="col-md-10">
                <input class="form-control" readonly id="fiFaxDn" name="fiFaxDn" data-bind="value : fiFaxDn" type="text" maxlength="50"/>
            </div>                
        </div>  
    </div>
    <div class="form-group">
        <div class="col-md-12">
            ...
            <div class="col-md-4">
                <input class="form-control" readonly id="fiSoGp" name="fiSoGp" data-bind="value : fiSoGp" type="text" maxlength="250"/>
            </div>
            ...
            <div class="col-md-4">
                <input class="form-control date-picker" placeholder="dd/mm/yyy" disabled id="fiNgaycap" name="fiNgaycap" data-bind="datepicker : fiNgaycap" type="text" data-date-format="dd/mm/yyyy"/>
            </div>
        </div>  
    </div>    
</fieldset>
