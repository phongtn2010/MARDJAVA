...
<fieldset>
    ...
    <div class="form-group">
        <div class="col-md-12">
            ...
            <div class="col-md-4">
                <select class="form-control select2 fiLoaihinhDn" id="fiLoaihinhDn" name="fiLoaihinhDn" data-bind="optionsCaption: 'Chọn...', optionsValue : 'id', value : fiLoaihinhDn, options : lstloaihinhDn, optionsText : 'name'"></select>
            </div>
        </div>  
    </div> 
    <div class="form-group">
    ...
    <div data-bind="visible: tuyencodinh">
        ...
        <div class="form-group">
            <div class="col-md-12">
                ...
                <div class="col-md-4">
                    <input class="form-control date-picker" placeholder="dd/mm/yyy" id="fiNgaycapCv" name="fiNgaycapCv"  data-bind="datepicker : fiNgaycapCv" type="text" data-date-format="dd/mm/yyyy" />
                </div> 
            </div>  
        </div>  
    </div>  
