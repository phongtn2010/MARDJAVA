...
<fieldset>
    ...
    <div class="form-group">
        <div class="col-md-12">
            ...
            <div class="col-md-4">
                <input class="form-control date-picker" placeholder="dd/mm/yyy" disabled id="fiNgaycapCv" name="fiNgaycapCv"  data-bind="datepicker : fiNgaycapCv" type="text" data-date-format="dd/mm/yyyy" />
            </div> 
        </div>  
    </div>  
</fieldset>
