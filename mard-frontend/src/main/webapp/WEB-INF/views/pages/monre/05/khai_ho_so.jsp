...
<script type="text/javascript" src="<c:url value="/app/monre/05/CAPlugin.js"/>"></script>
<script type="text/javascript" src="<c:url value="/app/monre/05/vt-connector.js"/>"></script>
