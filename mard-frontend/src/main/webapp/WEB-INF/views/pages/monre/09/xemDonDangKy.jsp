...
<form role="form" class="form-horizontal" id="monre09Form">
    <fieldset>
        ...
        <div class="form-group">
            <div class="col-md-12">
                <div class="col-md-2">
                    <label><spring:message code="monre.09.danhsach.mahoso" /></label>
                </div>
                <div class="col-md-4">
                ...
                <div class="col-md-2">
                    <label><spring:message code="monre.09.danhsach.trangthai" /></label>
                </div>
                <div class="col-md-4">
        ...
        <div class="form-group">
            <div class="col-md-12">
                <div class="col-md-2">
                    <label><spring:message code="monre.09.hoso.ngaytao" /></label>
                </div>
                <div class="col-md-4">
                ...
                <div class="col-md-2">
                    <label><spring:message code="monre.09.hoso.donvixuly" /> <a class="nsw-require-field">*</a></label>
                </div>
                <div class="col-md-4">                                        
    ...
    <fieldset>
        <legend><spring:message code="monre.09.hoso.thongtingxn" /></legend>
        <div class="form-group">
            <div class="col-md-12">
                <div class="col-md-2">
                    <label><spring:message code="monre.09.hoso.thongtingxn.sogxn" /> <a class="nsw-require-field">*</a></label>
                </div>
                <div class="col-md-4">
                ...
                <div class="col-md-2">
                    <spring:message code="monre.09.hoso.thongtingxn.ngaycap" />
                </div>
                <div class="col-md-4">
        ...
        <div class="form-group">
            <div class="col-md-12">
                <div class="col-md-2">
                    <spring:message code="monre.09.hoso.thongtingxn.coquancap" />
                </div>
                <div class="col-md-4">
    ...
    <fieldset>
        <legend>
            <spring:message code="monre.09.hoso.thongtincssx" />
        </legend>
                ...
                <table class="table table-striped table-bordered table-hover table-checkable order-column">
                    <thead>
                        <tr class="nsw-tr tr-nsw1-bgcolor">
                            <th class="text-center" style="width: 50px;"><spring:message code="monre.09.hoso.thongtincssx.tt" /></th>
                            <th class="text-center"><spring:message code="monre.09.hoso.thongtincssx.tencssx" /></th>
                            <th class="text-center"><spring:message code="monre.09.hoso.thongtincssx.diachi" /></th>
                            <th class="text-center" style="width: 150px;"><spring:message code="monre.09.hoso.thongtincssx.chucnang" /></th>
                        </tr>
                    </thead>
    ...
    <fieldset>
        <legend><spring:message code="monre.09.hoso.thongtinphelieu" /></legend>
        <div class="form-group">
            <div class="col-md-12">
                <table class="table table-striped table-bordered table-hover table-checkable order-column">
                    <thead>
                        <tr class="nsw-tr tr-nsw1-bgcolor">
                            <th class="text-center" style="width: 50px;"><spring:message code="monre.09.hoso.thongtinphelieu.tt" /></th>
                            <th class="text-center"><spring:message code="monre.09.hoso.thongtinphelieu.tenphelieu" /></th>
                            <th class="text-center" style="width: 210px;"><spring:message code="monre.09.hoso.thongtinphelieu.mahs" /></th>
                            <th class="text-center" style="width: 180px;"><spring:message code="monre.09.hoso.thongtinphelieu.khoiluog" /></th>
                        </tr>
                    </thead>
...
<template id="cssx-tmpl">
    <form role="form" class="form-horizontal" id="cssx-form">
        <div class="form-group">
            <div class="col-md-12">
                <div class="col-md-2">
                    <label><spring:message code="monre.09.hoso.cssx.ten" /> <a class="nsw-require-field">*</a></label>
                </div>
                <div class="col-md-10">
        ...
        <div class="form-group">
            <div class="col-md-12">
                <div class="col-md-2">
                    <label><spring:message code="monre.09.hoso.cssx.diachits" /> <a class="nsw-require-field">*</a></label>
                </div>
                <div class="col-md-10">
        ...
        <div class="form-group">
            <div class="col-md-12">
                <div class="col-md-2">
                    <label><spring:message code="monre.09.hoso.cssx.dienthoai" /><a class="nsw-require-field">*</a></label>
                </div>
                <div class="col-md-4">
                    <input class="form-control" type="text" id="fiSdtCssx" name="fiSdtCssx" readonly="readonly" data-bind="value : fiSdtCssx" maxlength="50" />
                </div>
                <div class="col-md-2">
                    <label><spring:message code="monre.09.hoso.cssx.fax" /></label>
                </div>
                <div class="col-md-4">                                        
        ...
        <div class="form-group">
            <div class="col-md-12">
                <div class="col-md-2">
                    <label><spring:message code="monre.09.hoso.cssx.email" /></label>
                </div>
                <div class="col-md-4">
                    <input class="form-control" id="fiEmailCssx" name="fiEmailCssx" readonly="readonly" data-bind="value : fiEmailCssx" type="text" />
                </div>
                <div class="col-md-2">
                    <label><spring:message code="monre.09.hoso.cssx.tinh" /> <a class="nsw-require-field">*</a></label>
                </div>
                <div class="col-md-4">                                       
        ...
        <div class="form-group">
            <div class="col-md-12">
                <div class="col-md-2">
                    <label><spring:message code="monre.09.hoso.cssx.huyen" /><a class="nsw-require-field">*</a></label>
                </div>
                <div class="col-md-4">
                    <input class="form-control" id="fiTenHuyen" name="fiTenHuyen" readonly="readonly" data-bind="value : fiTenHuyen" type="text" />
                </div>
                <div class="col-md-2">
                    <label><spring:message code="monre.09.hoso.cssx.xa" /> <a class="nsw-require-field">*</a></label>
                </div>
                <div class="col-md-4">                                        
