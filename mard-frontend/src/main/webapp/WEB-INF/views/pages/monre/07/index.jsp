...
<div class="row" id="monre07">
    <div class="col-md-12">
        <div class="portlet light ">
            <div class="portlet-title">
                <div class="caption font-dark">
                    <i class="icon-settings font-dark"></i>
                    <span class="caption-subject bold uppercase"><span class="caption-subject bold uppercase"> <spring:message code="monre.07.tenthutuc" /></span>
            ...
            <div class="portlet-body">
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <span class="caption-subject bold uppercase"><i class="fa fa-gift"></i> <spring:message code="monre.07.tracuu.timkiem" /> </span>
                                </div>
                                <div class="panel-body">
                                    <form role="form" class="form-horizontal" name="searchForm07" id="searchForm07">
                                        <div class="form-group" style="margin-top: 15px;">
                                            <div class="col-md-12">
                                                <div class="col-md-2">
                                                    <label><spring:message code="monre.07.tracuu.mahoso" /></label>
                                                </div>
                                                <div class="col-md-4">
                                                ...
                                                <div class="col-md-2">
                                                    <label><spring:message code="monre.07.tracuu.trangthaihoso" /></label>
                                                </div>
                                                <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                <div class="col-md-2">
                                                    <label><spring:message code="monre.07.tracuu.ngaynoptu" /></label>
                                                </div>
                                                <div class="col-md-4">   
                                                    <input placeholder="<spring:message code="monre.07.tracuu.ngaynoptu" />" name="ngayTaoTuNgay" id="ngayTaoTuNgay" data-bind="datepicker : ngayTaoTuNgay" class="form-control form-control-inline date-picker" data-date-format="dd/mm/yyyy"  type="text" value="" maxlength="10" />
                                                </div>

                                                <div class="col-md-2">
                                                    <label><spring:message code="monre.07.tracuu.ngaynopden" /></label>
                                                </div>
                                                <div class="col-md-4">
                                                    <input placeholder="<spring:message code="monre.07.tracuu.ngaynopden" />" name="ngayTaoDenNgay" id="ngayTaoDenNgay" data-bind="datepicker : ngayTaoDenNgay" class="form-control form-control-inline date-picker" data-date-format="dd/mm/yyyy" size="16" type="text" value="" maxlength="10" />
                                                </div>
                                            </div>  
                                        </div>
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                <div class="col-md-2">
                                                    <label><spring:message code="monre.07.tracuu.ngaycappheptu" /></label>
                                                </div>
                                                <div class="col-md-4">   
                                                    <input placeholder="<spring:message code="monre.07.tracuu.ngaycappheptu" />" name="ngayCapTuNgay" id="ngayCapTuNgay" data-bind="datepicker : ngayCapTuNgay" class="form-control form-control-inline date-picker" data-date-format="dd/mm/yyyy"  type="text" value="" maxlength="10" />
                                                </div>

                                                <div class="col-md-2">
                                                    <label><spring:message code="monre.07.tracuu.ngaycapphepden" /></label>
                                                </div>
                                                <div class="col-md-4">
                                                    <input placeholder="<spring:message code="monre.07.tracuu.ngaycapphepden" />" name="ngayCapDenNgay" id="ngayCapDenNgay" data-bind="datepicker : ngayCapDenNgay" class="form-control form-control-inline date-picker" data-date-format="dd/mm/yyyy" size="16" type="text" value="" maxlength="10" />
                                                </div>
                                            </div>  
                                        </div>
                ...
                <table class="table table-striped table-bordered table-hover table-checkable order-column" id="monre07Items">
                    <thead>
                        <tr class="nsw-tr tr-nsw1-bgcolor">
                            <th class="text-center"> <spring:message code="monre.07.danhsach.stt" /></th>
                            <th class="text-center" style="width: 100px;"> <spring:message code="monre.07.danhsach.lichsuxuly" /> </th>
                            <th class="text-center" style="width: 120px;"> <spring:message code="monre.07.danhsach.mahoso" /> </th>
                            <th class="text-center" style="max-width: 200px;"> <spring:message code="monre.07.danhsach.tendoanhnghiep" /> </th>
                            <th class="text-center" style="width: 100px;"> <spring:message code="monre.07.danhsach.ngaygui" /> </th>
                            <th class="text-center" style="width: 100px;"> <spring:message code="monre.07.danhsach.ngaycapphep" /> </th>
                            <th class="text-center"> <spring:message code="monre.07.danhsach.trangthai" /> </th>
                            <th class="text-center" style="width: 100px;"> <spring:message code="monre.07.danhsach.xemthongbao" /> </th>
                            <th class="text-center" style="width: 25px;"> <spring:message code="monre.07.danhsach.xinrut" /> </th>
                            <th class="text-center" style="width: 25px;"> <spring:message code="monre.07.danhsach.sua" /> </th>
                            <th class="text-center" style="width: 25px;"> <spring:message code="monre.07.danhsach.xoa" /> </th>
                        </tr>
                    </thead>
                    <tbody id="list-container" data-bind="template: { name: 'itemTmpl', foreach: monre07Items }">
                    </tbody>
                    <script id="itemTmpl" type="text/html">
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="javascript:void(0)"><i class="fa fa-lg fa-close tooltips" data-original-title="Xoá hồ sơ" data-bind="visible: bXoaHoSo, click: $parent.bXoaClick.bind($parent)" src="" alt=""/></a>
                            </td>  
                        </tr>                      
                        </script>
                    </table>
...
<script src="<c:url value='/app/monre/07/model.js?v=${version}'/>" type="text/javascript"></script>
<script src="<c:url value='/app/monre/07/index.js?v=${version}' />" type="text/javascript"></script>
...
<template id="history-tmpl">
    <form role="form" class="form-horizontal" id="history-form">
        ...
        <table class="table table-striped table-bordered table-hover table-checkable order-column">
            <thead>
                <tr>
                    <th class="text-center"><b><spring:message code="monre.07.lichsu.stt" /></b></th>
                    <th><b><spring:message code="monre.07.lichsu.nguoixuly" /></b></th>
                    <th><b><spring:message code="monre.07.lichsu.donvixuly" /></b></th>
                    <th style="max-width: 200px;"><b><spring:message code="monre.07.lichsu.noidung" /></b></th>
                    <th style="max-width: 200px;"><b><spring:message code="monre.07.lichsu.link" /></b></th>
                    <th class="text-center"><b><spring:message code="monre.07.lichsu.thoigian" /></b></th>
                    <th style="max-width: 200px;"><b><spring:message code="monre.07.lichsu.trangthaihoso" /></b></th>
                </tr>
            </thead>
    ...
    <form role="form" class="form-horizontal" id="kqxl-form">
        <div class="form-group">
            ...
            <div class="col-md-12">
                ...
                <div class="col-md-8">  
                    <textarea name="fiNoidungYc" id="fiNoidungYc" disabled="true" data-bind="value: fiNoidungYc" style="width: 90%; height: 150px;" maxlength="500"></textarea>
                </div>
            </div> 
            <div class="col-md-12">
                <div class="col-md-4">
                ...
                <div class="col-md-8">  
                    <textarea name="fiNoidungPh" id="fiNoidungPh" disabled="true" data-bind="value: fiNoidungPh" style="width: 90%; height: 150px;" maxlength="500"></textarea>
                </div>
            </div> 
            <div class="col-md-12">
                <div class="col-md-4">
