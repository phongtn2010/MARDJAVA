			...
			<div class="row">
				<div class="form-group row">
					...
					<div class="col-sm-8">
						<table width="100%">
							<tr>
								<td width="90%"><input  autocomplete="off" id="soGXNDaCap" class="form-control" data-bind="value: giayXacNhanModel.soGXNDaCap, enable: !$root.xemHoSo()" /></td>
		...
		<div class="col-md-6">
			<div class="row">
				<div class="form-group row">
					...
					<div class="col-sm-8">
						<input id="ngayCap"  data-date-format="dd/mm/yyyy" autocomplete="off" class="form-control date-picker" data-bind="value: giayXacNhanModel.ngayCap" />
					</div>
				</div>
			</div>
		</div>
		<div class="col-md-6">
			<div class="row">
				<div class="form-group row">
					...
					<div class="col-sm-8">
						<input id="ngayHetHan"  data-date-format="dd/mm/yyyy" autocomplete="off" class="form-control date-picker" data-bind="value: giayXacNhanModel.ngayHetHan" />
					</div>
				</div>
			</div>
		</div>
