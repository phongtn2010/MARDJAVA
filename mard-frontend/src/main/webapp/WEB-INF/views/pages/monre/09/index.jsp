                                    ...
                                    <form role="form" class="form-horizontal" name="searchForm09" id="searchForm09">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                ...
                                                <div class="col-md-4">   
                                                    <input placeholder="<spring:message code="monre.09.tracuu.ngaynoptu" />" name="ngayTaoTuNgay" id="ngayTaoTuNgay" data-bind="datepicker : ngayTaoTuNgay" class="form-control form-control-inline date-picker" data-date-format="dd/mm/yyyy"  type="text" value="" maxlength="10" />
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    <input placeholder="<spring:message code="monre.09.tracuu.ngaynopden" />" name="ngayTaoDenNgay" id="ngayTaoDenNgay" data-bind="datepicker : ngayTaoDenNgay" class="form-control form-control-inline date-picker" data-date-format="dd/mm/yyyy" size="16" type="text" value="" maxlength="10" />
                                                </div>
                                            </div>  
                                        </div>
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                ...
                                                <div class="col-md-4">   
                                                    <input placeholder="<spring:message code="monre.09.tracuu.ngaycappheptu" />" name="ngayCapTuNgay" id="ngayCapTuNgay" data-bind="datepicker : ngayCapTuNgay" class="form-control form-control-inline date-picker" data-date-format="dd/mm/yyyy"  type="text" value="" maxlength="10" />
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    <input placeholder="<spring:message code="monre.09.tracuu.ngaycapphepden" />" name="ngayCapDenNgay" id="ngayCapDenNgay" data-bind="datepicker : ngayCapDenNgay" class="form-control form-control-inline date-picker" data-date-format="dd/mm/yyyy" size="16" type="text" value="" maxlength="10" />
                                                </div>
                                            </div>  
                                        </div>
                ...
                <table class="table table-striped table-bordered table-hover table-checkable order-column" id="monre09Items">
                    <thead>
                        <tr class="nsw-tr tr-nsw1-bgcolor">
                            ...
                            <th class="text-center" style="width: 25px;"> <spring:message code="monre.09.danhsach.xinrut" /> </th>
                            <th class="text-center" style="width: 25px;"> <spring:message code="monre.09.danhsach.sua" /> </th>
                            <th class="text-center" style="width: 25px;"> <spring:message code="monre.09.danhsach.xoa" /> </th>
                        </tr>
                    </thead>
