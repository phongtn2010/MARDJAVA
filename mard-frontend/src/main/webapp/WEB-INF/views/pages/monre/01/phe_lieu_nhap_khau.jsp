...
<div class="table-responsive">
	<table class="table table-striped table-bordered table-hover table-checkable order-column" id="pheLieuNhapKhau">
		<thead class="nsw-tr tr-nsw1-bgcolor">
			...
			<th class="text-center"><spring:message code="monre.01.label.thong-tin-phe-lieu-nhap-khau.khoiLuong6"></spring:message><span class="nsw-require-field">(*)</span></th>
				...
				<td>
					<div class="pl-td-chuc-nang">
						<c:if test="<%=form != null && !form.isXemHoSo()%>">
							...
							<span data-bind="if:  !item.enable() && $root.dsPheLieu().length - 1 != $index()"> <a class="btn green bt-center" title="<spring:message code="monre_01_button_title_update" />" data-bind="click: $root.capNhatDongPheLieuNhapClick" id="btCapNhatDongPheLieu"> <i class="fa fa-pencil-square-o" aria-hidden="true"></i>&nbsp; <spring:message code="monre_01_button_title_update" />
							</a>
							</span>
							<span data-bind="if:  !item.enable() && $root.dsPheLieu().length - 1 != $index()"> <a class="btn red bt-center" title="<spring:message code="monre_01_button_title_delete" />" data-bind="click: $root.xoaDongPheLieuNhapClick" id="btXoaDongPheLieu"> <i class="fa fa-trash-o" aria-hidden="true"></i>&nbsp; <spring:message code="monre_01_button_title_delete" />
							</a>
							</span>
