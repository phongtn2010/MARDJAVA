		...
		<div class="col-md-12">
			...
			<div class="col-md-4">
				<input class="form-control" name="maHoSo" id="maHoSo"
					...
					data-bind="value: searchForm.maHoSo"
					type="text">
			</div>
			<div class="col-md-2">
			...
			<div class="col-md-4">
				<select id="trangThaiHoSo" name="trangThaiHoSo"
					class="form-control select2" data-bind="options: $root.danhSachTrangThai,
		...
		<div class="col-md-12">
			...
			<div class="col-md-4">
				<input name="ngayTaoTuNgay" id="ngayTaoTuNgay"
					...
					data-date-format="dd/mm/yyyy" size="16" type="text" data-bind="value: searchForm.ngayTaoTuNgay" />
			</div>
			...
			<div class="col-md-4">
				<input name="ngayTaoDenNgay" id="ngayTaoDenNgay"
					...
					class="form-control form-control-inline input-medium date-picker"
					data-date-format="dd/mm/yyyy" size="16" type="text" data-bind="value: searchForm.ngayTaoDenNgay" />
			</div>
		</div>
	</div>
	<div class="form-group">
		<div class="col-md-12">
			...
			<div class="col-md-4">
				<input name="ngayGuiTuNgay" id="ngayGuiTuNgay"
					field="common_tracuu_ngay_gui_tu"
					class="form-control form-control-inline input-medium date-picker"
					data-date-format="dd/mm/yyyy" size="16" type="text" data-bind="value: searchForm.ngayGuiTuNgay" />
			</div>
			...
			<div class="col-md-4">
				<input name="ngayGuiDenNgay" id="ngayGuiDenNgay"
					field="common_tracuu_ngay_gui_den"
					class="form-control form-control-inline input-medium date-picker"
					data-date-format="dd/mm/yyyy" size="16" type="text"  data-bind="value: searchForm.ngayGuiDenNgay" />
			</div>
		</div>
	</div>
	<div class="form-group nsw-text-center">
		<a href="javascript:;" class="btn green" id="searchHoSo" data-bind="click: $root.searchHoSo"><i
			class="fa fa-search"></i> <spring:message
				code="common.button.tim_kiem" /></a> <a href="javascript:;" data-bind="click: $root.themMoiHoSo"
			class="btn green" id="btnAddNew"><i class="fa fa-edit"></i> <spring:message
