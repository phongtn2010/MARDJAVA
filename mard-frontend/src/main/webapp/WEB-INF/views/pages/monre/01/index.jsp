        ...
        <div class="portlet light ">
            <div class="portlet-title">
                <div class="caption font-dark">
                    ...
                    <span class="caption-subject bold uppercase">${ tenThuTuc }</span>
                </div>
            </div>
                    ...
                    <thead>
                        <tr class="nsw-tr tr-nsw1-bgcolor">
                           <th class="text-center"><spring:message code="monre.01.label.index.tt01.stt"></spring:message> </th>
							...
							<th class="text-center"><spring:message code="monre.01.label.index.tt01.tb-phi"></spring:message></th>
                    ...
                    <tbody id="list-container" data-bind="foreach: { data: $root.danhSachHoSo, as: 'item'}">
						<tr >
							...
							<td class="text-center" >
								<a href="javascript:;" data-bind="attr: { 'title': item.maHoSo }, click: $root.xemKetQuaXuLy">
							...
							<td class="text-center" data-bind="if: (item.showButtonXemGXN())">
								<a href="javascript:;" data-bind="attr: { 'title': item.maHoSo }, click: $root.xemGiayXacNhanClick">
									<i class="fa fa-lg fa-search tooltips" ></i>
								</a>
							</td>
							
							<td class="text-center" data-bind="if: (item.showButtonTBPhi())">
								<a href="javascript:;" data-bind="attr: { 'title': item.maHoSo }, click: $root.thongBaoPhi">
									<i class="fa fa-lg fa-search tooltips" ></i>
								</a>
							 </td>
							
							<td class="text-center" data-bind="if: (item.showButtonXinRut())">
								<a href="javascript:;" data-bind="attr: { 'title': item.maHoSo }, click: $root.xinRut">
...
<!--							<td class="text-center" data-bind="if: (item.showButtonEdit()) "><a href="javascript:;" data-bind="click: $root.send" > <i class="fa fa-paper-plane request-cancel tooltips"></i>
							...
							<td class="text-center" data-bind="if: (item.showButtonEdit()) ">
							 	<a href="javascript:;" data-bind="attr: { 'title': item.maHoSo }, click: $root.chinhSuaHoSo">
							 		<i class="fa fa-lg fa-edit" aria-hidden="true"></i>
							 	</a>
							</td>
							
							<td class="text-center" data-bind="if: (item.showButtonDelete())">
								<a href="javascript:;" data-bind="attr: { 'title': item.maHoSo }, click: $root.xoaHoSo">
                    ...
                    <tbody id="loading_c4e6a343-dd41-b5c5-1ef9-75eeebba032d">
                    	<tr><td style="height: 50px; position: relative; zoom: 1;" colspan="15" id="td_c4e6a343-dd41-b5c5-1ef9-75eeebba032d"><div class="blockUI" style="display:none"></div><div class="blockUI blockOverlay" style="z-index: 1000; border: none; margin: 0px; padding: 0px; width: 100%; height: 100%; top: 0px; left: 0px; background-color: rgb(85, 85, 85); opacity: 0.1; cursor: wait; position: absolute;"></div><div class="blockUI blockMsg blockElement" style="z-index: 1011; position: absolute; padding: 0px; margin: 0px; width: 30%; top: 4px; left: 528.5px; text-align: center; color: rgb(0, 0, 0); border: 0px; cursor: wait;"><div class="loading-message "><img src="<c:url value="/static/assets/global/img/loading-spinner-grey.gif" />" align=""><span>&nbsp;&nbsp;LOADING...</span></div></div></td></tr>
                    </tbody>
                </table>
                            <!-- pagination -->
               <div class="row">
...
<script type="text/javascript" src="<c:url value="/app/monre/01/index.module.js?v=${ version }"/>" charset="utf-8"></script> 
