...
<div class="row" id="monre08">
    <div class="col-md-12">
        <div class="portlet light ">
            <div class="portlet-title">
                <div class="caption font-dark">
                    <i class="icon-settings font-dark"></i>
                    <span class="caption-subject bold uppercase"><span class="caption-subject bold uppercase"> <spring:message code="monre.08.tenthutuc" /></span>
            ...
            <div class="portlet-body">
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <span class="caption-subject bold uppercase"><i class="fa fa-gift"></i> <spring:message code="monre.08.tracuu.timkiem" /> </span>
                                </div>
                                <div class="panel-body">
                                    <form role="form" class="form-horizontal" name="searchForm08" id="searchForm08">
                                        <div class="form-group" style="margin-top: 15px;">
                                            <div class="col-md-12">
                                                <div class="col-md-2" style="text-align: right">
                                                    <label><spring:message code="monre.08.tracuu.mahoso" /></label>
                                                </div>
                                                <div class="col-md-4">
                                                ...
                                                <div class="col-md-2" style="text-align: right">
                                                    <label><spring:message code="monre.08.tracuu.trangthaihoso" /></label>
                                                </div>
                                                <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                <div class="col-md-2" style="text-align: right">
                                                    <label><spring:message code="monre.08.tracuu.ngaynoptu" /></label>
                                                </div>
                                                <div class="col-md-4">   
                                                ...
                                                <div class="col-md-2" style="text-align: right">
                                                    <label ><spring:message code="monre.08.tracuu.ngaynopden" /></label>
                                                </div>
                                                <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                <div class="col-md-2" style="text-align: right">
                                                    <label><spring:message code="monre.08.tracuu.ngaycappheptu" /></label>
                                                </div>
                                                <div class="col-md-4">   
                                                ...
                                                <div class="col-md-2" style="text-align: right">
                                                    <label><spring:message code="monre.08.tracuu.ngaycapphepden" /></label>
                                                </div>
                                                <div class="col-md-4">
                ...
                <table class="table table-striped table-bordered table-hover table-checkable order-column" id="monre08Items">
                    <thead>
                       <tr class="nsw-tr tr-nsw1-bgcolor">
                            <th class="text-center"> <spring:message code="monre.08.danhsach.stt" /></th>
                            <th class="text-center" style="width: 100px;"> <spring:message code="monre.08.danhsach.lichsuxuly" /> </th>
                            <th class="text-center" style="width: 120px;"> <spring:message code="monre.08.danhsach.mahoso" /> </th>
                            <th class="text-center" style="max-width: 200px;"> <spring:message code="monre.08.danhsach.tendoanhnghiep" /> </th>
                            <th class="text-center" style="width: 100px;"> <spring:message code="monre.08.danhsach.ngaygui" /> </th>
                            <th class="text-center" style="width: 100px;"> <spring:message code="monre.08.danhsach.ngaycapphep" /> </th>
                            <th class="text-center"> <spring:message code="monre.08.danhsach.trangthai" /> </th>
                            <th class="text-center" style="width: 100px;"> <spring:message code="monre.08.danhsach.xemthongbao" /> </th>
                            <th class="text-center" style="width: 25px;"> <spring:message code="monre.08.danhsach.xinrut" /> </th>
                            <th class="text-center" style="width: 25px;"> <spring:message code="monre.08.danhsach.sua" /> </th>
                            <th class="text-center" style="width: 25px;"> <spring:message code="monre.08.danhsach.xoa" /> </th>
                        </tr>
                    </thead>
                    <tbody id="list-container" data-bind="template: { name: 'itemTmpl', foreach: monre08Items }">
                    </tbody>
...
<script src="<c:url value='/app/monre/08/model.js?v=${version}'/>" type="text/javascript"></script>
<script src="<c:url value='/app/monre/08/index.js?v=${version}' />" type="text/javascript"></script>
...
<template id="history-tmpl">
    <form role="form" class="form-horizontal" id="history-form" style="max-height: 60vh !important;overflow-y: auto;overflow-x: hidden;">
        ...
        <table class="table table-striped table-bordered table-hover table-checkable order-column">
            <thead>
                <tr>
                    <th class="text-center"><b><spring:message code="monre.08.lichsu.stt" /></b></th>
                    <th class="text-center"><b><spring:message code="monre.08.lichsu.nguoixuly" /></b></th>
                    <th class="text-center"><b><spring:message code="monre.08.lichsu.donvixuly" /></b></th>
                    <th class="text-center" style="max-width: 200px;"><b><spring:message code="monre.08.lichsu.noidung" /></b></th>
                    <th class="text-center" style="max-width: 200px;"><b><spring:message code="monre.08.lichsu.link" /></b></th>
                    <th class="text-center"><b><spring:message code="monre.08.lichsu.thoigian" /></b></th>
                    <th class="text-center" style="max-width: 200px;"><b><spring:message code="monre.08.lichsu.trangthaihoso" /></b></th>
                </tr>
            </thead>
