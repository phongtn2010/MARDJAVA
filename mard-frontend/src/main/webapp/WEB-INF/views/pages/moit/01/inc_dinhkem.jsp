...
<fieldset>
    <legend><b><spring:message code="moit.01.hoso.dinhkem" /></b></legend>
        ...
        <div class="col-md-12">
            <table class="table table-striped table-bordered table-hover table-checkable order-column">
                ...
                <script id="dinhKemTmpl" type="text/html">
                    <tr>
                        <td style="width: 1%;" data-bind="text: $index() + 1">
                        </td>  
                        <td>
                    ...
                    <span id="msg-file-valid" data-bind="text : errorDinhKemMessage" style="color:red;"> </span><br>
                <span class="validationMessage" style="display: none" id="attract-size-lbl">Tổng dung lượng quá 3MB</span>
