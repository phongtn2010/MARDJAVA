				...
				<div class="portlet-body" id="table-search">
					...
					<div class="row table-responsive" id="GhiHoSoViewModel">
						<div class="col-md-12" align="center">
							...
							<button type="button" class="btn green" data-bind="click: $root.ghiLai" id="btghiLai">
								<i class="fa fa-floppy-o" aria-hidden="true"></i>&nbsp;
								<spring:message code="moit.06.form.06" />
							</button>
							<button type="button" class="btn green" id="btGuiHoSo" data-bind="click: guiHoSo">
								<i class="fa fa-paper-plane" aria-hidden="true"></i>&nbsp;
								<spring:message code="moit.06.form.07" />
							</button>
							</span>
							<a href="<c:url value="/moit/06/home" />" class="btn green" id="btDong"> <i class="fa fa-arrow-left" aria-hidden="true"></i></i>&nbsp; <spring:message code="moit.06.form.08" />
							</a>
						</div>
					</div>
				</div>
...
<script type="text/javascript" src="<c:url value="/app/moit/06/chitietcuakhau.module.js?v=${version}"/>"></script>
