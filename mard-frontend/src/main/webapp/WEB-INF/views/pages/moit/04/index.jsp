...
<div class="row" id="mt-container">
        ...
        <div class="portlet light ">
            <div class="portlet-title">
                <div class="caption font-dark">
                    ...
                    <span class="caption-subject bold uppercase"> <spring:message code="moit.04.tenthutuc" /></span>
                </div>
            </div>
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <span class="caption-subject bold uppercase"><i class="fa fa-gift"></i> <spring:message code="moit.04.tracuu.timkiem" /> </span>
                                </div>
                                <div class="panel-body">
                                    <form role="form" class="form-horizontal" name="searchForm">
                                        <div class="form-group" style="margin-top: 15px;">
                                            <div class="col-md-12">
                                                <div class="col-md-2 nsw-text-right">
                                                    <label><spring:message code="moit.04.tracuu.mahoso" /></label>
                                                </div>
                                                <div class="col-md-4">
                                                ...
                                                <div class="col-md-2 nsw-text-right">
                                                    <label><spring:message code="moit.04.tracuu.trangthaihoso" /></label>
                                                </div>
                                                <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                <div class="col-md-2 nsw-text-right">
                                                    <label><spring:message code="moit.04.tracuu.ngaynoptu" /></label>
                                                </div>
                                                <div class="col-md-4">   
                                                ...
                                                <div class="col-md-2 nsw-text-right">
                                                    <label ><spring:message code="moit.04.tracuu.ngaynopden" /></label>
                                                </div>
                                                <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                <div class="col-md-2 nsw-text-right">
                                                    <label><spring:message code="moit.04.tracuu.ngaycappheptu" /></label>
                                                </div>
                                                <div class="col-md-4">   
                                                ...
                                                <div class="col-md-2 nsw-text-right">
                                                    <label><spring:message code="moit.04.tracuu.ngaycapphepden" /></label>
                                                </div>
                                                <div class="col-md-4">
                ...
                <table class="table table-striped table-bordered table-hover table-checkable order-column" id="monre06Items">
                    <thead>
                        <tr class="nsw-tr tr-nsw1-bgcolor">
                            <th class="text-center"> <spring:message code="moit.04.danhsach.stt" /></th>
                            <th class="text-center" style="width: 100px;"> <spring:message code="moit.04.danhsach.lichsuxuly" /> </th>
                            <th class="text-center" style="width: 120px;"> <spring:message code="moit.04.danhsach.mahoso" /> </th>
                            <th class="text-center" style="max-width: 200px;"> <spring:message code="moit.04.danhsach.tendoanhnghiep" /> </th>
                            <th class="text-center" style="width: 100px;"> <spring:message code="moit.04.danhsach.ngaygui" /> </th>
                            <th class="text-center" style="width: 100px;"> <spring:message code="moit.04.danhsach.ngaycapphep" /> </th>
                            <th class="text-center"> <spring:message code="moit.04.danhsach.trangthai" /> </th>
                            <th class="text-center" style="width: 100px;"> <spring:message code="moit.04.danhsach.xemgiayphep" /> </th>
                            <th class="text-center" style="width: 25px;"> <spring:message code="moit.04.danhsach.xinsua" /> </th>
                            <th class="text-center" style="width: 25px;"> <spring:message code="moit.04.danhsach.xinrut" /> </th>
                            <th class="text-center" style="width: 25px;"> <spring:message code="moit.04.danhsach.sua" /> </th>
                            <th class="text-center" style="width: 25px;"> <spring:message code="moit.04.danhsach.xoa" /> </th>
                        </tr>
                    </thead>
    ...
    <script src="<c:url value='/app/moit/04/model.js?v=${version}'/>" type="text/javascript"></script>
    <script src="<c:url value='/app/moit/04/index.js?v=${version}' />" type="text/javascript"></script>
    ...
    <template id="history-tmpl">
        <form role="form" class="form-horizontal" id="history-form">
            ...
            <table class="table table-striped table-bordered table-hover table-checkable order-column">
                <thead>
                    <tr>
                        <th class="text-center"><b><spring:message code="moit.04.lichsu.stt" /></b></th>
                        <th class="text-center"><b><spring:message code="moit.04.lichsu.nguoixuly" /></b></th>
                        <th class="text-center"><b><spring:message code="moit.04.lichsu.donvixuly" /></b></th>
                        <th class="text-center" style="max-width: 200px;"><b><spring:message code="moit.04.lichsu.noidung" /></b></th>
                        <th class="text-center"><b><spring:message code="moit.04.lichsu.thoigian" /></b></th>
                        <th class="text-center" style="max-width: 200px;"><b><spring:message code="moit.04.lichsu.trangthaihoso" /></b></th>
                    </tr>
                </thead>
        ...
        <template id="ruthoso-tmpl">
            <div class="row">
                <form role="form" class="form-horizontal" name="ruthoso-form" id="ruthoso-form">
                    ...
                    <div class="col-md-10">
                        <textarea name="fiContent" id="fiContent" data-bind="value: fiContent" require="true" placeholder="<spring:message code="common.msg.ly_do" />" style="width: 90%; height: 150px; max-width: 90%; max-height: 150px" maxlength="2000"></textarea>
                    </div>
                </form>
            </div>
        </template>    
