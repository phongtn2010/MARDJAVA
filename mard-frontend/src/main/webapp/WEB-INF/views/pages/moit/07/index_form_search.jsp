...
<form role="form" class="form-horizontal " name="searchForm01" id="searchForm01">
	<div class="form-group" style="margin-top: 15px;">
		<div class="col-md-12">
			...
			<div class="col-md-4">
				<input autocomplete="off" class="form-control" name="maHoSo" id="maHoSo" placeholder="<spring:message code="moit.07.mahoso" />" data-bind="value: searchForm.maHoSo" type="text">
			</div>
			<div class="col-md-2">
