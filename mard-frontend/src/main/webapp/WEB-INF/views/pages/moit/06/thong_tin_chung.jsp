				...
				<div class="col-md-6">
						<div class="row">
							<div class="form-group">
								<label style="text-align: right;" for="maHoSo" class="col-sm-4 "><spring:message code="moit.06.label.thongTinHoSo.maHoSo"></spring:message><span class="nsw-require-field"></span>:</label>
								<div class="col-sm-8">
					...
					<div class="col-md-6">
						<div class="row">
							<div class="form-group">
								<label style="text-align: right;" for="trangThaiHoSo" class="col-sm-4 "><spring:message code="moit.06.label.thongTinHoSo.tenTrangThai"></spring:message><span class="nsw-require-field"></span>:</label>
								<div class="col-sm-8">
						...
						<div class="col-md-6">
							<div class="row">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input id="thongTinChungModel_noiCapGiayChungNhanDKKD"  class="form-control form-control-inline " data-bind="value: thongTinChungModel.noiCapGiayChungNhanDKKD , enable: !thongTinChungModel.xemHoSo()" />
									</div>
								</div>
							</div>
						</div>
						...
						<div class="col-md-6">
							<div class="row">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input id="thongTinChungModel_daiDienChucVu" class="form-control form-control-inline " data-bind="value: thongTinChungModel.daiDienChucVu, enable: !thongTinChungModel.xemHoSo()" />
									</div>
								</div>
							</div>
						</div>
						<div class="col-md-6">
							<div class="row">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input id="thongTinChungModel_daiDienNamSinh" class="form-control form-control-inline  date-picker" data-date-format="dd/mm/yyyy" size="16" placeholder="dd/mm/yyyy" data-bind="value: thongTinChungModel.daiDienNamSinh, enable: !thongTinChungModel.xemHoSo(), dateInput" autocomplete="off" />
									</div>
								</div>
							</div>
						</div>
						...
						<div class="col-md-6">
							<div class="row">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input id="thongTinChungModel_ngayCapGiayChungNhan" class="form-control form-control-inline  date-picker" data-date-format="dd/mm/yyyy" size="16" type="text" placeholder="dd/mm/yyyy" data-bind="value: thongTinChungModel.ngayCapGiayChungNhan, enable: !thongTinChungModel.xemHoSo(), dateInput" autocomplete="off" />
									</div>
								</div>
							</div>
						</div>
						...
						<div class="col-md-6">
							<div class="row">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input id="thongTinChungModel_ngayCapGiayPhepTCTN" class="form-control form-control-inline  date-picker" data-date-format="dd/mm/yyyy" size="16" type="text" placeholder="dd/mm/yyyy" data-bind="value: thongTinChungModel.ngayCapGiayPhepTCTN, enable: !thongTinChungModel.xemHoSo(), dateInput" autocomplete="off" />
									</div>
								</div>
							</div>
						</div>
