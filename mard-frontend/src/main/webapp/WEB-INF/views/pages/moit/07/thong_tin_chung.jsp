				...
				<div class="col-md-12">
					<div class="row">
						<div class="col-md-6">
							<div class="row">
								<div class="form-group">
									<label style="text-align: right;" for="inputPassword" class="col-sm-4 "><spring:message code="moit.07.form.thongtinchung.05"></spring:message></label>
									<div class="col-sm-8">
				...
				<div class="col-md-12">
					<div class="row">
						<div class="col-md-6">
							<div class="row">
								<div class="form-group">
									<label style="text-align: right;" for="inputPassword" class="col-sm-4 "><spring:message code="moit.07.form.thongtinchung.07"></spring:message></label>
									<div class="col-sm-8">
										<input id="thongTinChungModel_soGiayChungNhanDKKD" class="form-control form-control-inline " data-bind="value: thongTinChungModel.soGiayChungNhanDKKD" />
									</div>
								</div>
							</div>
						</div>
				...
				<div class="col-md-12">
					<div class="row">
						...
						<div class="col-md-6">
							<div class="row">
								<div class="form-group">
									<label style="text-align: right;" for="inputPassword" class="col-sm-4 "><spring:message code="moit.07.form.thongTinChung.faxNSX"></spring:message></label>
									<div class="col-sm-8">
