            ...
            <table class="table table-striped table-bordered table-hover table-checkable order-column" id="lstHanghoa10">
                ...
                <tbody data-bind="foreach: lstHanghoas">
                    <tr>
                        ...
                        <td>
                            <input style="text-align: right" class="form-control" name="fiSoluong" type="number" data-bind="value : fiSoluong, event: {change: $parent.countSoluongBao.bind($parent)}" maxlength="7" readonly/>
                        </td>                       
                    </tr>
                </tbody>
            </table>
