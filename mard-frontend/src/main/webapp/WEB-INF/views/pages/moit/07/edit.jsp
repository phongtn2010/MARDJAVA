				...
				<div class="portlet-body" id="table-search">
					...
					<div class="row table-responsive" id="GhiHoSoViewModel">
						<div class="col-md-12" align="center">
							...
							<a href="<c:url value="/moit/07/home" />" class="btn green" id="btDong"> <i class="fa fa-arrow-left" aria-hidden="true"></i></i>&nbsp; <spring:message code="moit.07.form.08" />
							</a>
						</div>
					</div>
				</div>
...
<script type="text/javascript" src="<c:url value="/app/moit/07/chitietcuakhau.module.js?v=${version}"/>"></script>
