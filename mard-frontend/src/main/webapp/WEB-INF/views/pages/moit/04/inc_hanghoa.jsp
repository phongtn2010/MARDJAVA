...
<fieldset>
    ...
    <div class="form-group">
        <div class="col-md-12">
            ...
            <div class="col-md-4">                
                <input class="form-control" type="text" id="fiSdtNguoigui" name="fiSdtNguoigui" data-bind="value : fiSdtNguoigui" maxlength="50" />
            </div>           
        </div>  
    </div> 
    <div class="form-group">
    ...
    <div class="form-group">
        <div class="col-md-12">
            ...
            <div class="col-md-4">                
                <input class="form-control" type="text" id="fiSdtNguoinhan" name="fiSdtNguoinhan" data-bind="value : fiSdtNguoinhan" maxlength="50" />
            </div>           
        </div>  
    </div> 
    ...
    <div class="form-group">
        <div class="col-md-12">
            <table class="table table-striped table-bordered table-hover table-checkable order-column" id="lstHanghoa10">
                <thead>
                    <tr class="nsw-tr tr-nsw1-bgcolor">
                        <th class="text-center" style="width: 5%"><spring:message code="moit.04.hoso.thongtinhanghoa.stt" /></th>
                ...
                <tbody data-bind="foreach: lstHanghoas">
                    <tr>
                        ...
                        <td style="width: 220px">
                            <input class="form-control" name="fiMahang" data-bind="value : fiMahang ,event: {change: $parent.valiTTlist.bind($parent)}" maxlength="250"/>
                            <span data-bind="attr: {'id': 'fiMahangvali_' + fiStt()}" class="validationMessage" style="display: none">Thông tin bắt buộc nhập</span>
                        </td>
                        <td>
                            <input style="text-align: right" class="form-control" name="fiSoluong" id="fiSoluong" data-bind="value : fiSoluong, event: {change: $parent.countSoluongBao.bind($parent)}"  maxlength="7" type="text" oninput="validity.valid||(value='');" pattern="^[0-9]+$"/>
                            <span  data-bind="attr: {'id': 'fiSoluongvali_' + fiStt()}" class="validationMessage" style="display: none">Thông tin bắt buộc nhập</span>
                        </td>
            ...
            <span id="HanghoaError" data-bind="text : errorHHMessage" style="color:red;"> </span>
            <br/>
