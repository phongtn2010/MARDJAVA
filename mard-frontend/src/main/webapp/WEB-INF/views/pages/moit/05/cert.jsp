            ...
            <table class="table table-striped table-bordered table-hover table-checkable order-column" id="lstHanghoa10" style="float: left;width: 100%;table-layout: fixed;">
                <thead>
                    <tr class="nsw-tr tr-nsw1-bgcolor">
                        <th  style="width: 8%" class="text-center"><spring:message code="moit.05.hoso.thongtinhanghoa.stt" /></th>
                ...
                <tbody data-bind="foreach: lstNguyenlieus">
                    <tr>
                        ...
                        <td class="text-right" data-bind="text : fiDangkyNhapkhauNamx1"></td>
                        <td class="text-right" data-bind="text : fiSoluongCapX1"></td>
                        <td class="text-right" data-bind="text : fiUocThuchienX1"></td>
                        <td class="text-right" data-bind="text : fiDangkyNhapkhauNamx"></td>
                    </tr>
                </tbody>
            </table>  
