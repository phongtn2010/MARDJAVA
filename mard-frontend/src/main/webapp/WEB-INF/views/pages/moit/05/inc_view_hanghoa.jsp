...
<fieldset>
    ...
    <div class="form-group">
        <div class="col-md-12">
                ...
                <tbody data-bind="foreach: lstNguyenlieus">
                    <tr>
                        ...
                        <td style="width: 220px">
                            <select class="form-control select2 fiLoaiNguyenlieu" disabled data-bind="value: fiLoaiNguyenlieu,
                        ...
                        <td>
                            <select class="form-control select2 fiMaNguyenlieu" disabled data-bind="value: fiMaNguyenlieu,
                        ...
                        <td>
                            <input class="form-control" style="text-align: right;" type="number" name="fiDangkyNhapkhauNamx1" data-bind="value : fiDangkyNhapkhauNamx1" minlength="3" maxlength="12" readonly/>
                        </td>
                        <td>
                            <input class="form-control" style="text-align: right;" type="number" name="fiSoluongCapX1" data-bind="value : fiSoluongCapX1" minlength="3" maxlength="12" readonly/>
                        </td>
                        <td>
                            <input class="form-control" style="text-align: right;" type="number" name="fiUocThuchienX1" data-bind="value : fiUocThuchienX1" minlength="3" maxlength="12" readonly/>
                        </td>
                        <td>
                            <input class="form-control" style="text-align: right;" type="number" name="fiDangkyNhapkhauNamx" data-bind="value : fiDangkyNhapkhauNamx" minlength="3" maxlength="12" readonly/>
                        </td>                        
                    </tr>
                </tbody>
            </table>
            ...
            <br />
            <!--<a class="btn green bt-center" data-bind="click: addHangHoaOnClick" id="btnAddHH"><i class="fa fa-add fa-lg"></i> Thêm Hàng hoá</a>-->
        </div>
    </div>
</fieldset>