				...
				<table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
					<thead>
						<tr class="nsw-tr tr-nsw1-bgcolor">
							...
							<th class="text-center"><spring:message code="moit.07.index.table.th.02"></spring:message></th>
							...
							<th class="text-center"><spring:message code="moit.07.index.table.th.09"></spring:message></th>
							<th class="text-center"><spring:message code="moit.07.index.table.th.10"></spring:message></th>
							<th class="text-center"><spring:message code="moit.07.index.table.th.11"></spring:message></th>
							<th class="text-center"><spring:message code="moit.07.index.table.th.12"></spring:message></th>
						</tr>
					</thead>
