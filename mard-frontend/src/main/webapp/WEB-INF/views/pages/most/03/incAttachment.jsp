...
<form role="form" class="form-horizontal" id="Most03Files">
    ...
    <div class="row-border">
        ...
        <div class="form-group" data-bind="visible: showDonViThuNghiem">
            <div class="col-md-12">
                <div class="col-md-2">
                    <label><spring:message code="most.03.dinhkem.ngayguimau" /><a class="nsw-require-field">*</a></label>
                </div>
                <div class="col-md-4">                                        
                    <input name="fiNgayguiMau" id="fiNgayguiMau" data-bind="datepicker : fiNgayguiMau" class="form-control form-control-inline date-picker" data-date-format="dd/mm/yyyy"  type="text" />
                </div>
                <div class="col-md-2">
                    <label><spring:message code="most.03.dinhkem.ngaynhanketqua" /><a class="nsw-require-field">*</a></label>
                </div>
                <div class="col-md-4">
                    <input name="fiNgaynhanKq" id="fiNgaynhanKq" data-bind="datepicker : fiNgaynhanKq" class="form-control form-control-inline date-picker" data-date-format="dd/mm/yyyy" size="16" type="text" />
                </div>
            </div>
        </div>
        <div class="form-group" data-bind="visible: showDonViThuNghiem">
            <div class="col-md-12">
                <div class="col-md-2">
                    <label><spring:message code="most.03.dinhkem.donvithunghiem" /><a class="nsw-require-field">*</a></label>
                </div>
                <div class="col-md-4">                                        
                    <select id="fiDvThunghiem" class="form-control" data-bind="optionsCaption: 'Chọn...', 
                        options: lstDonViThuNghiem,
                        optionsText : 'fiTen',
                        optionsValue : 'fiMa',
                        value : fiDvThunghiem"></select>
                </div>
            </div>
        </div>
        <div class="form-group">
