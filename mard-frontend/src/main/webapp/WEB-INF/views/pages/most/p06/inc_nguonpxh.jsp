            ...
            <form role="form" class="form-horizontal">
                ...
                <div class="form-group">
                    <div class="col-md-12">                       
                        ...
                        <div class="col-md-2">                                        
                            <input class="form-control" id="fiHoatDo" name="fiHoatDo" maxlength="25"  
                        ...
                        <div class="col-md-4">
                            <input class="form-control" id="fiMaHieu" name="fiMaHieu" type="text" data-bind="value: fiMaHieu" maxlength="255"/>
                        </div>
                    </div>  
                </div>
                <div class="form-group" style="margin-top: 15px;">
                    <div class="col-md-12">
                        ...
                        <div class="col-md-4">
                            <input class="form-control" id="fiCongThucHoaHoc" name="fiCongThucHoaHoc" data-bind="value: fiCongThucHoaHoc" maxlength="500"/> 
                        </div>
                        ...
                        <div class="col-md-4">
                            <input class="form-control" id="fiTrangThaiVatLy" name="fiTrangThaiVatLy" type="text" data-bind="value: fiTrangThaiVatLy" maxlength="500"/>
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-md-12">                       
                        ...
                        <div class="col-md-4 fiMucDichSuDungKhac" style="display: none">                                        
                            <input class="form-control" id="fiSoSeri" name="fiSoSeri" maxlength="500"  
