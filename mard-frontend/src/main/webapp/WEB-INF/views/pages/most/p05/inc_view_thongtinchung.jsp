    ...
    <form role="form" class="form-horizontal" name="searchForm">
        <div class="form-group">
            <div class="col-md-12">
                ...
                <div class="col-md-4">
                    <input disabled class="form-control" id="fiTenTrangthai" name="fiTenTrangthai" data-bind="value : fiTenTrangthai" type="text" readonly/>
                </div>
            </div>  
        </div> 
        <div class="form-group">
            <div class="col-md-12">
                ...
                <div class="col-md-4">                                        
                    <select disabled class="form-control select2" id="fiMaCoQuan" name="fiMaCoQuan" 
        ...
        <div class="form-group" style="margin-top: 15px;">
            <div class="col-md-12">
                ...
                <div class="col-md-4">
                    <input disabled class="form-control" id="fiTtcTenToChuc" name="fiTtcTenToChuc" maxlength="255"  
                ...
                <div class="col-md-4">
                    <input disabled class="form-control" id="fiTtcDiaChi" name="fiTtcDiaChi" data-bind="value : fiTtcDiaChi" type="text" readonly/>
        ...
        <div class="form-group">
            <div class="col-md-12">
                ...
                <div class="col-md-4">
                    <input disabled class="form-control" id="fiTtcDienThoai" name="fiTtcDienThoai" maxlength="255"  
                ...
                <div class="col-md-4">
                    <input disabled class="form-control" id="fiTtcFax" name="fiTtcFax" maxlength="255"  
        ...
        <div class="form-group">
            <div class="col-md-12">
                ...
                <div class="col-md-4">
                    <input disabled class="form-control" type="text" id="fiTtcEmail" name="fiTtcEmail" data-bind="value : fiTtcEmail" maxlength="250" />
                </div>
            </div>  
        </div> 
        <div class="form-group">
            <div class="col-md-12">
                ...
                <div class="col-md-4">
                    <input disabled class="form-control" id="fiNddHoTen" name="fiNddHoTen" readonly="readonly" type="text" data-bind="value: fiNddHoTen" maxlength="250"/>
                </div>  
                <div class="col-md-2 nsw-text-right">
                    <label><spring:message code="most.05.hoso.thongtinchung.chucvu" /> <a class="nsw-require-field">*</a></label>
                </div>
                <div class="col-md-4">
                    <input disabled class="form-control" id="fiNddChucVu" name="fiNddChucVu"  data-bind="value : fiNddChucVu" type="text" maxlength="50"/>
                </div>
            </div>  
        </div>
        <div class="form-group">
            <div class="col-md-12">
                ...
                <div class="col-md-4">
                    <input disabled class="form-control" id="fiNddCmnd" name="fiNddCmnd" data-bind="value : fiNddCmnd" type="text" maxlength="50"/>
                </div>
            </div> 
        </div>
        ...
        <div class="form-group">
            <div class="col-md-12">
                ...
                <div class="col-md-4">
                    <select disabled class="form-control select2" id="fiHinhThucCap" name="fiHinhThucCap" data-bind="optionsCaption: 'Chọn...',
                ...
                <div class="col-md-2 nsw-text-right">
                    <label><spring:message code="most.05.hoso.thongtinchung.sogiayphep" /><a id="sogiaypheplabel" class="nsw-require-field">*</a></label>
                </div>
                <div class="col-md-4">
                    <input disabled class="form-control " type="text" maxlength="50" data-bind="value: fiSoGiayPhep" />
                </div>
            </div>  
        </div>
        ...
        <div class="form-group">
            <div class="col-md-12">
                ...
                <div class="col-md-4">
                    <input disabled class="form-control date-picker" type="text" maxlength="50" data-bind="datepicker : fiNgayCap" placeholder="dd/mm/yyyy"  data-date-format="dd/mm/yyyy"/>
                </div>
                <div class="col-md-2 nsw-text-right">
                    <label><spring:message code="most.05.hoso.thongtinchung.lydocaplai" /><a id="lydocaplailabel" class="nsw-require-field">*</a></label>
                </div>
                <div class="col-md-4">
<!--                    <select disabled class="form-control" name="fiLydocaplai" 
                        data-bind="
                            value : fiLydocaplai'
                            ,optionsText : 'name'
                            ,"></select>-->
