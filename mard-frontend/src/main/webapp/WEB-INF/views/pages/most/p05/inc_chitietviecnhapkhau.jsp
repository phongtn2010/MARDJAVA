    ...
    <form role="form" class="form-horizontal" name="searchForm">
        <div class="form-group" style="margin-top: 15px;">
            <div class="col-md-12">
                ...
                <div class="col-md-4">   
                    <input name="ngayDuKien" id="ngayDuKien" readonly style="background: #fff"  data-bind="datepicker : $data.formVM().fiNkcpxNgayDuKien" class="form-control form-control-inline date-picker" data-date-format="dd/mm/yyyy"  placeholder="dd/mm/yyyy" />
                </div>
                <div class="col-md-2 nsw-text-right">
        ...
        <div class="form-group">
            <div class="col-md-12">
                ...
                <div class="col-md-4">
                    <select name="fiNkcpxMaCuaKhau" id="fiNkcpxMaCuaKhau" class="form-control"data-bind="optionsCaption: 'Chọn...'
