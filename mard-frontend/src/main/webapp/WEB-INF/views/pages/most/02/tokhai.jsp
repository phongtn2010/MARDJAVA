...
<div id="tokhai-tmpl" style="display: none;">
    <form role="form" class="form-horizontal tokhai-form">
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">                
                <input id="fiNamdk" name="fiNamdk" require="true" field="most_02_tokhai_namdangky" class="form-control" value="{{fiNamdk}}" placeholder="<spring:message code="most.02.tokhai.namdangky" />" type="text" />
            </div>
        </div>
        <div class="form-group">
            <div class="col-md-2">
        ...
        <div class="panel-body"> 
            <div class="row">
                ...
                <div class="col-md-3">
                    <b id="lbTKSo">{{fiSoTk}}</b>
                </div>
                <div class="col-md-3">
                    <label>{{_lang "common_tokhai_mahaiquan"}}</label>
                </div>
                <div class="col-md-3">
                    <b id="lbTKMaHq">{{fiMaHq}}</b>
                </div>
            </div>
            <div class="row">
                <div class="col-md-3">
                ...
                <div class="col-md-3">
                    <b id="lbTKNgayDK">{{convertToDateFromTimeStamp fiNgayDk false}}</b>
                </div>        
            </div>
        </div>
