                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default" id="pnl-import" style="display: ${hideImport}">
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-md-4">
                                        <p><a href="<c:url value='/templates/most/bm_most_04.xlsx'/>"><spring:message code="common.ban_khai_ho_so_mau" /></a></p>
                                    </div>
                                    <div class="col-md-8 ">
                            ...
                            <div class="tabbable-custom ">
                                ...
                                <div class="tab-content" >
                                    ...
                                    <p class="nsw-text-center" id="Mard02CreateFn">
                                        <a data-bind="click : btnLuuClick, visible: most04FormVM().fiTrangthai() + 0 == 0" href="javascript:void(0);" class="btn blue" id="btnLuu"><i class="fa fa-save" ></i> <spring:message code="common.button.luu" /></a>
...
<script src="<c:url value='/app/most/04/EditViewModel.js?v=${version}' />" type="text/javascript" charset="utf-8"></script>                                    