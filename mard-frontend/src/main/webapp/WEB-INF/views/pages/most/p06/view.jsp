                                ...
                                <div class="tab-content" >
                                    ...
                                    <div class="tab-pane active" id="tab_mt_1" >
                                        <form role="form" class="form-horizontal">
                                            ...
                                            <%@include file="inc_view_chitietnhap.jsp" %>
                                            <%@include file="inc_view_khaibaongpxk.jsp" %>
                                            <%@include file="inc_view_nguonpxkqsd.jsp" %>
                                            <%@include file="inc_view_nguonpxh.jsp" %>
...
<script src="<c:url value='/app/most/06/ResultVM.js?v=${version}'/>" type="text/javascript" charset="utf-8"></script>
<script src="<c:url value='/app/most/06/ViewVM.js?v=${version}'/>" type="text/javascript" charset="utf-8"></script>
