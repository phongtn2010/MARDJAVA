                                    ...
                                    <div class="form-group">
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <a href="javascript:;" class="btn green" id="addHoSo" data-bind="click: btnAddNewClick"><i class="fa fa-edit"></i> <spring:message code="common.button.them_moi" /></a>
                                            </div>
                                        </div>  
                                    </div>                                                
                                </form>
            ...
            <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                <thead>
                    <tr class="nsw-tr tr-nsw1-bgcolor">
                        ...
                        <th class="text-center w50"><spring:message code="most.04.danhsach.tb.sua" /></th>
                        <th class="text-center w50"><spring:message code="most.04.danhsach.tb.xoa" /></th>                            
                        <th class="text-center w50"><spring:message code="most.04.danhsach.tb.ruthoso" /></th>
                        <th class="text-center w50"><spring:message code="most.04.danhsach.tb.bosungtailieu" /></th>
                ...
                <script id="itemTmpl" type="text/html">
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="javascript:void(0)"><i class="fa fa-edit fa-lg" data-bind="visible: bSuaHoSo, click: $parent.bSuaHoSoClick.bind($parent)" src="" alt=""/></a>
                        </td> 
                        <td class="text-center">
                            <a href="javascript:void(0)"><i class="fa fa-remove fa-lg" data-bind="visible: bXoaHoSo, click: $parent.bXoaHoSoClick.bind($parent)" src="" alt=""/></a>
                        </td> 
                        <td class="text-center">
                            <a href="javascript:void(0)"><i class="fa fa-retweet fa-lg" data-bind="visible: bRutHoSo, click: $parent.bRutHoSoClick.bind($parent)" src="" alt=""/></a>
                        </td> 
                        <td class="text-center">
                            <a href="javascript:void(0)"><i class="fa fa-edit fa-lg" data-bind="visible: bBoSungTaiLieu, click: $parent.bBoSungTaiLieuClick.bind($parent)" src="" alt=""/></a>
                        </td> 
                        <td class="text-center">
