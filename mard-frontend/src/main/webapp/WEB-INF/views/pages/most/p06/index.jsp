                ...
                <table class="table table-striped table-bordered table-hover table-checkable order-column" id="monre06Items">
                    <thead>
                        <tr class="nsw-tr tr-nsw1-bgcolor">
                            ...
                            <th class="text-center" style="width: 25px;"> <spring:message code="most.06.hoso.danhsach.xinrut" /> </th>
                            <th class="text-center" style="width: 25px;"> <spring:message code="most.06.hoso.danhsach.sua" /> </th>
                            <th class="text-center" style="width: 25px;"> <spring:message code="most.06.hoso.danhsach.xoa" /> </th>
                        </tr>
                    </thead>
