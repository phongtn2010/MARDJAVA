            ...
            <form role="form" class="form-horizontal">
                    ...
                    <div class="col-md-12">                       
                        ...
                        <div class="col-md-4">                                        
                            <input class="form-control date-picker" placeholder="dd/mm/yyyy" id="fiNgayXacDinhHoatDo" 
                                   name="fiNgayXacDinhHoatDo" data-bind="datepicker : fiNgayXacDinhHoatDo, event: {change: ngayXacDinhHDValid}" type="text" data-date-format="dd/mm/yyyy"  readonly style="background: #fff"/>
                            <span class="validationMessage" id="valid-NgayXacDinhHD" style="display: none;">Thông tin bắt buộc nhập</span>
                        </div>
                    </div>  
                </div>
                <div class="form-group">
                    <div class="col-md-12">                       
                        ...
                        <div class="col-md-4">                                        
                            ...
                            <span id="lstMDsudung" style="display: none" class="validationMessage">Thông tin bắt buộc nhập</span>
                        </div>
                ...
                <div class="form-group">
                    <div class="col-md-12">                       
                        ...
                        <div class="col-md-4">                                        
                            <input class="form-control" id="fiSoSeri" name="fiSoSeri" maxlength="100"  
                        ...
                        <div class="col-md-4">                                        
                            <input class="form-control date-picker" placeholder="dd/mm/yyyy" id="fiXuatXuNguonNgaycap" readonly style="background: #fff"
                                   name="fiXuatXuNguonNgaycap" data-bind="datepicker : fiXuatXuNguonNgaycap , event: {change: ngaycapPXKValid}" type="text" data-date-format="dd/mm/yyyy" />
                            <span class="validationMessage" id="valid-XXngayCap" style="display: none;">Thông tin bắt buộc nhập</span>
                        </div>
                    </div>  
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <div class="col-md-12">                       
                        ...
                        <div class="col-md-4">                                        
                            <input class="form-control" id="fiTbMaHieu" name="fiTbMaHieu" maxlength="100"  
                        ...
                        <div class="col-md-4">                                        
                            <input class="form-control" id="fiTbSoSeri" name="fiTbSoSeri" maxlength="100"  
                ...
                <div class="form-group">
                    <div class="col-md-12">                       
                        ...
                        <div class="col-md-4">                                        
                            <input class="form-control" id="fiTbHangNuocSanXuat" name="fiTbHangNuocSanXuat" maxlength="250"  
