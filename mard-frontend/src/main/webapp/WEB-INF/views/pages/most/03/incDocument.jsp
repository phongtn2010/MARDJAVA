...
<form role="form" class="form-horizontal" id="Most03Form">
    ...
    <div class="row-border">
        ...
        <div class="form-group">
            <div class="col-md-12">
                <div class="col-md-2">
                    <label>Link về các tổ chức được chỉ định thử nghiệm phê duyệt mẫu phương tiện đo</label>
                </div>
                <div class="col-md-10">
                    <a href="https://drive.google.com/file/d/1QXR3HB79Wwcx3KlUsCshGlw0YRMRrdOU/view?usp=sharing">https://drive.google.com/file/d/1QXR3HB79Wwcx3KlUsCshGlw0YRMRrdOU/view?usp=sharing</a>
                </div>                
            </div>
        </div>
    </div>
    ...
    <div class="row-border">
        ...
        <template id="hanghoa-template">
            <form role="form" class="form-horizontal hanghoa-form" id="hanghoa-form">
                ...
                <div class="form-group">
                    <div class="col-md-3">
                        <label><spring:message code="most.03.hanghoa.capchinhxac" /></label>
                    </div>
                    <div class="col-md-9">
