                ...
                <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                    <thead>
                        <tr class="nsw-tr tr-nsw1-bgcolor">
                            ...
                            <th class="text-center w50"><spring:message code="most.03.danhsach.tb.sua" /></th>
                            <th class="text-center w50"><spring:message code="most.03.danhsach.tb.xoa" /></th>                            
                            <th class="text-center w50"><spring:message code="most.03.danhsach.tb.ruthoso" /></th>
                            <th class="text-center w50"><spring:message code="most.03.danhsach.tb.xinbosunggiahan" /></th>
                    ...
                    <script id="itemTmpl" type="text/html">
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="javascript:void(0)"><i class="fa fa-edit" data-bind="visible: bSuaHoSo, click: $parent.bSuaHoSoClick.bind($parent)" src="" alt=""/></a>
                            </td> 
                            <td class="text-center">
                                <a href="javascript:void(0)"><i class="fa fa-remove" data-bind="visible: bXoaHoSo, click: $parent.bXoaHoSoClick.bind($parent)" src="" alt=""/></a>
                            </td> 
                            <td class="text-center">
                                <a href="javascript:void(0)"><i class="fa fa-retweet" data-bind="visible: bRutHoSo, click: $parent.bRutHoSoClick.bind($parent)" src="" alt=""/></a>
                            </td> 
                            <td class="text-center">
                                <a href="javascript:void(0)"><i class="fa fa-edit" data-bind="visible: bXinGiaHanBoSung, click: $parent.bGiaHanBoSungClick.bind($parent)" src="" alt=""/></a>
                            </td> 
                            <td class="text-center">
