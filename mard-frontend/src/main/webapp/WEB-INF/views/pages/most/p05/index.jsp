                                ...
                                <div class="panel-body">
                                    <form role="form" class="form-horizontal" name="searchForm">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                <div class="col-md-2 nsw-text-right">
                                                    <label>Trạng thái lệ phí</label>
                                                </div>
                                                <div class="col-md-4">   
                                                    <select id="trangThaiHoSo" name="trangThaiHoSo" class="form-control select2" 
                                                            data-bind="
                                                                value : trangThaiLePhi, 
                                                                options : fiTrangThaiLePhi, 
                                                                optionsValue : 'id', 
                                                                optionsCaption: 'Tất cả...', 
                                                                optionsText : 'name'">
                                                    </select>
                                                </div>
                                            </div>  
                                        ...
                                        <div class="form-group nsw-text-center">
                                            ...
                                            <a href="javascript:;" class="btn green" id="btnAddNewClick" data-bind="click : btnAddNewClick"><i class="fa fa-edit"></i><spring:message code="most.05.hoso.themmoi" /></a>
                                        </div>
                                    </form>
                                </div>
                            </div>
                ...
                <table class="table table-striped table-bordered table-hover table-checkable order-column" id="monre06Items">
                    <thead>
                        <tr class="nsw-tr tr-nsw1-bgcolor">
                            ...
                            <th class="text-center">Trạng thái lệ phí</th>
                            <th class="text-center" style="width: 100px;"> <spring:message code="most.05.hoso.danhsach.xemketqua" /> </th>
                            <th class="text-center" style="width: 25px;"> <spring:message code="most.05.hoso.danhsach.xinrut" /> </th>
                            <th class="text-center" style="width: 25px;"> <spring:message code="most.05.hoso.danhsach.sua" /> </th>
                            <th class="text-center" style="width: 25px;"> <spring:message code="most.05.hoso.danhsach.xoa" /> </th>
                        </tr>
                    </thead>
                    ...
                    <script id="itemTmpl" type="text/html">4
                        <tr>
                            ...
                            <td class="text-center" data-bind="date : fiNgayCapPhep"></td> 
                            <td style="max-width: 200px;">
                                <a href="javascript:void(0)" data-bind="text : fiTenTrangthai, event : {click : $parent.fiTrangThaiClick.bind($parent)}"></a>
                            </td> 
                            <td style="max-width: 200px;">
                                <a href="javascript:void(0)" data-bind="text : fiTenTTLePhi, event : {click : $parent.fiTrangThaiLePhiClick.bind($parent)}"></a>
                            </td>
                            <td class="text-center">
