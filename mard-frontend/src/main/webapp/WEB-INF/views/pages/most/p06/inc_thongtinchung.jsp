...
<fieldset>    
    ...
    <div class="form-group">
        <div class="col-md-12">
            ...
            <div class="col-md-4">
                <input class="form-control" id="fiMaHoso" name="fiMaHoso" maxlength="50"  
    ...
    <div class="form-group">
        <div class="col-md-12">
            ...
            <div class="col-md-4">
                <input class="form-control" id="fiMaHoso" name="tendoanhnghiep" maxlength="250"  
            ...
            <div class="col-md-4">
                <input class="form-control" id="fiTenTt" name="diachitruso" data-bind="value : fiTtcDiaChi" type="text" maxlength="250" readonly/>
    ...
    <div class="form-group">
        <div class="col-md-12">
            ...
            <div class="col-md-4">
                <input class="form-control" id="fiTenTt" name="dienthoai" data-bind="value : fiTtcDienThoai" type="text" maxlength="250" readonly/>
            </div>
            <div class="col-md-2 nsw-text-right">
                <label><spring:message code="most.06.hoso.thongtinchung.fax" /></label>
            </div>  
            <div class="col-md-4">
                <input class="form-control" type="text" id="fiTenDn" name="fiTtcFax"  data-bind="value : fiTtcFax" maxlength="50" />
            </div>
        </div>  
    </div> 
    <div class="form-group">
    ...
    <div class="form-group">
        <div class="col-md-12">
            ...
            <div class="col-md-4">
                <input class="form-control" id="fiSdt" name="chucvu"  data-bind="value : fiNddChucVu" type="text" maxlength="250"/>
            </div>
        </div>  
    </div>
    <div class="form-group">
        <div class="col-md-12">
            ...
            <div class="col-md-4">
                <input class="form-control form-control-inline" id="fiFax" name="socmndhochieu" data-bind="value : fiNddCmnd" type="text" maxlength="250"/>
            </div>
        </div> 
    </div>
    <div class="form-group">
        <div class="col-md-12">
            ...
            <div class="col-md-4">
                <input class="form-control" id="fiSoGiayPhep" name="sogiayphep" type="text" data-bind="value: fiSoGiayPhep, event: {change: validHTC}" maxlength="100"/>
    ...
    <div class="form-group">
        <div class="col-md-12">            
            ...
            <div class="col-md-4">
                <select class="form-control" id="fiLydocaplai1" name="fiLydocaplai" data-bind="optionsCaption: '--- Chọn ---'
