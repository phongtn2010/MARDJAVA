    ...
    <form role="form" class="form-horizontal" name="searchForm">
        <div class="form-group" style="margin-top: 15px;">
            <div class="col-md-12">
                ...
                <div class="col-md-4">
                    <input class="form-control" id="fiTtBenCungCapTen" name="fiTtcTenToChuc" maxlength="250" data-bind="value: $data.formVM().fiTtBenCungCapTen"/>
                </div>
                ...
                <div class="col-md-4">
                    <input class="form-control" id="fiTtcDiaChi" maxlength="250" name="fiTtcDiaChi" type="text" data-bind="value: $data.formVM().fiTtBenCungCapDiaChi"/>
                </div>
            </div>
        </div>  
        <div class="form-group" style="margin-top: 15px;">
            <div class="col-md-12">
                ...
                <div class="col-md-4">
                    <input class="form-control" id="fiTtcDienThoai" name="fiTtcDienThoai" maxlength="50" type="text" data-bind="value: $data.formVM().fiTtBenCungCapDienThoai"/>
                </div>
                ...
                <div class="col-md-4">
                    <input class="form-control" id="fiTtcFax" name="fiTtcFax" maxlength="50" type="text" data-bind="value: $data.formVM().fiTtBenCungCapFax"/>
                </div>
            </div>  
        </div>
        <div class="form-group" style="margin-top: 15px;">
