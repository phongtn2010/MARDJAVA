    ...
    <form role="form" class="form-horizontal" name="CreateForm">
            ...
            <div class="col-md-12">
                ...
                <div class="col-md-4">
                    <input class="form-control date-picker" id="ngayCap" type="text" maxlength="50" data-bind="datepicker : fiNgayCapCmnd"
                           placeholder="dd/mm/yyyy"  data-date-format="dd/mm/yyyy" readonly style="background-color: #fff;"/>
        ...
        <div class="form-group">
            <div class="col-md-12">
                ...
                <div class="col-md-4">
                    <input class="form-control " id="" type="text" maxlength="20" data-bind="value: fiNguoiLienHe "/>
                </div>
                ...
                <div class="col-md-4">
                    <input class="form-control " id="" type="text" maxlength="20" data-bind="value: fiDcDatMayLanDau"/>
                </div>
            </div>  
        </div>
