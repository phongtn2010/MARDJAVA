            ...
            <tbody data-bind="foreach: $data.formVM().lstThietBiNk02">
                <tr>
                    ...
                    <td style="width: 220px" class="text-center">                            
                        <a class="btn green bt-center" data-bind="click: $parent.formVM().popupTBNK.bind($parent)"><i class="fa fa-eye"></i> Xem</a>
                    </td>
                </tr>
            </tbody>
        </table>
    ...
    <form role="form" class="form-horizontal" id="dstb-form">
        ...
        <div class="form-group" style="margin-top: 15px;">
            <div class="col-md-12">
                ...
                <div class="col-md-4">
                    <input class="form-control" id="fiSoLuong" name="fiSoLuong" data-bind="value: fiSoLuong" maxlength="250"readonly="readonly"/>
                </div>
                <div class="col-md-2 nsw-text-right">
        ...
        <div class="form-group" style="margin-top: 15px;">
            <div class="col-md-12">
                ...
                <div class="col-md-4">
                    <input class="form-control" id="fiGiaThietBi" name="fiGiaThietBi" data-bind="value: fiGiaThietBi" maxlength="250" readonly="readonly"/>
                </div>
            </div>
        </div> 
    </form>
