...
<form role="form" class="form-horizontal " name="searchForm04" id="searchForm04">
	...
	<div class="form-group" style="margin-top: 15px;">
		<div class="col-md-12">
			...
			<div class="col-md-4">
				<input autocomplete="off" class="form-control input-medium form-control"  data-bind="value: searchForm.fiDocumentName, i18n: {  placeholder: { key: 'fiDocumentName'} }" type="text">
			</div>
			<div class="col-md-2">
	...
	<div class="form-group">
		<div class="col-md-12">
			<c:if test="${isFcap}">
				...
				<div class="col-md-4">
					<input ${isFcap ? "": " disabled "} name="fiTaxCode" id="fiTaxCode"  class="form-control form-control-inline input-medium" size="255" type="text"  data-bind="value: searchForm.fiTaxCode , i18n: {  placeholder: { key: 'fiTaxCode'} }" />
				</div>
			</c:if>
	...
	<div class="form-group nsw-text-center">
		...
		<c:if test="${!isFcap}">
			<a href="javascript:;" data-bind="click: $root.themMoiHoSo" class="btn green" id="btnAddNew"><i class="fa fa-plus"></i> <span data-bind="i18n: { 'html': 'add' }"></span></a>
		</c:if>
	</div>
</form>