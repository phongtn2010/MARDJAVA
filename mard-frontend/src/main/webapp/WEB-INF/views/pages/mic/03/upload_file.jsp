...
<div class="col-md-12 table-responsive">
	<table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
		...
		<tr class="nsw-tr tr-nsw1-bgcolor">
			<th class="text-center" data-bind="i18n: { 'html': 'TbdDinhKem03.fiId' }"></th>
			<th class="text-center" data-bind="i18n: { 'html': 'TbdDinhKem03.fiFileName' }"></th>
			<th class="text-center" data-bind="i18n: { 'html': 'TbdDinhKem03.fiFileCode' }"></th>
			<th class="text-center" data-bind="i18n: { 'html': 'TbdDinhKem03.fiFileByte' }"></th>
		</tr>
		</thead>
		<tbody>
		...
		<tr >
			...
			<td>
					<div class="col-md-12">
							...
							<input   type="file" class="form-group form-control" multiple="multiple" data-bind="attr: { 'id': 'fileUpload' + $index()}, event:{ change: $root.uploadFileChangeEvent.bind($data, maLoaiTep, $index(), $data) }">
						</span>
					</div>
	...
	<div class="alert alert-danger">
		<strong data-bind="i18n: { 'html': 'TbdDinhKem03.ghiChu' }"></strong>
	</div>
</div>