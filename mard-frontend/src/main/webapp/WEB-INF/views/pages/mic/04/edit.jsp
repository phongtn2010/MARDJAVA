                ...
                <div class="portlet-body" id="table-search">
                                ...
                                <div class="col-md-12">
                                    <div class="panel panel-default">
                                        ...
                                        <div class="panel-body" id="">
                                            <jsp:include page="thong_tin_nguoi_tham_dinh.jsp"></jsp:include>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row table-responsive" id="GhiHoSoViewModel">
                        <div class="col-md-12" align="center">
                            ...
                            <a href="<c:url value="/mic/04/home" />" class="btn green" id="btDong">
...
<script type="text/javascript" src="<c:url value="/app/mic/04/module/thongtinnguoithamdinh.module.js?v=${version}"/>"></script>
<script type="text/javascript" src="<c:url value="/app/mic/04/module/tokhainguoithamdinh.module.js?v=${version}"/>"></script>
<script type="text/javascript" src="<c:url value="/app/mic/04/module/tepdinhkem.module.js?v=${version}"/>"></script>
<script type="text/javascript" src="<c:url value="/app/mic/04/module/ghihoso.module.js?v=${version}"/>"></script>
