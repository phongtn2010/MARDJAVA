...
<table-view params="titles:  $root.titles, rows: $root.dataTable, totalElements:  $root.totalElements, pageClick:  $root.pageClick, currentPage:  $root.currentPage, pageSize: 10, pagingUI: true, widths: [10, 10, 10, 10, 10, 10, 3, 15, 3, 3, 3, 15]"></table-view>
