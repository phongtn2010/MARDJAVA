...
<div class='col-md-12'>
	<div class="row">
		<div class='col-md-6 form-group'>
			<div class='row'>
				...
				<div class="col-md-9">
					<input ${ isView ? " disabled " : ""}  id="fiSoDonDeNghi" name="fiSoDonDeNghi" class="form-control"  data-bind="value: tbdHoSo03.fiSoDonDeNghi, i18n: {  placeholder: { key: 'TbdHoSo03.fiSoDonDeNghi'}}, tooltip: { title: 'help', trigger: 'hover' }">
				</div>
			</div>
		</div>
	...
	<div class="row">
		<div class='col-md-6 form-group'>
			<div class='row'>
				...
				<div class="col-md-9">
					<input ${ isView ? " disabled " : ""}  disabled id="fiTongSoXBPham" name="fiTongSoXBPham" class="form-control"  data-bind="value: tbdHoSo03.fiTongSoXBPham, i18n: {  placeholder: { key: 'TbdHoSo03.fiTongSoXBPham'}}, numberFormatDecimalInput: function(){return '9.0';}">
				</div>
			</div>
		</div>
	...
	<div class='row'>
		...
		<div class='col-md-6 form-group'>
			<div class='row'>
				...
				<div class="col-md-9">
					...
					<div data-bind="if: $root.saveOrSend()">
						<p style="color: red; font-size: small;" data-bind="validationMessage: tbdHoSo03.fiCuaKhauNhap"></p>
					</div>
		...
		<div class='col-md-6 form-group'>
			<div class='row'>
				<label class="col-md-3" ><span data-bind="i18n: {  html: { key: 'TbdHoSo03.fiTongSoTenXBP'}}"></span><span class="nsw-require-field">*</span></label>
				<div class="col-md-9">
					<input disabled  id="fiTongSoTenXBP" name="fiTongSoTenXBP" class="form-control"  data-bind="value: tbdHoSo03.fiTongSoTenXBP, i18n: {  placeholder: { key: 'TbdHoSo03.fiTongSoTenXBP'}}, numberFormatDecimalInput: function(){return '9.0';}">
				</div>
			</div>
		</div>
