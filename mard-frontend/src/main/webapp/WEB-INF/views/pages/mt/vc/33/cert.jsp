...
<page size="A4" class="a4-padding">
        ...
        <tr>
            <td class="w35p">
                <div class="left t-center" style="white-space: nowrap">
                    <p class="content">Số <b class="content" data-bind="text: fiSoCvanDn"></b>/TCĐBVN-VT</p>
                </div>
            </td>
            <td style="vertical-align: text-top;">
    ...
    <p class="title">
        CHẤP THUẬN NGỪNG KHAI THÁC TUYẾN VẬN TẢI HÀNH KHÁCH TUYẾN CỐ ĐỊNH BẰNG XE Ô TÔ GIỮA VIỆT NAM VÀ CAMPUCHIA
    </p>
    <p class="t-center">
    ...
    <p class="content">	
        Tổng cục Đường bộ Việt Nam chấp thuận cho doanh nghiệp, HTX ngừng khai thác tuyến vận tải hành khách tuyến cố định bằng xe ô tô giữa Việt Nam và Campuchia.
    </p>
    <p class="content">
