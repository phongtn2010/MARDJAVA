...
<div class="row" id="mt-container">
    ...
    <script src="<c:url value='/app/mt/vl/17/model.js?v=${version}'/>" type="text/javascript"></script>
    <script src="<c:url value='/app/mt/vl/17/index.js?v=${version}' />" type="text/javascript"></script>
