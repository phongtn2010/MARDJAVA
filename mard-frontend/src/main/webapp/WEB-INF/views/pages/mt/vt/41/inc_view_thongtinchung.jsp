...
<fieldset>
    ...
    <div class="form-group">
        <div class="col-md-12">
            ...
            <div class="col-md-4">
                <input class="form-control date-picker" placeholder="dd/mm/yyyy" id="fiNgcapDkkd" name="fiNgcapDkkd" readonly data-bind="datepicker : fiNgcapDkkd" type="text" data-date-format="dd/mm/yyyy" />
            </div>
        </div>  
    </div>  
    ...
    <div class="form-group">
        <div class="col-md-12">
            ...
            <div class="col-md-4">
                <input class="form-control" id="fiCqCapDkkd" name="fiCqCapDkkd" readonly data-bind="value : fiCqCapDkkd" type="text" maxlength="250"/>
            </div>
