    ...
    <div class="col-md-12">
        <div class="portlet light " id="contentBody">
            <div class="panel-heading">
                <span class="caption-subject bold uppercase">Cấp Giấy phép liên vận Việt - Lào cho phương tiện thương mại (áp dụng cho phương tiện kinh doanh vận tải)</span>
            </div>
...
<script type="text/javascript" src="<c:url value="/app/mt/p05/license.module.js?v=${ version }"/>"
