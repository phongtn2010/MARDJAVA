...
<div class="row" id="mt-container">
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <span class="caption-subject bold uppercase"><i class="fa fa-gift"></i> <spring:message code="mt.58.tracuu.timkiem" /> </span>
                                </div>
                                <div class="panel-body">
                                    <form role="form" class="form-horizontal" name="searchForm">
                                        <div class="form-group" style="margin-top: 15px;">
                                            <div class="col-md-12">
                                                <div class="col-md-2 nsw-text-right">
                                                    <label><spring:message code="mt.58.tracuu.mahoso" /></label>
                                                </div>
                                                <div class="col-md-4">
                                                ...
                                                <div class="col-md-2 nsw-text-right">
                                                    <label><spring:message code="mt.58.tracuu.trangthaihoso" /></label>
                                                </div>
                                                <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                <div class="col-md-2 nsw-text-right">
                                                    <label><spring:message code="mt.58.tracuu.ngaynoptu" /></label>
                                                </div>
                                                <div class="col-md-4">   
                                                ...
                                                <div class="col-md-2 nsw-text-right">
                                                    <label ><spring:message code="mt.58.tracuu.ngaynopden" /></label>
                                                </div>
                                                <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                <div class="col-md-2 nsw-text-right">
                                                    <label><spring:message code="mt.58.tracuu.ngaycappheptu" /></label>
                                                </div>
                                                <div class="col-md-4">   
                                                ...
                                                <div class="col-md-2 nsw-text-right">
                                                    <label><spring:message code="mt.58.tracuu.ngaycapphepden" /></label>
                                                </div>
                                                <div class="col-md-4">
                                        ...
                                        <div class="form-group"> 
                                            <div class="col-md-12">
                                                <div class="col-md-2 nsw-text-right">
                                                    <label><spring:message code="mt.58.tracuu.sovanban"/></label>
                                                </div>
                                                <div class="col-md-4">
                ...
                <table class="table table-striped table-bordered table-hover table-checkable order-column" id="monre06Items">
                    <thead>
                        <tr class="nsw-tr tr-nsw1-bgcolor">
                            <th class="text-center"> <spring:message code="mt.58.danhsach.stt" /></th>
                            <th class="text-center" style="width: 100px;"> <spring:message code="mt.58.danhsach.lichsuxuly" /> </th>
                            <th class="text-center" style="width: 120px;"> <spring:message code="mt.58.danhsach.mahoso" /> </th>
                            <th class="text-center" style="max-width: 200px;"> <spring:message code="mt.58.danhsach.tendoanhnghiep" /> </th>
                            <th class="text-center" style="width: 100px;"> <spring:message code="mt.58.danhsach.ngaygui" /> </th>
                            <th class="text-center" style="width: 100px;"> <spring:message code="mt.58.danhsach.ngaycapphep" /> </th>
                            <th class="text-center"> <spring:message code="mt.58.danhsach.trangthai" /> </th>
                            <th class="text-center" style="width: 100px;"> <spring:message code="mt.58.danhsach.xemgiayphep" /> </th>
                            <th class="text-center" style="width: 25px;"> <spring:message code="mt.58.danhsach.xinrut" /> </th>
                            <th class="text-center" style="width: 25px;"> <spring:message code="mt.58.danhsach.sua" /> </th>
                            <th class="text-center" style="width: 25px;"> <spring:message code="mt.58.danhsach.xoa" /> </th>
                        </tr>
                    </thead>
    ...
    <script src="<c:url value='/app/mt/gms/58/model.js?v=${version}'/>" type="text/javascript"></script>
    <script src="<c:url value='/app/mt/gms/58/index.js?v=${version}' />" type="text/javascript"></script>
