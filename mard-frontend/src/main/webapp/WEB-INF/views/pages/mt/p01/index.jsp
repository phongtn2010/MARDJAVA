                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div style="padding-right:50px; font-size: 14px;float:right ; padding-top:15px;">Tổng hồ sơ :<b
...
<script type="text/javascript" src="<c:url value="/app/mt/p01/index.module.js?v=${ version }"/>"
        charset="utf-8"></script>
<script type="text/javascript" src="<c:url value="/app/mt/p01/model.js?v=${ version }"/>"
        charset="utf-8"></script>
