...
<page size="A4" class="a4-padding">
    ...
    <p class="title">
        CHẤP THUẬN TĂNG/ GIẢM TẦN XUẤT CHẠY XE TUYẾN VẬN TẢI HÀNH KHÁCH CỐ ĐỊNH BẰNG XE Ô TÔ GIỮA VIỆT NAM VÀ LÀO
    </p>
    <p class="t-center">
        Kính gửi: <b data-bind="text : fiTenDn"></b>
    </p>
    <p class="content">
        Căn cứ các quy định hiện hành về tổ chức, quản lý hoạt động vận tải hành khách theo tuyến cố định bằng ô tô giữa Việt Nam và Lào;
    </p>
    <p class="content">	
        Tổng cục Đường bộ Việt Nam chấp thuận cho doanh nghiệp, HTX tăng/giảm tần suất chạy xe tuyến vận tải hành khách tuyến cố định bằng xe ô tô giữa Việt Nam và Lào.
    </p>
    <p class="content">
        Tên tuyến: <b data-bind="text : fiTuyenDi"></b> đi <b data-bind="text : fiTuyenDen"></b> và ngược lại
    </p>
    <p class="content">
        Số chuyến/xe tăng /giảm khai thác trên tuyến: <b data-bind="text : fiSoChuyen"></b>
    </p>
