...
<fieldset>
    <legend><b><spring:message code="mt.37.hoso.dinhkem" /></b></legend>
    <div class="form-group">
        <div class="col-md-12">
            <table class="table table-striped table-bordered table-hover table-checkable order-column">
                <thead>
                    <tr class="nsw-tr tr-nsw1-bgcolor">
                        <th class="text-center"><spring:message code="mt.37.hoso.dinhkem.stt" /></th>
                        <th class="text-center"><spring:message code="mt.37.hoso.dinhkem.tentep" /></th>
                        <th class="text-center"><spring:message code="mt.37.hoso.dinhkem.ghichu" /></th>
                        <th class="text-center"><spring:message code="mt.37.hoso.dinhkem.tepdinhkem" /></th>
                        <th class="text-center"><spring:message code="mt.37.hoso.dinhkem.chucnang" /></th>
                    </tr>
                </thead>
                ...
                <script id="dinhKemTmpl" type="text/html">
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <a href="javascript:void(0);"><i style="color:red" class="fa fa-trash red fa-lg" data-bind="visible: canDelete, click: doDelete " src="" alt=""/></a>
                        </td>  
                    </tr>                      
                    </script>
                </table>                    
