...
<fieldset>
    ...
    <div class="form-group">
        <div class="col-md-12">
            ...
            <div class="col-md-4">
                <input class="form-control" id="fiSoGpvtVn" name="fiSoGpvtVn" data-bind="value : fiSoGpvtVn" type="text" maxlength="250"/>
            </div>
            ...
            <div class="col-md-4">
                <input class="form-control date-picker" placeholder="dd/mm/yyyy" id="fiNgayGpvtVn" name="fiNgayGpvtVn"  data-bind="datepicker : fiNgayGpvtVn" type="text" data-date-format="dd/mm/yyyy" />
            </div>
        </div>  
    </div>  
    ...
    <div class="form-group">
        <div class="col-md-12">
            ...
            <div class="col-md-4">
                <input class="form-control" id="fiCqcapGpVn" name="fiCqcapGpVn" data-bind="value : fiCqcapGpVn" type="text" maxlength="250"/>
            </div>
    ...
    <div class="form-group">
        <div class="col-md-12">
            ...
            <div class="col-md-4">
                <input class="form-control" id="fiSoGpvtTq" name="fiSoGpvtTq" data-bind="value : fiSoGpvtTq" type="text" maxlength="250"/>
            </div>
            ...
            <div class="col-md-4">
                <input class="form-control date-picker" placeholder="dd/mm/yyyy" id="fiNgayGpvtTq" name="fiNgayGpvtTq"  data-bind="datepicker : fiNgayGpvtTq" type="text" data-date-format="dd/mm/yyyy" />
            </div>
        </div>  
    </div>  
