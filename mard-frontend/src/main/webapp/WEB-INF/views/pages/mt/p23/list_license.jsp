...
<%@include file="../p05/incLanguage.jsp" %>

<div class="row">
    <div class="col-md-12">
        <div class="portlet light " id="contentBody">
            <div class="panel-heading">
                <span class="caption-subject bold uppercase">Cấp Giấy phép liên vận Việt Nam - Campuchia đối với phương tiện thương mại
</span>
            </div>
            ...
            <table class="table table-striped table-bordered table-hover table-checkable order-column"
                ...
                <tr data-bind="css: {'selected':$root.hasItem(item)}">
                    ...
                    <td class="text-center" data-bind="visible : type == 1">
                        <a href="javascript:;"
                           data-bind="click: $root.xemLichSu">
                    ...
                    <td class="text-center" data-bind="visible : type == 1">
                        <input type="checkbox" data-bind="click: $root.selectItem, checked:  $root.hasItem(item)"/>
                    </td>
                </tr>
                </tbody>
    ...
    <div class="form-group nsw-text-center">
        <a class="btn green bt-center btwidth" id="btSua" data-bind="click: $root.suaGiayPhep,visible : type == 1"> <i
                class="fa fa-edit" aria-hidden="true"></i> &nbsp;
            Xin sửa giấy phép </a>
        <a class="btn blue bt-center btwidth" id="btTra" data-bind="click: $root.traGiayPhep,visible : type == 1"> <i
...
<script type="text/javascript" src="<c:url value="/app/mt/p23/license.module.js?v=${ version }"/>"
        charset="utf-8"></script>
<script type="text/javascript" src="<c:url value="/app/mt/p23/model.js?v=${ version }"/>"
        charset="utf-8"></script>
