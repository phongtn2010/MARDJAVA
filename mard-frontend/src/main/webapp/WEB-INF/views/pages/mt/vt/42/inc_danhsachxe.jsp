            ...
            <table class="table table-striped table-bordered table-hover table-checkable order-column">
                ...
                <tbody data-bind="foreach: lstXe">
                    <tr>
                        ...
                        <td>
                            <input class="form-control date-picker " style="width: max-content" disabled id="fiDncpDenNg" name="fiDncpDenNg" data-bind="datepicker : fiDncpDenNg" type="text" data-date-format="dd/mm/yyyy" />
                        </td>
                        <td >
            ...
            <form role="form" class="form-horizontal">
                ...
                <div class="form-group">
                    <div class="col-md-12">                       
                        ...
                        <div class="col-md-4">                                        
                            <input class="form-control" name="fiMauSon" data-bind="value : fiMauSon" maxlength="250" readonly/>
