...
<fieldset>
    <legend><spring:message code="mt.42.giayphep.danhsach" /></legend> 
    <div class="form-group">
        <div class="col-md-12">
            <table class="table table-striped table-bordered table-hover table-checkable order-column">
                <thead>
                    <tr class="nsw-tr tr-nsw1-bgcolor">
                        <th class="text-center"><spring:message code="mt.42.giayphep.stt" /></th>
                        <th class="text-center"><spring:message code="mt.42.giayphep.lichsu" /></th>
                        <th class="text-center"><spring:message code="mt.42.giayphep.sogiayphep" /></th>
                        <th class="text-center"><spring:message code="mt.42.giayphep.loaigiayphep" /></th>
                        <th class="text-center"><spring:message code="mt.42.giayphep.ngaycapphep" /></th>
                        <th class="text-center"><spring:message code="mt.42.giayphep.biensoxe" /></th>
                        <th class="text-center"><spring:message code="mt.42.giayphep.trangthai" /></th>
                        <th class="text-center"><spring:message code="mt.42.giayphep.xemgiayphep" /></th>
