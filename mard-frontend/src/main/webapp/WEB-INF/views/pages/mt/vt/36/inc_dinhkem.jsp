...
<fieldset>
    <legend><b><spring:message code="mt.36.hoso.dinhkem" /></b></legend>
    <div class="form-group">
        <div class="col-md-12">
            <table class="table table-striped table-bordered table-hover table-checkable order-column">
                <thead>
                    <tr class="nsw-tr tr-nsw1-bgcolor">
                        <th class="text-center"><spring:message code="mt.36.hoso.dinhkem.stt" /></th>
                        <th class="text-center"><spring:message code="mt.36.hoso.dinhkem.tentep" /></th>
                        <th class="text-center"><spring:message code="mt.36.hoso.dinhkem.ghichu" /></th>
                        <th class="text-center"><spring:message code="mt.36.hoso.dinhkem.tepdinhkem" /></th>
                        <th class="text-center"><spring:message code="mt.36.hoso.dinhkem.chucnang" /></th>
                    </tr>
                </thead>
