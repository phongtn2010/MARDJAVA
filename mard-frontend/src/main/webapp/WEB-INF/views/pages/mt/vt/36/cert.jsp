        ...
        <form role="form" class="form-horizontal" id="form-b">
            <div class="form-group">
                ...
                <div class="col-md-12">
                    ...
                    <div class="col-md-8">
                        <input type="checkbox" disabled class="mucdichchuyendi" id="cbThuongMai" name="cbThuongMai" value="cbThuongMai"/>
                        <label for="cbThuongMai">Thương mại</label>
                        <br/>
                        <input type="checkbox" disabled class="mucdichchuyendi" id="cbCongVu" name="cbCongVu" value="cbCongVu"/>
        ...
        <form role="form" class="form-horizontal" id="form-f">
            <div class="form-group">
                ...
                <div class="col-md-12">
                    ...
                    <div class="col-md-8">
                        <input class="mucdichchuyendi" type="checkbox" id="cbThuongMai" name="cbThuongMai" value="cbThuongMai" disabled/>
                        <label for="cbThuongMai">Thương mại</label>
                        <br/>
                        <input class="mucdichchuyendi" type="checkbox" id="cbCongVu" name="cbCongVu" value="cbCongVu" disabled/>
                        <label for="cbCongVu">Công vụ</label>
                    </div>
                </div>
                <div class="col-md-12">
