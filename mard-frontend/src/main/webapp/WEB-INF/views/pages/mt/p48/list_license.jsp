...
<div class="row">
		...
		<div class="portlet light " id="contentBody">
			<div class="panel-heading">
				<span class="caption-subject bold uppercase">Danh sách Giấy
					phép liên vận CLV đối với phương tiện thương mại</span>
			</div>
			...
			<table
				...
				<tbody id="list-container"
					...
					<tr data-bind="css: {'selected':$root.hasItem(item)}">
						...
						<td class="text-center" data-bind="text: item?item.fiSoDangKy:''"></td>
						<td class="text-center"
						...
						<td class="text-center" data-bind="visible : type == 1"><input type="checkbox"
							data-bind="click: $root.selectItem, checked:  $root.hasItem(item)" />
						</td>
					</tr>
				</tbody>
	...
	<div class="form-group nsw-text-center">
		<a class="btn green bt-center btwidth" id="btSua"
			data-bind="click: $root.suaGiayPhep,visible : type == 1"> <i class="fa fa-edit"
			aria-hidden="true"></i> &nbsp; Xin sửa giấy phép
		</a> <a class="btn blue bt-center btwidth" id="btTra"
			data-bind="click: $root.traGiayPhep,visible : type == 1"> <i class="fa fa-undo"
			aria-hidden="true"></i></i>&nbsp; Trả lại giấy phép
...
<script type="text/javascript"
	src="<c:url value="/app/mt/p48/license.module.js?v=${ version }"/>"
	charset="utf-8"></script>
<script type="text/javascript"
	src="<c:url value="/app/mt/p48/model.js?v=${ version }"/>"
	charset="utf-8"></script>
