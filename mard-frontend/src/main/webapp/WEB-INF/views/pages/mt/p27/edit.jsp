                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group" style="margin-top: 15px;">
                            <div class="col-md-12">
                                <div class="col-md-2 label-text-right">
                                    <label>Giấy chứng nhận đăng ký kinh doanh số<span class="nsw-require-field">*</span></label>
                                </div>
                                <div class="col-md-4"
                        ...
                        <div class="form-group" style="margin-top: 15px;">
                            <div class="col-md-12">
                                ...
                                <div class="col-md-4">
                                    <input class="form-control" data-bind="value: hoSoChiTiet.Tbdhoso.fiCoquancapphep"
...
<script type="text/javascript" src="<c:url value="/app/mt/p27/edit.module.js?v=${ version }"/>"
        charset="utf-8"></script>
