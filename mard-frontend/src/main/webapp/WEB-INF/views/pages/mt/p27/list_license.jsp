    ...
    <div class="col-md-12">
        <div class="portlet light " id="contentBody">
            <div class="panel-heading">
                <span class="caption-subject bold uppercase">Cấp Giấy phép liên vận Việt Nam - Campuchia cho phương tiện phi thương mại
</span>
            </div>
...
<script type="text/javascript" src="<c:url value="/app/mt/p27/license.module.js?v=${ version }"/>"
