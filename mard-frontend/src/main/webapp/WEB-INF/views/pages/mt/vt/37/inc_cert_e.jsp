...
<template id="form-e-template">
    <div class="row">
    <form role="form" class="form-horizontal" id="form-e">
        <div class="form-group">
            ...
            <div class="col-md-12">
                <div class="col-md-2 nsw-text-right">
                    <label><spring:message code="mt.37.giayphep.bendi" />: </label>
                </div>
                <div class="col-md-4">
                    <input class="form-control" type="text" data-bind="value : fiBenDi" readonly="readonly"/>
                </div>
                <div class="col-md-2 nsw-text-right">
                    <label><spring:message code="mt.37.giayphep.benden" />: </label>
                </div>
                <div class="col-md-4">
                    <input class="form-control" type="text" data-bind="value : fiBenDen" readonly="readonly"/>
                </div>
            </div> 
            <div class="col-md-12">
                <div class="col-md-2 nsw-text-right">
                    <label><spring:message code="mt.37.giayphep.hanhtrinh3" />: </label>
                </div>
                <div class="col-md-8">
