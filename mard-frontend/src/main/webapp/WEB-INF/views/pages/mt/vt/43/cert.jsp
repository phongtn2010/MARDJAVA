...
<fieldset>
    <legend><spring:message code="mt.43.giayphep.danhsach" /></legend> 
    <div class="form-group">
        <div class="col-md-12">
            <table class="table table-striped table-bordered table-hover table-checkable order-column">
                <thead>
                    <tr class="nsw-tr tr-nsw1-bgcolor">
                        <th class="text-center"><spring:message code="mt.43.giayphep.stt" /></th>
                        <th class="text-center"><spring:message code="mt.43.giayphep.lichsu" /></th>
                        <th class="text-center"><spring:message code="mt.43.giayphep.sogiayphep" /></th>
                        <th class="text-center"><spring:message code="mt.43.giayphep.loaigiayphep" /></th>
                        <th class="text-center"><spring:message code="mt.43.giayphep.ngaycapphep" /></th>
                        <th class="text-center"><spring:message code="mt.43.giayphep.biensoxe" /></th>
                        <th class="text-center"><spring:message code="mt.43.giayphep.trangthai" /></th>
                        <th class="text-center"><spring:message code="mt.43.giayphep.xemgiayphep" /></th>
