...
<div class="row" id="mt-container">
        ...
        <div class="portlet light ">
            <div class="portlet-title">
                <div class="caption font-dark">
                    ...
                    <span class="caption-subject bold uppercase"> <spring:message code="mt.34.tenthutuc" /></span>
                </div>
            </div>
    ...
    <script src="<c:url value='/app/mt/vc/34/model.js?v=${version}'/>" type="text/javascript"></script>
    <script src="<c:url value='/app/mt/vc/34/index.js?v=${version}' />" type="text/javascript"></script>
