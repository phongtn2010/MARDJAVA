...
<div class="row" id="mt-container">
    ...
    <script src="<c:url value='/app/mt/vt/44/model.js?v=${version}'/>" type="text/javascript"></script>
    <script src="<c:url value='/app/mt/vt/44/index.js?v=${version}' />" type="text/javascript"></script>
