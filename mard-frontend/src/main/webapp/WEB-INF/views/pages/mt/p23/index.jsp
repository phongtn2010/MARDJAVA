                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <table class="table table-striped table-bordered table-hover table-checkable order-column"
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center" data-bind="if: item.fiTrangthai()==7"><a
                                                    href="javascript:;"
                                                    data-bind="click: $root.xemGiayPhep"><i class="fa fa-list-alt"
                                                                                            aria-hidden="true"></i>
                                            </a></td>
                                            <td class="text-center"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="text-right" style="padding-right:50px; font-size: 14px;padding-top:15px;">Tổng hồ sơ :<b
                                                data-bind="text:totalData()"></b></div>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script type="text/javascript" src="<c:url value="/app/mt/p23/index.module.js?v=${ version }"/>"
        charset="utf-8"></script>
