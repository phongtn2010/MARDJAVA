    ...
    <div class="doc">
        ...
        <P CLASS="western" ALIGN=CENTER STYLE="margin-top: 0.08in; margin-bottom: 0in">
            <FONT SIZE=3><B>GIẤY PHÉP VẬN TẢI ĐƯỜNG BỘ QUỐC TẾ
                VIỆT NAM - CAMPUCHIA<BR>VIET NAM - CAMBODIA INTERNATIONAL ROAD
        ...
        <div class="form-group">
            <div class="col-md-12">
                <div>
                    <p style="font-size: 12pt;">Link giấy phép: <a target="_blank" data-bind="text: 'Giấy phép vận tải đường bộ quốc tế Việt Nam - Campuchia', attr: { href: giayphep.fiLinkGiayphep}"></a></p>
                </div>
            </div>
        </div>
    </div>
