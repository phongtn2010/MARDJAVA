...
<template id="form-d-template">
    <div class="row">
    <form role="form" class="form-horizontal" id="form-d">
        <div class="form-group">
            <div class="col-md-12">
                <div class="col-md-2 nsw-text-right">
                    <label><spring:message code="mt.41.giayphep.sogiayphep" />: </label>
                </div>
                <div class="col-md-4">
                    <input class="form-control" type="text" data-bind="value : fiSoGp" readonly="readonly"/>
                </div>
                <div class="col-md-2 nsw-text-right">
                    <label><spring:message code="mt.41.giayphep.tendoanhnghiep" />: </label>
                </div>
                <div class="col-md-4">
            ...
            <div class="col-md-12">
                <div class="col-md-2 nsw-text-right">
                    <label><spring:message code="mt.41.giayphep.diachi" />: </label>
                </div>
                <div class="col-md-4">
                    <input class="form-control" type="text" data-bind="value : fiDiachiDn" readonly="readonly"/>
                </div>
                <div class="col-md-2 nsw-text-right">
                    <label><spring:message code="mt.41.giayphep.dienthoai" />: </label>
                </div>
                <div class="col-md-4">
            ...
            <div class="col-md-12">
                <div class="col-md-2 nsw-text-right">
                    <label><spring:message code="mt.41.giayphep.nguoiky" />: </label>
                </div>
                <div class="col-md-4">  
                    <input class="form-control" type="text" data-bind="value : fiTenNgKy" readonly="readonly"/>
                </div>
                <div class="col-md-2 nsw-text-right">
                    <label><spring:message code="mt.41.giayphep.chucdanh" />: </label>
                </div>
                <div class="col-md-4">  
            ...
            <div class="col-md-12">
                <div class="col-md-2 nsw-text-right">
                    <label><spring:message code="mt.41.giayphep.diadiemky" />: </label>
                </div>
                <div class="col-md-4">
                    <input class="form-control" type="text" data-bind="value : fiDiaDiem" readonly="readonly"/>
                </div>
                <div class="col-md-2 nsw-text-right">
                    <label><spring:message code="mt.41.giayphep.ngayky" />: </label>
                </div>
                <div class="col-md-4">  
            ...
            <div class="col-md-12">
                <div class="col-md-2 nsw-text-right">
                    <label><spring:message code="mt.41.giayphep.giatritungay" />: </label>
                </div>
                <div class="col-md-4">
                    <input class="form-control" type="text" data-bind="value : fiGpTuNgayText" readonly="readonly"/>
                </div>
                <div class="col-md-2 nsw-text-right">
                    <label><spring:message code="mt.41.giayphep.giatridenngay" />: </label>
                </div>
                <div class="col-md-4">  
            ...
            <div class="col-md-12">
                <div class="col-md-2 nsw-text-right">
                    <label><spring:message code="mt.41.giayphep.biensoxe" />: </label>
                </div>
                <div class="col-md-4">
                    <input class="form-control" type="text" data-bind="value : fiBksXe" readonly="readonly"/>
                </div>
                <div class="col-md-2 nsw-text-right">
                    <label><spring:message code="mt.41.giayphep.soghe" />: </label>
                </div>
                <div class="col-md-4">
            ...
            <div class="col-md-12">
                <div class="col-md-2 nsw-text-right">
                    <label><spring:message code="mt.41.giayphep.sokhung" />: </label>
                </div>
                <div class="col-md-4">
                    <input class="form-control" type="text" data-bind="value : fiSoKhung" readonly="readonly"/>
                </div>
                <div class="col-md-2 nsw-text-right">
                    <label><spring:message code="mt.41.giayphep.somay" />: </label>
                </div>
                <div class="col-md-4">
            ...
            <div class="col-md-12">
                <div class="col-md-2 nsw-text-right">
                    <label><spring:message code="mt.41.giayphep.mauson" />: </label>
                </div>
                <div class="col-md-4">
                    <input class="form-control" type="text" data-bind="value : fiMauSon" readonly="readonly"/>
                </div>
                <div class="col-md-2 nsw-text-right">
                    <label><spring:message code="mt.41.giayphep.nhanhieu" />: </label>
                </div>
                <div class="col-md-4">
            ...
            <div class="col-md-12">
                <div class="col-md-2 nsw-text-right">
                    <label><spring:message code="mt.41.giayphep.hanhtrinh3" />: </label>
                </div>
                <div class="col-md-8">
            ...
            <div class="col-md-12">
                <div class="col-md-2 nsw-text-right">
                    <label><spring:message code="mt.41.giayphep.tuyenvantaitu" />: </label>
                </div>
                <div class="col-md-4">
                    <input class="form-control" type="text" data-bind="value : fiTuyenDi" readonly="readonly"/>
                </div>
                <div class="col-md-2 nsw-text-right">
                    <label><spring:message code="mt.41.giayphep.tuyenvantaiden" />: </label>
                </div>
                <div class="col-md-4">
            ...
            <div class="col-md-12">
                <div class="col-md-2 nsw-text-right">
                    <label><spring:message code="mt.41.giayphep.loaihanghoa" />: </label>
                </div>
                <div class="col-md-8">
            ...
            <div class="col-md-12">
                <div class="col-md-2 nsw-text-right">
                    <label><spring:message code="mt.41.giayphep.link" />: </label>
                </div>
                <div class="col-md-8">
