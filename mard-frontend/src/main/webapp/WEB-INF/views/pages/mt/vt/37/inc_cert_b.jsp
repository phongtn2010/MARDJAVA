        ...
        <form role="form" class="form-horizontal" id="form-b">
            <div class="form-group">
                ...
                <div class="col-md-12">
                    ...
                    <div class="col-md-2 nsw-text-right">
                        <label><spring:message code="mt.37.giayphep.sohanhkhach" />: </label>
                    </div>
                    <div class="col-md-4">
                ...
                <div class="col-md-12">
                    <div class="col-md-2 nsw-text-right">
                        <label><spring:message code="mt.37.giayphep.hanhtrinh" />: </label>
                    </div>
                    <div class="col-md-8">
                ...
                <div class="col-md-12">
                    <div class="col-md-2 nsw-text-right">
                        <label><spring:message code="mt.37.giayphep.mucdich" />: </label>
                    </div>
                    <div class="col-md-8">
                        <input type="checkbox" disabled id="cbThuongMai" name="cbThuongMai" value="cbThuongMai"/>
                        <label for="cbThuongMai">Thương mại</label>
                        <br/>
                        <input type="checkbox" disabled id="cbCongVu" name="cbCongVu" value="cbCongVu"/>
