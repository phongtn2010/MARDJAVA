        ...
        <div class="portlet light ">
            <div class="portlet-title">
                <div class="caption font-dark">
                    <span class="caption-subject bold uppercase"> <spring:message code="mt.17.tenthutuc" /></span>
                </div>
            </div>
                                ...
                                <div class="tab-content" >
                                    ...
                                    <div class="tab-pane active" id="tab_mt_1" >
                                        <form role="form" class="form-horizontal">
                                            ...
                                            <%@include file="inc_view_tuyenxedieuchinh.jsp" %>
...
<script src="<c:url value='/app/mt/vl/17/model.js?v=${version}'/>" type="text/javascript" charset="utf-8"></script>
<script src="<c:url value='/app/mt/vl/17/FormVM.js?v=${version}'/>" type="text/javascript" charset="utf-8"></script>
<script src="<c:url value='/app/mt/vl/17/FileVM.js?v=${version}'/>" type="text/javascript" charset="utf-8"></script>
<script src="<c:url value='/app/mt/vl/17/ResultVM.js?v=${version}'/>" type="text/javascript" charset="utf-8"></script>
<script src="<c:url value='/app/mt/vl/17/ViewVM.js?v=${version}'/>" type="text/javascript" charset="utf-8"></script>
