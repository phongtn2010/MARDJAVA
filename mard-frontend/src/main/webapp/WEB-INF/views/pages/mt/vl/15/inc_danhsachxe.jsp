            ...
            <table class="table table-striped table-bordered table-hover table-checkable order-column" id="lstHanghoa10">
                ...
                <tbody data-bind="foreach: lstXe">
                    <tr>
                        ...
                        <td>
                            <input class="form-control" name="fiBksXe" data-bind="value : fiBksXe" maxlength="250" readonly/>
                        </td> 
                        <td>
                        ...
                        <td>
                            <input class="form-control" name="fiNamSx" data-bind="value : fiNamSx" maxlength="250" readonly/>
                        </td>
                        <td style="width: 220px">
                        ...
                        <td>
                            <input class="form-control" name="fiBksXeKoHd" data-bind="value : fiBksXeKoHd" maxlength="50" readonly/>
                        </td>
        ...
        <div class="col-md-12">
            <form role="form" class="form-horizontal">
                ...
                <div class="form-group">
                    <div class="col-md-12">
                        <div class="col-md-2 nsw-text-right">
                            <label><spring:message code="mt.hoso.danhsachxe.xengung" /> <a class="nsw-require-field">*</a></label>
                        </div>
                        <div class="col-md-4">
                            <select class="form-control select2 fiBksXeKoHd" id="fiBksXeKoHd-New" name="fiBksXeKoHd" data-bind="optionsCaption: '...Chọn...', 
                                    optionsValue : 'fiBksXe', 
                                    value : fiBksXeKoHd, options : lstXe, 
                                    optionsText : 'fiBksXe'"></select>
                        </div>
                        <div class="col-md-2 nsw-text-right">
