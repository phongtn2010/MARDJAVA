    ...
    <div class="col-md-12">
        <div class="portlet light " id="contentBody">
            <div class="panel-heading">
                <span class="caption-subject bold uppercase">Danh sách Giấy phép liên vận Việt - Lào cho phương tiện phi thương mại
                </span>
            </div>
...
<script type="text/javascript" src="<c:url value="/app/mt/p09/license.module.js?v=${ version }"/>"
        charset="utf-8"></script>
<script type="text/javascript" src="<c:url value="/app/mt/p09/model.js?v=${ version }"/>"
        charset="utf-8"></script>
