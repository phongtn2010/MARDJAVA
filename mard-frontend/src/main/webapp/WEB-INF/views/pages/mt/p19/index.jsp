                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="text-right" style="padding-right:50px; font-size: 14px">Tổng hồ sơ :<b
...
<script type="text/javascript" src="<c:url value="/app/mt/p19/index.module.js?v=${ version }"/>"
