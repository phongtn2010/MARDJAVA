                        ...
                        <form role="form" class="form-horizontal">
                            ...
                            <div class="form-group">
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-10">
                                        <input class="form-control" id="fiTenNhh" name="fiTenNhh" maxlength="250"  
                            ...
                            <div class="form-group">
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-4">
                                        <input class="form-control" id="fiHochieu" name="fiHochieu" maxlength="50"  
                                    ...
                                    <div class="col-md-4">
                                        <input class="form-control datepicker" id="fiNgaycapHochieu" name="fiNgaycapHochieu" readonly style="background-color: #fff !important" 
                                               type="text" data-bind=" datepicker : fiNgaycapHochieu,event:{change:validTimeInOut}" placeholder="dd/mm/yyyy" data-date-format="dd/mm/yyyy"/>
                                    ...
                                    <table class="table table-striped table-bordered table-hover table-checkable order-column">
                                        ...
                                        <tbody data-bind="foreach: lstHanghoa01s">
                                            <tr>
                                                ...
                                                <td><input class="form-control"  name="fiTenhanghoa" data-bind="value : fiTenhanghoa" maxlength="500"/></td>
                                                <td><input class="form-control"  name="fiMahs" data-bind="value : fiMahs" maxlength="250"/></td>
                                                <td><input class="form-control"  name="fiChungloai" data-bind="value : fiChungloai" maxlength="500"/></td>
                                                <td><input class="form-control"  style="text-align: right;" name="fiSoluong" data-bind="value : fiSoluong" maxlength="15"/></td>
                                                <td><input class="form-control"  name="fiTenDvt" data-bind="value : fiTenDvt" maxlength="50"/></td>
                                            ...
                                            <span class="validationMessage" style="display: none;" data-bind="attr: {'id': 'hh_lbl_' + STT()}">Khai báo ít nhất 1 hàng hóa</span><br>
                            ...
                            <div class="form-group">
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-10">
                                        <input class="form-control" id="fiLydo" name="fiLydo" maxlength="500"  
                            ...
                            <div class="form-group">
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-4">
                                        <select class="form-control select2" id="fiHinhthuc" name="fiHinhthuc" data-bind="
                                            optionsCaption: '---Chọn---', 
                                            optionsValue : 'id', 
                                            value : fiHinhthuc,
                                            options : lstHinhthuc,
                                            event:{change:changeHTItem},
                                    ...
                                    <div class="col-md-4">
                                        <input class="form-control" id="fiPtVanchuyen" name="fiPtVanchuyen" maxlength="250"  
                            ...
                            <div class="form-group">
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-4">
                                        <input class="form-control datepicker" name="fiThoigianvaoTungay" id="fiThoigianvaoTungay" 
                                    ...
                                    <div class="col-md-4">
                                        <input class="form-control datepicker" id="fiThoigianvaoDenngay" name="fiThoigianvaoDenngay" 
                            ...
                            <div class="form-group">
                                <div class="col-md-12">
                                    <div class="col-md-2 nsw-text-right">
                                        <label>
                                            <spring:message code="bca.01.hoso.thontinnhomhh.tgratungay" />
                                            <a class="nsw-require-field" data-bind="attr: {'id': 'tgratungay_lbl_' + STT()}" style="display: none;">*</a>
                                        </label>
                                    </div>
                                    <div class="col-md-4">
                                        <input class="form-control datepicker" id="fiThoigianraTungay" name="fiThoigianraTungay"  
                                    ...
                                    <div class="col-md-2 nsw-text-right">
                                        <label>
                                            <spring:message code="bca.01.hoso.thontinnhomhh.tgradenngay" />
                                            <a class="nsw-require-field" data-bind="attr: {'id': 'tgradenngay_lbl_' + STT()}" style="display: none;">*</a>
                                        </label>
                                    </div>
                                    <div class="col-md-4">
                                        <input class="form-control datepicker" id="fiThoigianraDenngay" name="fiThoigianraDenngay" 
                            ...
                            <div class="form-group">
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-4">
                                        <input class="form-control" id="fiCuakhauVao" name="fiCuakhauVao" maxlength="250"  
                                    ...
                                    <div class="col-md-4">
                                        <input class="form-control" id="fiCuakhauRa" name="fiCuakhauRa" maxlength="250"  
