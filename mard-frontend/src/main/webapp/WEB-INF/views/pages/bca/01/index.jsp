...
<div class="row" id="mt-container">
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <span class="caption-subject bold uppercase"><i class="fa fa-gift"></i> <spring:message code="bca.01.hoso.tracuu.timkiem" /> </span>
                                </div>
                                <div class="panel-body">
                                    <form role="form" class="form-horizontal" name="searchForm">
                                        <div class="form-group" style="margin-top: 15px;">
                                            <div class="col-md-12">
                                                <div class="col-md-2 nsw-text-right">
                                                    <label><spring:message code="bca.01.hoso.tracuu.mahoso" /></label>
                                                </div>
                                                <div class="col-md-4">
                                                ...
                                                <div class="col-md-2 nsw-text-right">
                                                    <label><spring:message code="bca.01.hoso.tracuu.trangthaihoso" /></label>
                                                </div>
                                                <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                <div class="col-md-2 nsw-text-right">
                                                    <label><spring:message code="bca.01.hoso.tracuu.ngaynoptu" /></label>
                                                </div>
                                                <div class="col-md-4">   
                                                    <input name="ngayTaoTuNgay" id="ngayTaoTuNgay" placeholder="dd/mm/yyyy" data-bind="datepicker : ngayTaoTuNgay" class="form-control form-control-inline date-picker" data-date-format="dd/mm/yyyy"  type="text" value="" maxlength="10" />
                                                </div>

                                                <div class="col-md-2 nsw-text-right">
                                                    <label ><spring:message code="bca.01.hoso.tracuu.ngaynopden" /></label>
                                                </div>
                                                <div class="col-md-4">
                                                    <input name="ngayTaoDenNgay" id="ngayTaoDenNgay" placeholder="dd/mm/yyyy" data-bind="datepicker : ngayTaoDenNgay" class="form-control form-control-inline date-picker" data-date-format="dd/mm/yyyy" size="16" type="text" value="" maxlength="10" />
                                                </div>
                                            </div>  
                                        </div>
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                <div class="col-md-2 nsw-text-right">
                                                    <label><spring:message code="bca.01.hoso.tracuu.ngaycappheptu" /></label>
                                                </div>
                                                <div class="col-md-4">   
                                                    <input name="ngayCapTuNgay" id="ngayCapTuNgay" placeholder="dd/mm/yyyy" data-bind="datepicker : ngayCapTuNgay" class="form-control form-control-inline date-picker" data-date-format="dd/mm/yyyy"  type="text" value="" maxlength="10" />
                                                </div>

                                                <div class="col-md-2 nsw-text-right">
                                                    <label><spring:message code="bca.01.hoso.tracuu.ngaycapphepden" /></label>
                                                </div>
                                                <div class="col-md-4">
                                                    <input name="ngayCapDenNgay" id="ngayCapDenNgay" placeholder="dd/mm/yyyy" data-bind="datepicker : ngayCapDenNgay" class="form-control form-control-inline date-picker" data-date-format="dd/mm/yyyy" size="16" type="text" value="" maxlength="10" />
                                                </div>
                                            </div>  
                                        </div>
                ...
                <table class="table table-striped table-bordered table-hover table-checkable order-column" id="monre06Items">
                    <thead>
                        <tr class="nsw-tr tr-nsw1-bgcolor">
                            <th class="text-center"> <spring:message code="bca.01.hoso.danhsach.stt" /></th>
                            <th class="text-center" style="width: 100px;"> <spring:message code="bca.01.hoso.danhsach.lichsuxuly" /> </th>
                            <th class="text-center" style="width: 120px;"> <spring:message code="bca.01.hoso.danhsach.mahoso" /> </th>
                            <th class="text-center" style="max-width: 200px;"> <spring:message code="bca.01.hoso.danhsach.tendoanhnghiep" /> </th>
                            <th class="text-center" style="width: 100px;"> <spring:message code="bca.01.hoso.danhsach.ngaygui" /> </th>
                            <th class="text-center" style="width: 100px;"> <spring:message code="bca.01.hoso.danhsach.ngaycapphep" /> </th>
                            <th class="text-center"> <spring:message code="bca.01.hoso.danhsach.trangthai" /> </th>
                            <th class="text-center" style="width: 100px;"> <spring:message code="bca.01.hoso.danhsach.xemgiayphep" /> </th>
                            <th class="text-center" style="width: 100px;"> <spring:message code="bca.01.hoso.danhsach.thongtinphi" /> </th>
                            <th class="text-center" style="width: 25px;"> <spring:message code="bca.01.hoso.danhsach.xinsua" /> </th>
                            <th class="text-center" style="width: 25px;"> <spring:message code="bca.01.hoso.danhsach.xinrut" /> </th>
                            <th class="text-center" style="width: 25px;"> <spring:message code="bca.01.hoso.danhsach.sua" /> </th>
                            <th class="text-center" style="width: 25px;"> <spring:message code="bca.01.hoso.danhsach.xoa" /> </th>
                        </tr>
                    </thead>
                    ...
                    <script id="itemTmpl" type="text/html">
                        <tr>
                            ...
                            <td class="text-center" data-bind="date : fiNgaycapGp"></td> 
                            ...
                            <td class="text-center">
                                <a href="javascript:void(0)"><i class="fa fa-lg fa-search tooltips" data-original-title="Thông tin phí" data-bind="visible: bThongTinPhi, click: $parent.bThongTinPhiClick.bind($parent)" src="" alt=""/></a>
                            </td>
                            <td class="text-center">
                                <a href="javascript:void(0)"><i class="fa fa-lg fa-edit tooltips" data-original-title="Sửa hồ sơ" data-bind="visible: bXinSuaHoSo, click: $parent.bXinSuaClick.bind($parent)" src="" alt=""/></a>
                            </td> 
                            <td class="text-center">
    ...
    <script src="<c:url value='/app/bca/01/model.js?v=${version}'/>" type="text/javascript"></script>
    <script src="<c:url value='/app/bca/01/index.js?v=${version}' />" type="text/javascript"></script>
    ...
    <template id="history-tmpl">
        <form role="form" class="form-horizontal" id="history-form">
            ...
            <table class="table table-striped table-bordered table-hover table-checkable order-column">
                <thead>
                    <tr>
                        <th class="text-center"><b><spring:message code="bca.01.hoso.lichsu.stt" /></b></th>
                        <th class="text-center" style="text-align: center;"><b><spring:message code="bca.01.hoso.lichsu.donvixuly" /></b></th>
                        <th class="text-center" style="max-width: 200px; text-align: center;"><b><spring:message code="bca.01.hoso.lichsu.noidung" /></b></th>
                        <th class="text-center" style="text-align: center;"><b><spring:message code="bca.01.hoso.lichsu.thoigian" /></b></th>
                        <th class="text-center" style="max-width: 200px;text-align: center;"><b><spring:message code="bca.01.hoso.lichsu.trangthaihoso" /></b></th>
                    </tr>
                </thead>
