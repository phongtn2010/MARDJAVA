                                ...
                                <div class="tab-content" >
                                    ...
                                    <div class="tab-pane active" id="tab_mt_1" >
                                        <form role="form" class="form-horizontal" data-bind="with: formVM()">
                                            ...
                                            <%@include file="inc_view_nhomhanghoa.jsp" %>
...
<script src="<c:url value='/app/bca/01/ResultVM.js?v=${version}'/>" type="text/javascript" charset="utf-8"></script>
<script src="<c:url value='/app/bca/01/ViewVM.js?v=${version}'/>" type="text/javascript" charset="utf-8"></script>
