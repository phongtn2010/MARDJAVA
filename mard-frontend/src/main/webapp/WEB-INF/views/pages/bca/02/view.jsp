                                    ...
                                    <div class="tab-pane" id="tab_mt_2" data-bind="visible: showCert">
                                        <form role="form" class="form-horizontal">
                                            ...
                                            <p class="nsw-text-center">
                                                <a data-bind="click : btnXinSuaCVClick" href="javascript:void(0);" class="btn blue "><i class="fa fa-edit"></i> Xin sửa giấy phép</a>
                                            </p>
                                        </form>
                                    </div>
...
<script src="<c:url value='/app/bca/02/model.js?v=${version}'/>" type="text/javascript" charset="utf-8"></script>
<script src="<c:url value='/app/bca/02/FormVM.js?v=${version}'/>" type="text/javascript" charset="utf-8"></script>
<script src="<c:url value='/app/bca/02/FileVM.js?v=${version}'/>" type="text/javascript" charset="utf-8"></script>
<script src="<c:url value='/app/bca/02/ResultVM.js?v=${version}'/>" type="text/javascript" charset="utf-8"></script>
<script src="<c:url value='/app/bca/02/ViewVM.js?v=${version}'/>" type="text/javascript" charset="utf-8"></script>
