...
<fieldset>    
    ...
    <div class="form-group">
        <div class="col-md-12">
            ...
            <div class="col-md-4">
                <input class="form-control date-picker" placeholder="dd/mm/yyyy" id="fiNgaytao" name="fiNgaytao"  data-bind="datepicker : fiNgaytao" type="text" data-date-format="dd/mm/yyyy" disabled/>
            </div>
            <div class="col-md-2 nsw-text-right">
    ...
    <div class="form-group">
        <div class="col-md-12">
            ...
            <div class="col-md-4">                                        
                <input class="form-control" type="text" id="fiMst" name="fiMst" disabled data-bind="value : fiMst" maxlength="13" />
            </div>
        </div>  
    </div> 
    <div class="form-group">
    ...
    <div class="form-group">
        <div class="col-md-12">
            ...
            <div class="col-md-4">
                <input class="form-control" id="fiNguoiDaidien" name="fiNguoiDaidien" type="text" data-bind="value: fiNguoiDaidien" maxlength="100"/>
            </div>     
            <div class="col-md-2 nsw-text-right">
                <label><spring:message code="bca.02.hoso.thongtinchung.chucvu" /> <a class="nsw-require-field">*</a></label>
            </div>
            <div class="col-md-4">
                <input class="form-control" id="fiChucvuDaidien" name="fiChucvuDaidien" type="text" data-bind="value: fiChucvuDaidien" maxlength="50"/>
            </div> 
        </div>  
    </div>
    <div class="form-group">
        <div class="col-md-12">
            ...
            <div class="col-md-4">
                <input class="form-control" id="fiSoCmnd" name="fiSoCmnd" type="text" data-bind="value: fiSoCmnd" maxlength="50"/>
            </div>     
            <div class="col-md-2 nsw-text-right">
                <label><spring:message code="bca.02.hoso.thongtinchung.ngaycap" /> <a class="nsw-require-field">*</a></label>
            </div>
            <div class="col-md-4">
                <input class="form-control date-picker" placeholder="dd/mm/yyyy" id="fiNgaycapCmnd" name="fiNgaycapCmnd"  data-bind="datepicker : fiNgaycapCmnd,event:{change:changeValidDate}" type="text" data-date-format="dd/mm/yyyy" readonly style="background-color: #fff"/>
                <span class="validationMessage" style="display: none" id="fiNgaycapCmnd-lbl">Thông tin bắt buộc nhập</span>
            </div> 
        </div>  
    </div>
    ...
    <div class="form-group">
        <div class="col-md-12">
            ...
            <div class="col-md-4">
                <input class="form-control" id="fiNoicapCmnd" name="fiNoicapCmnd" type="text" data-bind="value: fiNoicapCmnd" maxlength="250"/>
            </div>         
        </div>  
    </div>
    <div class="form-group">
        <div class="col-md-12">
            ...
            <div class="col-md-4">
                <input class="form-control" id="fiHoadonSo" name="fiHoadonSo" type="text" data-bind="value: fiHoadonSo" maxlength="50"/>
            </div>     
            <div class="col-md-2 nsw-text-right">
                <label><spring:message code="bca.02.hoso.thongtinchung.ngayhoadon" /> <a class="nsw-require-field">*</a></label>
            </div>
            <div class="col-md-4">
                <input class="form-control date-picker" placeholder="dd/mm/yyyy" id="fiHoadonNgay" name="fiHoadonNgay"  data-bind="datepicker : fiHoadonNgay,event:{change:changeValidDate}" type="text" data-date-format="dd/mm/yyyy" readonly style="background-color: #fff"/>
                <span class="validationMessage" style="display: none" id="fiHoadonNgay-lbl">Thông tin bắt buộc nhập</span>
            </div> 
        </div>  
    </div>
    <div class="form-group">
        <div class="col-md-12">
            ...
            <div class="col-md-4">
                <input class="form-control" id="fiHoadonTencqc" name="fiHoadonTencqc" type="text" data-bind="value: fiHoadonTencqc" maxlength="250"/>
            </div>         
        </div>  
    </div>
</fieldset>
