                        ...
                        <form role="form" class="form-horizontal">
                            ...
                            <div class="form-group">
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-4">
                                        <input disabled class="form-control datepicker"  name="fiThoigianraTungay" maxlength="255"  
                                               type="text" data-bind="datepicker : fiThoigianraTungay"  data-date-format="dd/mm/yyyy"/>
                                    </div>
                                    <div class="col-md-2 nsw-text-right">
                                        <label><spring:message code="bca.01.hoso.thontinnhomhh.tgradenngay" /></label>
                                    </div>
                                    <div class="col-md-4">
                                        <input disabled class="form-control datepicker"  name="fiThoigianraDenngay" maxlength="255"  
                                               type="text" data-bind="datepicker : fiThoigianraDenngay"  data-date-format="dd/mm/yyyy"/>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
