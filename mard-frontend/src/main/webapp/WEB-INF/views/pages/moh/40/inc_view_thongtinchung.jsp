...
<fieldset>
    ...
    <div class="form-group">
        <div class="col-md-12">
            ...
            <div class="col-md-4">
                <input class="form-control" readonly="readonly" name="fiNguoiDd" data-bind="value : fiNguoiDd" type="text" maxlength="100"/>
            </div>
    ...
    <div class="form-group">
        <div class="col-md-12">
            ...
            <div class="col-md-4">
                <select class="form-control select2" disabled id="fiMucDichNk" name="fiMucDichNk" data-bind="optionsCaption: 'Chọn...', optionsValue : 'id', value : fiMucDichNk, options : lstMucDichNhapKhau, optionsText : 'name'"></select>
            </div> 
            ...
            <div class="col-md-4" data-bind="visible: visibleCuaKhau">
                <select class="form-control select2 fiMaCuaKhau" disabled
                        id="fiMaCuaKhau" name="fiMaCuaKhau" multiple="multiple" 
