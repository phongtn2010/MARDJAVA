            ...
            <form role="form" class="form-horizontal" id="chungloai-form">
                <div class="form-group">
                    <div class="col-md-12">
                        ...
                        <div class="col-md-9">
                            <input class="form-control" readonly="true" type="text" id="fiMaSpCl" name="fiMaSpCl" data-bind="value : fiMaSpCl" maxlength="255" />
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-md-12">
                        ...
                        <div class="col-md-9">
                            <input class="form-control" readonly="true" type="text" id="fiDongGoiCl" name="fiDongGoiCl" data-bind="value : fiDongGoiCl" maxlength="255" />
                        </div>
                    </div>
                </div>
