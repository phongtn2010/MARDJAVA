        ...
        <div class="portlet light ">
            <div class="portlet-title">
                <div class="caption font-dark">
                    ...
                    <span class="caption-subject bold uppercase"><span class="caption-subject bold uppercase"> <spring:message code="moh.43.tenthutuc" /></span>
                </div>
            </div>
                                ...
                                <div class="panel-body">
                                    <form role="form" class="form-horizontal" name="searchForm">
                                        ...
                                        <div class="form-group nsw-text-center">
                                            ...
                                            <a href="javascript:;" class="btn green" id="btnAddNew1" data-bind="click : btnAddNew12Click"><i class="fa fa-edit"></i> Thêm mới Tá dược</a>
                                            <a href="javascript:;" class="btn green" id="btnAddNew2" data-bind="click : btnAddNew34Click"><i class="fa fa-edit"></i> Thêm mới Vỏ nang/Bao bì/Chất chuẩn</a>
                                        </div>
                                    </form>
                                </div>
                            </div>
