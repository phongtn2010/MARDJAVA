...
<fieldset>
    ...
    <div class="form-group">
        <div class="col-md-12">
            ...
            <div class="col-md-4">
                <select class="form-control select2" disabled name="fiMaQgCc" data-bind="optionsCaption: 'Chọn...', optionsValue : 'id', selectedText : fiTenQgCc, value : fiMaQgCc, options : ltsNuocSanXuat, optionsText : 'name'"></select>
            </div>                
        </div>  
    </div>
    <div class="form-group">
