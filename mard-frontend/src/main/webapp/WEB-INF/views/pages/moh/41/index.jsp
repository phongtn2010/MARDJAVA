...
<div class="row" id="mt-container">
        ...
        <div class="portlet light ">
            <div class="portlet-title">
                <div class="caption font-dark">
                    ...
                    <span class="caption-subject bold uppercase"><span class="caption-subject bold uppercase"> <spring:message code="moh.41.tenthutuc" /></span>
                </div>
            </div>
                                ...
                                <div class="panel-body">
                                    <form role="form" class="form-horizontal" name="searchForm">
                                        ...
                                        <div class="form-group nsw-text-center">
                                            ...
                                            <a href="javascript:;" class="btn green" id="btnAddNew1" data-bind="click : btnAddNew12Click"><i class="fa fa-edit"></i> Thêm mới Dược chất, bán thành phẩm thuốc</a>
                                            <a href="javascript:;" class="btn green" id="btnAddNew2" data-bind="click : btnAddNew34Click"><i class="fa fa-edit"></i> Thêm mới Dược liệu, bán thành phẩm dược liệu</a>
                                        </div>
                                    </form>
                                </div>
                            </div>
                ...
                <table class="table table-striped table-bordered table-hover table-checkable order-column" id="monre06Items">
                    <thead>
                        <tr class="nsw-tr tr-nsw1-bgcolor">
                            ...
                            <th class="text-center" style="width: 25px;"> <spring:message code="mt.danhsach.xinrut" /> </th>
                            <th class="text-center" style="width: 25px;"> <spring:message code="mt.danhsach.sua" /> </th>
                            <th class="text-center" style="width: 25px;"> <spring:message code="mt.danhsach.xoa" /> </th>
                        </tr>
                    </thead>
    ...
    <script src="<c:url value='/app/moh/39/model.js?v=${version}'/>" type="text/javascript"></script>
    <script src="<c:url value='/app/moh/39/index.js?v=${version}' />" type="text/javascript"></script>
