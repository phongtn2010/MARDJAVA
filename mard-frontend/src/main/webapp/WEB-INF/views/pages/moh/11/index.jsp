...
<div class="row" id="mt-container">
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <span class="caption-subject bold uppercase"><i class="fa fa-gift"></i> <spring:message code="moh.11.tracuu.timkiem" /> </span>
                                </div>
                                <div class="panel-body">
                                    <form role="form" class="form-horizontal" name="searchForm">
                                        <div class="form-group" style="margin-top: 15px;">
                                            <div class="col-md-12">
                                                <div class="col-md-2 nsw-text-right">
                                                    <label><spring:message code="moh.11.tracuu.mahoso" /></label>
                                                </div>
                                                <div class="col-md-4">
                                                    <input class="form-control" name="maHoSo" id="maHoSo" placeholder="<spring:message code="moh.11.tracuu.mahoso" />" data-bind="value : maHoSo, executeOnEnter : searchFieldEnter, valueUpdate: 'input'" placeholder="<spring:message code="common.tracuu.ma_ho_so" />" type="text"/>
                                                </div>
                                                <div class="col-md-2 nsw-text-right">
                                                    <label><spring:message code="moh.11.tracuu.trangthaihoso" /></label>
                                                </div>
                                                <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                <div class="col-md-2 nsw-text-right">
                                                    <label><spring:message code="moh.11.tracuu.ngaytaotu" /></label>
                                                </div>
                                                <div class="col-md-4">   
                                                ...
                                                <div class="col-md-2 nsw-text-right">
                                                    <label><spring:message code="moh.11.tracuu.ngaytaoden" /></label>
                                                </div>
                                                <div class="col-md-4">
                                                    <input name="ngayTaoDenNgay" id="ngayTaoDenNgay" placeholder="<spring:message code="moh.11.tracuu.ngaytaoden" />" 
                                        ...
                                        <div class="form-group"> 
                                            <div class="col-md-12">
                                                <div class="col-md-2 nsw-text-right">
                                                    <label><spring:message code="moh.11.tracuu.sovanbancuadn" /></label>
                                                </div>
                                                <div class="col-md-4">
                                                    <input class="form-control" name="soVanBanDN" id="soVanBan" data-bind="value : soVanBanDN, executeOnEnter : searchFieldEnter, valueUpdate: 'input'" placeholder="Số văn bản" type="text">
                                                </div>
                                            </div>
                                        </div>
                ...
                <table class="table table-striped table-bordered table-hover table-checkable order-column" id="monre06Items">
                    <thead>
                        <tr class="nsw-tr tr-nsw1-bgcolor">
                            <th class="text-center"> <spring:message code="moh.11.danhsach.stt" /></th>
                            <th class="text-center" style="width: 100px;"> <spring:message code="moh.11.danhsach.lichsutacdong" /> </th>
                            <th class="text-center" style="width: 120px;"> <spring:message code="moh.11.danhsach.mahoso" /> </th>
                            <th class="text-center" style="max-width: 200px;"> <spring:message code="moh.11.danhsach.sovanbandn" /> </th>
                            <th class="text-center"> <spring:message code="moh.11.danhsach.trangthai" /> </th>
                            <th class="text-center" style="width: 100px;"> <spring:message code="moh.11.danhsach.ngaytao" /> </th>
                            <th class="text-center" style="width: 25px;"> <spring:message code="moh.11.danhsach.sua" /> </th>
                            <th class="text-center" style="width: 25px;"> <spring:message code="moh.11.danhsach.xoa" /> </th>
                            <th class="text-center" style="width: 25px;"> <spring:message code="moh.11.danhsach.gui" /> </th>
                            <th class="text-center" style="width: 25px;"> <spring:message code="moh.07.danhsach.xinrut" /> </th>
                            <th class="text-center" style="width: 100px;"> <spring:message code="moh.11.danhsach.ketqua" /> </th>
    ...
    <script src="<c:url value='/app/moh/11/model.js?v=${version}'/>" type="text/javascript"></script>
    <script src="<c:url value='/app/moh/11/index.js?v=${version}' />" type="text/javascript"></script>
