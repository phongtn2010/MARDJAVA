            ...
            <table class="table table-striped table-bordered table-hover table-checkable order-column">
                <thead>
                    <tr class="nsw-tr tr-nsw1-bgcolor">
                        ...
                        <th class="text-center"><spring:message code="moh.10.tepdinhkem.loaitep" /></th>                        
                        <th class="text-center" style="width: 150px"><spring:message code="moh.10.tepdinhkem.tailen" /></th>
                        <th class="text-center" style="width: 150px"><spring:message code="moh.10.tepdinhkem.chucnang" /></th>
                    </tr>
                </thead>
