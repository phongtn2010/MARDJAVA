...
<div class="row" id="mt-container">
                                    ...
                                    <form role="form" class="form-horizontal" name="searchForm">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                ...
                                                <div class="col-md-4">
                                                    <input name="ngayTaoDenNgay" id="ngayTaoDenNgay" data-bind="datepicker : ngayTaoDenNgay" 
    ...
    <script type="text/javascript" charset="UTF-8">
        ...
        NSWLang["moh_19_tenthutuc"] = "<spring:message code="moh.19.tenthutuc" />";
    ...
    <script src="<c:url value='/app/moh/19/model.js?v=${version}'/>" type="text/javascript"></script>
    <script src="<c:url value='/app/moh/19/index.js?v=${version}' />" type="text/javascript"></script>
