...
<fieldset>
    ...
    <div class="form-group" data-bind="visible: visibleFiSoGpNkNn">
        <div class="col-md-12">
            ...
            <div class="col-md-4">
                <input class="form-control" id="fiSoGpNkNn" name="fiSoGpNkNn" type="text" data-bind="value: fiSoGpNkNn" maxlength="250"/>
            </div> 
            <div class="col-md-2 nsw-text-right">
                <label><spring:message code="moh.19.donhang.ngaycap" /><a class="nsw-require-field">*</a></label>
            </div>
            <div class="col-md-4">
                <input class="form-control form-control-inline date-picker" id="fiNgayGpNkNn" name="fiNgayGpNkNn" type="text" data-bind="datepicker : fiNgayGpNkNn"  data-date-format="dd/mm/yyyy" maxlength="10"/>
            </div>
        </div>  
    </div>
    <div class="form-group" data-bind="visible: visibleFiSoGpNkNn">
        <div class="col-md-12">
            ...
            <div class="col-md-4">
                <input class="form-control" id="fiNoicapGpNn" name="fiNoicapGpNn" type="text" data-bind="value: fiNoicapGpNn" maxlength="250"/>
            </div> 
            <div class="col-md-2 nsw-text-right">
                <label><spring:message code="moh.19.donhang.ngayhethieuluc" /><a class="nsw-require-field">*</a></label>
            </div>
            <div class="col-md-4">
                <input class="form-control form-control-inline date-picker" id="fiHieulucGpNn" name="fiHieulucGpNn" type="text" data-bind="datepicker : fiHieulucGpNn"  data-date-format="dd/mm/yyyy" maxlength="10"/>
            </div>
        </div>  
    </div>
    <div class="form-group">
