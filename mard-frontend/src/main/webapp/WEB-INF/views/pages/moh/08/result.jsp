        ...
        <div class="portlet light ">
            <div class="portlet-title">
                <div class="caption font-dark">
                    <span class="caption-subject bold uppercase">GIẤY CHỨNG NHẬN LƯU HÀNH TỰ DO</span>
                </div>
            </div>
                                                            ...
                                                            <table class="table table-striped table-bordered table-hover table-checkable order-column">
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <td style="width: 20%">
                                                                            <a data-bind="attr: {href: fiDuongDan}, text: fiTenTep"></a>
                                                                        </td>  
                                                                        <td style="width: 30%">Link download file</td>  
                                                                        <td style="width: 20%">
                                                                            <a data-bind="attr: {href: fiDuongDan}"></a>
                                                                        </td>  
                                                                    </tr>
                                                                </tbody>
                                                            </table>
