...
<div class="row" id="mt-container">
        ...
        <div class="portlet light ">
            <div class="portlet-title">
                <div class="caption font-dark">
                    ...
                    <span class="caption-subject bold uppercase"><span class="caption-subject bold uppercase"> <spring:message code="moh.10.tenthutuc" /></span>
                </div>
            </div>
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <span class="caption-subject bold uppercase"><i class="fa fa-gift"></i> <spring:message code="moh.10.tracuu.timkiem" /> </span>
                                </div>
                                <div class="panel-body">
                                    <form role="form" class="form-horizontal" name="searchForm">
                                        <div class="form-group" style="margin-top: 15px;">
                                            <div class="col-md-12">
                                                <div class="col-md-2 nsw-text-right">
                                                    <label><spring:message code="moh.10.tracuu.mahoso" /></label>
                                                </div>
                                                <div class="col-md-4">
                                                    <input class="form-control" name="maHoSo" id="maHoSo" placeholder="<spring:message code="moh.10.tracuu.mahoso" />" data-bind="value : maHoSo, executeOnEnter : searchFieldEnter, valueUpdate: 'input'" placeholder="<spring:message code="common.tracuu.ma_ho_so" />" type="text"/>
                                                </div>
                                                <div class="col-md-2 nsw-text-right">
                                                    <label><spring:message code="moh.10.tracuu.trangthaihoso" /></label>
                                                </div>
                                                <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                <div class="col-md-2 nsw-text-right">
                                                    <label><spring:message code="moh.10.tracuu.ngaytaotu" /></label>
                                                </div>
                                                <div class="col-md-4">   
                                                    <input name="ngayTaoTuNgay" id="ngayTaoTuNgay" placeholder="<spring:message code="moh.10.tracuu.ngaytaotu" />" data-bind="datepicker : ngayTaoTuNgay" class="form-control form-control-inline date-picker" data-date-format="dd/mm/yyyy"  type="text" value="" maxlength="10" />
                                                </div>

                                                <div class="col-md-2 nsw-text-right">
                                                    <label><spring:message code="moh.10.tracuu.ngaytaoden" /></label>
                                                </div>
                                                <div class="col-md-4">
                                                    <input name="ngayTaoDenNgay" id="ngayTaoDenNgay" placeholder="<spring:message code="moh.10.tracuu.ngaytaoden" />" data-bind="datepicker : ngayTaoDenNgay" class="form-control form-control-inline date-picker" data-date-format="dd/mm/yyyy" size="16" type="text" value="" maxlength="10" />
                                                </div>
                                            </div>  
                                        </div>
                                        ...
                                        <div class="form-group"> 
                                            <div class="col-md-12">
                                                <div class="col-md-2 nsw-text-right">
                                                    <label><spring:message code="moh.10.tracuu.sovanbancuadn" /></label>
                                                </div>
                                                <div class="col-md-4">
                ...
                <table class="table table-striped table-bordered table-hover table-checkable order-column" id="monre06Items">
                    <thead>
                        <tr class="nsw-tr tr-nsw1-bgcolor">
                            <th class="text-center"> <spring:message code="moh.10.danhsach.stt" /></th>
                            <th class="text-center" style="width: 100px;"> <spring:message code="moh.10.danhsach.lichsutacdong" /> </th>
                            <th class="text-center" style="width: 120px;"> <spring:message code="moh.10.danhsach.mahoso" /> </th>
                            <th class="text-center" style="max-width: 200px;"> <spring:message code="moh.10.danhsach.sovanbandn" /> </th>
                            <th class="text-center"> <spring:message code="moh.10.danhsach.trangthai" /> </th>
                            <th class="text-center" style="width: 100px;"> <spring:message code="moh.10.danhsach.ngaytao" /> </th>
                            <th class="text-center" style="width: 25px;"> <spring:message code="moh.10.danhsach.sua" /> </th>
                            <th class="text-center" style="width: 25px;"> <spring:message code="moh.10.danhsach.xoa" /> </th>
                            <th class="text-center" style="width: 25px;"> <spring:message code="moh.10.danhsach.gui" /> </th>
                            <th class="text-center" style="width: 25px;"> <spring:message code="moh.07.danhsach.xinrut" /> </th>
                            <th class="text-center" style="width: 100px;"> <spring:message code="moh.10.danhsach.ketqua" /> </th>
    ...
    <script src="<c:url value='/app/moh/10/model.js?v=${version}'/>" type="text/javascript"></script>
    <script src="<c:url value='/app/moh/10/index.js?v=${version}' />" type="text/javascript"></script>
