...
<fieldset>
    ...
    <div class="form-group" data-bind="visible: isSecondGroup">
        <div class="col-md-12">
            <div class="col-md-2 nsw-text-right">
                <label>Tên dược liệu<a class="nsw-require-field">*</a></label>
            </div>
            <div class="col-md-4">                                        
    ...
    <div class="form-group">
        <div class="col-md-12">
            ...
            <div class="col-md-4">
                <input class="form-control" id="fiHanDung" name="fiHanDung" type="text" data-bind="value: fiHanDung" maxlength="250"/>
            </div>
            <div class="col-md-2 nsw-text-right">
