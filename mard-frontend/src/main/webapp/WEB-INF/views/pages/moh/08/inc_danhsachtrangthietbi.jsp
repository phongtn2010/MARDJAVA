            ...
            <form role="form" class="form-horizontal" id="trangthietbi-form">
                ...
                <div class="form-group" data-bind="visible: isShowSoDKLH">
                    <div class="col-md-12">
                        ...
                        <div class="col-md-4">
                            <input class="form-control" type="checkbox" id="fiDaCoDklh" name="fiDaCoDklh" data-bind="value : fiDaCoDklh" />
                        </div> 
                        <div class="col-md-2 nsw-text-right">
                ...
                <b data-bind="visible: !isShowSoDKLH"><spring:message code="moh.07.cosobaohanh" /></b> 
                <div class="form-group" data-bind="visible: !isShowSoDKLH">
                    <div class="col-md-12">
