...
<div class="form-group">
    <div class="col-md-12">
        <div class="col-md-2 nsw-text-right">
            <label><spring:message code="moh.10.xacnhannopphi.hinhthuc" /><a class="nsw-require-field">*</a></label>
        </div>
        <div class="col-md-4">
        ...
        <div class="col-md-2 nsw-text-right">
            <label><spring:message code="moh.10.xacnhannopphi.chungtu" /></label>
        </div>
        <div class="col-md-4">
...
<div class="form-group">
    <div class="col-md-12">
        <div class="col-md-2 nsw-text-right">
            <label><spring:message code="moh.10.xacnhannopphi.nguoinop" /><a class="nsw-require-field">*</a></label>
        </div>
        <div class="col-md-4">
            <input class="form-control" type="text" id="fiNguoiNop" name="fiNguoiNop" data-bind="value : fiNguoiNop" maxlength="255" />
        </div> 
        <div class="col-md-2 nsw-text-right">
            <label><spring:message code="moh.10.xacnhannopphi.dienthoai" /><a class="nsw-require-field">*</a></label>
        </div>
        <div class="col-md-4">
...
<div class="form-group">
    <div class="col-md-12">
        <div class="col-md-2 nsw-text-right">
            <label><spring:message code="moh.10.xacnhannopphi.ngaynop" /><a class="nsw-require-field">*</a></label>
        </div>
        <div class="col-md-4">
        ...
        <div class="col-md-2 nsw-text-right">
            <label><spring:message code="moh.10.xacnhannopphi.sohoadon" /><a class="nsw-require-field">*</a></label>
        </div>
        <div class="col-md-4">
...
<div class="form-group">
    <div class="col-md-12">
        <div class="col-md-2 nsw-text-right">
            <label><spring:message code="moh.10.xacnhannopphi.tongtien" /><a class="nsw-require-field">*</a></label>
        </div>
        <div class="col-md-4">
            <input class="form-control" type="text" id="fiTongTien" name="fiTongTien" data-bind="value : fiTongTien" maxlength="255" />
        </div> 
        <div class="col-md-2 nsw-text-right">
            <label><spring:message code="moh.10.xacnhannopphi.ghichu" /></label>
        </div>
        <div class="col-md-4">
        ...
        <table class="table table-striped table-bordered table-hover table-checkable order-column">
            <thead>
                <tr class="nsw-tr tr-nsw1-bgcolor">
                    <th class="text-center" style="width: 50px"><spring:message code="moh.10.xacnhannopphi.stt" /></th>
                    <th class="text-center"><spring:message code="moh.10.xacnhannopphi.loaiphi" /></th>
                    <th class="text-center"><spring:message code="moh.10.xacnhannopphi.nguoinop" /></th>
                    <th class="text-center" style="width: 100px"><spring:message code="moh.10.xacnhannopphi.sdt" /></th>
                    <th class="text-center" style="width: 200px"><spring:message code="moh.10.xacnhannopphi.ngaynop" /></th>
                    <th class="text-center"><spring:message code="moh.10.xacnhannopphi.sohoadon" /></th>
                    <th class="text-center"><spring:message code="moh.10.xacnhannopphi.tongtien" /></th>
                    <th class="text-center" style="width: 80px"><spring:message code="moh.10.xacnhannopphi.taitep" /></th>
                    <th class="text-center" style="width: 80px"><spring:message code="moh.10.xacnhannopphi.xoa" /></th>
                </tr>
            </thead>
