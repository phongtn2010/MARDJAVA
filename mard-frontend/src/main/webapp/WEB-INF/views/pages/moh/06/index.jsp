                ...
                <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                    <thead>
                        <tr class="nsw-tr tr-nsw1-bgcolor">
                            ...
                            <th class="text-center"> <spring:message code="common.table.col.so_van_ban_doanh_nghiep" /> </th>
                            ...
                            <th class="text-center"> <spring:message code="common.table.col.sua" /> </th>
                            <th class="text-center"> <spring:message code="common.table.col.xoa" /> </th>
                            <th class="text-center"> <spring:message code="moh.typea.table.col.gui" /> </th>
                            <th class="text-center"> <spring:message code="moh.typea.table.col.phieu_tiep_nhan" /> </th>
                        </tr>
                    </thead>
