...
<html>
    <head>
        ...
        <link rel="shortcut icon" href="<c:url value='/static/images/favicon.ico' />" type="image/vnd.microsoft.icon" />
        ...
        <link href="<c:url value='/static/assets/global/plugins/bootstrap/css/bootstrap.css'/>" rel="stylesheet" type="text/css" />
        ...
        <!-- TREE PLUGIN -->
        <link href="<c:url value='/static/assets/global/plugins/jstree/dist/themes/default/style.min.css' />" rel="stylesheet" type="text/css" />

        <!-- BUTTON PLUGIN -->
        <link href="<c:url value='/static/assets/global/plugins/ladda/ladda-themeless.min.css' />" rel="stylesheet" type="text/css" />

        <!-- DATETIME PLUGINS -->
        <link href="<c:url value='/static/assets/global/plugins/bootstrap-daterangepicker/daterangepicker.min.css' />" rel="stylesheet" type="text/css" />
        <link href="<c:url value='/static/assets/global/plugins/bootstrap-datepicker/css/bootstrap-datepicker3.min.css' />" rel="stylesheet" type="text/css" />
        <link href="<c:url value='/static/assets/global/plugins/bootstrap-timepicker/css/bootstrap-timepicker.min.css' />" rel="stylesheet" type="text/css" />
        <link href="<c:url value='/static/assets/global/plugins/bootstrap-datetimepicker/css/bootstrap-datetimepicker.min.css' />" rel="stylesheet" type="text/css" />
        ...
        <link href="<c:url value='/static/assets/global/plugins/select2/css/select2.min.css' />" rel="stylesheet" type="text/css" />
        <link href="<c:url value='/static/assets/global/plugins/select2/css/select2-bootstrap.min.css' />" rel="stylesheet" type="text/css" />

        <link href="<c:url value='/static/assets/global/plugins/bootstrap-modal/css/bootstrap-modal-bs3patch.css' />" rel="stylesheet" type="text/css" />
        <link href="<c:url value='/static/assets/global/plugins/bootstrap-modal/css/bootstrap-modal.css' />" rel="stylesheet" type="text/css" />
        <link href="<c:url value='/static/assets/global/plugins/bootstrap-toastr/toastr.min.css' />" rel="stylesheet" type="text/css" />

        <!-- BEGIN THEME GLOBAL STYLES -->
        <link href="<c:url value='/static/assets/global/css/components.css' />" rel="stylesheet" id="style_components" type="text/css" />
        ...
        <link href="<c:url value='/static/assets/layouts/layout3/css/themes/default.css' />" rel="stylesheet" type="text/css" id="style_color" />
        ...
        <script src="<c:url value='/static/assets/global/plugins/bootstrap-switch/js/bootstrap-switch.min.js' />" type="text/javascript"></script>
        <!-- END CORE PLUGINS -->

        <!-- PLUGINS -->        
        <script src="<c:url value='/static/assets/global/plugins/bootstrap-datepicker/js/bootstrap-datepicker.min.js' />" type="text/javascript"></script>        
        <script src="<c:url value='/static/assets/global/plugins/bootstrap-datetimepicker/js/bootstrap-datetimepicker.min.js' />" type="text/javascript"></script>        
        <script src="<c:url value='/static/assets/global/plugins/select2/js/select2.full.min.js' />" type="text/javascript"></script>
        <script src="<c:url value='/static/assets/global/plugins/bootstrap-modal/js/bootstrap-modalmanager.js' />" type="text/javascript"></script>
        <script src="<c:url value='/static/assets/global/plugins/bootstrap-modal/js/bootstrap-modal.js' />" type="text/javascript"></script>
        <script src="<c:url value='/static/assets/global/plugins/bootstrap-toastr/toastr.min.js' />" type="text/javascript"></script>
        ...
        <script src="<c:url value='/static/lib/xss.min.js' />" type="text/javascript"></script>
        <script type="text/javascript">
            var context = '${pageContext.request.contextPath}';
        </script>
        <script src="<c:url value='/app/RTVNSignClient.js?v=${version}' />" type="text/javascript"></script>
        <script src="<c:url value='/app/language.js?v=${version}' />" type="text/javascript"></script>
        ...
        <script src="<c:url value='/app/knockout.binding2.js?v=${version}' />" type="text/javascript"></script>
    </head>
    ...
    <body class="page-container-bg-solid">
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                try {
                    app.requireSigning = ${sign};
                } catch (ex) {
                    app.requireSigning = false;
                }
            });
        </script>
        <c:if test="${loggedinuser != null}">
            <script type="text/javascript">
                ...
                function connect() {
                    var socket = new SockJS('http://10.224.164.16:8008/SocketServer/connect');
                    ...
                    window.stompClient.connect({}, function (frame) {
                        window.stompClient.subscribe('/topic/showSignResult/' + user, function (calResult) {
                        });
                    });
                }
                ...
                function sendMessageToSign(xml, msgType, msgFun, docCode, minCode, docId, docType, data) {
                    stompClient.send("/signMessage/sign", {}, JSON.stringify({'taxCode': user,
                        'fiXml': xml,
                        'fiMsgType': msgType,
                        'fiFunc': msgFun,
                        'fiDocumentCode': docCode,
                        'ministryCode': minCode,
                        'fiDocumentId': docId,
                        'fiDocumentType': docType,
                        'fiData': data}));
                    app.Alert(NSWLang["common_msg_cho_ky_so"]);
                }
            </script>
        </c:if>              
