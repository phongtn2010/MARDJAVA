...
function Tbdhoso10(STT, item) {
    ...
    self.bSua = ko.dependentObservable(function () {
        return [TAO_MOI,YEU_CAU_BO_SUNG,CHO_TIEP_NHAN,CHO_TIEP_NHAN_BO_SUNG,DONG_Y_YCCS].indexOf(self.fiTrangthai()) >= 0;
    }, self);
    self.bXinSua = ko.dependentObservable(function () {
        return [CHO_TIEP_NHAN_BO_SUNG,THONG_BAO_XU_LY_LO_HANG,QUYET_DINH_XU_LY_VSTY, DA_TIEP_NHAN,DA_XAC_NHAN_DON_KHAI_BAO_KD,DA_GUI_THONG_BAO_AP_PHI,DA_NOP_PHI_CK,DA_YC_NOP_BS_PHI].indexOf(self.fiTrangthai()) >= 0;
    }, self);
    ...
    self.bXinHuy = ko.dependentObservable(function () {
        return [YEU_CAU_BO_SUNG, CHO_TIEP_NHAN_BO_SUNG, THONG_BAO_XU_LY_LO_HANG,QUYET_DINH_XU_LY_VSTY, DONG_Y_YCCS, CHO_TIEP_NHAN_YCCS,DA_TIEP_NHAN,DA_XAC_NHAN_DON_KHAI_BAO_KD,DA_GUI_THONG_BAO_AP_PHI,DA_NOP_PHI_CK,DA_YC_NOP_BS_PHI].indexOf(self.fiTrangthai()) >= 0 ;
    }, self);
