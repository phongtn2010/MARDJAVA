function Mard07EditVM() {
    ...
    editVMSelf.applyState = function (options) {
        ...
        editVMSelf.kdnkVM().applyState(options);
    };
...
function init(options) {
    var mard07EditVM = new Mard07EditVM();
    ko.applyBindings(mard07EditVM, document.getElementById('mard07Edit'));
    mard07EditVM.applyState(options);
}
