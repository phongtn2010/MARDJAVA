...
function IndexVM(params) {
    ...
    self.search = function (page, pushState) {
        if (!RAW_HS_STATUS || RAW_HS_STATUS.length <= 0) {
            app.getCategory('/moit/01/danhmuc', 'HS_TRANGTHAI', null, function (res) {
                if (res.success) {
    ...
    self.btnAddNewClick = function (e) {
        document.location = app.appContext + '/moit/01/edit';
        return false;
    };
    ...
    self.bXemClick = function (item, e) {
        document.location = app.appContext + '/moit/01/view?fiIdHoso=' + item.fiIdHoso();
        return false;
    };
    /**
     * Xem Thông báo
    ...
    self.bXemThongBaoClick = function (item, e) {
        document.location = app.appContext + '/moit/01/view?fiIdHoso=' + item.fiIdHoso() + '&fiMaHoso=' + item.fiMaHoso() + '&tab=cert';
        return false;
    };
    /**
     * Xem Lich su
    ...
    self.bSuaClick = function (item, e) {
        document.location = app.appContext + '/moit/01/edit?fiIdHoso=' + item.fiIdHoso();
        return false;
    };
    ...
    self.bXinSuaClick = function (item, e) {
        document.location = app.appContext + '/moit/01/edit?fiIdHoso=' + item.fiIdHoso() + '&requestedit=true';
        return false;
    };
    /**
     * Hủy hồ sơ (xóa)
            ...
            buttons: [
                {
                    ...
                    action: function () {
                        app.makePost({
                            url: '/moit/01/hoso/xoa/' + item.fiIdHoso(),
                            data: JSON.stringify({}),
                            success: function (d) {
                                var msg = '';
                                if (d.success) {
...
$(document).ready(function () {
    var d = {};
    $('#loading10').show();
    $.when(app.getCategory('/moit/01/danhmuc', 'DM_TRANGTHAI', null, function (res) {
        if (res.success) {
