function HistoryView() {
	...
	self.show = function(item) {
		var url =  '/moit/api/07/layDsLichSuHS/' + item.maHoSo() + '/1';
                ...
                if (d.success) {
                    ...
                    var history = {
	           		...
	           		$('#' +'lich-su-pagination').pagination({
	                    ...
	                    edges: 2,
	                    displayedPages: 5,
	                    prevText: NSWLang['moit.07.trang-truoc'],
	                    nextText: NSWLang['moit.07.trang-sau'],
	                    onPageClick: function (pageNumber, event) {
	                		var url = '/moit/api/07/layDsLichSuHS/' + item.maHoSo() + '/' +pageNumber;
	                    	 app.bindData({
	                             ministryCode: 'moit',
	                             code: '06',
