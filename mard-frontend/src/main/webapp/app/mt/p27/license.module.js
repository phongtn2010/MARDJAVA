...
$(document).ready(function () {
    ...
    function ViewModel() {
        ...
        self.xemLichSu = function (item) {
            var url = '/mt/27/history/giayphep/' + item.fiSoGiayphep()+'/1';
                    ...
                    if (d.success) {
                        ...
                        $('#' + 'lich-su-pagination').pagination({
                            ...
                            onPageClick: function (pageNumber, event) {
                                var url = '/mt/27/history/giayphep/' + item.fiSoGiayphep() + '/' + pageNumber;
                                app.bindData({
                                    ministryCode: 'mt',
                                    code: 'p27',
...
//        ======
        ...
        self.dong = function () {
        	if(type==1){
        		location.href = app.appContext + '/mt/27/home/'+  procedureId;
        	}else{
