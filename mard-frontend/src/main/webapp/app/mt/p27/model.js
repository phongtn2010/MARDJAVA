...
var Tbdhoso = function () {
    ...
    this.fiCoquancapphep = ko.observable().extend({required: {message: 'Cơ quan cấp phép không được trống!'}});
...
var Tbdgiayphep = function () {
    ...
    this.objectTypeDate = ['fiNgaydangky', 'fiCappheptungay' , 'fiNgayhethan', 'fiNgaycapphep', 'fiNgaycaphethan', 'fiNgayky',
        'fiNgaygiahan'];
}
