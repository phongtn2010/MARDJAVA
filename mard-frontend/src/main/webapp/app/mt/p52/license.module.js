...
$(document).ready(function () {
    ...
    function ViewModel() {
        ...
        self.xemLichSu = function (item) {
            var url = '/mt/52/history/giayphep/' + item.fiSoGiayPhep()+'/1';
                    ...
                    if (d.success) {
                        ...
                        $('#' + 'lich-su-pagination').pagination({
                            ...
                            onPageClick: function (pageNumber, event) {
                                var url = '/mt/52/history/giayphep/' + item.fiSoGiayPhep() + '/' + pageNumber;
                                app.bindData({
                                    ministryCode: 'mt',
                                    code: 'p52',
...
//      =====
        ...
        self.getGiayPhep = function (id) {
            ...
            app.makePost({
                ...
                data: JSON.stringify({
                    URL_BACKEND: "/mt/52/giayphep/license_detail/" + id,
                    URL_GET_TOTAL:"/mt/52/giayphep/license_detail/getTotal/" + id ,
                    METHOD: "POST",
