    ...
    self.makeRequest = function (cb) {
        ...
        app.makePost({
            ...
            data: JSON.stringify({
                ...
                fiSoVb: item.resultVM().fiPermitNumber()
            }),
            success: function (d) {
                var msg = '';
                if (d.success) {
...
function ViewVM(options) {
    ...
    self.btnXinSuaCVClick = function () {
        ...
        self.yeuCauVM = new YeuCauVM('Bạn chắc chắn muốn gửi yêu cầu xin sửa Công văn:  ', self, '/mt/58/hoso/yc-suavanban');
    ...
    self.btnTraLaiCVClick = function () {
        ...
        self.yeuCauVM = new YeuCauVM('Bạn chắc chắn muốn gửi yêu cầu xin trả lại Công văn:  ', self, '/mt/58/hoso/yc-tralaivanban');
...
$(document).ready(function () {
    ...
    var init = function () {
        if (options && options.fiIdHoso > 0) {
            ...
            var url_result = '/mt/58/hoso/vanban';
            app.makePost({
                url: url,
                data: JSON.stringify({}),
                success: function (d) {
