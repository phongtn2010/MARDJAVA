...
function XeVM(op) {
    ...
    var xeVG = [self.fiBksXe, self.fiSoGhe, self.fiDncpDenNg, self.fiDncpTuNg, self.fiMaNhanhieu, self.fiMaTuyen, self.fiHinhthuc, self.fiDiemDung];
...
function FormVM(options) {
    ...
    self.fiSoGpDkkd = ko.observable(null).extend({
        maxLength: {message: 'Tối đa 255 ký tự', params: 255}
    });
    self.fiCqCapDkkd = ko.observable(null).extend({
        maxLength: {message: 'Tối đa 255 ký tự', params: 255}
    });
    self.fiNgcapDkkd = ko.observable(null);
    self.fiSoGpvt = ko.observable(null).extend({
        maxLength: {message: 'Tối đa 255 ký tự', params: 255}
    });
    self.fiNgcapGpvt = ko.observable(null);
    self.fiCqCapGpvt = ko.observable(null).extend({
        maxLength: {message: 'Tối đa 255 ký tự', params: 255}
    });
    ...
    self.init = function (hoso) {
        ...
        if (hoso !== null) {
            ...
            self.fiSoGpDkkd(hoso.hasOwnProperty('fiSoGpDkkd') ? hoso.fiSoGpDkkd : null);
            self.fiNgcapDkkd(hoso.hasOwnProperty('fiNgcapDkkd') && hoso.fiNgcapDkkd != null ? new Date(hoso.fiNgcapDkkd) : null);
            self.fiCqCapDkkd(hoso.hasOwnProperty('fiCqCapDkkd') ? hoso.fiCqCapDkkd : null);
            self.fiSoGpvt(hoso.hasOwnProperty('fiSoGpvt') ? hoso.fiSoGpvt : null);
            self.fiNgcapGpvt(hoso.hasOwnProperty('fiNgcapGpvt') && hoso.fiNgcapGpvt != null ? new Date(hoso.fiNgcapGpvt) : null);
            self.fiCqCapGpvt(hoso.hasOwnProperty('fiCqCapGpvt') ? hoso.fiCqCapGpvt : null);
            ...
            self.fiNgaytao(hoso.hasOwnProperty('fiNgaytao') && hoso.fiNgaytao != null ? new Date(hoso.fiNgaytao) : new Date());
            ...
            self.lstXe(mapTbdhsXe37(hoso.hasOwnProperty('lstXe') ? hoso.lstXe : []));
    ...
    self.isValidForm = function () {
        ...
        if (self.lstXe() && self.lstXe().length > 0) {
            for (var i = 0; i < self.lstXe().length; i++) {
                var xe = self.lstXe()[i];
                if (!xe.fiBksXe() || !xe.fiHinhthuc() || !xe.fiSoGhe() || !xe.fiSoGhe() || !xe.fiDncpTuNg() || !xe.fiDncpDenNg() || !xe.fiMaTuyen()) {
                    errorXe = false;
                    break;
                }
            }
...
//        $("#fiHinhthuc-" + xeInfo.fiStt()).select2({placeholder: '-- Chọn --', width: '100%', allowClear: true});
    ...
    self.updateXeInfo = function (item) {
        ...
        var cb = function () {
                        ...
                        action: function () {
                            if (self.xeVM.isValid()) {
                                ...
                                if (null == xeInfo.fiIdXe) {
                                    ...
                                    var xeModel = new TbdhsXe37(xeInfo);
            ...
            if (item != null) {
                ...
                $("#fiHinhthuc-New").val(item.fiHinhthuc()).select2({placeholder: '-- Chọn --', width: '100%', allowClear: true});
            } else {
    ...
    self.toJSON = function () {
        var mapping = {
            'ignore': ["removeCarOnClick", "addCarOnClick", "isValidForm", "init",
                ...
                "toJSON", "lstHinhThuc", "__ko_mapping__", 'fiDiaDiem', 'fiChucDanh', 'fiTenNgKy',
