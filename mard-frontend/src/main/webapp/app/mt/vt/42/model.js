...
var mapTbdlichsu42 = function (dataFromServer,p) {
    return ko.utils.arrayMap(dataFromServer, function (item, index) {
        return new Tbdlichsu42(index + 1+p, item);
    });
};
var Tbdlichsu42 = function (STT, item) {
    var self = this;
...
var mapTbdhoso42 = function (d, p) {
    return ko.utils.arrayMap(d, function (item, index) {
        return new Tbdhoso42((index + 1) + p, item);
    });
};
function Tbdhoso42(STT, item) {
    var self = this;
...
var mapTbdhsXe42 = function (d) {
    return ko.utils.arrayMap(d, function (item, index) {
        item.fiStt = index + 1;
        return new TbdhsXe42(item);
    });
};

var mapTbdgiayphep42 = function (d) {
    return ko.utils.arrayMap(d, function (item, index) {
        return new Tbdgiayphep42(index + 1, item);
    });
};
var Tbdgiayphep42 = function (STT, item) {
    var self = this;
    this.STT = ko.observable(STT);
    if (item) {
        ko.mapping.fromJS(item, {}, self);
...
var mapTbdgpLichsu42 = function (dataFromServer) {
    return ko.utils.arrayMap(dataFromServer, function (item, index) {
        return new Tbdgplichsu42(index + 1, item);
    });
};
var Tbdgplichsu42 = function (STT, item) {
    var self = this;
    this.STT = ko.observable(STT);
    if (item != null) {
        ko.mapping.fromJS(item, {}, self);
