    ...
    function ViewModel() {
                ...
                success: function (d) {
                    ...
                    if (d.success) {
                        ...
                        for (const file of d.data.Tbddinhkem) {
                            ...
                            if (file.fiSothutu == 5 && self.hoSoChiTiet.Tbdhoso.fiLoaihoso() == 'BGTVT0600018') {
        ...
        self.uploadFileChangeEvent = function (thutu, eleId, elemet, event) {
            ...
            for (var i = 0, file; file = files[i]; i++) {
                ...
                } else if (thutu == 5 && self.hoSoChiTiet.Tbdhoso.fiLoaihoso() == 'BGTVT0600018') {
        ...
        self.xoaMotFile = function (item) {
            if (item.fiSothutu() === 1) {
                ...
                resetInput($("#GCN_001"));
            } else if (item.fiSothutu() === 5 && self.hoSoChiTiet.Tbdhoso.fiLoaihoso() == 'BGTVT0600018') {
        ...
        self.xoaTepTin = function (loaiTep) {
            if (loaiTep === '1') {
                ...
                resetInput($("#GCN_001"));
            } else if (loaiTep === '5' && self.hoSoChiTiet.Tbdhoso.fiLoaihoso() == 'BGTVT0600018') {
