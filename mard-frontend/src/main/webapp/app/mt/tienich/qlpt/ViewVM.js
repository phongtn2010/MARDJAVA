    ...
    self.makeRequest = function (cb) {
        ...
        app.makePost({
            ...
            data: JSON.stringify({
                ...
                fiSoVb: item.resultVM().fiSoVanban()
            }),
            success: function (d) {
                var msg = '';
                if (d.success) {
...
function ViewVM(options) {
    ...
    self.btnXinSuaCVClick = function () {
        ...
        self.yeuCauVM = new YeuCauVM('Bạn chắc chắn muốn gửi yêu cầu xin sửa Công văn:  ', self, '/mt/13/hoso/yc-suavanban');
    ...
    self.btnTraLaiCVClick = function () {
        ...
        self.yeuCauVM = new YeuCauVM('Bạn chắc chắn muốn gửi yêu cầu xin sửa Công văn:  ', self, '/mt/13/hoso/yc-tralaivanban');
...
$(document).ready(function () {
    ...
    $.when(
            app.getCategory('/mt/13/danhmuc', 'HS_DONVIXULY', null, function (res) {
                if (res.success) {
    ...
    var init = function () {
        if (options && options.fiIdHoso > 0) {
            ...
            var url_result = '/mt/13/hoso/vanban';
            app.makePost({
                url: url,
                data: JSON.stringify({}),
                success: function (d) {
