...
$(document).ready(function () {
    ...
    function ViewModel() {
        ...
        self.xemLichSu = function (item) {
            var url = '/mt/05/history/giayphep/' + item.fiSoGiayphep()+'/1';
                    ...
                    if (d.success) {
                        ...
                        $('#' + 'lich-su-pagination').pagination({
                            ...
                            onPageClick: function (pageNumber, event) {
                                var url = '/mt/05/history/giayphep/' + item.fiSoGiayphep() + '/' + pageNumber;
                                app.bindData({
                                    ministryCode: 'mt',
                                    code: 'p05',
        ...
        self.getGiayPhep = function (id) {
          ...
          self.page.currentPage(self.pagingVM.currentPage());
            app.makePost({
                ...
                data: JSON.stringify({
                    URL_BACKEND: "/mt/05/giayphep/license_detail/" + id,
                    URL_GET_TOTAL:"/mt/05/giayphep/license_detail/getTotal/" + id ,
                    METHOD: "POST",
...
//        ======
        ...
        self.dong = function () {
        	if(type==1){
        		location.href = app.appContext + '/mt/05/home/'+  procedureId;
        	}else{
