...
function ViewModel() {
	...
	self.xemGiayXacNhanClick = function(item) {
		...
		var loaiThuTucHienTai = parseInt($('#loaiThuTucHienTai').val());
		var show = (loaiThuTucHienTai == 3 || loaiThuTucHienTai == 4) ? true: false;
		app.makePost({
                              ...
                              app.makePost({
					            ...
					            success: function (d) {
					                ...
					                app.toast({
					                    ...
					                    message: NSWLang["monre_xinrut_success"],
					                    function: fun
					                });
					              
					            },
					            error: function (e) {
					                toastr.error(NSWLang["monre_xinrut_errer"], NSWLang["common_msg_thong_bao"]);
					                app.popupRemove(pop.selector);
