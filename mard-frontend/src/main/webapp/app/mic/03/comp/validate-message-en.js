...
(function(factory) {
	...
	return kv.defineLocale('en', {
		...
		notEqual: 'Choose a different default value.',
		unique: 'Please make sure the value is unique.',
        greaterThan: 'Input value must be greater {0}.',
        greaterThanOrEqual: 'Input value must be greater than or equal to {0}.',
        dateVI: 'Incorrect date / month / year (dd / mm / yyyy) format or year starting from 1900-2999 or the incorrect import date.'
	});
}));
