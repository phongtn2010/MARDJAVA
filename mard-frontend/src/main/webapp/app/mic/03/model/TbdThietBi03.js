function TbdThietBi03() {
	...
	this.fiSoBan = ko.observable(null).extend({required : true, maxLength : 255});

	this.fiSoLuongDia = ko.observable(null).extend({required : true, maxLength : 255});

	this.fiSoLuongBang = ko.observable(null).extend({required : true, maxLength : 255});

	this.fiSoLuongCatset = ko.observable(null).extend({required : true, maxLength : 255});
