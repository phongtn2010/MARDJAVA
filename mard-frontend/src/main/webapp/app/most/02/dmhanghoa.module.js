...
DMHangHoaController.prototype = {
    ...
    registerEvents: function () {
        ...
        $("#btnFileDMHangHoaThemMoi").on('click', function (e) {
            ...
            fileInfo.fiTenLoai = NSWLang["most_02_filetypename_dmhanghoa"];

            if (Util.validateFieExtensionByDom('dmhanghoa-ip')) {
    ...
    bindGrid: function () {
        var self = this;
        if (self.list != null && self.list.length > 0) {
            $('#btnFileDMHangHoaThemMoi').parents('tfoot').hide();
        } else {
            $('#btnFileDMHangHoaThemMoi').parents('tfoot').show();
        }
    ...
    clearForm: function () {
        ...
        document.getElementById("dmhanghoa-ip").value = "";
    },
    isVaild: function () {
