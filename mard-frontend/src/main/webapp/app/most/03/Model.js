...
function Tbddinhkem3(STT, item) {
    ...
    self.fiNgayguiMauText = ko.observable(item.fiNgayguiMau ? new Date(item.fiNgayguiMau).toDayFirstString() : null);
    self.fiNgaynhanKqText = ko.observable(item.fiNgaynhanKq ? new Date(item.fiNgaynhanKq).toDayFirstString() : null);
