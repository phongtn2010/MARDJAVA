...
function IndexVM(params) {
    ...
    self.btnAddNewClick = function (e) {
        document.location = app.appContext + '/bca/02/edit?maThuTuc=BCA0100002';
        return false;
    };
    ...
    self.bXemClick = function (item, e) {
        document.location = app.appContext + '/bca/02/view?fiIdHoso=' + item.fiIdHoso() + '&maThuTuc=BCA0100002';
        return false;
    };
    /**
     * Xin sua ho so
    ...
    self.bXinSuaClick = function (item, e) {
        document.location = app.appContext + '/bca/02/edit?fiIdHoso=' + item.fiIdHoso() + '&requestedit=true&maThuTuc=BCA0100002';
        return false;
    };
    /**
     * Xem Thông báo
    ...
    self.bSuaClick = function (item, e) {
        document.location = app.appContext + '/bca/02/edit?fiIdHoso=' + item.fiIdHoso() + '&maThuTuc=BCA0100002';
        return false;
    };
    /**
     * Hủy hồ sơ (xóa)
