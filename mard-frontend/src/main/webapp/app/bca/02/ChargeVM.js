...
function ChargeVM(option) {
    ...
    self.fiSotien = ko.observable(null).extend({
        ...
        pattern: {
            message: 'Không nhập trước dấu chấm quá 12 chữ số, sau dấu phẩy quá 3 chữ số , số âm và chữ', 
            params: /^([0-9]{1,12}(\.[1-9]{1,3})?)$/}
    });
