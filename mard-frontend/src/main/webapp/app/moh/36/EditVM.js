...
function EditVM(options) {
    ...
    self.btnLuuClick = function () {
        ...
        var url = !fiIdHoso || fiIdHoso <= 0 ? '/moh/36/hoso/taomoi' : '/moh/36/hoso/capnhap';
...
$(document).ready(function () {
    ...
    $.when(
            app.getCategory('/moh/36/danhmuc', 'DANHMUC_DONVITINH', null, function (res) {
                if (res.success) {
            ...
            app.getCategory('/moh/36/danhmuc', 'DANHMUC_TINHTHANH', null, function (res) {
                if (res.success) {
            ...
            app.getCategory('/moh/36/danhmuc', 'DANHMUC_CUAKHAU_NHAPKHAU', null, function (res) {
                if (res.success) {
            ...
            app.getCategory('/moh/36/danhmuc', 'DANHMUC_NUOCSANXUAT', null, function (res) {
                if (res.success) {
            ...
            app.getCategory('/moh/36/danhmuc', 'DANHMUC_LOAIDONHANG', null, function (res) {
                if (res.success) {
            ...
            app.getCategory('/moh/36/danhmuc', 'DANHMUC_LOAIFILE', null, function (res) {
                if (res.success) {
            ...
            app.getCategory('/moh/36/danhmuc', 'DANHMUC_NGUYENLIEU', null, function (res) {
                if (res.success) {
            ...
            app.getCategory('/moh/36/danhmuc', 'DANHMUC_MUCDICHNHAPKHAU', null, function (res) {
                if (res.success) {
    ...
    var init = function () {
        if (options && options.fiIdHoso > 0) {
            var url = '/moh/36/hoso/t/' + options.fiIdHoso;
            app.makePost({
                url: url,
                data: JSON.stringify({}),
                success: function (d) {
                    if (d.success) {
                        ...
                        $("#fiMaQgSh").select2({placeholder: '-- Chọn --', width: '100%', allowClear: true});
                        $("#fiMaQgXk").select2({placeholder: '-- Chọn --', width: '100%', allowClear: true});
