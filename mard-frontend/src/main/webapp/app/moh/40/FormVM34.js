...
function FormVM(options) {
    ...
    var hosoVG = [self.fiTenDn, self.fiChucvuNgDd, self.fiMstDn,
        self.fiDiachiDn, self.fiMaTinh, self.fiNguoiDd,
        self.fiLoaiDon, self.fiTenHang, self.fiTccl,
        self.fiSoLuong, self.fiMaDvtinh, self.fiTenCoSoSx, self.fiMaQgSx, self.fiMaQgCc,
        self.fiMucDichNk, self.fiBoPhanDung, self.lstCuaKhaus];
