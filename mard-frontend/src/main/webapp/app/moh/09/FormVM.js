...
function FormVM(data) {
    ...
    self.init = function (hoso) {
        ...
        self.fiNgayNkTu(hoso.hasOwnProperty('fiNgayNkTu') ? new Date(hoso.fiNgayNkTu) : null);
        self.fiNgayNkDen(hoso.hasOwnProperty('fiNgayNkDen') ? new Date(hoso.fiNgayNkDen) : null);
        ...
        self.fiNgayKtTu(hoso.hasOwnProperty('fiNgayKtTu') ? new Date(hoso.fiNgayKtTu) : null);
